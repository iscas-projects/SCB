...
(assert (and true (and (>= 1 0) (>= (str.len var90) 1))))
(define-const var688 String (substring/850833817 var90 1)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int)>(1) 
(define-const var1391 Int (Int_parseLong/758265864 var688 36)) ; Statement: l0 = staticinvoke <java.lang.Long: long parseLong(java.lang.String,int)>($r3, 36) 
(define-const var2722 Int (maxSegmentName/421352666 var3423)) ; Statement: $l1 = r4.<org.apache.lucene.index.CheckIndex$Status: long maxSegmentName> 
(define-const var3050 Int (ite (> var1391 var2722) 1 (ite (< var1391 var2722) (- 1) 0))) ; Statement: $b2 = l0 cmp $l1 
(define-const var1986 Int (cast-from-Int-to-Int var3050)) ; Statement: $i3 = (int) $b2 
