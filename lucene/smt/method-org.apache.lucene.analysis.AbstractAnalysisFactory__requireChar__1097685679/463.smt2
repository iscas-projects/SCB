...
(assert (and true (and (> (str.len var3231) 0) (<= 0 0))))
(define-const var1298 Int (charAt/698050440 var3231 0)) ; Statement: $c0 = virtualinvoke $r3.<java.lang.String: char charAt(int)>(0) 
 ; Statement: return $c0 
(check-sat)
(get-model)
(get-unsat-core)
