...
(assert (and true (and (> (str.len var3129) var1060) (<= 0 var1060))))
(define-const var3001 Int (charAt/698050440 var3129 var1060)) ; Statement: $c4 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i2) 
(define-const var2141 Int (cast-from-Int-to-Int var3001)) ; Statement: $i5 = (int) $c4 
 ; Statement: return $i5 
(check-sat)
(get-model)
(get-unsat-core)
