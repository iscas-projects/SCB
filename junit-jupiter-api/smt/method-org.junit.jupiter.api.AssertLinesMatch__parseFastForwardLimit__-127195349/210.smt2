...
(assert (and true (and (>= 2 0) (>= (str.len var10) var2191) (>= var2191 2))))
(define-const var1353 String (substring/-1240304868 var10 2 var2191)) ; Statement: $r0 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int,int)>(2, $i1) 
(assert true)
(define-const var391 String (trim/-847153721 var1353)) ; Statement: r1 = virtualinvoke $r0.<java.lang.String: java.lang.String trim()>() 
(assert true) ; Handling Exception: java.lang.Throwable 
(declare-const var533 var3371) ; Statement: $r3 := @caughtexception 
(assert (not (= var533 null-var3371)))
