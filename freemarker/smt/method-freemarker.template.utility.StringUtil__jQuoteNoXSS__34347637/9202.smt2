...
(assert (and true (and (> (str.len var952) var97) (<= 0 var97))))
(define-const var559 Int (charAt/698050440 var952 var97)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i7) 
(define-const var3827 Int (cast-from-Int-to-Int var559)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 != 34 goto $i9 = (int) c2 
(assert (not (= var3827 34))) ; Cond: $i8 != 34 
(define-const var2611 Int (cast-from-Int-to-Int var559)) ; Statement: $i9 = (int) c2 
 ; Statement: if $i9 != 92 goto $i10 = (int) c2 
(assert (not (= var2611 92))) ; Cond: $i9 != 92 
(define-const var1501 Int (cast-from-Int-to-Int var559)) ; Statement: $i10 = (int) c2 
 ; Statement: if $i10 != 60 goto $i11 = (int) c2 
(assert (not (= var1501 60))) ; Cond: $i10 != 60 
(define-const var1572 Int (cast-from-Int-to-Int var559)) ; Statement: $i11 = (int) c2 
 ; Statement: if $i11 >= 32 goto virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c2) 
(assert (not (>= var1572 32))) ; Negate: Cond: $i11 >= 32  
(define-const var3601 Int (cast-from-Int-to-Int var559)) ; Statement: $i12 = (int) c2 
 ; Statement: if $i12 != 10 goto $i13 = (int) c2 
(assert (not (= var3601 10))) ; Cond: $i12 != 10 
(define-const var2499 Int (cast-from-Int-to-Int var559)) ; Statement: $i13 = (int) c2 
 ; Statement: if $i13 != 13 goto $i14 = (int) c2 
(assert (not (not (= var2499 13)))) ; Negate: Cond: $i13 != 13  
(assert true)
;(assert (append/672562846 var2069!2 "\u005cr")) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\\r") 
(declare-const var2069!3 String)
(assert (= var2069!3 (str.++ var2069!2 "\u005cr")))
 ; Statement: goto [?= i7 = i7 + 1] 
(assert true) ; Non Conditional
(define-const var97!1 Int (+ var97 1)) ; Statement: i7 = i7 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i0 goto virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(assert (>= var97!1 var10)) ; Cond: i7 >= i0 
(assert true)
;(assert (append/-1166366385 var2069!3 34)) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(declare-const var2069!4 String)
(assert (str.prefixof var2069!3 var2069!4))
(assert true)
(define-const var42 String (toString/-2075883882 var2069!4)) ; Statement: $r2 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
