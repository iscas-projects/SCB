...
(assert (and true (and (> (str.len var490) var194!1) (<= 0 var194!1))))
(define-const var3151!1 Int (charAt/698050440 var490 var194!1)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i7) 
(define-const var3093!1 Int (cast-from-Int-to-Int var3151!1)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 != 34 goto $i9 = (int) c2 
(assert (not (not (= var3093!1 34)))) ; Negate: Cond: $i8 != 34  
(assert true)
;(assert (append/672562846 var130!3 "\u005c\u0022")) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\\\"") 
(declare-const var130!4 String)
(assert (= var130!4 (str.++ var130!3 "\u005c\u0022")))
 ; Statement: goto [?= i7 = i7 + 1] 
(assert true) ; Non Conditional
(define-const var194!2 Int (+ var194!1 1)) ; Statement: i7 = i7 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i0 goto virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(assert (>= var194!2 var2959)) ; Cond: i7 >= i0 
(assert true)
;(assert (append/-1166366385 var130!4 34)) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(declare-const var130!5 String)
(assert (str.prefixof var130!4 var130!5))
(assert true)
(define-const var2770 String (toString/-2075883882 var130!5)) ; Statement: $r2 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
