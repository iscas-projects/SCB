...
(assert (and true (and (> (str.len var1419) var269) (<= 0 var269))))
(define-const var2663 Int (charAt/698050440 var1419 var269)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i7) 
(define-const var1872 Int (cast-from-Int-to-Int var2663)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 != 34 goto $i9 = (int) c2 
(assert (not (not (= var1872 34)))) ; Negate: Cond: $i8 != 34  
(assert true)
;(assert (append/672562846 var2516!2 "\u005c\u0022")) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\\\"") 
(declare-const var2516!3 String)
(assert (= var2516!3 (str.++ var2516!2 "\u005c\u0022")))
 ; Statement: goto [?= i7 = i7 + 1] 
(assert true) ; Non Conditional
(define-const var269!1 Int (+ var269 1)) ; Statement: i7 = i7 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i0 goto virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(assert (not (>= var269!1 var2766))) ; Negate: Cond: i7 >= i0  
(assert (and true (and (> (str.len var1419) var269!1) (<= 0 var269!1))))
(define-const var2663!1 Int (charAt/698050440 var1419 var269!1)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i7) 
(define-const var1872!1 Int (cast-from-Int-to-Int var2663!1)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 != 34 goto $i9 = (int) c2 
(assert (not (not (= var1872!1 34)))) ; Negate: Cond: $i8 != 34  
(assert true)
;(assert (append/672562846 var2516!3 "\u005c\u0022")) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\\\"") 
(declare-const var2516!4 String)
(assert (= var2516!4 (str.++ var2516!3 "\u005c\u0022")))
 ; Statement: goto [?= i7 = i7 + 1] 
(assert true) ; Non Conditional
(define-const var269!2 Int (+ var269!1 1)) ; Statement: i7 = i7 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i0 goto virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(assert (>= var269!2 var2766)) ; Cond: i7 >= i0 
(assert true)
;(assert (append/-1166366385 var2516!4 34)) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(34) 
(declare-const var2516!5 String)
(assert (str.prefixof var2516!4 var2516!5))
(assert true)
(define-const var2078 String (toString/-2075883882 var2516!5)) ; Statement: $r2 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
