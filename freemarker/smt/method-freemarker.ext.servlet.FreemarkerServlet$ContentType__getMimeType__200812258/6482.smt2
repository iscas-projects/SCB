...
(assert (and true (and (>= 0 0) (>= (str.len var147) var1218) (>= var1218 0))))
(define-const var2750 String (substring/-1240304868 var147 0 var1218)) ; Statement: $r4 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert true) ; Non Conditional
(assert true)
(define-const var1403 String (trim/-847153721 var2750)) ; Statement: $r3 = virtualinvoke $r4.<java.lang.String: java.lang.String trim()>() 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
