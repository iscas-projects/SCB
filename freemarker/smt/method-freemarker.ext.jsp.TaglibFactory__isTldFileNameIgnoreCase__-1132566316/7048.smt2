...
(assert (and true (and (>= var154 0) (>= (str.len var2494) var154))))
(define-const var1718 String (substring/850833817 var2494 var154)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true)
(define-const var1807 String (toLowerCase/415700667 var1718)) ; Statement: r2 = virtualinvoke $r1.<java.lang.String: java.lang.String toLowerCase()>() 
(assert true)
(define-const var1954 Bool (equalsIgnoreCase/-92311102 var1807 "tld")) ; Statement: $z0 = virtualinvoke r2.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>("tld") 
 ; Statement: return $z0 
(check-sat)
(get-model)
(get-unsat-core)
