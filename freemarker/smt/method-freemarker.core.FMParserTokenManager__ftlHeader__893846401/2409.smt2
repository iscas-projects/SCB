...
(assert (and true (and (> (str.len var517) 0) (<= 0 0))))
(define-const var1129 Int (charAt/698050440 var517 0)) ; Statement: $c1 = virtualinvoke $r3.<java.lang.String: char charAt(int)>(0) 
(assert true)
(define-const var204 Int (length/-134980193 var517)) ; Statement: $i2 = virtualinvoke $r3.<java.lang.String: int length()>() 
(define-const var3916 Int (- var204 1)) ; Statement: $i3 = $i2 - 1 
(assert (and true (and (> (str.len var517) var3916) (<= 0 var3916))))
(define-const var3222 Int (charAt/698050440 var517 var3916)) ; Statement: $c4 = virtualinvoke $r3.<java.lang.String: char charAt(int)>($i3) 
(define-const var3344 Int (cast-from-Int-to-Int var1129)) ; Statement: $i7 = (int) $c1 
 ; Statement: if $i7 != 91 goto $i8 = (int) $c1 
(assert (not (= var3344 91))) ; Cond: $i7 != 91 
(define-const var1073 Int (cast-from-Int-to-Int var1129)) ; Statement: $i8 = (int) $c1 
 ; Statement: if $i8 != 60 goto $i5 = r1.<freemarker.core.Token: int kind> 
(assert (not (= var1073 60))) ; Cond: $i8 != 60 
(define-const var1824 Int (kind/-1758362606 var911)) ; Statement: $i5 = r1.<freemarker.core.Token: int kind> 
 ; Statement: if $i5 == 80 goto return 
(assert (= var1824 80)) ; Cond: $i5 == 80 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
