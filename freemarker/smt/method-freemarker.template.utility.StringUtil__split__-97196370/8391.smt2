...
(assert (and true (and (>= var1114 0) (>= (str.len var3915) var1192) (>= var1192 var1114))))
(define-const var2076 String (substring/-1240304868 var3915 var1114 var1192)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i7, i8) 
(declare-const var2148!1 (Array Int String))
(assert (not (= var2148!1 null-__Array__Int__String__)))
(assert (= (select var2148!1 var3521) var2076)) ; Statement: r1[$i3] = $r2 
(define-const var1114!1 Int (+ var1192 1)) ; Statement: i7 = i8 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i7 > i0 goto return r1 
(assert (> var1114!1 var3075)) ; Cond: i7 > i0 
 ; Statement: return r1 
(check-sat)
(get-model)
(get-unsat-core)
