...
(assert (and true (and (>= 0 0) (>= (str.len var648) var3375) (>= var3375 0))))
(define-const var2032 String (substring/-1240304868 var648 0 var3375)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i2) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
