...
(assert (and true (and (>= var2377 0) (>= (str.len var292) var3927) (>= var3927 var2377))))
(define-const var3314 String (substring/-1240304868 var292 var2377 var3927)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i1, $i0) 
(declare-const var2323!2 var1495)
(assert (not (= var2323!2 null-var1495)))
(assert (= (matchedInputPart/1550028859 var2323!2) var3314)) ; Statement: r0.<freemarker.core.BuiltInsForStringsRegexp$RegexMatchModel$MatchWithGroups: java.lang.String matchedInputPart> = $r3 
(assert true)
(define-const var1281 Int (groupCount/-1794770617 var1156)) ; Statement: $i2 = virtualinvoke r2.<java.util.regex.Matcher: int groupCount()>() 
(define-const var2030 Int (+ var1281 1)) ; Statement: i3 = $i2 + 1 
(define-const var1978 var1285 var1285-init) ; Statement: $r4 = new freemarker.template.SimpleSequence 
(define-const var3468 var3890 var19-SAFE_OBJECT_WRAPPER) ; Statement: $r5 = <freemarker.template._ObjectWrappers: freemarker.template.SimpleObjectWrapper SAFE_OBJECT_WRAPPER> 
(assert true)
;(assert (<init>/-120806475 var1978 var2030 (cast-from-var3890-to-var1613 var3468))) ; Statement: specialinvoke $r4.<freemarker.template.SimpleSequence: void <init>(int,freemarker.template.ObjectWrapper)>(i3, $r5) 

(declare-const var1978!1 var1285)
(declare-const var2030!1 Int)
(declare-const var3468!1 var3890)
(declare-const var2323!3 var1495)
(assert (not (= var2323!3 null-var1495)))
(assert (= (groupsSeq/1550028859 var2323!3) var1978!1)) ; Statement: r0.<freemarker.core.BuiltInsForStringsRegexp$RegexMatchModel$MatchWithGroups: freemarker.template.SimpleSequence groupsSeq> = $r4 
(define-const var2292 Int 0) ; Statement: i4 = 0 
(assert true) ; Non Conditional
 ; Statement: if i4 >= i3 goto return 
(assert (>= var2292 var2030!1)) ; Cond: i4 >= i3 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
