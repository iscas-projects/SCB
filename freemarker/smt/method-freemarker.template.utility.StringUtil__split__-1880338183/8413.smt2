...
(assert (and true (and (> (str.len var158) var1558) (<= 0 var1558))))
(define-const var167 Int (charAt/698050440 var158 var1558)) ; Statement: $c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i4) 
(define-const var27 String (String_valueOf/-371898945 var167)) ; Statement: $r4 = staticinvoke <java.lang.String: java.lang.String valueOf(char)>($c2) 
(declare-const var1114!1 (Array Int String))
(assert (not (= var1114!1 null-__Array__Int__String__)))
(assert (= (select var1114!1 var1558) var27)) ; Statement: r6[i4] = $r4 
(define-const var1558!1 Int (+ var1558 1)) ; Statement: i4 = i4 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i4 >= $i3 goto return r6 
(assert (>= var1558!1 var1356)) ; Cond: i4 >= $i3 
 ; Statement: return r6 
(check-sat)
(get-model)
(get-unsat-core)
