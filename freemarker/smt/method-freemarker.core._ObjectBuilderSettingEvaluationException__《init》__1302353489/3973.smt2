...
(assert (and true (and (> (str.len var572) var3294) (<= 0 var3294))))
(define-const var1828 Int (charAt/698050440 var572 var3294)) ; Statement: $c2 = virtualinvoke r5.<java.lang.String: char charAt(int)>(i0) 
(assert true)
(define-const var3178 String (append/-1166366385 var772 var1828)) ; Statement: $r12 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>($c2) 
(declare-const var772!1 String)
(assert (str.prefixof var772 var772!1))
(assert true)
(define-const var1837 String (toString/-2075883882 var3178)) ; Statement: $r13 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var3553 String (var3023_jQuote/1315253176 var1837)) ; Statement: $r14 = staticinvoke <freemarker.template.utility.StringUtil: java.lang.String jQuote(java.lang.String)>($r13) 
(assert true)
(define-const var3634 String (append/672562846 var331 var3553)) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r14) 
(declare-const var331!1 String)
(assert (= var331!1 (str.++ var331 var3553)))
(assert true)
(define-const var209 String (append/672562846 var3634 " at position ")) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" at position ") 
(declare-const var3634!1 String)
(assert (= var3634!1 (str.++ var3634 " at position ")))
(define-const var603 Int (+ var3294 1)) ; Statement: $i3 = i0 + 1 
(assert true)
(define-const var1562 String (append/-1001720160 var209 var603)) ; Statement: $r18 = virtualinvoke $r17.<java.lang.StringBuilder: java.lang.StringBuilder append(int)>($i3) 
(declare-const var209!1 String)
(assert (str.prefixof var209 var209!1))
(assert true)
(define-const var2472 String (append/672562846 var1562 ".")) ; Statement: $r19 = virtualinvoke $r18.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(".") 
(declare-const var1562!1 String)
(assert (= var1562!1 (str.++ var1562 ".")))
(assert true)
(define-const var1662 String (toString/-2075883882 var2472)) ; Statement: $r20 = virtualinvoke $r19.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: goto [?= $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r20)] 
(assert true) ; Non Conditional
(assert true)
(define-const var2127 String (append/672562846 var204 var1662)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r20) 
(declare-const var204!1 String)
(assert (= var204!1 (str.++ var204 var1662)))
(assert true)
(define-const var2531 String (toString/-2075883882 var2127)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/-8765015 (cast-from-var1536-to-var3513 var301) var2531)) ; Statement: specialinvoke r0.<java.lang.Exception: void <init>(java.lang.String)>($r8) 

(declare-const var301!1 var1536)
