...
(assert (and true (and (> (str.len var2762) 0) (<= 0 0))))
(define-const var376 Int (charAt/698050440 var2762 0)) ; Statement: $c0 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(0) 
 ; Statement: return $c0 
(check-sat)
(get-model)
(get-unsat-core)
