...
(assert (and true (and (> (str.len var2371) 0) (<= 0 0))))
(define-const var605 Int (charAt/698050440 var2371 0)) ; Statement: c0 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(0) 
(define-const var748 Bool (autodetectTagSyntax/929889025 var1135)) ; Statement: $z0 = r2.<freemarker.core.FMParserTokenManager: boolean autodetectTagSyntax> 
 ; Statement: if $z0 == 0 goto $z4 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
(assert (= (ite var748 1 0) 0)) ; Cond: $z0 == 0 
(define-const var3724 Bool (squBracTagSyntax/929889025 var1135)) ; Statement: $z4 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
 ; Statement: if $z4 == 0 goto $z1 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
(assert (= (ite var3724 1 0) 0)) ; Cond: $z4 == 0 
(define-const var3345 Bool (squBracTagSyntax/929889025 var1135)) ; Statement: $z1 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
 ; Statement: if $z1 != 0 goto r2.<freemarker.core.FMParserTokenManager: boolean tagSyntaxEstablished> = 1 
(assert (not (= (ite var3345 1 0) 0))) ; Cond: $z1 != 0 
(declare-const var1135!1 var2454)
(assert (not (= var1135!1 null-var2454)))
(assert (= (tagSyntaxEstablished/929889025 var1135!1) (ite (= 1 1) true false))) ; Statement: r2.<freemarker.core.FMParserTokenManager: boolean tagSyntaxEstablished> = 1 
(assert true)
;(assert (SwitchTo/-1839513100 var1135!1 6)) ; Statement: virtualinvoke r2.<freemarker.core.FMParserTokenManager: void SwitchTo(int)>(6) 

(declare-const var1135!2 var2454)
