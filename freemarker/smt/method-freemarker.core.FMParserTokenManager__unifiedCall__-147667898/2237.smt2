...
(assert (and true (and (> (str.len var3307) 0) (<= 0 0))))
(define-const var3228 Int (charAt/698050440 var3307 0)) ; Statement: c0 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(0) 
(define-const var2807 Bool (autodetectTagSyntax/929889025 var1145)) ; Statement: $z0 = r2.<freemarker.core.FMParserTokenManager: boolean autodetectTagSyntax> 
...
(define-const var449 Bool (squBracTagSyntax/929889025 var1145)) ; Statement: $z4 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
 ; Statement: if $z4 == 0 goto $z1 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
(assert (not (= (ite var449 1 0) 0))) ; Negate: Cond: $z4 == 0  
(define-const var3323 Int (cast-from-Int-to-Int var3228)) ; Statement: $i2 = (int) c0 
 ; Statement: if $i2 != 60 goto $z1 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
(assert (not (not (= var3323 60)))) ; Negate: Cond: $i2 != 60  
(declare-const var2479!1 var458)
(assert (not (= var2479!1 null-var458)))
(assert (= (kind/-1758362606 var2479!1) 80)) ; Statement: r0.<freemarker.core.Token: int kind> = 80 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
