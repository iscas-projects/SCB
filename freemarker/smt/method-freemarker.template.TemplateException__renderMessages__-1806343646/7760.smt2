...
(assert (and true (and (>= 0 0) (>= (str.len var1366) var3540) (>= var3540 0))))
(define-const var323 String (substring/-1240304868 var1366 0 var3540)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
(declare-const var1013!3 var3187)
(assert (not (= var1013!3 null-var3187)))
(assert (= (messageWithoutStackTop/1424937385 var1013!3) var323)) ; Statement: r0.<freemarker.template.TemplateException: java.lang.String messageWithoutStackTop> = $r17 
