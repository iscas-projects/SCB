...
(assert (and true (and (> (str.len var711) var2141) (<= 0 var2141))))
(define-const var946 Int (charAt/698050440 var711 var2141)) ; Statement: $c3 = virtualinvoke r1.<java.lang.String: char charAt(int)>($i2) 
 ; Statement: return $c3 
(check-sat)
(get-model)
(get-unsat-core)
