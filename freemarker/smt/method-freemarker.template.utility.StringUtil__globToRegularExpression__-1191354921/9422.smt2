...
(assert (and true (and (> (str.len var3330!1) var568) (<= 0 var568))))
(define-const var510 Int (charAt/698050440 var3330!1 var568)) ; Statement: $c5 = virtualinvoke r1.<java.lang.String: char charAt(int)>($i4) 
(define-const var3515 Int (cast-from-Int-to-Int var510)) ; Statement: $i17 = (int) $c5 
 ; Statement: if $i17 != 42 goto virtualinvoke $r21.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("[^/]*") 
(assert (not (not (= var3515 42)))) ; Negate: Cond: $i17 != 42  
 ; Statement: if i13 == 0 goto $i6 = i13 + 2 
(assert (not (= var868!1 0))) ; Negate: Cond: i13 == 0  
(define-const var3911 Int (- var868!1 1)) ; Statement: $i10 = i13 - 1 
(assert (and true (and (> (str.len var3330!1) var3911) (<= 0 var3911))))
(define-const var101 Int (charAt/698050440 var3330!1 var3911)) ; Statement: $c11 = virtualinvoke r1.<java.lang.String: char charAt(int)>($i10) 
(define-const var232 Int (cast-from-Int-to-Int var101)) ; Statement: $i18 = (int) $c11 
 ; Statement: if $i18 == 47 goto $i6 = i13 + 2 
(assert (not (= var232 47))) ; Negate: Cond: $i18 == 47  
(define-const var1630 var1649 var1649-init) ; Statement: $r23 = new java.lang.IllegalArgumentException 
(define-const var1414 String String-init) ; Statement: $r22 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1414)) ; Statement: specialinvoke $r22.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1414!1 String)
(assert (= var1414!1 ""))
(assert true)
(define-const var3956 String (append/672562846 var1414!1 "The \u0022**\u0022 wildcard must be directly after a \u0022/\u0022 or it must be at the beginning, in this glob: ")) ; Statement: $r18 = virtualinvoke $r22.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("The \"**\" wildcard must be directly after a \"/\" or it must be at the beginning, in this glob: ") 
(declare-const var1414!2 String)
(assert (= var1414!2 (str.++ var1414!1 "The \u0022**\u0022 wildcard must be directly after a \u0022/\u0022 or it must be at the beginning, in this glob: ")))
(assert true)
(define-const var3537 String (append/672562846 var3956 var3330!1)) ; Statement: $r19 = virtualinvoke $r18.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var3956!1 String)
(assert (= var3956!1 (str.++ var3956 var3330!1)))
(assert true)
(define-const var1123 String (toString/-2075883882 var3537)) ; Statement: $r20 = virtualinvoke $r19.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var1630 var1123)) ; Statement: specialinvoke $r23.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r20) 

(declare-const var1630!1 var1649)
