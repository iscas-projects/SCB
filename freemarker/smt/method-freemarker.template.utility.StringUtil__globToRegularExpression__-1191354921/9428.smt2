...
(assert (and true (and (> (str.len var521) var3057) (<= 0 var3057))))
(define-const var3004 Int (charAt/698050440 var521 var3057)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (= (ite var3403 1 0) 0))) ; Cond: z1 != 0 
(define-const var3403!1 Bool (ite (= 1 0) true false)) ; Statement: z1 = 0 
(assert true) ; Non Conditional
(define-const var3057!1 Int (+ var3057 1)) ; Statement: i13 = i13 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i13 >= i0 goto $i1 = virtualinvoke r1.<java.lang.String: int length()>() 
(assert (not (>= var3057!1 var992))) ; Negate: Cond: i13 >= i0  
(assert (and true (and (> (str.len var521) var3057!1) (<= 0 var3057!1))))
(define-const var3004!1 Int (charAt/698050440 var521 var3057!1)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (not (= (ite var3403!1 1 0) 0)))) ; Negate: Cond: z1 != 0  
(define-const var803 Int (cast-from-Int-to-Int var3004!1)) ; Statement: $i15 = (int) c2 
 ; Statement: if $i15 != 63 goto $i16 = (int) c2 
(assert (not (= var803 63))) ; Cond: $i15 != 63 
(define-const var3085 Int (cast-from-Int-to-Int var3004!1)) ; Statement: $i16 = (int) c2 
 ; Statement: if $i16 != 42 goto $i20 = (int) c2 
(assert (not (= var3085 42))) ; Cond: $i16 != 42 
(define-const var1378 Int (cast-from-Int-to-Int var3004!1)) ; Statement: $i20 = (int) c2 
 ; Statement: if $i20 != 92 goto $i21 = (int) c2 
(assert (not (= var1378 92))) ; Cond: $i20 != 92 
(define-const var2298 Int (cast-from-Int-to-Int var3004!1)) ; Statement: $i21 = (int) c2 
 ; Statement: if $i21 == 91 goto $r27 = new java.lang.IllegalArgumentException 
(assert (= var2298 91)) ; Cond: $i21 == 91 
(define-const var164 var1804 var1804-init) ; Statement: $r27 = new java.lang.IllegalArgumentException 
(define-const var2187 String String-init) ; Statement: $r26 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2187)) ; Statement: specialinvoke $r26.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2187!1 String)
(assert (= var2187!1 ""))
(assert true)
(define-const var3199 String (append/672562846 var2187!1 "The \u0022")) ; Statement: $r6 = virtualinvoke $r26.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("The \"") 
(declare-const var2187!2 String)
(assert (= var2187!2 (str.++ var2187!1 "The \u0022")))
(assert true)
(define-const var2120 String (append/-1166366385 var3199 var3004!1)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c2) 
(declare-const var3199!1 String)
(assert (str.prefixof var3199 var3199!1))
(assert true)
(define-const var509 String (append/672562846 var2120 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\" glob operator is currently unsupported (precede it with \\ for literal matching), in this glob: ") 
(declare-const var2120!1 String)
(assert (= var2120!1 (str.++ var2120 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")))
(assert true)
(define-const var1055 String (append/672562846 var509 var521)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var509!1 String)
(assert (= var509!1 (str.++ var509 var521)))
(assert true)
(define-const var1199 String (toString/-2075883882 var1055)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var164 var1199)) ; Statement: specialinvoke $r27.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r10) 

(declare-const var164!1 var1804)
