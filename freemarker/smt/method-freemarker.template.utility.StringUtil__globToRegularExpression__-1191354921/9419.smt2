...
(assert (and true (and (> (str.len var741) var1810) (<= 0 var1810))))
(define-const var2781 Int (charAt/698050440 var741 var1810)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (= (ite var3792 1 0) 0))) ; Cond: z1 != 0 
(define-const var3792!1 Bool (ite (= 1 0) true false)) ; Statement: z1 = 0 
(assert true) ; Non Conditional
(define-const var1810!1 Int (+ var1810 1)) ; Statement: i13 = i13 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i13 >= i0 goto $i1 = virtualinvoke r1.<java.lang.String: int length()>() 
(assert (>= var1810!1 var1712)) ; Cond: i13 >= i0 
(assert true)
(define-const var1515 Int (length/-134980193 var741)) ; Statement: $i1 = virtualinvoke r1.<java.lang.String: int length()>() 
;(assert (var924_appendLiteralGlobSection/-427210499 var646!1 var741 var3921 var1515)) ; Statement: staticinvoke <freemarker.template.utility.StringUtil: void appendLiteralGlobSection(java.lang.StringBuilder,java.lang.String,int,int)>($r21, r1, i12, $i1) 

(declare-const var646!2 String)
(declare-const var741!1 String)
(declare-const var3921!1 Int)
(declare-const var1515!1 Int)
(assert true)
(define-const var3649 String (toString/-2075883882 var646!2)) ; Statement: $r2 = virtualinvoke $r21.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: if z0 == 0 goto $b14 = 0 
(assert (= (ite var2936 1 0) 0)) ; Cond: z0 == 0 
(define-const var1132 Int 0) ; Statement: $b14 = 0 
(assert true) ; Non Conditional
(define-const var2924 var1927 (var1927_compile/915022044 var3649 var1132)) ; Statement: $r3 = staticinvoke <java.util.regex.Pattern: java.util.regex.Pattern compile(java.lang.String,int)>($r2, $b14) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
