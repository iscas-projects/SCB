...
(assert (and true (and (> (str.len var2884) var2255) (<= 0 var2255))))
(define-const var3381 Int (charAt/698050440 var2884 var2255)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (not (= (ite var2055 1 0) 0)))) ; Negate: Cond: z1 != 0  
(define-const var3108 Int (cast-from-Int-to-Int var3381)) ; Statement: $i15 = (int) c2 
 ; Statement: if $i15 != 63 goto $i16 = (int) c2 
(assert (not (= var3108 63))) ; Cond: $i15 != 63 
(define-const var3268 Int (cast-from-Int-to-Int var3381)) ; Statement: $i16 = (int) c2 
 ; Statement: if $i16 != 42 goto $i20 = (int) c2 
(assert (not (= var3268 42))) ; Cond: $i16 != 42 
(define-const var734 Int (cast-from-Int-to-Int var3381)) ; Statement: $i20 = (int) c2 
 ; Statement: if $i20 != 92 goto $i21 = (int) c2 
(assert (not (= var734 92))) ; Cond: $i20 != 92 
(define-const var2545 Int (cast-from-Int-to-Int var3381)) ; Statement: $i21 = (int) c2 
 ; Statement: if $i21 == 91 goto $r27 = new java.lang.IllegalArgumentException 
(assert (not (= var2545 91))) ; Negate: Cond: $i21 == 91  
(define-const var3406 Int (cast-from-Int-to-Int var3381)) ; Statement: $i22 = (int) c2 
 ; Statement: if $i22 != 123 goto i13 = i13 + 1 
(assert (not (not (= var3406 123)))) ; Negate: Cond: $i22 != 123  
(define-const var297 var508 var508-init) ; Statement: $r27 = new java.lang.IllegalArgumentException 
(define-const var1683 String String-init) ; Statement: $r26 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1683)) ; Statement: specialinvoke $r26.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1683!1 String)
(assert (= var1683!1 ""))
(assert true)
(define-const var1541 String (append/672562846 var1683!1 "The \u0022")) ; Statement: $r6 = virtualinvoke $r26.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("The \"") 
(declare-const var1683!2 String)
(assert (= var1683!2 (str.++ var1683!1 "The \u0022")))
(assert true)
(define-const var1811 String (append/-1166366385 var1541 var3381)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c2) 
(declare-const var1541!1 String)
(assert (str.prefixof var1541 var1541!1))
(assert true)
(define-const var193 String (append/672562846 var1811 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\" glob operator is currently unsupported (precede it with \\ for literal matching), in this glob: ") 
(declare-const var1811!1 String)
(assert (= var1811!1 (str.++ var1811 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")))
(assert true)
(define-const var146 String (append/672562846 var193 var2884)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var193!1 String)
(assert (= var193!1 (str.++ var193 var2884)))
(assert true)
(define-const var3673 String (toString/-2075883882 var146)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var297 var3673)) ; Statement: specialinvoke $r27.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r10) 

(declare-const var297!1 var508)
