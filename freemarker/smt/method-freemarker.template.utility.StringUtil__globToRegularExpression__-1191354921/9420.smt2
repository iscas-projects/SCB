...
(assert (and true (and (> (str.len var3859) var1518) (<= 0 var1518))))
(define-const var3986 Int (charAt/698050440 var3859 var1518)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (not (= (ite var1545 1 0) 0)))) ; Negate: Cond: z1 != 0  
(define-const var1737 Int (cast-from-Int-to-Int var3986)) ; Statement: $i15 = (int) c2 
 ; Statement: if $i15 != 63 goto $i16 = (int) c2 
(assert (not (not (= var1737 63)))) ; Negate: Cond: $i15 != 63  
;(assert (var695_appendLiteralGlobSection/-427210499 var2953!1 var3859 var1540 var1518)) ; Statement: staticinvoke <freemarker.template.utility.StringUtil: void appendLiteralGlobSection(java.lang.StringBuilder,java.lang.String,int,int)>($r21, r1, i12, i13) 

(declare-const var2953!2 String)
(declare-const var3859!1 String)
(declare-const var1540!1 Int)
(declare-const var1518!1 Int)
(assert true)
;(assert (append/672562846 var2953!2 "[^/]")) ; Statement: virtualinvoke $r21.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("[^/]") 
(declare-const var2953!3 String)
(assert (= var2953!3 (str.++ var2953!2 "[^/]")))
(define-const var1540!2 Int (+ var1518!1 1)) ; Statement: i12 = i13 + 1 
 ; Statement: goto [?= i13 = i13 + 1] 
(assert true) ; Non Conditional
(define-const var1518!2 Int (+ var1518!1 1)) ; Statement: i13 = i13 + 1 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if i13 >= i0 goto $i1 = virtualinvoke r1.<java.lang.String: int length()>() 
(assert (>= var1518!2 var3576)) ; Cond: i13 >= i0 
(assert true)
(define-const var2004 Int (length/-134980193 var3859!1)) ; Statement: $i1 = virtualinvoke r1.<java.lang.String: int length()>() 
;(assert (var695_appendLiteralGlobSection/-427210499 var2953!3 var3859!1 var1540!2 var2004)) ; Statement: staticinvoke <freemarker.template.utility.StringUtil: void appendLiteralGlobSection(java.lang.StringBuilder,java.lang.String,int,int)>($r21, r1, i12, $i1) 

(declare-const var2953!4 String)
(declare-const var3859!2 String)
(declare-const var1540!3 Int)
(declare-const var2004!1 Int)
(assert true)
(define-const var750 String (toString/-2075883882 var2953!4)) ; Statement: $r2 = virtualinvoke $r21.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: if z0 == 0 goto $b14 = 0 
(assert (not (= (ite var2108 1 0) 0))) ; Negate: Cond: z0 == 0  
(define-const var3077 Int 66) ; Statement: $b14 = 66 
 ; Statement: goto [?= $r3 = staticinvoke <java.util.regex.Pattern: java.util.regex.Pattern compile(java.lang.String,int)>($r2, $b14)] 
(assert true) ; Non Conditional
(define-const var1123 var2149 (var2149_compile/915022044 var750 var3077)) ; Statement: $r3 = staticinvoke <java.util.regex.Pattern: java.util.regex.Pattern compile(java.lang.String,int)>($r2, $b14) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
