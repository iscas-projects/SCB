...
(assert (and true (and (> (str.len var2319!1) var65) (<= 0 var65))))
(define-const var3805 Int (charAt/698050440 var2319!1 var65)) ; Statement: $c9 = virtualinvoke r1.<java.lang.String: char charAt(int)>($i8) 
(define-const var400 Int (cast-from-Int-to-Int var3805)) ; Statement: $i19 = (int) $c9 
 ; Statement: if $i19 == 47 goto virtualinvoke $r21.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("(.*?/)*") 
(assert (not (= var400 47))) ; Negate: Cond: $i19 == 47  
(define-const var3503 var1860 var1860-init) ; Statement: $r25 = new java.lang.IllegalArgumentException 
(define-const var625 String String-init) ; Statement: $r24 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var625)) ; Statement: specialinvoke $r24.<java.lang.StringBuilder: void <init>()>() 
(declare-const var625!1 String)
(assert (= var625!1 ""))
(assert true)
(define-const var2842 String (append/672562846 var625!1 "The \u0022**\u0022 wildcard must be followed by \u0022/\u0022, or must be at tehe end, in this glob: ")) ; Statement: $r13 = virtualinvoke $r24.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("The \"**\" wildcard must be followed by \"/\", or must be at tehe end, in this glob: ") 
(declare-const var625!2 String)
(assert (= var625!2 (str.++ var625!1 "The \u0022**\u0022 wildcard must be followed by \u0022/\u0022, or must be at tehe end, in this glob: ")))
(assert true)
(define-const var3411 String (append/672562846 var2842 var2319!1)) ; Statement: $r14 = virtualinvoke $r13.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var2842!1 String)
(assert (= var2842!1 (str.++ var2842 var2319!1)))
(assert true)
(define-const var833 String (toString/-2075883882 var3411)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var3503 var833)) ; Statement: specialinvoke $r25.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r15) 

(declare-const var3503!1 var1860)
