...
(assert (and true (and (> (str.len var1552) var2876) (<= 0 var2876))))
(define-const var1721 Int (charAt/698050440 var1552 var2876)) ; Statement: c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i13) 
 ; Statement: if z1 != 0 goto z1 = 0 
(assert (not (not (= (ite var1028 1 0) 0)))) ; Negate: Cond: z1 != 0  
(define-const var3795 Int (cast-from-Int-to-Int var1721)) ; Statement: $i15 = (int) c2 
 ; Statement: if $i15 != 63 goto $i16 = (int) c2 
(assert (not (= var3795 63))) ; Cond: $i15 != 63 
(define-const var1484 Int (cast-from-Int-to-Int var1721)) ; Statement: $i16 = (int) c2 
 ; Statement: if $i16 != 42 goto $i20 = (int) c2 
(assert (not (= var1484 42))) ; Cond: $i16 != 42 
(define-const var452 Int (cast-from-Int-to-Int var1721)) ; Statement: $i20 = (int) c2 
 ; Statement: if $i20 != 92 goto $i21 = (int) c2 
(assert (not (= var452 92))) ; Cond: $i20 != 92 
(define-const var1638 Int (cast-from-Int-to-Int var1721)) ; Statement: $i21 = (int) c2 
 ; Statement: if $i21 == 91 goto $r27 = new java.lang.IllegalArgumentException 
(assert (= var1638 91)) ; Cond: $i21 == 91 
(define-const var398 var755 var755-init) ; Statement: $r27 = new java.lang.IllegalArgumentException 
(define-const var1521 String String-init) ; Statement: $r26 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1521)) ; Statement: specialinvoke $r26.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1521!1 String)
(assert (= var1521!1 ""))
(assert true)
(define-const var3117 String (append/672562846 var1521!1 "The \u0022")) ; Statement: $r6 = virtualinvoke $r26.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("The \"") 
(declare-const var1521!2 String)
(assert (= var1521!2 (str.++ var1521!1 "The \u0022")))
(assert true)
(define-const var3591 String (append/-1166366385 var3117 var1721)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c2) 
(declare-const var3117!1 String)
(assert (str.prefixof var3117 var3117!1))
(assert true)
(define-const var1749 String (append/672562846 var3591 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\" glob operator is currently unsupported (precede it with \\ for literal matching), in this glob: ") 
(declare-const var3591!1 String)
(assert (= var3591!1 (str.++ var3591 "\u0022 glob operator is currently unsupported (precede it with \u005c for literal matching), in this glob: ")))
(assert true)
(define-const var3856 String (append/672562846 var1749 var1552)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var1749!1 String)
(assert (= var1749!1 (str.++ var1749 var1552)))
(assert true)
(define-const var1319 String (toString/-2075883882 var3856)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var398 var1319)) ; Statement: specialinvoke $r27.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r10) 

(declare-const var398!1 var755)
