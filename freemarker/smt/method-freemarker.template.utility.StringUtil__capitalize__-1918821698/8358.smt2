...
(assert (and true (and (>= 1 0) (>= (str.len var81) 1))))
(define-const var41 String (substring/850833817 var81 1)) ; Statement: $r7 = virtualinvoke r4.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var629 String (toLowerCase/415700667 var41)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.String: java.lang.String toLowerCase()>() 
(assert true)
;(assert (append/672562846 var2538!2 var629)) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r8) 
(declare-const var2538!3 String)
(assert (= var2538!3 (str.++ var2538!2 var629)))
 ; Statement: goto [?= $z0 = virtualinvoke $r0.<java.util.StringTokenizer: boolean hasMoreTokens()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var2259!1 Bool (hasMoreTokens/711654492 var2909!1)) ; Statement: $z0 = virtualinvoke $r0.<java.util.StringTokenizer: boolean hasMoreTokens()>() 
 ; Statement: if $z0 == 0 goto $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (= (ite var2259!1 1 0) 0)) ; Cond: $z0 == 0 
(assert true)
(define-const var3055 String (toString/-2075883882 var2538!3)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
