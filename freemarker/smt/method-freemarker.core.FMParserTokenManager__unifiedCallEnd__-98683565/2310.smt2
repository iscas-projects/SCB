...
(assert (and true (and (> (str.len var5) 0) (<= 0 0))))
(define-const var3184 Int (charAt/698050440 var5 0)) ; Statement: c0 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(0) 
(define-const var2958 Bool (squBracTagSyntax/929889025 var2078)) ; Statement: $z0 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
...
(define-const var160 Bool (squBracTagSyntax/929889025 var2078)) ; Statement: $z1 = r2.<freemarker.core.FMParserTokenManager: boolean squBracTagSyntax> 
 ; Statement: if $z1 != 0 goto return 
(assert (not (= (ite var160 1 0) 0))) ; Cond: $z1 != 0 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
