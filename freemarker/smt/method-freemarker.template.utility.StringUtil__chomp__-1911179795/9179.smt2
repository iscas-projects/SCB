...
(assert (and true (and (>= 0 0) (>= (str.len var3187) var751) (>= var751 0))))
(define-const var1671 String (substring/-1240304868 var3187 0 var751)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i3) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
