...
(assert (and true (and (>= 0 0) (>= (str.len var818) var687) (>= var687 0))))
(define-const var2364 String (substring/-1240304868 var818 0 var687)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
