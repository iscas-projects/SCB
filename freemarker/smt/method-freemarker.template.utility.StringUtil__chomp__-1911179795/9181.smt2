...
(assert (and true (and (>= 0 0) (>= (str.len var363) var703) (>= var703 0))))
(define-const var1032 String (substring/-1240304868 var363 0 var703)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
