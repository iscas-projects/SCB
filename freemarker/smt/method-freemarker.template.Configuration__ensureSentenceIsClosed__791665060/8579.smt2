...
(assert (and true (and (> (str.len var3118) var346) (<= 0 var346))))
(define-const var1451 Int (charAt/698050440 var3118 var346)) ; Statement: c3 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i2) 
(define-const var2203 Int (cast-from-Int-to-Int var1451)) ; Statement: $i4 = (int) c3 
 ; Statement: if $i4 == 46 goto $r5 = r0 
(assert (= var2203 46)) ; Cond: $i4 == 46 
(define-const var1732 String var3118) ; Statement: $r5 = r0 
