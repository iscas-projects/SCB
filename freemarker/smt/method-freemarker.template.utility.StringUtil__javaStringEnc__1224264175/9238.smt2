...
(declare-const var3981 Bool) ; Statement: z0 := @parameter1: boolean 
(assert (not (= var3981 null-Bool)))
(assert true)
(define-const var2401 Int (length/-134980193 var1092)) ; Statement: i0 = virtualinvoke r0.<java.lang.String: int length()>() 
(define-const var2253 Int 0) ; Statement: i6 = 0 
(assert true) ; Non Conditional
 ; Statement: if i6 >= i0 goto (branch) 
(assert (not (>= var2253 var2401))) ; Negate: Cond: i6 >= i0  
(assert (and true (and (> (str.len var1092) var2253) (<= 0 var2253))))
(define-const var2892 Int (charAt/698050440 var1092 var2253)) ; Statement: c7 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i6) 
(define-const var586 Int (cast-from-Int-to-Int var2892)) ; Statement: $i9 = (int) c7 
 ; Statement: if $i9 == 34 goto $r8 = new java.lang.StringBuilder 
(assert (= var586 34)) ; Cond: $i9 == 34 
(define-const var601 String String-init) ; Statement: $r8 = new java.lang.StringBuilder 
 ; Statement: if z0 == 0 goto $b8 = 4 
(assert (not (= (ite var3981 1 0) 0))) ; Negate: Cond: z0 == 0  
(define-const var2602 Int 6) ; Statement: $b8 = 6 
 ; Statement: goto [?= $i1 = i0 + $b8] 
(assert true) ; Non Conditional
(define-const var2909 Int (+ var2401 var2602)) ; Statement: $i1 = i0 + $b8 
(assert true)
;(assert (<init>/543593434 var601 var2909)) ; Statement: specialinvoke $r8.<java.lang.StringBuilder: void <init>(int)>($i1) 
...
(assert (= (ite var3981 1 0) 0)) ; Cond: z0 == 0 
(assert true)
;(assert (append/50905802 var601!1 (cast-from-String-to-String var1092) 0 var2253)) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.CharSequence,int,int)>(r0, 0, i6) 
(declare-const var601!2 String)
(assert (str.prefixof var601!1 var601!2))
(assert true) ; Non Conditional
(define-const var1520 Int (cast-from-Int-to-Int var2892)) ; Statement: $i12 = (int) c7 
 ; Statement: if $i12 != 34 goto $i13 = (int) c7 
(assert (not (not (= var1520 34)))) ; Negate: Cond: $i12 != 34  
(assert true)
;(assert (append/672562846 var601!2 "\u005c\u0022")) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\\\"") 
(declare-const var601!3 String)
(assert (= var601!3 (str.++ var601!2 "\u005c\u0022")))
 ; Statement: goto [?= i6 = i6 + 1] 
(assert true) ; Non Conditional
(define-const var2253!1 Int (+ var2253 1)) ; Statement: i6 = i6 + 1 
 ; Statement: if i6 < i0 goto c7 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i6) 
(assert (not (< var2253!1 var2401))) ; Negate: Cond: i6 < i0  
 ; Statement: if z0 == 0 goto $r6 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (not (= (ite var3981 1 0) 0))) ; Negate: Cond: z0 == 0  
(assert true)
;(assert (append/672562846 var601!3 "\u0022")) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\"") 
(declare-const var601!4 String)
(assert (= var601!4 (str.++ var601!3 "\u0022")))
(assert true) ; Non Conditional
(assert true)
(define-const var668 String (toString/-2075883882 var601!4)) ; Statement: $r6 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var1092=r0, var3026=null_type, var3981=z0, var2401=i0, var2253=i6, var2892=c7, var586=$i9, var601=$r8, var2602=$b8, var2909=$i1, var1520=$i12, var668=$r6}
; {r0=var1092, null_type=var3026, z0=var3981, i0=var2401, i6=var2253, c7=var2892, $i9=var586, $r8=var601, $b8=var2602, $i1=var2909, $i12=var1520, $r6=var668}
