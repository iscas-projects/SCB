...
(assert (and true (and (>= var2477 0) (>= (str.len var3357) var1903) (>= var1903 var2477))))
(define-const var14 String (substring/-1240304868 var3357 var2477 var1903)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>($i6, $i5) 
(assert true)
(define-const var3662 String (append/672562846 var963 var14)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var963!1 String)
(assert (= var963!1 (str.++ var963 var14)))
(assert true)
(define-const var1644 String (toString/-2075883882 var3662)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
