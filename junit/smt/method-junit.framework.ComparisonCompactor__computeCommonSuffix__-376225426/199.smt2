...
(assert (and true (and (>= var3146 0) (>= (str.len var1557) var2141) (>= var2141 var3146))))
(define-const var606 String (substring/-1240304868 var1557 var3146 var2141)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.String: java.lang.String substring(int,int)>($i11, i7) 
(assert true)
(define-const var1596 String (append/672562846 var700!1 var606)) ; Statement: $r9 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r6) 
(declare-const var700!2 String)
(assert (= var700!2 (str.++ var700!1 var606)))
(define-const var3229 String (fExpected/748987693 var2082)) ; Statement: $r7 = r0.<junit.framework.ComparisonCompactor: java.lang.String fExpected> 
(assert true)
(define-const var3070 Int (length/-134980193 var3229)) ; Statement: $i13 = virtualinvoke $r7.<java.lang.String: int length()>() 
(define-const var1045 Int (fSuffix/748987693 var2082)) ; Statement: $i12 = r0.<junit.framework.ComparisonCompactor: int fSuffix> 
(define-const var500 Int (- var3070 var1045)) ; Statement: $i14 = $i13 - $i12 
(define-const var2496 Int (+ var500 1)) ; Statement: $i18 = $i14 + 1 
(define-const var3933 String (fExpected/748987693 var2082)) ; Statement: $r8 = r0.<junit.framework.ComparisonCompactor: java.lang.String fExpected> 
(assert true)
(define-const var1966 Int (length/-134980193 var3933)) ; Statement: $i16 = virtualinvoke $r8.<java.lang.String: int length()>() 
(define-const var3858 Int (fContextLength/748987693 var2082)) ; Statement: $i15 = r0.<junit.framework.ComparisonCompactor: int fContextLength> 
(define-const var1217 Int (- var1966 var3858)) ; Statement: $i17 = $i16 - $i15 
 ; Statement: if $i18 >= $i17 goto $r12 = "" 
(assert (>= var2496 var1217)) ; Cond: $i18 >= $i17 
(define-const var1418 String "") ; Statement: $r12 = "" 
(assert true) ; Non Conditional
(assert true)
(define-const var224 String (append/672562846 var1596 var1418)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r12) 
(declare-const var1596!1 String)
(assert (= var1596!1 (str.++ var1596 var1418)))
(assert true)
(define-const var2322 String (toString/-2075883882 var224)) ; Statement: $r11 = virtualinvoke $r10.<java.lang.StringBuilder: java.lang.String toString()>() 
