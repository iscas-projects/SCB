...
(assert (and true (and (>= var360 0) (>= (str.len var2247) var360))))
(define-const var2299 String (substring/850833817 var2247 var360)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
