...
(assert (and true (and (>= var286 0) (>= (str.len var1087) var286))))
(define-const var234 String (substring/850833817 var1087 var286)) ; Statement: $r7 = virtualinvoke $r5.<java.lang.String: java.lang.String substring(int)>($i4) 
(assert true)
(define-const var1437 String (append/672562846 var3379 var234)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r7) 
(declare-const var3379!1 String)
(assert (= var3379!1 (str.++ var3379 var234)))
(assert true)
(define-const var1545 String (toString/-2075883882 var1437)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
