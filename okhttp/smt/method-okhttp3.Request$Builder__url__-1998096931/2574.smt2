...
(assert (and true (and (>= 3 0) (>= (str.len var3193!1) 3))))
(define-const var310 String (substring/850833817 var3193!1 3)) ; Statement: $r7 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(3) 
;(assert (var2476_checkNotNullExpressionValue/47304269 (cast-from-String-to-var1994 var310) "this as java.lang.String).substring(startIndex)")) ; Statement: staticinvoke <kotlin.jvm.internal.Intrinsics: void checkNotNullExpressionValue(java.lang.Object,java.lang.String)>($r7, "this as java.lang.String).substring(startIndex)") 

(declare-const var310!1 String)
(declare-const var672 String)
(assert true)
(define-const var3240 String (append/672562846 var1224 var310!1)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r7) 
(declare-const var1224!1 String)
(assert (= var1224!1 (str.++ var1224 var310!1)))
(assert true)
(define-const var565 String (toString/-2075883882 var3240)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: goto [?= $r11 = <okhttp3.HttpUrl: okhttp3.HttpUrl$Companion Companion>] 
(assert true) ; Non Conditional
(define-const var595 var1653 var2080-Companion) ; Statement: $r11 = <okhttp3.HttpUrl: okhttp3.HttpUrl$Companion Companion> 
(assert true)
(define-const var229 var2080 (get/90547134 var595 var565)) ; Statement: $r12 = virtualinvoke $r11.<okhttp3.HttpUrl$Companion: okhttp3.HttpUrl get(java.lang.String)>($r10) 
(assert true)
(define-const var2075 var2825 (url/-1513984934 var92 var229)) ; Statement: $r13 = virtualinvoke r1.<okhttp3.Request$Builder: okhttp3.Request$Builder url(okhttp3.HttpUrl)>($r12) 
