...
(assert (and true (and (>= var754 0) (>= (str.len var2677) var1118) (>= var1118 var754))))
(define-const var2621 String (substring/-1240304868 var2677 var754 var1118)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.String: java.lang.String substring(int,int)>(i4, i5) 
;(assert (var1714_checkNotNullExpressionValue/47304269 (cast-from-String-to-var2746 var2621) "this as java.lang.String\u2026ing(startIndex, endIndex)")) ; Statement: staticinvoke <kotlin.jvm.internal.Intrinsics: void checkNotNullExpressionValue(java.lang.Object,java.lang.String)>($r9, "this as java.lang.String\u2026ing(startIndex, endIndex)") 

(declare-const var2621!1 String)
(declare-const var1133 String)
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
