...
(assert (and true (and (>= var1479 0) (>= (str.len var1102) var876) (>= var876 var1479))))
(define-const var2990 String (substring/-1240304868 var1102 var1479 var876)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.String: java.lang.String substring(int,int)>(i4, i5) 
;(assert (var382_checkNotNullExpressionValue/47304269 (cast-from-String-to-var2452 var2990) "this as java.lang.String\u2026ing(startIndex, endIndex)")) ; Statement: staticinvoke <kotlin.jvm.internal.Intrinsics: void checkNotNullExpressionValue(java.lang.Object,java.lang.String)>($r9, "this as java.lang.String\u2026ing(startIndex, endIndex)") 

(declare-const var2990!1 String)
(declare-const var617 String)
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
