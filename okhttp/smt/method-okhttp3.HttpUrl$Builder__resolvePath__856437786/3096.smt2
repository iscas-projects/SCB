...
(assert (and true (and (> (str.len var3952) var1471) (<= 0 var1471))))
(define-const var2565 Int (charAt/698050440 var3952 var1471)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var165 Int (cast-from-Int-to-Int var2565)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 == 47 goto $r2 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
(assert (= var165 47)) ; Cond: $i8 == 47 
(define-const var1943 var2842 (encodedPathSegments/627676127 var2530)) ; Statement: $r2 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
;(assert (var2842_clear/2124191932 var1943)) ; Statement: interfaceinvoke $r2.<java.util.List: void clear()>() 

(declare-const var1943!1 var2842)
(define-const var1884 var2842 (encodedPathSegments/627676127 var2530)) ; Statement: $r3 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
;(assert (var2842_add/328494887 var1884 (cast-from-String-to-var2209 ""))) ; Statement: interfaceinvoke $r3.<java.util.List: boolean add(java.lang.Object)>("") 

(declare-const var1884!1 var2842)
(declare-const var2338 String)
(define-const var3080!1 Int (+ var1471 1)) ; Statement: i6 = i0 + 1 
 ; Statement: goto [?= i7 = i6] 
(assert true) ; Non Conditional
(define-const var2265 Int var3080!1) ; Statement: i7 = i6 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i1 goto return 
(assert (>= var2265 var2943)) ; Cond: i7 >= i1 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
