...
(assert (and true (and (> (str.len var3295) var3674) (<= 0 var3674))))
(define-const var2113 Int (charAt/698050440 var3295 var3674)) ; Statement: c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var2173 Int (cast-from-Int-to-Int var2113)) ; Statement: $i8 = (int) c2 
 ; Statement: if $i8 == 47 goto $r2 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
(assert (not (= var2173 47))) ; Negate: Cond: $i8 == 47  
(define-const var2917 Int (cast-from-Int-to-Int var2113)) ; Statement: $i9 = (int) c2 
 ; Statement: if $i9 != 92 goto $r5 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
(assert (not (not (= var2917 92)))) ; Negate: Cond: $i9 != 92  
(define-const var1460 var992 (encodedPathSegments/627676127 var2770)) ; Statement: $r2 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
;(assert (var992_clear/2124191932 var1460)) ; Statement: interfaceinvoke $r2.<java.util.List: void clear()>() 

(declare-const var1460!1 var992)
(define-const var3445 var992 (encodedPathSegments/627676127 var2770)) ; Statement: $r3 = r1.<okhttp3.HttpUrl$Builder: java.util.List encodedPathSegments> 
;(assert (var992_add/328494887 var3445 (cast-from-String-to-var1914 ""))) ; Statement: interfaceinvoke $r3.<java.util.List: boolean add(java.lang.Object)>("") 

(declare-const var3445!1 var992)
(declare-const var1032 String)
(define-const var789!1 Int (+ var3674 1)) ; Statement: i6 = i0 + 1 
 ; Statement: goto [?= i7 = i6] 
(assert true) ; Non Conditional
(define-const var1770 Int var789!1) ; Statement: i7 = i6 
(assert true) ; Non Conditional
 ; Statement: if i7 >= i1 goto return 
(assert (>= var1770 var1080)) ; Cond: i7 >= i1 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
