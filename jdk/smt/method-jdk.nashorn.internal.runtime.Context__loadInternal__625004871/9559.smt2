...
(assert (and true (and (>= var1334 0) (>= (str.len var3106) var1334))))
(define-const var2066 String (substring/850833817 var3106 var1334)) ; Statement: $r4 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var1674 String (append/672562846 var2723 var2066)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r4) 
(declare-const var2723!1 String)
(assert (= var2723!1 (str.++ var2723 var2066)))
(assert true)
(define-const var3014 String (toString/-2075883882 var1674)) ; Statement: r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var1645 var2184 var2184-init) ; Statement: $r8 = new jdk.nashorn.internal.runtime.Context$3 
(assert true)
;(assert (<init>/-765892618 var1645 var3014 var3106)) ; Statement: specialinvoke $r8.<jdk.nashorn.internal.runtime.Context$3: void <init>(java.lang.String,java.lang.String)>(r7, r0) 

(declare-const var1645!1 var2184)
(declare-const var3014!1 String)
(declare-const var3106!1 String)
(define-const var1609 var1640 (var3771_doPrivileged/1828555841 (cast-from-var2184-to-var267 var1645!1))) ; Statement: $r9 = staticinvoke <java.security.AccessController: java.lang.Object doPrivileged(java.security.PrivilegedAction)>($r8) 
(define-const var2664 var146 (cast-from-var1640-to-var146 var1609)) ; Statement: $r10 = (jdk.nashorn.internal.runtime.Source) $r9 
