...
(assert (and true (and (> (str.len var3592) var2315) (<= 0 var2315))))
(define-const var1761 Int (charAt/698050440 var3592 var2315)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i1) 
(define-const var2304 Int (cast-from-Int-to-Int var1761)) ; Statement: $i5 = (int) $c2 
 ; Statement: if $i5 != 59 goto $i9 = (int) -1 
(assert (not (= var2304 59))) ; Cond: $i5 != 59 
(define-const var1325 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i9 = (int) -1 
 ; Statement: if i0 != $i9 goto $i3 = i0 + 1 
(assert (not (not (= var1903 var1325)))) ; Negate: Cond: i0 != $i9  
(define-const var1345 String var3592) ; Statement: $r1 = r0 
