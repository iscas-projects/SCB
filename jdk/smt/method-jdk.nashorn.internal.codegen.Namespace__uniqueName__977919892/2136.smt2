...
(assert (and true (and (>= 0 0) (>= (str.len var454) var218) (>= var218 0))))
(define-const var1493 String (substring/-1240304868 var454 0 var218)) ; Statement: $r16 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i6) 
 ; Statement: goto [?= r1 = $r16] 
(assert true) ; Non Conditional
(define-const var726 String var1493) ; Statement: r1 = $r16 
(define-const var574 var423 var3298) ; Statement: r17 = r2 
(assert true) ; Non Conditional
 ; Statement: if r17 == null goto $r3 = r2.<jdk.nashorn.internal.codegen.Namespace: java.util.HashMap directory> 
(assert (= var574 null-var423)) ; Cond: r17 == null 
(define-const var3841 var1552 (directory/687146279 var3298)) ; Statement: $r3 = r2.<jdk.nashorn.internal.codegen.Namespace: java.util.HashMap directory> 
(define-const var1371 Int (Int_valueOf/-1371140006 0)) ; Statement: $r4 = staticinvoke <java.lang.Integer: java.lang.Integer valueOf(int)>(0) 
(assert true)
;(assert (put/-1127386829 var3841 (cast-from-String-to-var3420 var726) (cast-from-Int-to-var3420 var1371))) ; Statement: virtualinvoke $r3.<java.util.HashMap: java.lang.Object put(java.lang.Object,java.lang.Object)>(r1, $r4) 

(declare-const var3841!1 var1552)
