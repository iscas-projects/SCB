...
(assert (and true (and (> (str.len var3791) var683) (<= 0 var683))))
(define-const var3422 Int (charAt/698050440 var3791 var683)) ; Statement: $c31 = virtualinvoke $r24.<java.lang.String: char charAt(int)>($i30) 
(define-const var1006 Int (cast-from-Int-to-Int var3422)) ; Statement: $i32 = (int) $c31 
...
(assert (and (not (= var1006 68)) (and (not (= var1006 67)) (and (not (= var1006 66)) true)))) ; Intersect: Negate: Cond: $i32 == 68   and Intersect: Negate: Cond: $i32 == 67   and Intersect: Negate: Cond: $i32 == 66   and Non Conditional   
 ; Statement: goto [?= $r18 = r0.<jdk.internal.org.objectweb.asm.MethodWriter: int[] frame>] 
(assert true) ; Non Conditional
(define-const var2838 (Array Int Int) (frame/-1797295458 var926)) ; Statement: $r18 = r0.<jdk.internal.org.objectweb.asm.MethodWriter: int[] frame> 
(define-const var2748 Int (- var627 3)) ; Statement: $i21 = i28 - 3 
(declare-const var2838!1 (Array Int Int))
(assert (not (= var2838!1 null-__Array__Int__Int__)))
(assert (= (select var2838!1 1) var2748)) ; Statement: $r18[1] = $i21 
(assert true)
;(assert (endFrame/-574198841 var926)) ; Statement: specialinvoke r0.<jdk.internal.org.objectweb.asm.MethodWriter: void endFrame()>() 

(declare-const var926!1 var314)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
