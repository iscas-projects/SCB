...
(assert (and true (and (>= var1471 0) (>= (str.len var3647) var1588) (>= var1588 var1471))))
(define-const var1209 String (substring/-1240304868 var3647 var1471 var1588)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i4, $i8) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
