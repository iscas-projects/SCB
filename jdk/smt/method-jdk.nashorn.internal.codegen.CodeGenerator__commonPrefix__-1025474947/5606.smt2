...
(assert (and true (and (>= 0 0) (>= (str.len var2719) var2085) (>= var2085 0))))
(define-const var1982 String (substring/-1240304868 var2719 0 var2085)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i5) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
