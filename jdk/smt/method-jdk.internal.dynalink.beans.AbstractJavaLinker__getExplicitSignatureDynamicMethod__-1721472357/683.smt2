...
(assert (and true (and (> (str.len var1413) var2518) (<= 0 var2518))))
(define-const var436 Int (charAt/698050440 var1413 var2518)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i1) 
(define-const var3888 Int (cast-from-Int-to-Int var436)) ; Statement: $i5 = (int) $c2 
 ; Statement: if $i5 == 41 goto i3 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(40) 
(assert (not (= var3888 41))) ; Negate: Cond: $i5 == 41  
