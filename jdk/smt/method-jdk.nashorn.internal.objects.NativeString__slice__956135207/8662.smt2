...
(assert (and true (and (>= var3830 0) (>= (str.len var1812) var3830))))
(define-const var2242 String (substring/850833817 var1812 var3830)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i4) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
