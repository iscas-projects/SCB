...
(assert (and true (and (>= var3172 0) (>= (str.len var253) var3476) (>= var3476 var3172))))
(define-const var3304 String (substring/-1240304868 var253 var3172 var3476)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i2, $i5) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
