...
(assert (and true (and (> (str.len var1715) var687) (<= 0 var687))))
(define-const var872 Int (charAt/698050440 var1715 var687)) ; Statement: $s3 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i2) 
