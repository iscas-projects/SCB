...
(assert (and true (and (>= 0 0) (>= (str.len var1341) var740) (>= var740 0))))
(define-const var1091 String (substring/-1240304868 var1341 0 var740)) ; Statement: $r16 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(0, $i3) 
 ; Statement: goto [?= staticinvoke <jdk.nashorn.internal.ir.debug.NashornTextifier: void appendDescriptor(java.lang.StringBuilder,int,java.lang.String)>($r0, 1, $r16)] 
(assert true) ; Non Conditional
;(assert (var3103_appendDescriptor/-359262046 var968!3 1 var1091)) ; Statement: staticinvoke <jdk.nashorn.internal.ir.debug.NashornTextifier: void appendDescriptor(java.lang.StringBuilder,int,java.lang.String)>($r0, 1, $r16) 

(declare-const var968!4 String)
(declare-const var158 Int)
(declare-const var1091!1 String)
(assert true)
(define-const var1571 String (append/-1166366385 var968!4 32)) ; Statement: $r4 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(32) 
(declare-const var968!5 String)
(assert (str.prefixof var968!4 var968!5))
(assert true)
;(assert (append/672562846 var1571 var1515)) ; Statement: virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r3) 
(declare-const var1571!1 String)
(assert (= var1571!1 (str.++ var1571 var1515)))
 ; Statement: if r5 == null goto virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(";\n") 
(assert (= var2392 null-var2356)) ; Cond: r5 == null 
(assert true)
;(assert (append/672562846 var968!5 ";\n")) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(";\n") 
(declare-const var968!6 String)
(assert (= var968!6 (str.++ var968!5 ";\n")))
(assert true)
;(assert (addText/1451988652 var1861 (cast-from-String-to-var2356 var968!6))) ; Statement: specialinvoke r6.<jdk.nashorn.internal.ir.debug.NashornTextifier: void addText(java.lang.Object)>($r0) 

(declare-const var1861!1 var3103)
(declare-const var968!7 String)
(assert true)
(define-const var824 var3103 (createNashornTextifier/-1153041222 var1861!1)) ; Statement: $r17 = virtualinvoke r6.<jdk.nashorn.internal.ir.debug.NashornTextifier: jdk.nashorn.internal.ir.debug.NashornTextifier createNashornTextifier()>() 
(assert true)
(define-const var3682 var2221 (getText/-142638630 (cast-from-var3103-to-var2995 var824))) ; Statement: $r18 = virtualinvoke $r17.<jdk.nashorn.internal.ir.debug.NashornTextifier: java.util.List getText()>() 
(assert true)
;(assert (addText/1451988652 var1861!1 (cast-from-var2221-to-var2356 var3682))) ; Statement: specialinvoke r6.<jdk.nashorn.internal.ir.debug.NashornTextifier: void addText(java.lang.Object)>($r18) 

(declare-const var1861!2 var3103)
(declare-const var3682!1 var2221)
