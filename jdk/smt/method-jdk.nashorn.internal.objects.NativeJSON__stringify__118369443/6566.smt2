...
(assert (and true (and (>= 0 0) (>= (str.len var3151) var27) (>= var27 0))))
(define-const var3464 String (substring/-1240304868 var3151 0 var27)) ; Statement: r15 = virtualinvoke r16.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
 ; Statement: goto [?= $r0.<jdk.nashorn.internal.objects.NativeJSON$StringifyState: java.lang.String gap> = r15] 
(assert true) ; Non Conditional
(declare-const var2074!3 var3173)
(assert (not (= var2074!3 null-var3173)))
(assert (= (gap/906978120 var2074!3) var3464)) ; Statement: $r0.<jdk.nashorn.internal.objects.NativeJSON$StringifyState: java.lang.String gap> = r15 
(define-const var2603 var3472 var1544_newEmptyInstance/-1533132012) ; Statement: $r17 = staticinvoke <jdk.nashorn.internal.objects.Global: jdk.nashorn.internal.runtime.ScriptObject newEmptyInstance()>() 
(assert true)
;(assert (set/-239134907 var2603 (cast-from-String-to-var951 "") var3861 0)) ; Statement: virtualinvoke $r17.<jdk.nashorn.internal.runtime.ScriptObject: void set(java.lang.Object,java.lang.Object,int)>("", r3, 0) 

(declare-const var2603!1 var3472)
(declare-const var1679 String)
(declare-const var3861!1 var951)
(declare-const var2091 Int)
(define-const var1901 var951 (var19_str/1408181749 (cast-from-String-to-var951 "") (cast-from-var3472-to-var951 var2603!1) var2074!3)) ; Statement: $r18 = staticinvoke <jdk.nashorn.internal.objects.NativeJSON: java.lang.Object str(java.lang.Object,java.lang.Object,jdk.nashorn.internal.objects.NativeJSON$StringifyState)>("", $r17, $r0) 
