...
(assert (and true (and (>= 0 0) (>= (str.len var661) var1210) (>= var1210 0))))
(define-const var2708 String (substring/-1240304868 var661 0 var1210)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(declare-const var1333!3 var296)
(assert (not (= var1333!3 null-var296)))
(assert (= (key/-1281701860 var1333!3) var2708)) ; Statement: r0.<jdk.nashorn.internal.parser.DateParser$Name: java.lang.String key> = $r2 
(declare-const var1333!4 var296)
(assert (not (= var1333!4 null-var296)))
(assert (= (type/-1281701860 var1333!4) var2333)) ; Statement: r0.<jdk.nashorn.internal.parser.DateParser$Name: int type> = i2 
(declare-const var1333!5 var296)
(assert (not (= var1333!5 null-var296)))
(assert (= (value/-1281701860 var1333!5) var2365)) ; Statement: r0.<jdk.nashorn.internal.parser.DateParser$Name: int value> = i3 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
