...
(assert (and true (and (>= var2443 0) (>= (str.len var3542) var3088) (>= var3088 var2443))))
(define-const var1051 String (substring/-1240304868 var3542 var2443 var3088)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i5, $i4) 
(assert true)
(define-const var3373 Int (addType/2103704251 var1563 var1051)) ; Statement: $i6 = virtualinvoke r1.<jdk.internal.org.objectweb.asm.ClassWriter: int addType(java.lang.String)>(r2) 
(define-const var3882 Int (bv2nat (bvor ((_ int2bv 64) 24117248) ((_ int2bv 64) var3373)))) ; Statement: $i7 = 24117248 | $i6 
 ; Statement: return $i7 
(check-sat)
(get-model)
(get-unsat-core)
