...
(assert (and true (and (> (str.len var1374) var3808) (<= 0 var3808))))
(define-const var636 Int (charAt/698050440 var1374 var3808)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i15) 
(define-const var2604 Int (cast-from-Int-to-Int var636)) ; Statement: $i22 = (int) $c2 
