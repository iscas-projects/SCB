...
(assert (and true (and (> (str.len var3466) var211) (<= 0 var211))))
(define-const var3420 Int (charAt/698050440 var3466 var211)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i15) 
(define-const var695 Int (cast-from-Int-to-Int var3420)) ; Statement: $i22 = (int) $c2 
...
(assert (and (= var695 74) (and (not (= var695 73)) (and (not (= var695 72)) (and (not (= var695 71)) (and (not (= var695 70)) (and (not (= var695 69)) (and (not (= var695 68)) (and (not (= var695 67)) (and (not (= var695 66)) true)))))))))) ; Intersect: Cond: $i22 == 74  and Intersect: Negate: Cond: $i22 == 73   and Intersect: Negate: Cond: $i22 == 72   and Intersect: Negate: Cond: $i22 == 71   and Intersect: Negate: Cond: $i22 == 70   and Intersect: Negate: Cond: $i22 == 69   and Intersect: Negate: Cond: $i22 == 68   and Intersect: Negate: Cond: $i22 == 67   and Intersect: Negate: Cond: $i22 == 66   and Non Conditional         
