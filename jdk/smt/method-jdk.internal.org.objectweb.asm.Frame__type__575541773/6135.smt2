...
(assert (and true (and (> (str.len var2514) 0) (<= 0 0))))
(define-const var211 Int (charAt/698050440 var2514 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var3384 Int (cast-from-Int-to-Int var211)) ; Statement: $i21 = (int) $c0 
 ; Statement: if $i21 != 40 goto $i15 = 0 
(assert (not (not (= var3384 40)))) ; Negate: Cond: $i21 != 40  
(assert true)
(define-const var1414 Int (indexOf/-1037706067 var2514 41)) ; Statement: $i14 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(41) 
(define-const var3808 Int (+ var1414 1)) ; Statement: $i15 = $i14 + 1 
 ; Statement: goto [?= i1 = $i15] 
(assert true) ; Non Conditional
(define-const var3926 Int var3808) ; Statement: i1 = $i15 
(assert (and true (and (> (str.len var2514) var3808) (<= 0 var3808))))
(define-const var802 Int (charAt/698050440 var2514 var3808)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i15) 
(define-const var316 Int (cast-from-Int-to-Int var802)) ; Statement: $i22 = (int) $c2 
...
(assert (and (= var316 68) (and (not (= var316 67)) (and (not (= var316 66)) true)))) ; Intersect: Cond: $i22 == 68  and Intersect: Negate: Cond: $i22 == 67   and Intersect: Negate: Cond: $i22 == 66   and Non Conditional   
 ; Statement: return 16777219 
(check-sat)
(get-model)
(get-unsat-core)
