...
(assert (and true (and (> (str.len var1440) 0) (<= 0 0))))
(define-const var1860 Int (charAt/698050440 var1440 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var14 Int (cast-from-Int-to-Int var1860)) ; Statement: $i21 = (int) $c0 
 ; Statement: if $i21 != 40 goto $i15 = 0 
(assert (not (= var14 40))) ; Cond: $i21 != 40 
(define-const var1728 Int 0) ; Statement: $i15 = 0 
(assert true) ; Non Conditional
(define-const var3716 Int var1728) ; Statement: i1 = $i15 
(assert (and true (and (> (str.len var1440) var1728) (<= 0 var1728))))
(define-const var2412 Int (charAt/698050440 var1440 var1728)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i15) 
(define-const var871 Int (cast-from-Int-to-Int var2412)) ; Statement: $i22 = (int) $c2 
...
(assert (and (= var871 68) (and (not (= var871 67)) (and (not (= var871 66)) true)))) ; Intersect: Cond: $i22 == 68  and Intersect: Negate: Cond: $i22 == 67   and Intersect: Negate: Cond: $i22 == 66   and Non Conditional   
