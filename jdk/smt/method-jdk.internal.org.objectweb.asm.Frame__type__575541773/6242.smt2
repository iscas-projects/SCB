...
(assert (and true (and (> (str.len var2916) var1318) (<= 0 var1318))))
(define-const var3806 Int (charAt/698050440 var2916 var1318)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i15) 
(define-const var1527 Int (cast-from-Int-to-Int var3806)) ; Statement: $i22 = (int) $c2 
...
(assert (and (= var1527 66) true)) ; Intersect: Cond: $i22 == 66  and Non Conditional 
