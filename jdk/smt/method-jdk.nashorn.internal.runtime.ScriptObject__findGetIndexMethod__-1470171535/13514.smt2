...
(assert (and true (and (>= 1 0) (>= (str.len var3378) var3003) (>= var3003 1))))
(define-const var1742 String (substring/-1240304868 var3378 1 var3003)) ; Statement: $r10 = virtualinvoke r16.<java.lang.String: java.lang.String substring(int,int)>(1, $i2) 
(assert true)
(define-const var777 String (append/672562846 var204 var1742)) ; Statement: $r12 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r10) 
(declare-const var204!1 String)
(assert (= var204!1 (str.++ var204 var1742)))
(assert true)
(define-const var1867 String (toString/-2075883882 var777)) ; Statement: r17 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.String toString()>() 
...
(assert true) ; Non Conditional
(assert true)
(define-const var3695 var2077 (findGetIndexMethodHandle/-1145191930 var891 var1172 var1867 var3767 var3725)) ; Statement: $r13 = virtualinvoke r5.<jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle findGetIndexMethodHandle(java.lang.Class,java.lang.String,java.lang.Class,jdk.internal.dynalink.CallSiteDescriptor)>(r3, r17, $r14, r0) 
(define-const var655 var3660 var3660-init) ; Statement: $r6 = new jdk.internal.dynalink.linker.GuardedInvocation 
(define-const var1602 var2077 (var1977_getScriptObjectGuard/-1702191085 var415 var510)) ; Statement: $r7 = staticinvoke <jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle getScriptObjectGuard(java.lang.invoke.MethodType,boolean)>(r1, $z2) 
 ; Statement: if $z2 == 0 goto $r18 = class "Ljava/lang/ClassCastException;" 
(assert (= (ite var510 1 0) 0)) ; Cond: $z2 == 0 
(define-const var1006 ClassObject var1824!class) ; Statement: $r18 = class "Ljava/lang/ClassCastException;" 
(assert true) ; Non Conditional
(assert true)
;(assert (<init>/-1026995654 var655 var3695 var1602 null-var3193 var1006)) ; Statement: specialinvoke $r6.<jdk.internal.dynalink.linker.GuardedInvocation: void <init>(java.lang.invoke.MethodHandle,java.lang.invoke.MethodHandle,java.lang.invoke.SwitchPoint,java.lang.Class)>($r13, $r7, null, $r18) 

(declare-const var655!1 var3660)
(declare-const var3695!1 var2077)
(declare-const var1602!1 var2077)
(declare-const var3072 var1074)
(declare-const var1006!1 ClassObject)
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
