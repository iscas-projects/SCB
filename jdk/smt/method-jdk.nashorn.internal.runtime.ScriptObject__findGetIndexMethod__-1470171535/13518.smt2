...
(assert (and true (and (> (str.len var433) 0) (<= 0 0))))
(define-const var2307 Int (charAt/698050440 var433 0)) ; Statement: $c0 = virtualinvoke r16.<java.lang.String: char charAt(int)>(0) 
(define-const var2642 Int (var3142_toUpperCase/1913344327 var2307)) ; Statement: $c1 = staticinvoke <java.lang.Character: char toUpperCase(char)>($c0) 
(assert true)
(define-const var352 String (append/-1166366385 var2269 var2642)) ; Statement: $r11 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>($c1) 
(declare-const var2269!1 String)
(assert (str.prefixof var2269 var2269!1))
(assert true)
(define-const var3740 Int (length/-134980193 var433)) ; Statement: $i2 = virtualinvoke r16.<java.lang.String: int length()>() 
(assert (and true (and (>= 1 0) (>= (str.len var433) var3740) (>= var3740 1))))
(define-const var290 String (substring/-1240304868 var433 1 var3740)) ; Statement: $r10 = virtualinvoke r16.<java.lang.String: java.lang.String substring(int,int)>(1, $i2) 
(assert true)
(define-const var2391 String (append/672562846 var352 var290)) ; Statement: $r12 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r10) 
(declare-const var352!1 String)
(assert (= var352!1 (str.++ var352 var290)))
(assert true)
(define-const var920 String (toString/-2075883882 var2391)) ; Statement: r17 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.String toString()>() 
...
(assert true) ; Non Conditional
(assert true)
(define-const var2615 var3205 (findGetIndexMethodHandle/-1145191930 var1468 var721 var920 var3952 var873)) ; Statement: $r13 = virtualinvoke r5.<jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle findGetIndexMethodHandle(java.lang.Class,java.lang.String,java.lang.Class,jdk.internal.dynalink.CallSiteDescriptor)>(r3, r17, $r14, r0) 
(define-const var1844 var3095 var3095-init) ; Statement: $r6 = new jdk.internal.dynalink.linker.GuardedInvocation 
(define-const var3234 var3205 (var3700_getScriptObjectGuard/-1702191085 var1322 var1454)) ; Statement: $r7 = staticinvoke <jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle getScriptObjectGuard(java.lang.invoke.MethodType,boolean)>(r1, $z2) 
 ; Statement: if $z2 == 0 goto $r18 = class "Ljava/lang/ClassCastException;" 
(assert (= (ite var1454 1 0) 0)) ; Cond: $z2 == 0 
(define-const var1857 ClassObject var3868!class) ; Statement: $r18 = class "Ljava/lang/ClassCastException;" 
(assert true) ; Non Conditional
(assert true)
;(assert (<init>/-1026995654 var1844 var2615 var3234 null-var284 var1857)) ; Statement: specialinvoke $r6.<jdk.internal.dynalink.linker.GuardedInvocation: void <init>(java.lang.invoke.MethodHandle,java.lang.invoke.MethodHandle,java.lang.invoke.SwitchPoint,java.lang.Class)>($r13, $r7, null, $r18) 

(declare-const var1844!1 var3095)
(declare-const var2615!1 var3205)
(declare-const var3234!1 var3205)
(declare-const var2037 var3694)
(declare-const var1857!1 ClassObject)
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
