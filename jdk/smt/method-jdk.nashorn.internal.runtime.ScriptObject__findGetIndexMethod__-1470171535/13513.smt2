...
(assert (and true (and (>= 1 0) (>= (str.len var1806) var1881) (>= var1881 1))))
(define-const var2912 String (substring/-1240304868 var1806 1 var1881)) ; Statement: $r10 = virtualinvoke r16.<java.lang.String: java.lang.String substring(int,int)>(1, $i2) 
(assert true)
(define-const var1833 String (append/672562846 var3341 var2912)) ; Statement: $r12 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r10) 
(declare-const var3341!1 String)
(assert (= var3341!1 (str.++ var3341 var2912)))
(assert true)
(define-const var1753 String (toString/-2075883882 var1833)) ; Statement: r17 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.String toString()>() 
...
(assert true) ; Non Conditional
(assert true)
(define-const var2137 var1745 (findGetIndexMethodHandle/-1145191930 var1652 var3741 var1753 var3618 var639)) ; Statement: $r13 = virtualinvoke r5.<jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle findGetIndexMethodHandle(java.lang.Class,java.lang.String,java.lang.Class,jdk.internal.dynalink.CallSiteDescriptor)>(r3, r17, $r14, r0) 
(define-const var242 var1038 var1038-init) ; Statement: $r6 = new jdk.internal.dynalink.linker.GuardedInvocation 
(define-const var2030 var1745 (var2749_getScriptObjectGuard/-1702191085 var2042 var2780)) ; Statement: $r7 = staticinvoke <jdk.nashorn.internal.runtime.ScriptObject: java.lang.invoke.MethodHandle getScriptObjectGuard(java.lang.invoke.MethodType,boolean)>(r1, $z2) 
 ; Statement: if $z2 == 0 goto $r18 = class "Ljava/lang/ClassCastException;" 
(assert (not (= (ite var2780 1 0) 0))) ; Negate: Cond: $z2 == 0  
(define-const var1110 ClassObject null-ClassObject) ; Statement: $r18 = null 
...
(assert true) ; Non Conditional
(assert true)
;(assert (<init>/-1026995654 var242 var2137 var2030 null-var2595 var1110)) ; Statement: specialinvoke $r6.<jdk.internal.dynalink.linker.GuardedInvocation: void <init>(java.lang.invoke.MethodHandle,java.lang.invoke.MethodHandle,java.lang.invoke.SwitchPoint,java.lang.Class)>($r13, $r7, null, $r18) 

(declare-const var242!1 var1038)
(declare-const var2137!1 var1745)
(declare-const var2030!1 var1745)
(declare-const var567 var3033)
(declare-const var1110!1 ClassObject)
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
