...
(assert (and true (and (>= var962 0) (>= (str.len var1915) var3565) (>= var3565 var962))))
(define-const var521 String (substring/-1240304868 var1915 var962 var3565)) ; Statement: $r5 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i6, $i3) 
(assert true) ; Non Conditional
 ; Statement: return $r5 
(check-sat)
(get-model)
