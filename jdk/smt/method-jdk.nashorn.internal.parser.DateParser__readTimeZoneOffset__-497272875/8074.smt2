...
(assert (and true (and (> (str.len var1946) var819) (<= 0 var819))))
(define-const var142 Int (charAt/698050440 var1946 var819)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i1) 
(define-const var3548 Int (cast-from-Int-to-Int var142)) ; Statement: $i9 = (int) $c2 
 ; Statement: if $i9 != 43 goto $b8 = -1 
(assert (not (not (= var3548 43)))) ; Negate: Cond: $i9 != 43  
(define-const var724 Int 1) ; Statement: $b8 = 1 
 ; Statement: goto [?= $i6 = specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: int readNumber(int)>(2)] 
(assert true) ; Non Conditional
(assert true)
(define-const var1661 Int (readNumber/1976387137 var2512 2)) ; Statement: $i6 = specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: int readNumber(int)>(2) 
(assert true)
;(assert (skipDelimiter/666932120 var2512 58)) ; Statement: specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: boolean skipDelimiter(char)>(58) 

(declare-const var2512!1 var1957)
(declare-const var1517 Int)
(define-const var1485 Int (* var1661 60)) ; Statement: $i4 = $i6 * 60 
(assert true)
(define-const var2719 Int (readNumber/1976387137 var2512!1 2)) ; Statement: $i3 = specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: int readNumber(int)>(2) 
(define-const var2367 Int (+ var1485 var2719)) ; Statement: $i7 = $i4 + $i3 
(define-const var3730 Int (* var724 var2367)) ; Statement: $i5 = $b8 * $i7 
 ; Statement: return $i5 
(check-sat)
(get-model)
(get-unsat-core)
