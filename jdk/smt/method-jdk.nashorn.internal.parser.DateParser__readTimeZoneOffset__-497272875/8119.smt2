...
(assert (and true (and (> (str.len var52) var2503) (<= 0 var2503))))
(define-const var3681 Int (charAt/698050440 var52 var2503)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i1) 
(define-const var742 Int (cast-from-Int-to-Int var3681)) ; Statement: $i9 = (int) $c2 
 ; Statement: if $i9 != 43 goto $b8 = -1 
(assert (not (= var742 43))) ; Cond: $i9 != 43 
(define-const var1050 Int (- 1)) ; Statement: $b8 = -1 
(assert true) ; Non Conditional
(assert true)
(define-const var2944 Int (readNumber/1976387137 var673 2)) ; Statement: $i6 = specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: int readNumber(int)>(2) 
(assert true)
;(assert (skipDelimiter/666932120 var673 58)) ; Statement: specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: boolean skipDelimiter(char)>(58) 

(declare-const var673!1 var1506)
(declare-const var844 Int)
(define-const var2921 Int (* var2944 60)) ; Statement: $i4 = $i6 * 60 
(assert true)
(define-const var576 Int (readNumber/1976387137 var673!1 2)) ; Statement: $i3 = specialinvoke r0.<jdk.nashorn.internal.parser.DateParser: int readNumber(int)>(2) 
(define-const var2096 Int (+ var2921 var576)) ; Statement: $i7 = $i4 + $i3 
(define-const var3666 Int (* var1050 var2096)) ; Statement: $i5 = $b8 * $i7 
 ; Statement: return $i5 
(check-sat)
(get-model)
(get-unsat-core)
