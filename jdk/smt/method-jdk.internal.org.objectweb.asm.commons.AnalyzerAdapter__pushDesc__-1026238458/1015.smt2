...
(assert (and true (and (> (str.len var672) 0) (<= 0 0))))
(define-const var3157 Int (charAt/698050440 var672 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var986 Int (cast-from-Int-to-Int var3157)) ; Statement: $i10 = (int) $c0 
 ; Statement: if $i10 != 40 goto $i9 = 0 
(assert (not (not (= var986 40)))) ; Negate: Cond: $i10 != 40  
(assert true)
(define-const var3158 Int (indexOf/-1037706067 var672 41)) ; Statement: $i8 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(41) 
(define-const var2368 Int (+ var3158 1)) ; Statement: $i9 = $i8 + 1 
 ; Statement: goto [?= $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9)] 
(assert true) ; Non Conditional
(assert (and true (and (> (str.len var672) var2368) (<= 0 var2368))))
(define-const var2276 Int (charAt/698050440 var672 var2368)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var1728 Int (cast-from-Int-to-Int var2276)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var1728 68) (and (not (= var1728 67)) (and (not (= var1728 66)) true)))) ; Intersect: Cond: $i11 == 68  and Intersect: Negate: Cond: $i11 == 67   and Intersect: Negate: Cond: $i11 == 66   and Non Conditional   
(define-const var2232 Int var2606-DOUBLE) ; Statement: $r6 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer DOUBLE> 
(assert true)
;(assert (push/-694766459 var293 (cast-from-Int-to-var1382 var2232))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r6) 

(declare-const var293!1 var1769)
(declare-const var2232!1 Int)
(define-const var224 Int var2606-TOP) ; Statement: $r7 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer TOP> 
(assert true)
;(assert (push/-694766459 var293!1 (cast-from-Int-to-var1382 var224))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r7) 

(declare-const var293!2 var1769)
