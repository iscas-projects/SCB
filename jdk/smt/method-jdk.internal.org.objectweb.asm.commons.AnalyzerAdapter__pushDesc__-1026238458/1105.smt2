...
(assert (and true (and (> (str.len var1208) 0) (<= 0 0))))
(define-const var2641 Int (charAt/698050440 var1208 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var665 Int (cast-from-Int-to-Int var2641)) ; Statement: $i10 = (int) $c0 
 ; Statement: if $i10 != 40 goto $i9 = 0 
(assert (not (= var665 40))) ; Cond: $i10 != 40 
(define-const var3638 Int 0) ; Statement: $i9 = 0 
(assert true) ; Non Conditional
(assert (and true (and (> (str.len var1208) var3638) (<= 0 var3638))))
(define-const var3213 Int (charAt/698050440 var1208 var3638)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var2232 Int (cast-from-Int-to-Int var3213)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var2232 66) true)) ; Intersect: Cond: $i11 == 66  and Non Conditional 
(define-const var3017 Int var438-INTEGER) ; Statement: $r8 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer INTEGER> 
(assert true)
;(assert (push/-694766459 var2110 (cast-from-Int-to-var1068 var3017))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r8) 

(declare-const var2110!1 var1907)
