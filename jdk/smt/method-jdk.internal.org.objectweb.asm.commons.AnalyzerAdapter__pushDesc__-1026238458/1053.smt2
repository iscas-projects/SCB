...
(assert (and true (and (> (str.len var2226) var2960) (<= 0 var2960))))
(define-const var565 Int (charAt/698050440 var2226 var2960)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var139 Int (cast-from-Int-to-Int var565)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var139 70) (and (not (= var139 69)) (and (not (= var139 68)) (and (not (= var139 67)) (and (not (= var139 66)) true)))))) ; Intersect: Cond: $i11 == 70  and Intersect: Negate: Cond: $i11 == 69   and Intersect: Negate: Cond: $i11 == 68   and Intersect: Negate: Cond: $i11 == 67   and Intersect: Negate: Cond: $i11 == 66   and Non Conditional     
(define-const var2816 Int var3187-FLOAT) ; Statement: $r5 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer FLOAT> 
(assert true)
;(assert (push/-694766459 var3228 (cast-from-Int-to-var1016 var2816))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r5) 

(declare-const var3228!1 var2202)
(declare-const var2816!1 Int)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
