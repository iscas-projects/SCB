...
(assert (and true (and (> (str.len var956) 0) (<= 0 0))))
(define-const var1841 Int (charAt/698050440 var956 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1986 Int (cast-from-Int-to-Int var1841)) ; Statement: $i10 = (int) $c0 
 ; Statement: if $i10 != 40 goto $i9 = 0 
(assert (not (not (= var1986 40)))) ; Negate: Cond: $i10 != 40  
(assert true)
(define-const var3634 Int (indexOf/-1037706067 var956 41)) ; Statement: $i8 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(41) 
(define-const var920 Int (+ var3634 1)) ; Statement: $i9 = $i8 + 1 
 ; Statement: goto [?= $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9)] 
(assert true) ; Non Conditional
(assert (and true (and (> (str.len var956) var920) (<= 0 var920))))
(define-const var2687 Int (charAt/698050440 var956 var920)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var3279 Int (cast-from-Int-to-Int var2687)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var3279 74) (and (not (= var3279 73)) (and (not (= var3279 72)) (and (not (= var3279 71)) (and (not (= var3279 70)) (and (not (= var3279 69)) (and (not (= var3279 68)) (and (not (= var3279 67)) (and (not (= var3279 66)) true)))))))))) ; Intersect: Cond: $i11 == 74  and Intersect: Negate: Cond: $i11 == 73   and Intersect: Negate: Cond: $i11 == 72   and Intersect: Negate: Cond: $i11 == 71   and Intersect: Negate: Cond: $i11 == 70   and Intersect: Negate: Cond: $i11 == 69   and Intersect: Negate: Cond: $i11 == 68   and Intersect: Negate: Cond: $i11 == 67   and Intersect: Negate: Cond: $i11 == 66   and Non Conditional         
(define-const var807 Int var1006-LONG) ; Statement: $r3 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer LONG> 
(assert true)
;(assert (push/-694766459 var2244 (cast-from-Int-to-var3409 var807))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r3) 

(declare-const var2244!1 var3572)
(declare-const var807!1 Int)
(define-const var2141 Int var1006-TOP) ; Statement: $r4 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer TOP> 
(assert true)
;(assert (push/-694766459 var2244!1 (cast-from-Int-to-var3409 var2141))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r4) 

(declare-const var2244!2 var3572)
(declare-const var2141!1 Int)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
