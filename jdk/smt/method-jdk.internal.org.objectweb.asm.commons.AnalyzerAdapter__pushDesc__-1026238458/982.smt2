...
(assert (and true (and (> (str.len var757) 0) (<= 0 0))))
(define-const var1696 Int (charAt/698050440 var757 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var756 Int (cast-from-Int-to-Int var1696)) ; Statement: $i10 = (int) $c0 
 ; Statement: if $i10 != 40 goto $i9 = 0 
(assert (not (not (= var756 40)))) ; Negate: Cond: $i10 != 40  
(assert true)
(define-const var1043 Int (indexOf/-1037706067 var757 41)) ; Statement: $i8 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(41) 
(define-const var3080 Int (+ var1043 1)) ; Statement: $i9 = $i8 + 1 
 ; Statement: goto [?= $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9)] 
(assert true) ; Non Conditional
(assert (and true (and (> (str.len var757) var3080) (<= 0 var3080))))
(define-const var241 Int (charAt/698050440 var757 var3080)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var2968 Int (cast-from-Int-to-Int var241)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var2968 66) true)) ; Intersect: Cond: $i11 == 66  and Non Conditional 
(define-const var1944 Int var3719-INTEGER) ; Statement: $r8 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer INTEGER> 
(assert true)
;(assert (push/-694766459 var399 (cast-from-Int-to-var1538 var1944))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r8) 

(declare-const var399!1 var2375)
(declare-const var1944!1 Int)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
