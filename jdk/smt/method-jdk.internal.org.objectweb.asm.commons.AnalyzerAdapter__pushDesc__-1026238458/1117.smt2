...
(assert (and true (and (> (str.len var2425) var1366) (<= 0 var1366))))
(define-const var2551 Int (charAt/698050440 var2425 var1366)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var2283 Int (cast-from-Int-to-Int var2551)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var2283 68) (and (not (= var2283 67)) (and (not (= var2283 66)) true)))) ; Intersect: Cond: $i11 == 68  and Intersect: Negate: Cond: $i11 == 67   and Intersect: Negate: Cond: $i11 == 66   and Non Conditional   
(define-const var3397 Int var3482-DOUBLE) ; Statement: $r6 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer DOUBLE> 
(assert true)
;(assert (push/-694766459 var1779 (cast-from-Int-to-var3972 var3397))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r6) 

(declare-const var1779!1 var2390)
(declare-const var3397!1 Int)
(define-const var2518 Int var3482-TOP) ; Statement: $r7 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer TOP> 
(assert true)
;(assert (push/-694766459 var1779!1 (cast-from-Int-to-var3972 var2518))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r7) 

(declare-const var1779!2 var2390)
