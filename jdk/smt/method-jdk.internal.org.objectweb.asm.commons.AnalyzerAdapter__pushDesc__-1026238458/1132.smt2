...
(assert (and true (and (> (str.len var3574) 0) (<= 0 0))))
(define-const var1084 Int (charAt/698050440 var3574 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var667 Int (cast-from-Int-to-Int var1084)) ; Statement: $i10 = (int) $c0 
 ; Statement: if $i10 != 40 goto $i9 = 0 
(assert (not (= var667 40))) ; Cond: $i10 != 40 
(define-const var264 Int 0) ; Statement: $i9 = 0 
(assert true) ; Non Conditional
(assert (and true (and (> (str.len var3574) var264) (<= 0 var264))))
(define-const var2521 Int (charAt/698050440 var3574 var264)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i9) 
(define-const var374 Int (cast-from-Int-to-Int var2521)) ; Statement: $i11 = (int) $c1 
...
(assert (and (= var374 70) (and (not (= var374 69)) (and (not (= var374 68)) (and (not (= var374 67)) (and (not (= var374 66)) true)))))) ; Intersect: Cond: $i11 == 70  and Intersect: Negate: Cond: $i11 == 69   and Intersect: Negate: Cond: $i11 == 68   and Intersect: Negate: Cond: $i11 == 67   and Intersect: Negate: Cond: $i11 == 66   and Non Conditional     
(define-const var1333 Int var834-FLOAT) ; Statement: $r5 = <jdk.internal.org.objectweb.asm.Opcodes: java.lang.Integer FLOAT> 
(assert true)
;(assert (push/-694766459 var351 (cast-from-Int-to-var1473 var1333))) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void push(java.lang.Object)>($r5) 

(declare-const var351!1 var1310)
(declare-const var1333!1 Int)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
