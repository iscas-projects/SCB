...
(assert (and true (and (>= var1236 0) (>= (str.len var2928) var3320) (>= var3320 var1236))))
(define-const var533 String (substring/-1240304868 var2928 var1236 var3320)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i4, $i1) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
