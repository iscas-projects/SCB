...
(assert (and true (and (> (str.len var3675) var3111) (<= 0 var3111))))
(define-const var1038 Int (charAt/698050440 var3675 var3111)) ; Statement: $c2 = virtualinvoke $r6.<java.lang.String: char charAt(int)>($i1) 
(define-const var549 Int (cast-from-Int-to-Int var1038)) ; Statement: $i4 = (int) $c2 
 ; Statement: if $i4 != 59 goto $r7 = $r6 
(assert (not (not (= var549 59)))) ; Negate: Cond: $i4 != 59  
(define-const var1425 String "O") ; Statement: $r7 = "O" 
 ; Statement: goto [?= virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r7)] 
(assert true) ; Non Conditional
(assert true)
;(assert (append/672562846 var3212!1 var1425)) ; Statement: virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r7) 
(declare-const var3212!2 String)
(assert (= var3212!2 (str.++ var3212!1 var1425)))
(assert true)
(define-const var1804 Bool (isOptimistic/-1593152072 var2750)) ; Statement: $z0 = virtualinvoke r1.<jdk.nashorn.internal.ir.Expression: boolean isOptimistic()>() 
 ; Statement: if $z0 == 0 goto virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(125) 
(assert (= (ite var1804 1 0) 0)) ; Cond: $z0 == 0 
(assert true)
;(assert (append/-1166366385 var3212!2 125)) ; Statement: virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(125) 
(declare-const var3212!3 String)
(assert (str.prefixof var3212!2 var3212!3))
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
