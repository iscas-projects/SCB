...
(assert (and true (and (> (str.len var2382) var721) (<= 0 var721))))
(define-const var3183 Int (charAt/698050440 var2382 var721)) ; Statement: $c2 = virtualinvoke $r6.<java.lang.String: char charAt(int)>($i1) 
(define-const var1449 Int (cast-from-Int-to-Int var3183)) ; Statement: $i4 = (int) $c2 
 ; Statement: if $i4 != 59 goto $r7 = $r6 
(assert (not (= var1449 59))) ; Cond: $i4 != 59 
(define-const var3327 String var2382) ; Statement: $r7 = $r6 
(assert true) ; Non Conditional
(assert true)
;(assert (append/672562846 var2642!1 var3327)) ; Statement: virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r7) 
(declare-const var2642!2 String)
(assert (= var2642!2 (str.++ var2642!1 var3327)))
(assert true)
(define-const var2273 Bool (isOptimistic/-1593152072 var3310)) ; Statement: $z0 = virtualinvoke r1.<jdk.nashorn.internal.ir.Expression: boolean isOptimistic()>() 
...
(assert true)
;(assert (append/-1166366385 var2642!2 125)) ; Statement: virtualinvoke r0.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(125) 
(declare-const var2642!3 String)
(assert (str.prefixof var2642!2 var2642!3))
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
