...
(assert (and true (and (>= var3668 0) (>= (str.len var2804) var3668))))
(define-const var2225 String (substring/850833817 var2804 var3668)) ; Statement: $r4 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int)>($i2) 
