...
(assert (and true (and (>= 0 0) (>= (str.len var248) var1046) (>= var1046 0))))
(define-const var1275 String (substring/-1240304868 var248 0 var1046)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
