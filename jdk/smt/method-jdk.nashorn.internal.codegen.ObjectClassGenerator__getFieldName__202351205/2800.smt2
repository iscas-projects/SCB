...
(assert (and true (and (>= 0 0) (>= (str.len var877) 1) (>= 1 0))))
(define-const var895 String (substring/-1240304868 var877 0 1)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, 1) 
(assert true)
(define-const var1693 String (append/672562846 var2345!1 var895)) ; Statement: $r4 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var2345!2 String)
(assert (= var2345!2 (str.++ var2345!1 var895)))
(assert true)
(define-const var1632 String (append/-1001720160 var1693 var855)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(int)>(i0) 
(declare-const var1693!1 String)
(assert (str.prefixof var1693 var1693!1))
(assert true)
(define-const var2775 String (toString/-2075883882 var1632)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
