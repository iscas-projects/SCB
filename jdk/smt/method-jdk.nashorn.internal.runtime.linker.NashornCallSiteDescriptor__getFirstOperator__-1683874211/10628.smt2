...
(assert (and true (and (>= 0 0) (>= (str.len var389) var1383) (>= var1383 0))))
(define-const var1117 String (substring/-1240304868 var389 0 var1383)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
