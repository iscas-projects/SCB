...
(assert (and true (and (>= 0 0) (>= (str.len var3623) var39) (>= var39 0))))
(define-const var2001 String (substring/-1240304868 var3623 0 var39)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
