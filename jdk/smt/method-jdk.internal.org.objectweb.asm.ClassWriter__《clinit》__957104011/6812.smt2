...
(assert (and true (and (> (str.len var3263) var899!2) (<= 0 var899!2))))
(define-const var3713!2 Int (charAt/698050440 var3263 var899!2)) ; Statement: $c1 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i4) 
(define-const var2839!2 Int (cast-from-Int-to-Int var3713!2)) ; Statement: $i5 = (int) $c1 
(define-const var3758!2 Int (- var2839!2 65)) ; Statement: $i2 = $i5 - 65 
(define-const var3802!2 Int (cast-from-Int-to-Int var3758!2)) ; Statement: $b3 = (byte) $i2 
(declare-const var1096!3 (Array Int Int))
(assert (not (= var1096!3 null-__Array__Int__Int__)))
(assert (= (select var1096!3 var899!2) var3802!2)) ; Statement: r0[i4] = $b3 
(define-const var899!3 Int (+ var899!2 1)) ; Statement: i4 = i4 + 1 
 ; Statement: goto [?= $i0 = lengthof r0] 
(assert true) ; Non Conditional
(define-const var2212!3 Int (getLength-Arr-Int-1 var1096!3)) ; Statement: $i0 = lengthof r0 
 ; Statement: if i4 >= $i0 goto <jdk.internal.org.objectweb.asm.ClassWriter: byte[] TYPE> = r0 
(assert (>= var899!3 var2212!3)) ; Cond: i4 >= $i0 
(define-const var2316 (Array Int Int) var1096!3) ; Statement: <jdk.internal.org.objectweb.asm.ClassWriter: byte[] TYPE> = r0 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
