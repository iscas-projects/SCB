...
(assert (and true (and (> (str.len var3362) var2549) (<= 0 var2549))))
(define-const var561 Int (charAt/698050440 var3362 var2549)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i9) 
(define-const var2186 Int (cast-from-Int-to-Int var561)) ; Statement: $i13 = (int) $c0 
...
(assert (and (= var2186 66) true)) ; Intersect: Cond: $i13 == 66  and Non Conditional 
(assert true)
;(assert (visitBaseType/-615989239 var2412 var561)) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.signature.SignatureVisitor: void visitBaseType(char)>($c0) 

(declare-const var2412!1 var736)
