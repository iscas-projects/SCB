...
(assert (and true (and (> (str.len var1758) var777) (<= 0 var777))))
(define-const var3233 Int (charAt/698050440 var1758 var777)) ; Statement: $c3 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i2) 
(define-const var1761 Int (cast-from-Int-to-Int var3233)) ; Statement: $i6 = (int) $c3 
 ; Statement: return $i6 
(check-sat)
(get-model)
(get-unsat-core)
