...
(assert (and true (and (> (str.len var3235) 0) (<= 0 0))))
(define-const var2060 Int (charAt/698050440 var3235 0)) ; Statement: c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var3475 Int (cast-from-Int-to-Int var2060)) ; Statement: $i5 = (int) c0 
 ; Statement: if $i5 != 40 goto $i6 = (int) c0 
(assert (not (= var3475 40))) ; Cond: $i5 != 40 
(define-const var836 Int (cast-from-Int-to-Int var2060)) ; Statement: $i6 = (int) c0 
 ; Statement: if $i6 == 74 goto specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void pop(int)>(2) 
(assert (= var836 74)) ; Cond: $i6 == 74 
(assert true)
;(assert (pop/348358588 var3750 2)) ; Statement: specialinvoke r1.<jdk.internal.org.objectweb.asm.commons.AnalyzerAdapter: void pop(int)>(2) 

(declare-const var3750!1 var1246)
