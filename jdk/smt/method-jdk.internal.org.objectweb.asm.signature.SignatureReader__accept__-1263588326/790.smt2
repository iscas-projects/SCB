...
(assert (and true (and (> (str.len var3457) var2716) (<= 0 var2716))))
(define-const var337 Int (charAt/698050440 var3457 var2716)) ; Statement: $c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i10) 
(define-const var2131 Int (cast-from-Int-to-Int var337)) ; Statement: $i22 = (int) $c2 
 ; Statement: if $i22 != 40 goto $r3 = virtualinvoke r2.<jdk.internal.org.objectweb.asm.signature.SignatureVisitor: jdk.internal.org.objectweb.asm.signature.SignatureVisitor visitSuperclass()>() 
(assert (not (= var2131 40))) ; Cond: $i22 != 40 
(assert true)
(define-const var2588 var2923 (visitSuperclass/-1297122273 var2471)) ; Statement: $r3 = virtualinvoke r2.<jdk.internal.org.objectweb.asm.signature.SignatureVisitor: jdk.internal.org.objectweb.asm.signature.SignatureVisitor visitSuperclass()>() 
(define-const var1291 Int (var341_parseType/-1077406896 var3457 var2716 var2588)) ; Statement: i15 = staticinvoke <jdk.internal.org.objectweb.asm.signature.SignatureReader: int parseType(java.lang.String,int,jdk.internal.org.objectweb.asm.signature.SignatureVisitor)>(r1, i10, $r3) 
(assert true) ; Non Conditional
 ; Statement: if i15 >= i0 goto return 
(assert (>= var1291 var3389)) ; Cond: i15 >= i0 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
