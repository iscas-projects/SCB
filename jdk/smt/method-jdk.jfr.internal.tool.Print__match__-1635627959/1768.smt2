...
(assert (and true (and (> (str.len var380) 0) (<= 0 0))))
(define-const var839 Int (charAt/698050440 var380 0)) ; Statement: $c1 = virtualinvoke r6.<java.lang.String: char charAt(int)>(0) 
(define-const var3873 Int (cast-from-Int-to-Int var839)) ; Statement: $i9 = (int) $c1 
 ; Statement: if $i9 != 42 goto $i2 = virtualinvoke r0.<java.lang.String: int length()>() 
(assert (not (= var3873 42))) ; Cond: $i9 != 42 
(assert true)
(define-const var1333 Int (length/-134980193 var2356)) ; Statement: $i2 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if $i2 != 0 goto $c3 = virtualinvoke r6.<java.lang.String: char charAt(int)>(0) 
(assert (not (not (= var1333 0)))) ; Negate: Cond: $i2 != 0  
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
