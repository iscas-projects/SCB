...
(assert (and true (and (>= var2499 0) (>= (str.len var3961) var2499))))
(define-const var1959 String (substring/850833817 var3961 var2499)) ; Statement: r41 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true) ; Non Conditional
(define-const var805 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r10 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var805 (cast-from-String-to-var1137 "import java.util.*;\n"))) ; Statement: interfaceinvoke $r10.<java.util.List: boolean add(java.lang.Object)>("import java.util.*;\n") 

(declare-const var805!1 var3244)
(declare-const var2696 String)
(define-const var2567 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r11 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var2567 (cast-from-String-to-var1137 "import jdk.internal.org.objectweb.asm.*;\n"))) ; Statement: interfaceinvoke $r11.<java.util.List: boolean add(java.lang.Object)>("import jdk.internal.org.objectweb.asm.*;\n") 

(declare-const var2567!1 var3244)
(declare-const var1363 String)
(define-const var251 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r13 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var345 String String-init) ; Statement: $r53 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var345)) ; Statement: specialinvoke $r53.<java.lang.StringBuilder: void <init>()>() 
(declare-const var345!1 String)
(assert (= var345!1 ""))
(assert true)
(define-const var3462 String (append/672562846 var345!1 "public class ")) ; Statement: $r14 = virtualinvoke $r53.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("public class ") 
(declare-const var345!2 String)
(assert (= var345!2 (str.++ var345!1 "public class ")))
(assert true)
(define-const var3815 String (append/672562846 var3462 var1959)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r41) 
(declare-const var3462!1 String)
(assert (= var3462!1 (str.++ var3462 var1959)))
(assert true)
(define-const var449 String (append/672562846 var3815 "Dump implements Opcodes {\n\n")) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Dump implements Opcodes {\n\n") 
(declare-const var3815!1 String)
(assert (= var3815!1 (str.++ var3815 "Dump implements Opcodes {\n\n")))
(assert true)
(define-const var1680 String (toString/-2075883882 var449)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.String toString()>() 
;(assert (var3244_add/328494887 var251 (cast-from-String-to-var1137 var1680))) ; Statement: interfaceinvoke $r13.<java.util.List: boolean add(java.lang.Object)>($r17) 

(declare-const var251!1 var3244)
(declare-const var1680!1 String)
(define-const var1897 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r18 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var1897 (cast-from-String-to-var1137 "public static byte[] dump () throws Exception {\n\n"))) ; Statement: interfaceinvoke $r18.<java.util.List: boolean add(java.lang.Object)>("public static byte[] dump () throws Exception {\n\n") 

(declare-const var1897!1 var3244)
(declare-const var799 String)
(define-const var788 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r19 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var788 (cast-from-String-to-var1137 "ClassWriter cw = new ClassWriter(0);\n"))) ; Statement: interfaceinvoke $r19.<java.util.List: boolean add(java.lang.Object)>("ClassWriter cw = new ClassWriter(0);\n") 

(declare-const var788!1 var3244)
(declare-const var1967 String)
(define-const var1337 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r20 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var1337 (cast-from-String-to-var1137 "FieldVisitor fv;\n"))) ; Statement: interfaceinvoke $r20.<java.util.List: boolean add(java.lang.Object)>("FieldVisitor fv;\n") 

(declare-const var1337!1 var3244)
(declare-const var783 String)
(define-const var866 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r21 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var866 (cast-from-String-to-var1137 "MethodVisitor mv;\n"))) ; Statement: interfaceinvoke $r21.<java.util.List: boolean add(java.lang.Object)>("MethodVisitor mv;\n") 

(declare-const var866!1 var3244)
(declare-const var932 String)
(define-const var483 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r22 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3244_add/328494887 var483 (cast-from-String-to-var1137 "AnnotationVisitor av0;\n\n"))) ; Statement: interfaceinvoke $r22.<java.util.List: boolean add(java.lang.Object)>("AnnotationVisitor av0;\n\n") 

(declare-const var483!1 var3244)
(declare-const var189 String)
(define-const var3256 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r23 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (setLength/163251007 var3256 0)) ; Statement: virtualinvoke $r23.<java.lang.StringBuffer: void setLength(int)>(0) 

(declare-const var3256!1 String)
(declare-const var3464 Int)
(define-const var2869 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r24 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2869 "cw.visit(")) ; Statement: virtualinvoke $r24.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("cw.visit(") 
(declare-const var2869!1 String)
(assert (str.prefixof var2869 var2869!1))
...
(assert (and (= var1216 46) true)) ; Intersect: Cond: i2 == 46  and Non Conditional 
(define-const var2196 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r39 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2196 "V1_2")) ; Statement: virtualinvoke $r39.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("V1_2") 
...
(assert true) ; Non Conditional
(define-const var281 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527))) ; Statement: $r42 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var281 ", ")) ; Statement: virtualinvoke $r42.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var281!1 String)
(assert (str.prefixof var281 var281!1))
(define-const var464 Int (bv2nat (bvor ((_ int2bv 64) var1527) ((_ int2bv 64) 262144)))) ; Statement: $i6 = i3 | 262144 
(assert true)
;(assert (appendAccess/732682052 var2527 var464)) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendAccess(int)>($i6) 

(declare-const var2527!1 var1452)
(declare-const var464!1 Int)
(define-const var2530 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!1))) ; Statement: $r43 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2530 ", ")) ; Statement: virtualinvoke $r43.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var2530!1 String)
(assert (str.prefixof var2530 var2530!1))
(assert true)
;(assert (appendConstant/2119113448 var2527!1 (cast-from-String-to-var1137 var3961))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r0) 

(declare-const var2527!2 var1452)
(declare-const var3961!1 String)
(define-const var16 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!2))) ; Statement: $r44 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var16 ", ")) ; Statement: virtualinvoke $r44.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var16!1 String)
(assert (str.prefixof var16 var16!1))
(assert true)
;(assert (appendConstant/2119113448 var2527!2 (cast-from-String-to-var1137 var3883))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r26) 

(declare-const var2527!3 var1452)
(declare-const var3883!1 String)
(define-const var342 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!3))) ; Statement: $r45 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var342 ", ")) ; Statement: virtualinvoke $r45.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var342!1 String)
(assert (str.prefixof var342 var342!1))
(assert true)
;(assert (appendConstant/2119113448 var2527!3 (cast-from-String-to-var1137 var3291))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r27) 

(declare-const var2527!4 var1452)
(declare-const var3291!1 String)
(define-const var381 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!4))) ; Statement: $r46 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var381 ", ")) ; Statement: virtualinvoke $r46.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
...
(assert (= var430 null-__Array__Int__String__)) ; Cond: r28 == null 
(define-const var2639 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!4))) ; Statement: $r29 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2639 "null")) ; Statement: virtualinvoke $r29.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("null") 
(declare-const var2639!1 String)
(assert (str.prefixof var2639 var2639!1))
(assert true) ; Non Conditional
(define-const var3105 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!4))) ; Statement: $r48 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3105 ");\n\n")) ; Statement: virtualinvoke $r48.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(");\n\n") 
(declare-const var3105!1 String)
(assert (str.prefixof var3105 var3105!1))
(define-const var1338 var3244 (text/-10557480 (cast-from-var1452-to-var3303 var2527!4))) ; Statement: $r49 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var358 String (buf/-10557480 (cast-from-var1452-to-var3303 var2527!4))) ; Statement: $r50 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
(define-const var3080 String (toString/-222306083 var358)) ; Statement: $r51 = virtualinvoke $r50.<java.lang.StringBuffer: java.lang.String toString()>() 
;(assert (var3244_add/328494887 var1338 (cast-from-String-to-var1137 var3080))) ; Statement: interfaceinvoke $r49.<java.util.List: boolean add(java.lang.Object)>($r51) 

(declare-const var1338!1 var3244)
