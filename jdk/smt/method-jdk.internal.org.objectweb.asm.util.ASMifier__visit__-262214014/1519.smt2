...
(assert (and true (and (>= var1679 0) (>= (str.len var2378) var1679))))
(define-const var105 String (substring/850833817 var2378 var1679)) ; Statement: r41 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true) ; Non Conditional
(define-const var1352 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r10 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var1352 (cast-from-String-to-var2581 "import java.util.*;\n"))) ; Statement: interfaceinvoke $r10.<java.util.List: boolean add(java.lang.Object)>("import java.util.*;\n") 

(declare-const var1352!1 var2412)
(declare-const var2977 String)
(define-const var3986 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r11 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var3986 (cast-from-String-to-var2581 "import jdk.internal.org.objectweb.asm.*;\n"))) ; Statement: interfaceinvoke $r11.<java.util.List: boolean add(java.lang.Object)>("import jdk.internal.org.objectweb.asm.*;\n") 

(declare-const var3986!1 var2412)
(declare-const var373 String)
(define-const var935 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r13 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var566 String String-init) ; Statement: $r53 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var566)) ; Statement: specialinvoke $r53.<java.lang.StringBuilder: void <init>()>() 
(declare-const var566!1 String)
(assert (= var566!1 ""))
(assert true)
(define-const var1034 String (append/672562846 var566!1 "public class ")) ; Statement: $r14 = virtualinvoke $r53.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("public class ") 
(declare-const var566!2 String)
(assert (= var566!2 (str.++ var566!1 "public class ")))
(assert true)
(define-const var2966 String (append/672562846 var1034 var105)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r41) 
(declare-const var1034!1 String)
(assert (= var1034!1 (str.++ var1034 var105)))
(assert true)
(define-const var3736 String (append/672562846 var2966 "Dump implements Opcodes {\n\n")) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Dump implements Opcodes {\n\n") 
(declare-const var2966!1 String)
(assert (= var2966!1 (str.++ var2966 "Dump implements Opcodes {\n\n")))
(assert true)
(define-const var780 String (toString/-2075883882 var3736)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.String toString()>() 
;(assert (var2412_add/328494887 var935 (cast-from-String-to-var2581 var780))) ; Statement: interfaceinvoke $r13.<java.util.List: boolean add(java.lang.Object)>($r17) 

(declare-const var935!1 var2412)
(declare-const var780!1 String)
(define-const var959 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r18 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var959 (cast-from-String-to-var2581 "public static byte[] dump () throws Exception {\n\n"))) ; Statement: interfaceinvoke $r18.<java.util.List: boolean add(java.lang.Object)>("public static byte[] dump () throws Exception {\n\n") 

(declare-const var959!1 var2412)
(declare-const var2868 String)
(define-const var3381 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r19 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var3381 (cast-from-String-to-var2581 "ClassWriter cw = new ClassWriter(0);\n"))) ; Statement: interfaceinvoke $r19.<java.util.List: boolean add(java.lang.Object)>("ClassWriter cw = new ClassWriter(0);\n") 

(declare-const var3381!1 var2412)
(declare-const var1842 String)
(define-const var1830 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r20 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var1830 (cast-from-String-to-var2581 "FieldVisitor fv;\n"))) ; Statement: interfaceinvoke $r20.<java.util.List: boolean add(java.lang.Object)>("FieldVisitor fv;\n") 

(declare-const var1830!1 var2412)
(declare-const var3973 String)
(define-const var2331 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r21 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var2331 (cast-from-String-to-var2581 "MethodVisitor mv;\n"))) ; Statement: interfaceinvoke $r21.<java.util.List: boolean add(java.lang.Object)>("MethodVisitor mv;\n") 

(declare-const var2331!1 var2412)
(declare-const var2257 String)
(define-const var931 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r22 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var2412_add/328494887 var931 (cast-from-String-to-var2581 "AnnotationVisitor av0;\n\n"))) ; Statement: interfaceinvoke $r22.<java.util.List: boolean add(java.lang.Object)>("AnnotationVisitor av0;\n\n") 

(declare-const var931!1 var2412)
(declare-const var3748 String)
(define-const var1222 String (buf/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r23 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (setLength/163251007 var1222 0)) ; Statement: virtualinvoke $r23.<java.lang.StringBuffer: void setLength(int)>(0) 

(declare-const var1222!1 String)
(declare-const var2965 Int)
(define-const var2865 String (buf/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r24 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2865 "cw.visit(")) ; Statement: virtualinvoke $r24.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("cw.visit(") 
...
(assert (and (= var447 47) (and (not (= var447 46)) true))) ; Intersect: Cond: i2 == 47  and Intersect: Negate: Cond: i2 == 46   and Non Conditional  
(define-const var2673 String (buf/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r38 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2673 "V1_3")) ; Statement: virtualinvoke $r38.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("V1_3") 
...
(assert true) ; Non Conditional
(define-const var3338 String (buf/-10557480 (cast-from-var3144-to-var3147 var12))) ; Statement: $r42 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3338 ", ")) ; Statement: virtualinvoke $r42.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var3338!1 String)
(assert (str.prefixof var3338 var3338!1))
(define-const var3715 Int (bv2nat (bvor ((_ int2bv 64) var2137) ((_ int2bv 64) 262144)))) ; Statement: $i6 = i3 | 262144 
(assert true)
;(assert (appendAccess/732682052 var12 var3715)) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendAccess(int)>($i6) 

(declare-const var12!1 var3144)
(declare-const var3715!1 Int)
(define-const var562 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!1))) ; Statement: $r43 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var562 ", ")) ; Statement: virtualinvoke $r43.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var562!1 String)
(assert (str.prefixof var562 var562!1))
(assert true)
;(assert (appendConstant/2119113448 var12!1 (cast-from-String-to-var2581 var2378))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r0) 

(declare-const var12!2 var3144)
(declare-const var2378!1 String)
(define-const var2468 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!2))) ; Statement: $r44 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2468 ", ")) ; Statement: virtualinvoke $r44.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var2468!1 String)
(assert (str.prefixof var2468 var2468!1))
(assert true)
;(assert (appendConstant/2119113448 var12!2 (cast-from-String-to-var2581 var484))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r26) 

(declare-const var12!3 var3144)
(declare-const var484!1 String)
(define-const var266 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!3))) ; Statement: $r45 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var266 ", ")) ; Statement: virtualinvoke $r45.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var266!1 String)
(assert (str.prefixof var266 var266!1))
(assert true)
;(assert (appendConstant/2119113448 var12!3 (cast-from-String-to-var2581 var2639))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r27) 

(declare-const var12!4 var3144)
(declare-const var2639!1 String)
(define-const var3225 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!4))) ; Statement: $r46 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3225 ", ")) ; Statement: virtualinvoke $r46.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
...
(assert (= var3169 null-__Array__Int__String__)) ; Cond: r28 == null 
(define-const var1871 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!4))) ; Statement: $r29 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1871 "null")) ; Statement: virtualinvoke $r29.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("null") 
(declare-const var1871!1 String)
(assert (str.prefixof var1871 var1871!1))
(assert true) ; Non Conditional
(define-const var102 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!4))) ; Statement: $r48 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var102 ");\n\n")) ; Statement: virtualinvoke $r48.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(");\n\n") 
(declare-const var102!1 String)
(assert (str.prefixof var102 var102!1))
(define-const var2953 var2412 (text/-10557480 (cast-from-var3144-to-var3147 var12!4))) ; Statement: $r49 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var2400 String (buf/-10557480 (cast-from-var3144-to-var3147 var12!4))) ; Statement: $r50 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
(define-const var304 String (toString/-222306083 var2400)) ; Statement: $r51 = virtualinvoke $r50.<java.lang.StringBuffer: java.lang.String toString()>() 
;(assert (var2412_add/328494887 var2953 (cast-from-String-to-var2581 var304))) ; Statement: interfaceinvoke $r49.<java.util.List: boolean add(java.lang.Object)>($r51) 

(declare-const var2953!1 var2412)
