...
(assert (and true (and (>= var3082 0) (>= (str.len var979) var3082))))
(define-const var359 String (substring/850833817 var979 var3082)) ; Statement: r41 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true) ; Non Conditional
(define-const var1578 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r10 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var1578 (cast-from-String-to-var1556 "import java.util.*;\n"))) ; Statement: interfaceinvoke $r10.<java.util.List: boolean add(java.lang.Object)>("import java.util.*;\n") 

(declare-const var1578!1 var3971)
(declare-const var2753 String)
(define-const var630 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r11 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var630 (cast-from-String-to-var1556 "import jdk.internal.org.objectweb.asm.*;\n"))) ; Statement: interfaceinvoke $r11.<java.util.List: boolean add(java.lang.Object)>("import jdk.internal.org.objectweb.asm.*;\n") 

(declare-const var630!1 var3971)
(declare-const var246 String)
(define-const var1231 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r13 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var2368 String String-init) ; Statement: $r53 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2368)) ; Statement: specialinvoke $r53.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2368!1 String)
(assert (= var2368!1 ""))
(assert true)
(define-const var3289 String (append/672562846 var2368!1 "public class ")) ; Statement: $r14 = virtualinvoke $r53.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("public class ") 
(declare-const var2368!2 String)
(assert (= var2368!2 (str.++ var2368!1 "public class ")))
(assert true)
(define-const var2237 String (append/672562846 var3289 var359)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r41) 
(declare-const var3289!1 String)
(assert (= var3289!1 (str.++ var3289 var359)))
(assert true)
(define-const var2312 String (append/672562846 var2237 "Dump implements Opcodes {\n\n")) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Dump implements Opcodes {\n\n") 
(declare-const var2237!1 String)
(assert (= var2237!1 (str.++ var2237 "Dump implements Opcodes {\n\n")))
(assert true)
(define-const var260 String (toString/-2075883882 var2312)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.String toString()>() 
;(assert (var3971_add/328494887 var1231 (cast-from-String-to-var1556 var260))) ; Statement: interfaceinvoke $r13.<java.util.List: boolean add(java.lang.Object)>($r17) 

(declare-const var1231!1 var3971)
(declare-const var260!1 String)
(define-const var3963 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r18 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var3963 (cast-from-String-to-var1556 "public static byte[] dump () throws Exception {\n\n"))) ; Statement: interfaceinvoke $r18.<java.util.List: boolean add(java.lang.Object)>("public static byte[] dump () throws Exception {\n\n") 

(declare-const var3963!1 var3971)
(declare-const var44 String)
(define-const var506 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r19 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var506 (cast-from-String-to-var1556 "ClassWriter cw = new ClassWriter(0);\n"))) ; Statement: interfaceinvoke $r19.<java.util.List: boolean add(java.lang.Object)>("ClassWriter cw = new ClassWriter(0);\n") 

(declare-const var506!1 var3971)
(declare-const var635 String)
(define-const var787 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r20 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var787 (cast-from-String-to-var1556 "FieldVisitor fv;\n"))) ; Statement: interfaceinvoke $r20.<java.util.List: boolean add(java.lang.Object)>("FieldVisitor fv;\n") 

(declare-const var787!1 var3971)
(declare-const var2563 String)
(define-const var2854 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r21 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var2854 (cast-from-String-to-var1556 "MethodVisitor mv;\n"))) ; Statement: interfaceinvoke $r21.<java.util.List: boolean add(java.lang.Object)>("MethodVisitor mv;\n") 

(declare-const var2854!1 var3971)
(declare-const var1661 String)
(define-const var2507 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r22 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3971_add/328494887 var2507 (cast-from-String-to-var1556 "AnnotationVisitor av0;\n\n"))) ; Statement: interfaceinvoke $r22.<java.util.List: boolean add(java.lang.Object)>("AnnotationVisitor av0;\n\n") 

(declare-const var2507!1 var3971)
(declare-const var2557 String)
(define-const var34 String (buf/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r23 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (setLength/163251007 var34 0)) ; Statement: virtualinvoke $r23.<java.lang.StringBuffer: void setLength(int)>(0) 

(declare-const var34!1 String)
(declare-const var858 Int)
(define-const var920 String (buf/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r24 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var920 "cw.visit(")) ; Statement: virtualinvoke $r24.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("cw.visit(") 
(declare-const var920!1 String)
(assert (str.prefixof var920 var920!1))
...
(assert (and (= var642 48) (and (not (= var642 47)) (and (not (= var642 46)) true)))) ; Intersect: Cond: i2 == 48  and Intersect: Negate: Cond: i2 == 47   and Intersect: Negate: Cond: i2 == 46   and Non Conditional   
(define-const var1866 String (buf/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r37 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1866 "V1_4")) ; Statement: virtualinvoke $r37.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("V1_4") 
...
(assert true) ; Non Conditional
(define-const var3748 String (buf/-10557480 (cast-from-var2634-to-var2113 var983))) ; Statement: $r42 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3748 ", ")) ; Statement: virtualinvoke $r42.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var3748!1 String)
(assert (str.prefixof var3748 var3748!1))
(define-const var102 Int (bv2nat (bvor ((_ int2bv 64) var2083) ((_ int2bv 64) 262144)))) ; Statement: $i6 = i3 | 262144 
(assert true)
;(assert (appendAccess/732682052 var983 var102)) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendAccess(int)>($i6) 

(declare-const var983!1 var2634)
(declare-const var102!1 Int)
(define-const var712 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!1))) ; Statement: $r43 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var712 ", ")) ; Statement: virtualinvoke $r43.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var712!1 String)
(assert (str.prefixof var712 var712!1))
(assert true)
;(assert (appendConstant/2119113448 var983!1 (cast-from-String-to-var1556 var979))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r0) 

(declare-const var983!2 var2634)
(declare-const var979!1 String)
(define-const var524 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!2))) ; Statement: $r44 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var524 ", ")) ; Statement: virtualinvoke $r44.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var524!1 String)
(assert (str.prefixof var524 var524!1))
(assert true)
;(assert (appendConstant/2119113448 var983!2 (cast-from-String-to-var1556 var1168))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r26) 

(declare-const var983!3 var2634)
(declare-const var1168!1 String)
(define-const var3535 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!3))) ; Statement: $r45 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3535 ", ")) ; Statement: virtualinvoke $r45.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var3535!1 String)
(assert (str.prefixof var3535 var3535!1))
(assert true)
;(assert (appendConstant/2119113448 var983!3 (cast-from-String-to-var1556 var1316))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r27) 

(declare-const var983!4 var2634)
(declare-const var1316!1 String)
(define-const var1180 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!4))) ; Statement: $r46 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1180 ", ")) ; Statement: virtualinvoke $r46.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var1180!1 String)
(assert (str.prefixof var1180 var1180!1))
 ; Statement: if r28 == null goto $r29 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert (= var1999 null-__Array__Int__String__)) ; Cond: r28 == null 
(define-const var255 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!4))) ; Statement: $r29 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var255 "null")) ; Statement: virtualinvoke $r29.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("null") 
(declare-const var255!1 String)
(assert (str.prefixof var255 var255!1))
(assert true) ; Non Conditional
(define-const var838 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!4))) ; Statement: $r48 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var838 ");\n\n")) ; Statement: virtualinvoke $r48.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(");\n\n") 
(declare-const var838!1 String)
(assert (str.prefixof var838 var838!1))
(define-const var3633 var3971 (text/-10557480 (cast-from-var2634-to-var2113 var983!4))) ; Statement: $r49 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var86 String (buf/-10557480 (cast-from-var2634-to-var2113 var983!4))) ; Statement: $r50 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
(define-const var3356 String (toString/-222306083 var86)) ; Statement: $r51 = virtualinvoke $r50.<java.lang.StringBuffer: java.lang.String toString()>() 
;(assert (var3971_add/328494887 var3633 (cast-from-String-to-var1556 var3356))) ; Statement: interfaceinvoke $r49.<java.util.List: boolean add(java.lang.Object)>($r51) 

(declare-const var3633!1 var3971)
