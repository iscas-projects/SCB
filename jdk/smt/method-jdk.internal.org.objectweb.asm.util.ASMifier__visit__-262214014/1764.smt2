...
(assert (and true (and (>= var209 0) (>= (str.len var3741) var209))))
(define-const var3370 String (substring/850833817 var3741 var209)) ; Statement: r41 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true) ; Non Conditional
(define-const var2285 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r10 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var2285 (cast-from-String-to-var1621 "import java.util.*;\n"))) ; Statement: interfaceinvoke $r10.<java.util.List: boolean add(java.lang.Object)>("import java.util.*;\n") 

(declare-const var2285!1 var3050)
(declare-const var1550 String)
(define-const var1007 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r11 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var1007 (cast-from-String-to-var1621 "import jdk.internal.org.objectweb.asm.*;\n"))) ; Statement: interfaceinvoke $r11.<java.util.List: boolean add(java.lang.Object)>("import jdk.internal.org.objectweb.asm.*;\n") 

(declare-const var1007!1 var3050)
(declare-const var2427 String)
(define-const var2154 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r13 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var2428 String String-init) ; Statement: $r53 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2428)) ; Statement: specialinvoke $r53.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2428!1 String)
(assert (= var2428!1 ""))
(assert true)
(define-const var1997 String (append/672562846 var2428!1 "public class ")) ; Statement: $r14 = virtualinvoke $r53.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("public class ") 
(declare-const var2428!2 String)
(assert (= var2428!2 (str.++ var2428!1 "public class ")))
(assert true)
(define-const var1715 String (append/672562846 var1997 var3370)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r41) 
(declare-const var1997!1 String)
(assert (= var1997!1 (str.++ var1997 var3370)))
(assert true)
(define-const var3942 String (append/672562846 var1715 "Dump implements Opcodes {\n\n")) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Dump implements Opcodes {\n\n") 
(declare-const var1715!1 String)
(assert (= var1715!1 (str.++ var1715 "Dump implements Opcodes {\n\n")))
(assert true)
(define-const var2752 String (toString/-2075883882 var3942)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.String toString()>() 
;(assert (var3050_add/328494887 var2154 (cast-from-String-to-var1621 var2752))) ; Statement: interfaceinvoke $r13.<java.util.List: boolean add(java.lang.Object)>($r17) 

(declare-const var2154!1 var3050)
(declare-const var2752!1 String)
(define-const var358 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r18 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var358 (cast-from-String-to-var1621 "public static byte[] dump () throws Exception {\n\n"))) ; Statement: interfaceinvoke $r18.<java.util.List: boolean add(java.lang.Object)>("public static byte[] dump () throws Exception {\n\n") 

(declare-const var358!1 var3050)
(declare-const var2139 String)
(define-const var1526 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r19 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var1526 (cast-from-String-to-var1621 "ClassWriter cw = new ClassWriter(0);\n"))) ; Statement: interfaceinvoke $r19.<java.util.List: boolean add(java.lang.Object)>("ClassWriter cw = new ClassWriter(0);\n") 

(declare-const var1526!1 var3050)
(declare-const var3493 String)
(define-const var2499 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r20 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var2499 (cast-from-String-to-var1621 "FieldVisitor fv;\n"))) ; Statement: interfaceinvoke $r20.<java.util.List: boolean add(java.lang.Object)>("FieldVisitor fv;\n") 

(declare-const var2499!1 var3050)
(declare-const var1958 String)
(define-const var3772 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r21 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var3772 (cast-from-String-to-var1621 "MethodVisitor mv;\n"))) ; Statement: interfaceinvoke $r21.<java.util.List: boolean add(java.lang.Object)>("MethodVisitor mv;\n") 

(declare-const var3772!1 var3050)
(declare-const var1468 String)
(define-const var3151 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r22 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
;(assert (var3050_add/328494887 var3151 (cast-from-String-to-var1621 "AnnotationVisitor av0;\n\n"))) ; Statement: interfaceinvoke $r22.<java.util.List: boolean add(java.lang.Object)>("AnnotationVisitor av0;\n\n") 

(declare-const var3151!1 var3050)
(declare-const var1023 String)
(define-const var3367 String (buf/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r23 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (setLength/163251007 var3367 0)) ; Statement: virtualinvoke $r23.<java.lang.StringBuffer: void setLength(int)>(0) 

(declare-const var3367!1 String)
(declare-const var1579 Int)
(define-const var3261 String (buf/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r24 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3261 "cw.visit(")) ; Statement: virtualinvoke $r24.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("cw.visit(") 
...
(assert (and (not (= var1485 196653)) (and (not (= var1485 51)) (and (not (= var1485 50)) (and (not (= var1485 49)) (and (not (= var1485 48)) (and (not (= var1485 47)) (and (not (= var1485 46)) true)))))))) ; Intersect: Negate: Cond: i2 == 196653   and Intersect: Negate: Cond: i2 == 51   and Intersect: Negate: Cond: i2 == 50   and Intersect: Negate: Cond: i2 == 49   and Intersect: Negate: Cond: i2 == 48   and Intersect: Negate: Cond: i2 == 47   and Intersect: Negate: Cond: i2 == 46   and Non Conditional       
(define-const var2164 String (buf/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r40 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1845021834 var2164 var1485)) ; Statement: virtualinvoke $r40.<java.lang.StringBuffer: java.lang.StringBuffer append(int)>(i2) 

(declare-const var2164!1 String)
(declare-const var1485!1 Int)
(assert true) ; Non Conditional
(define-const var1684 String (buf/-10557480 (cast-from-var313-to-var873 var2157))) ; Statement: $r42 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1684 ", ")) ; Statement: virtualinvoke $r42.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var1684!1 String)
(assert (str.prefixof var1684 var1684!1))
(define-const var1844 Int (bv2nat (bvor ((_ int2bv 64) var1508) ((_ int2bv 64) 262144)))) ; Statement: $i6 = i3 | 262144 
(assert true)
;(assert (appendAccess/732682052 var2157 var1844)) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendAccess(int)>($i6) 

(declare-const var2157!1 var313)
(declare-const var1844!1 Int)
(define-const var2744 String (buf/-10557480 (cast-from-var313-to-var873 var2157!1))) ; Statement: $r43 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var2744 ", ")) ; Statement: virtualinvoke $r43.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var2744!1 String)
(assert (str.prefixof var2744 var2744!1))
(assert true)
;(assert (appendConstant/2119113448 var2157!1 (cast-from-String-to-var1621 var3741))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r0) 

(declare-const var2157!2 var313)
(declare-const var3741!1 String)
(define-const var1184 String (buf/-10557480 (cast-from-var313-to-var873 var2157!2))) ; Statement: $r44 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1184 ", ")) ; Statement: virtualinvoke $r44.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var1184!1 String)
(assert (str.prefixof var1184 var1184!1))
(assert true)
;(assert (appendConstant/2119113448 var2157!2 (cast-from-String-to-var1621 var3511))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r26) 

(declare-const var2157!3 var313)
(declare-const var3511!1 String)
(define-const var3881 String (buf/-10557480 (cast-from-var313-to-var873 var2157!3))) ; Statement: $r45 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var3881 ", ")) ; Statement: virtualinvoke $r45.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
(declare-const var3881!1 String)
(assert (str.prefixof var3881 var3881!1))
(assert true)
;(assert (appendConstant/2119113448 var2157!3 (cast-from-String-to-var1621 var662))) ; Statement: virtualinvoke r1.<jdk.internal.org.objectweb.asm.util.ASMifier: void appendConstant(java.lang.Object)>(r27) 

(declare-const var2157!4 var313)
(declare-const var662!1 String)
(define-const var627 String (buf/-10557480 (cast-from-var313-to-var873 var2157!4))) ; Statement: $r46 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var627 ", ")) ; Statement: virtualinvoke $r46.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(", ") 
...
(assert (= var1562 null-__Array__Int__String__)) ; Cond: r28 == null 
(define-const var1166 String (buf/-10557480 (cast-from-var313-to-var873 var2157!4))) ; Statement: $r29 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1166 "null")) ; Statement: virtualinvoke $r29.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>("null") 
(declare-const var1166!1 String)
(assert (str.prefixof var1166 var1166!1))
(assert true) ; Non Conditional
(define-const var1413 String (buf/-10557480 (cast-from-var313-to-var873 var2157!4))) ; Statement: $r48 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
;(assert (append/1560614132 var1413 ");\n\n")) ; Statement: virtualinvoke $r48.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>(");\n\n") 
(declare-const var1413!1 String)
(assert (str.prefixof var1413 var1413!1))
(define-const var3000 var3050 (text/-10557480 (cast-from-var313-to-var873 var2157!4))) ; Statement: $r49 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.util.List text> 
(define-const var1792 String (buf/-10557480 (cast-from-var313-to-var873 var2157!4))) ; Statement: $r50 = r1.<jdk.internal.org.objectweb.asm.util.ASMifier: java.lang.StringBuffer buf> 
(assert true)
(define-const var3203 String (toString/-222306083 var1792)) ; Statement: $r51 = virtualinvoke $r50.<java.lang.StringBuffer: java.lang.String toString()>() 
;(assert (var3050_add/328494887 var3000 (cast-from-String-to-var1621 var3203))) ; Statement: interfaceinvoke $r49.<java.util.List: boolean add(java.lang.Object)>($r51) 

(declare-const var3000!1 var3050)
