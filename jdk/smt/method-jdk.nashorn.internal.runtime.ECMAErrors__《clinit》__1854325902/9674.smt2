...
(assert (and true (and (>= 0 0) (>= (str.len var1053) var2762) (>= var2762 0))))
(define-const var291 String (substring/-1240304868 var1053 0 var2762)) ; Statement: $r4 = virtualinvoke $r5.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
(define-const var1969 String var291) ; Statement: <jdk.nashorn.internal.runtime.ECMAErrors: java.lang.String scriptPackage> = $r4 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
