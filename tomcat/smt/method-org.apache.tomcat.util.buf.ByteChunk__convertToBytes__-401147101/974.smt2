...
(assert (and true (and (> (str.len var302) var773) (<= 0 var773))))
(define-const var240 Int (charAt/698050440 var302 var773)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i4) 
(define-const var3871 Int (cast-from-Int-to-Int var240)) ; Statement: $b3 = (byte) $c2 
(declare-const var618!1 (Array Int Int))
(assert (not (= var618!1 null-__Array__Int__Int__)))
(assert (= (select var618!1 var773) var3871)) ; Statement: r1[i4] = $b3 
(define-const var773!1 Int (+ var773 1)) ; Statement: i4 = i4 + 1 
 ; Statement: goto [?= $i1 = virtualinvoke r0.<java.lang.String: int length()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var2442!1 Int (length/-134980193 var302)) ; Statement: $i1 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if i4 >= $i1 goto return r1 
(assert (not (>= var773!1 var2442!1))) ; Negate: Cond: i4 >= $i1  
(assert (and true (and (> (str.len var302) var773!1) (<= 0 var773!1))))
(define-const var240!1 Int (charAt/698050440 var302 var773!1)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i4) 
(define-const var3871!1 Int (cast-from-Int-to-Int var240!1)) ; Statement: $b3 = (byte) $c2 
(declare-const var618!2 (Array Int Int))
(assert (not (= var618!2 null-__Array__Int__Int__)))
(assert (= (select var618!2 var773!1) var3871!1)) ; Statement: r1[i4] = $b3 
(define-const var773!2 Int (+ var773!1 1)) ; Statement: i4 = i4 + 1 
 ; Statement: goto [?= $i1 = virtualinvoke r0.<java.lang.String: int length()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var2442!2 Int (length/-134980193 var302)) ; Statement: $i1 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if i4 >= $i1 goto return r1 
(assert (>= var773!2 var2442!2)) ; Cond: i4 >= $i1 
 ; Statement: return r1 
(check-sat)
(get-model)
(get-unsat-core)
