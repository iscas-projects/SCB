...
(assert (and true (and (> (str.len var3576) var3989) (<= 0 var3989))))
(define-const var3955 Int (charAt/698050440 var3576 var3989)) ; Statement: c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var3099 Int (+ var3989 var2273)) ; Statement: i3 = i0 + i2 
(define-const var292 Int (start/-1046112200 var2986)) ; Statement: $i5 = r1.<org.apache.tomcat.util.buf.AbstractChunk: int start> 
(define-const var3406 Int (+ var3552 var292)) ; Statement: i15 = i4 + $i5 
(assert true) ; Non Conditional
(define-const var3142 Int (end/-1046112200 var2986)) ; Statement: $i6 = r1.<org.apache.tomcat.util.buf.AbstractChunk: int end> 
(define-const var3473 Int (- var3142 var2273)) ; Statement: $i7 = $i6 - i2 
 ; Statement: if i15 > $i7 goto $i21 = (int) -1 
(assert (> var3406 var3473)) ; Cond: i15 > $i7 
(define-const var2562 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i21 = (int) -1 
