...
(assert (and true (and (>= 0 0) (>= (str.len var859) var3358) (>= var3358 0))))
(define-const var796 String (substring/-1240304868 var859 0 var3358)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
