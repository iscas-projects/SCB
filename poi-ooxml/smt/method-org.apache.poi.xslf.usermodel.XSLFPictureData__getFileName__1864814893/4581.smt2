...
(assert (and true (and (>= var3360 0) (>= (str.len var3555) var3360))))
(define-const var2113 String (substring/850833817 var3555 var3360)) ; Statement: $r4 = virtualinvoke r3.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
