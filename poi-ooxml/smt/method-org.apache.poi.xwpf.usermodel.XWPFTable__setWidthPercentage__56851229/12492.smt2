...
(assert (and true (and (>= 0 0) (>= (str.len var773) var2692) (>= var2692 0))))
(define-const var3851 String (substring/-1240304868 var773 0 var2692)) ; Statement: r10 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(define-const var2070 Float64 (Float64_parseDouble/1471110886 var3851)) ; Statement: $d0 = staticinvoke <java.lang.Double: double parseDouble(java.lang.String)>(r10) 
(define-const var853 Float64 (fp.mul roundNearestTiesToEven var2070 ((_ to_fp 11 53) #x4049000000000000))) ; Statement: d1 = $d0 * 50.0 
(define-const var833 Int (var3671_round/-2009194042 var853)) ; Statement: l2 = staticinvoke <java.lang.Math: long round(double)>(d1) 
(define-const var1062 var2036 (var2036_valueOf/913516287 var833)) ; Statement: $r11 = staticinvoke <java.math.BigInteger: java.math.BigInteger valueOf(long)>(l2) 
;(assert (var3634_setW/1636956788 var767!1 (cast-from-var2036-to-var2474 var1062))) ; Statement: interfaceinvoke r0.<org.openxmlformats.schemas.wordprocessingml.x2006.main.CTTblWidth: void setW(java.lang.Object)>($r11) 

(declare-const var767!2 var3634)
(declare-const var1062!1 var2036)
