...
(assert (and true (and (>= 0 0) (>= (str.len var831) var3998) (>= var3998 0))))
(define-const var2008 String (substring/-1240304868 var831 0 var3998)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i4) 
(define-const var1761 Int (Int_parseInt/1370970945 var2008)) ; Statement: $i5 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r2) 
(define-const var3679 Int (* var1761 1000)) ; Statement: $i6 = $i5 * 1000 
 ; Statement: return $i6 
(check-sat)
(get-model)
(get-unsat-core)
