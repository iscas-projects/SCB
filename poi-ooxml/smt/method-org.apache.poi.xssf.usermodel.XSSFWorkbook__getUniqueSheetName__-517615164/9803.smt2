...
(assert (and true (and (>= 0 0) (>= (str.len var2075) var1914) (>= var1914 0))))
(define-const var123 String (substring/-1240304868 var2075 0 var1914)) ; Statement: $r2 = virtualinvoke r17.<java.lang.String: java.lang.String substring(int,int)>(0, $i3) 
(assert true)
(define-const var2094 String (append/672562846 var1182!1 var123)) ; Statement: $r3 = virtualinvoke $r22.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r2) 
(declare-const var1182!2 String)
(assert (= var1182!2 (str.++ var1182!1 var123)))
(assert true)
(define-const var2322 String (append/672562846 var2094 "(")) ; Statement: $r4 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("(") 
(declare-const var2094!1 String)
(assert (= var2094!1 (str.++ var2094 "(")))
(assert true)
(define-const var359 String (append/672562846 var2322 var1882)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r19) 
(declare-const var2322!1 String)
(assert (= var2322!1 (str.++ var2322 var1882)))
(assert true)
(define-const var2636 String (append/672562846 var359 ")")) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(")") 
(declare-const var359!1 String)
(assert (= var359!1 (str.++ var359 ")")))
(assert true)
(define-const var1324 String (toString/-2075883882 var2636)) ; Statement: r20 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true) ; Non Conditional
(assert true)
(define-const var3619 Int (getSheetIndex/33662570 var81 var1324)) ; Statement: $i4 = virtualinvoke r7.<org.apache.poi.xssf.usermodel.XSSFWorkbook: int getSheetIndex(java.lang.String)>(r20) 
(define-const var1127 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i17 = (int) -1 
 ; Statement: if $i4 != $i17 goto (branch) 
(assert (not (not (= var3619 var1127)))) ; Negate: Cond: $i4 != $i17  
