...
(assert (and true (and (>= 1 0) (>= (str.len var881) var1629) (>= var1629 1))))
(define-const var3494 String (substring/-1240304868 var881 1 var1629)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(1, $i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
