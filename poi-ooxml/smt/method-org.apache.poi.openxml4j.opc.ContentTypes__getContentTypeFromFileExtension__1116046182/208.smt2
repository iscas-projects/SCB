...
(declare-fun toLowerCase/1946809429 (String var2063) String)
(declare-fun hashCode/-467973558 (String) Int)
(declare-const null-String String)
(declare-const var2063-ROOT var2063)
(declare-const var1387 String) ; Statement: r0 := @parameter0: java.lang.String 
(assert (not (= var1387 null-String)))
(assert true)
(define-const var71 Int (lastIndexOf/-1292097097 var1387 46)) ; Statement: $i0 = virtualinvoke r0.<java.lang.String: int lastIndexOf(int)>(46) 
(define-const var1347 Int (+ var71 1)) ; Statement: $i1 = $i0 + 1 
(assert (and true (and (>= var1347 0) (>= (str.len var1387) var1347))))
(define-const var3326 String (substring/850833817 var1387 var1347)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var1486 var2063 var2063-ROOT) ; Statement: $r1 = <java.util.Locale: java.util.Locale ROOT> 
(assert true)
(define-const var2109 String (toLowerCase/1946809429 var3326 var1486)) ; Statement: r3 = virtualinvoke $r2.<java.lang.String: java.lang.String toLowerCase(java.util.Locale)>($r1) 
(define-const var198 Int (- 1)) ; Statement: b3 = -1 
(assert true)
(define-const var1425 Int (hashCode/-467973558 var2109)) ; Statement: $i2 = virtualinvoke r3.<java.lang.String: int hashCode()>() 
...
(assert (and (= var198 0) true)) ; Intersect: Cond: b3 == 0  and Non Conditional 
 ; Statement: return "image/jpeg" 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var1387=r0, var2022=null_type, var71=$i0, var1347=$i1, var3326=$r2, var2063=java.util.Locale, var1486=$r1, var2109=r3, var198=b3, var1425=$i2}
; {r0=var1387, null_type=var2022, $i0=var71, $i1=var1347, $r2=var3326, java.util.Locale=var2063, $r1=var1486, r3=var2109, b3=var198, $i2=var1425}
