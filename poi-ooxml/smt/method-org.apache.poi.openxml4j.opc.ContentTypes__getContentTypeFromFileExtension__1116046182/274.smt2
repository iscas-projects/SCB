...
(assert (and true (and (>= var758 0) (>= (str.len var3347) var758))))
(define-const var1652 String (substring/850833817 var3347 var758)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var3034 var3381 var3381-ROOT) ; Statement: $r1 = <java.util.Locale: java.util.Locale ROOT> 
(assert true)
(define-const var576 String (toLowerCase/1946809429 var1652 var3034)) ; Statement: r3 = virtualinvoke $r2.<java.lang.String: java.lang.String toLowerCase(java.util.Locale)>($r1) 
(define-const var3430 Int (- 1)) ; Statement: b3 = -1 
(assert true)
(define-const var3911 Int (hashCode/-467973558 var576)) ; Statement: $i2 = virtualinvoke r3.<java.lang.String: int hashCode()>() 
...
(assert (and (not (= var3911 3559925)) (and (not (= var3911 3440682)) (and (not (= var3911 3268712)) (and (not (= var3911 118807)) (and (not (= var3911 111145)) (and (not (= var3911 105441)) (and (not (= var3911 102340)) true)))))))) ; Intersect: Negate: Cond: $i2 == 3559925   and Intersect: Negate: Cond: $i2 == 3440682   and Intersect: Negate: Cond: $i2 == 3268712   and Intersect: Negate: Cond: $i2 == 118807   and Intersect: Negate: Cond: $i2 == 111145   and Intersect: Negate: Cond: $i2 == 105441   and Intersect: Negate: Cond: $i2 == 102340   and Non Conditional       
...
(assert (and (= var3430 5) (and (not (= var3430 4)) (and (not (= var3430 3)) (and (not (= var3430 2)) (and (not (= var3430 1)) (and (not (= var3430 0)) true))))))) ; Intersect: Cond: b3 == 5  and Intersect: Negate: Cond: b3 == 4   and Intersect: Negate: Cond: b3 == 3   and Intersect: Negate: Cond: b3 == 2   and Intersect: Negate: Cond: b3 == 1   and Intersect: Negate: Cond: b3 == 0   and Non Conditional      
 ; Statement: return "image/tiff" 
(check-sat)
(get-model)
(get-unsat-core)
