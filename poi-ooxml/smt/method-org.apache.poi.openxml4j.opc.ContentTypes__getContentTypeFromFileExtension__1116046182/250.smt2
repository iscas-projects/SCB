...
(declare-fun toLowerCase/1946809429 (String var3948) String)
(declare-fun hashCode/-467973558 (String) Int)
(declare-const null-String String)
(declare-const var3948-ROOT var3948)
(declare-const var2664 String) ; Statement: r0 := @parameter0: java.lang.String 
(assert (not (= var2664 null-String)))
(assert true)
(define-const var2241 Int (lastIndexOf/-1292097097 var2664 46)) ; Statement: $i0 = virtualinvoke r0.<java.lang.String: int lastIndexOf(int)>(46) 
(define-const var283 Int (+ var2241 1)) ; Statement: $i1 = $i0 + 1 
(assert (and true (and (>= var283 0) (>= (str.len var2664) var283))))
(define-const var329 String (substring/850833817 var2664 var283)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var3095 var3948 var3948-ROOT) ; Statement: $r1 = <java.util.Locale: java.util.Locale ROOT> 
(assert true)
(define-const var314 String (toLowerCase/1946809429 var329 var3095)) ; Statement: r3 = virtualinvoke $r2.<java.lang.String: java.lang.String toLowerCase(java.util.Locale)>($r1) 
(define-const var3434 Int (- 1)) ; Statement: b3 = -1 
(assert true)
(define-const var1424 Int (hashCode/-467973558 var314)) ; Statement: $i2 = virtualinvoke r3.<java.lang.String: int hashCode()>() 
...
(assert (and (not (= var1424 3559925)) (and (not (= var1424 3440682)) (and (not (= var1424 3268712)) (and (not (= var1424 118807)) (and (not (= var1424 111145)) (and (not (= var1424 105441)) (and (not (= var1424 102340)) true)))))))) ; Intersect: Negate: Cond: $i2 == 3559925   and Intersect: Negate: Cond: $i2 == 3440682   and Intersect: Negate: Cond: $i2 == 3268712   and Intersect: Negate: Cond: $i2 == 118807   and Intersect: Negate: Cond: $i2 == 111145   and Intersect: Negate: Cond: $i2 == 105441   and Intersect: Negate: Cond: $i2 == 102340   and Non Conditional       
...
(assert (and (= var3434 3) (and (not (= var3434 2)) (and (not (= var3434 1)) (and (not (= var3434 0)) true))))) ; Intersect: Cond: b3 == 3  and Intersect: Negate: Cond: b3 == 2   and Intersect: Negate: Cond: b3 == 1   and Intersect: Negate: Cond: b3 == 0   and Non Conditional    
 ; Statement: return "image/x-pict" 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var2664=r0, var1719=null_type, var2241=$i0, var283=$i1, var329=$r2, var3948=java.util.Locale, var3095=$r1, var314=r3, var3434=b3, var1424=$i2}
; {r0=var2664, null_type=var1719, $i0=var2241, $i1=var283, $r2=var329, java.util.Locale=var3948, $r1=var3095, r3=var314, b3=var3434, $i2=var1424}
