...
(assert (and true (and (>= var1264 0) (>= (str.len var3678) var1264))))
(define-const var702 String (substring/850833817 var3678 var1264)) ; Statement: $r4 = virtualinvoke r3.<java.lang.String: java.lang.String substring(int)>($i0) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
