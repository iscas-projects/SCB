...
(assert (and true (and (>= 0 0) (>= (str.len var1480) var3273) (>= var3273 0))))
(define-const var1398 String (substring/-1240304868 var1480 0 var3273)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i5) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
