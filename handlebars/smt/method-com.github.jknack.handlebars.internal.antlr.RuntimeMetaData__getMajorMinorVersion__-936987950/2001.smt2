...
(assert (and true (and (>= 0 0) (>= (str.len var2385) var2984) (>= var2984 0))))
(define-const var3925 String (substring/-1240304868 var2385 0 var2984)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i5) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
