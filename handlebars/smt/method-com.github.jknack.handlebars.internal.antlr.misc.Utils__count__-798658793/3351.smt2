...
(assert (and true (and (> (str.len var737) var3882) (<= 0 var3882))))
(define-const var2446 Int (charAt/698050440 var737 var3882)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i4) 
(define-const var304 Int (cast-from-Int-to-Int var2446)) ; Statement: $i5 = (int) $c2 
(define-const var1927 Int (cast-from-Int-to-Int var810)) ; Statement: $i6 = (int) c1 
 ; Statement: if $i5 != $i6 goto i4 = i4 + 1 
(assert (not (= var304 var1927))) ; Cond: $i5 != $i6 
(define-const var3882!1 Int (+ var3882 1)) ; Statement: i4 = i4 + 1 
 ; Statement: goto [?= $i0 = virtualinvoke r0.<java.lang.String: int length()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var649!1 Int (length/-134980193 var737)) ; Statement: $i0 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if i4 >= $i0 goto return i3 
(assert (>= var3882!1 var649!1)) ; Cond: i4 >= $i0 
 ; Statement: return i3 
(check-sat)
(get-model)
(get-unsat-core)
