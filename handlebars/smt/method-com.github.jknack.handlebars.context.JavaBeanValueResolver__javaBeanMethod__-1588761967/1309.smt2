...
(assert (and true (and (> (str.len var732) 0) (<= 0 0))))
(define-const var140 Int (charAt/698050440 var732 0)) ; Statement: $c0 = virtualinvoke r2.<java.lang.String: char charAt(int)>(0) 
(define-const var2045 Int (var2097_toUpperCase/1913344327 var140)) ; Statement: $c1 = staticinvoke <java.lang.Character: char toUpperCase(char)>($c0) 
(assert true)
;(assert (setCharAt/-2056395727 var516!2 var1912 var2045)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: void setCharAt(int,char)>($i2, $c1) 

(declare-const var516!3 String)
(declare-const var1912!1 Int)
(declare-const var2045!1 Int)
(assert true)
(define-const var1883 String (toString/-2075883882 var516!3)) ; Statement: $r3 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
