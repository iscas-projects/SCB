...
(assert (and true (and (>= var905 0) (>= (str.len var161) var905))))
(define-const var1231 String (substring/850833817 var161 var905)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
