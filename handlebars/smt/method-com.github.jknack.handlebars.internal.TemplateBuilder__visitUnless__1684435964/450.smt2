...
(assert (and true (and (>= 0 0) (>= (str.len var1856) var2048) (>= var2048 0))))
(define-const var388 String (substring/-1240304868 var1856 0 var2048)) ; Statement: $r18 = virtualinvoke $r26.<java.lang.String: java.lang.String substring(int,int)>(0, $i5) 
(assert true)
;(assert (startDelimiter/-2121265389 var1425!3 var388)) ; Statement: virtualinvoke $r9.<com.github.jknack.handlebars.internal.Block: com.github.jknack.handlebars.internal.Block startDelimiter(java.lang.String)>($r18) 

(declare-const var1425!4 var2750)
(declare-const var388!1 String)
(define-const var144 var82 (stop/1874176084 (cast-from-var2622-to-var2537 var1389))) ; Statement: $r19 = r1.<com.github.jknack.handlebars.internal.HbsParser$UnlessContext: com.github.jknack.handlebars.internal.antlr.Token stop> 
(define-const var2089 String (var82_getText/-195748462 var144)) ; Statement: $r20 = interfaceinvoke $r19.<com.github.jknack.handlebars.internal.antlr.Token: java.lang.String getText()>() 
(assert true)
;(assert (endDelimiter/1877473676 var1425!4 var2089)) ; Statement: virtualinvoke $r9.<com.github.jknack.handlebars.internal.Block: com.github.jknack.handlebars.internal.Block endDelimiter(java.lang.String)>($r20) 

(declare-const var1425!5 var2750)
(declare-const var2089!1 String)
(assert true)
(define-const var2242 var2685 (body/1432661313 var1389)) ; Statement: $r21 = virtualinvoke r1.<com.github.jknack.handlebars.internal.HbsParser$UnlessContext: com.github.jknack.handlebars.internal.HbsParser$BodyContext body()>() 
(assert true)
(define-const var239 var708 (visitBody/348329788 var2840!2 var2242)) ; Statement: $r27 = virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: com.github.jknack.handlebars.Template visitBody(com.github.jknack.handlebars.internal.HbsParser$BodyContext)>($r21) 
 ; Statement: if $r27 == null goto virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: void hasTag(boolean)>(1) 
(assert (= var239 null-var708)) ; Cond: $r27 == null 
(assert true)
;(assert (hasTag/-2046867243 var2840!2 (ite (= 1 1) true false))) ; Statement: virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: void hasTag(boolean)>(1) 

(declare-const var2840!3 var748)
(declare-const var2597!2 Int)
(define-const var1159 Int (level/564043682 var2840!3)) ; Statement: $i6 = r0.<com.github.jknack.handlebars.internal.TemplateBuilder: int level> 
(define-const var3691 Int (- var1159 1)) ; Statement: $i7 = $i6 - 1 
(declare-const var2840!4 var748)
(assert (not (= var2840!4 null-var748)))
(assert (= (level/564043682 var2840!4) var3691)) ; Statement: r0.<com.github.jknack.handlebars.internal.TemplateBuilder: int level> = $i7 
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
