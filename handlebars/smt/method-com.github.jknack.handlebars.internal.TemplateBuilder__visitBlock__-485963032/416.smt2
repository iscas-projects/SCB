...
(assert (and true (and (>= 0 0) (>= (str.len var1050) var1321) (>= var1321 0))))
(define-const var1641 String (substring/-1240304868 var1050 0 var1321)) ; Statement: $r56 = virtualinvoke $r54.<java.lang.String: java.lang.String substring(int,int)>(0, $i6) 
(assert true)
;(assert (startDelimiter/-2121265389 var3902!2 var1641)) ; Statement: virtualinvoke r73.<com.github.jknack.handlebars.internal.Block: com.github.jknack.handlebars.internal.Block startDelimiter(java.lang.String)>($r56) 

(declare-const var3902!3 var250)
(declare-const var1641!1 String)
(assert true)
;(assert (endDelimiter/1877473676 var3902!3 var3696)) ; Statement: virtualinvoke r73.<com.github.jknack.handlebars.internal.Block: com.github.jknack.handlebars.internal.Block endDelimiter(java.lang.String)>($r55) 

(declare-const var3902!4 var250)
(declare-const var3696!1 String)
(define-const var3850 var3755 (thenBody/626416749 var2609)) ; Statement: $r19 = r1.<com.github.jknack.handlebars.internal.HbsParser$BlockContext: com.github.jknack.handlebars.internal.HbsParser$BodyContext thenBody> 
(assert true)
(define-const var2221 var19 (visitBody/348329788 var1621!2 var3850)) ; Statement: $r57 = virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: com.github.jknack.handlebars.Template visitBody(com.github.jknack.handlebars.internal.HbsParser$BodyContext)>($r19) 
 ; Statement: if $r57 == null goto r74 = r73 
(assert (= var2221 null-var19)) ; Cond: $r57 == null 
(define-const var1557 var250 var3902!4) ; Statement: r74 = r73 
(assert true)
(define-const var3922 var1044 (elseBlock/-228779620 var2609)) ; Statement: $r20 = virtualinvoke r1.<com.github.jknack.handlebars.internal.HbsParser$BlockContext: java.util.List elseBlock()>() 
(define-const var629 Iterator (var1044_iterator/-912451715 var3922)) ; Statement: $r48 = interfaceinvoke $r20.<java.util.List: java.util.Iterator iterator()>() 
(assert true) ; Non Conditional
(define-const var718 Bool (Iterator_hasNext/-1669924200 var629)) ; Statement: $z8 = interfaceinvoke $r48.<java.util.Iterator: boolean hasNext()>() 
 ; Statement: if $z8 == 0 goto virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: void hasTag(boolean)>(1) 
(assert (= (ite var718 1 0) 0)) ; Cond: $z8 == 0 
(assert true)
;(assert (hasTag/-2046867243 var1621!2 (ite (= 1 1) true false))) ; Statement: virtualinvoke r0.<com.github.jknack.handlebars.internal.TemplateBuilder: void hasTag(boolean)>(1) 

(declare-const var1621!3 var648)
(declare-const var1993!1 Int)
(define-const var1346 var2066 (qualifier/564043682 var1621!3)) ; Statement: $r21 = r0.<com.github.jknack.handlebars.internal.TemplateBuilder: java.util.LinkedList qualifier> 
(assert true)
;(assert (removeLast/1195514639 var1346)) ; Statement: virtualinvoke $r21.<java.util.LinkedList: java.lang.Object removeLast()>() 

(declare-const var1346!1 var2066)
(define-const var3788 Int (paramSize/-1588764717 (cast-from-var250-to-var3566 var3902!4))) ; Statement: $i7 = r73.<com.github.jknack.handlebars.internal.Block: int paramSize> 
 ; Statement: if $i7 <= 0 goto $i8 = r0.<com.github.jknack.handlebars.internal.TemplateBuilder: int level> 
(assert (<= var3788 0)) ; Cond: $i7 <= 0 
(define-const var1875 Int (level/564043682 var1621!3)) ; Statement: $i8 = r0.<com.github.jknack.handlebars.internal.TemplateBuilder: int level> 
(define-const var3150 Int (- var1875 1)) ; Statement: $i9 = $i8 - 1 
(declare-const var1621!4 var648)
(assert (not (= var1621!4 null-var648)))
(assert (= (level/564043682 var1621!4) var3150)) ; Statement: r0.<com.github.jknack.handlebars.internal.TemplateBuilder: int level> = $i9 
