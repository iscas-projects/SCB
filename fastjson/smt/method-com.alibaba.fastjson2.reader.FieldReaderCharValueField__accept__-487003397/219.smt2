...
(assert (and true (and (> (str.len var113) 0) (<= 0 0))))
(define-const var1513 Int (charAt/698050440 var113 0)) ; Statement: c0 = virtualinvoke $r5.<java.lang.String: char charAt(int)>(0) 
 ; Statement: goto [?= virtualinvoke r3.<com.alibaba.fastjson2.reader.FieldReaderCharValueField: void accept(java.lang.Object,char)>(r4, c0)] 
(assert true) ; Non Conditional
(assert true)
;(assert (accept/-806481348 (cast-from-var1054-to-var3447 var458) var2216 var1513)) ; Statement: virtualinvoke r3.<com.alibaba.fastjson2.reader.FieldReaderCharValueField: void accept(java.lang.Object,char)>(r4, c0) 

(declare-const var458!1 var1054)
(declare-const var2216!1 var981)
(declare-const var1513!1 Int)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
