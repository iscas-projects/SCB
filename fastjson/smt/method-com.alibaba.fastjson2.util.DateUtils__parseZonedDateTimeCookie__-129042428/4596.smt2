...
(assert (and true (and (>= 0 0) (>= (str.len var21) var1343) (>= var1343 0))))
(define-const var1032 String (substring/-1240304868 var21 0 var1343)) ; Statement: $r6 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(define-const var403 var1594 (var1594_parse/-1286663772 (cast-from-String-to-String var1032) var1055)) ; Statement: $r7 = staticinvoke <java.time.LocalDateTime: java.time.LocalDateTime parse(java.lang.CharSequence,java.time.format.DateTimeFormatter)>($r6, r8) 
(define-const var70 var2843 var2311-SHANGHAI_ZONE_ID) ; Statement: $r3 = <com.alibaba.fastjson2.util.DateUtils: java.time.ZoneId SHANGHAI_ZONE_ID> 
(define-const var3193 var39 (var39_of/-360792653 var403 var70)) ; Statement: $r4 = staticinvoke <java.time.ZonedDateTime: java.time.ZonedDateTime of(java.time.LocalDateTime,java.time.ZoneId)>($r7, $r3) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
