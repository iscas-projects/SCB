...
(assert (and true (and (> (str.len var2926) 0) (<= 0 0))))
(define-const var2998 Int (charAt/698050440 var2926 0)) ; Statement: $c0 = virtualinvoke r1.<java.lang.String: char charAt(int)>(0) 
 ; Statement: return $c0 
(check-sat)
(get-model)
(get-unsat-core)
