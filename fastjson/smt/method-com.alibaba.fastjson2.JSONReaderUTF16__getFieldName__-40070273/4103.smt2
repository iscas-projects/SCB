...
(assert (and true (and (>= var1683 0) (>= (str.len var2083) var438) (>= var438 var1683))))
(define-const var1811 String (substring/-1240304868 var2083 var1683 var438)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.String: java.lang.String substring(int,int)>($i19, $i18) 
 ; Statement: return $r8 
(check-sat)
(get-model)
(get-unsat-core)
