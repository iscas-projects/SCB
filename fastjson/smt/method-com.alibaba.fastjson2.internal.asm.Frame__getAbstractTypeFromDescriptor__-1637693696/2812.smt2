...
(assert (and true (and (> (str.len var458) var320) (<= 0 var320))))
(define-const var3988 Int (charAt/698050440 var458 var320)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var2200 Int (cast-from-Int-to-Int var3988)) ; Statement: $i32 = (int) $c1 
...
(assert (and (= var2200 86) (and (not (= var2200 85)) (and (not (= var2200 84)) (and (not (= var2200 83)) (and (not (= var2200 82)) (and (not (= var2200 81)) (and (not (= var2200 80)) (and (not (= var2200 79)) (and (not (= var2200 78)) (and (not (= var2200 77)) (and (not (= var2200 76)) (and (not (= var2200 75)) (and (not (= var2200 74)) (and (not (= var2200 73)) (and (not (= var2200 72)) (and (not (= var2200 71)) (and (not (= var2200 70)) (and (not (= var2200 69)) (and (not (= var2200 68)) (and (not (= var2200 67)) (and (not (= var2200 66)) true)))))))))))))))))))))) ; Intersect: Cond: $i32 == 86  and Intersect: Negate: Cond: $i32 == 85   and Intersect: Negate: Cond: $i32 == 84   and Intersect: Negate: Cond: $i32 == 83   and Intersect: Negate: Cond: $i32 == 82   and Intersect: Negate: Cond: $i32 == 81   and Intersect: Negate: Cond: $i32 == 80   and Intersect: Negate: Cond: $i32 == 79   and Intersect: Negate: Cond: $i32 == 78   and Intersect: Negate: Cond: $i32 == 77   and Intersect: Negate: Cond: $i32 == 76   and Intersect: Negate: Cond: $i32 == 75   and Intersect: Negate: Cond: $i32 == 74   and Intersect: Negate: Cond: $i32 == 73   and Intersect: Negate: Cond: $i32 == 72   and Intersect: Negate: Cond: $i32 == 71   and Intersect: Negate: Cond: $i32 == 70   and Intersect: Negate: Cond: $i32 == 69   and Intersect: Negate: Cond: $i32 == 68   and Intersect: Negate: Cond: $i32 == 67   and Intersect: Negate: Cond: $i32 == 66   and Non Conditional                     
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
