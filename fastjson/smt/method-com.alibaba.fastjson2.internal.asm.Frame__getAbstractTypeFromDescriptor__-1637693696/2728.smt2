...
(assert (and true (and (> (str.len var328) var3705) (<= 0 var3705))))
(define-const var3968 Int (charAt/698050440 var328 var3705)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var1990 Int (cast-from-Int-to-Int var3968)) ; Statement: $i32 = (int) $c1 
...
(assert (and (= var1990 66) true)) ; Intersect: Cond: $i32 == 66  and Non Conditional 
 ; Statement: return 4194305 
(check-sat)
(get-model)
(get-unsat-core)
