...
(assert (and true (and (> (str.len var1447) var2164) (<= 0 var2164))))
(define-const var2486 Int (charAt/698050440 var1447 var2164)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var881 Int (cast-from-Int-to-Int var2486)) ; Statement: $i32 = (int) $c1 
...
(assert (and (= var881 68) (and (not (= var881 67)) (and (not (= var881 66)) true)))) ; Intersect: Cond: $i32 == 68  and Intersect: Negate: Cond: $i32 == 67   and Intersect: Negate: Cond: $i32 == 66   and Non Conditional   
 ; Statement: return 4194307 
(check-sat)
(get-model)
(get-unsat-core)
