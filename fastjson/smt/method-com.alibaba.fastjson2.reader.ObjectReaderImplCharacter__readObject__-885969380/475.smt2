...
(assert (and true (and (> (str.len var415) 0) (<= 0 0))))
(define-const var3498 Int (charAt/698050440 var415 0)) ; Statement: $c0 = virtualinvoke r1.<java.lang.String: char charAt(int)>(0) 
(define-const var3072 var1494 (var1494_valueOf/-1186540555 var3498)) ; Statement: $r2 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
