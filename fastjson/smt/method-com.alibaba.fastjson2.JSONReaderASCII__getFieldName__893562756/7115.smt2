...
(assert (and true (and (>= var3658 0) (>= (str.len var162) var1954) (>= var1954 var3658))))
(define-const var2429 String (substring/-1240304868 var162 var3658 var1954)) ; Statement: $r14 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int,int)>(i34, $i33) 
