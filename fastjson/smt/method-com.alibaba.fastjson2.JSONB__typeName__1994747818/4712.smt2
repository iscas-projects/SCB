...
(declare-const var1352 Int) ; Statement: b0 := @parameter0: byte 
(assert (not (= var1352 null-Int)))
(define-const var3160 Int (cast-from-Int-to-Int var1352)) ; Statement: $i1 = (int) b0 
...
(assert (and (= var3160 (- 111)) true)) ; Intersect: Cond: $i1 == -111  and Non Conditional 
(define-const var3058 String String-init) ; Statement: $r206 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var3058)) ; Statement: specialinvoke $r206.<java.lang.StringBuilder: void <init>()>() 
(declare-const var3058!1 String)
(assert (= var3058!1 ""))
(assert true)
(define-const var1231 String (append/672562846 var3058!1 "BINARY ")) ; Statement: $r142 = virtualinvoke $r206.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("BINARY ") 
(declare-const var3058!2 String)
(assert (= var3058!2 (str.++ var3058!1 "BINARY ")))
(define-const var1765 Int (cast-from-Int-to-Int var1352)) ; Statement: $i22 = (int) b0 
(define-const var995 String (Int_toString/1350422511 var1765)) ; Statement: $r141 = staticinvoke <java.lang.Integer: java.lang.String toString(int)>($i22) 
(assert true)
(define-const var1729 String (append/672562846 var1231 var995)) ; Statement: $r143 = virtualinvoke $r142.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r141) 
(declare-const var1231!1 String)
(assert (= var1231!1 (str.++ var1231 var995)))
(assert true)
(define-const var871 String (toString/-2075883882 var1729)) ; Statement: $r144 = virtualinvoke $r143.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r144 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var1352=b0, var3160=$i1, var3058=$r206, var1231=$r142, var1765=$i22, var995=$r141, var1729=$r143, var871=$r144}
; {b0=var1352, $i1=var3160, $r206=var3058, $r142=var1231, $i22=var1765, $r141=var995, $r143=var1729, $r144=var871}
...
;stmts b0 := @parameter0: byte;	$i1 = (int) b0;	lookupswitch($i1) {     case -111: goto $r206 = new java.lang.StringBuilder;     case -110: goto $r214 = new java.lang.StringBuilder;     case -109: goto $r188 = new java.lang.StringBuilder;     case -91: goto $r187 = new java.lang.StringBuilder;     case -90: goto $r186 = new java.lang.StringBuilder;     case -89: goto $r205 = new java.lang.StringBuilder;     case -88: goto $r207 = new java.lang.StringBuilder;     case -87: goto $r213 = new java.lang.StringBuilder;     case -86: goto $r212 = new java.lang.StringBuilder;     case -85: goto $r211 = new java.lang.StringBuilder;     case -84: goto $r210 = new java.lang.StringBuilder;     case -83: goto $r209 = new java.lang.StringBuilder;     case -82: goto $r208 = new java.lang.StringBuilder;     case -81: goto $r190 = new java.lang.StringBuilder;     case -80: goto $r192 = new java.lang.StringBuilder;     case -79: goto $r191 = new java.lang.StringBuilder;     case -78: goto $r202 = new java.lang.StringBuilder;     case -77: goto $r202 = new java.lang.StringBuilder;     case -76: goto $r202 = new java.lang.StringBuilder;     case -75: goto $r202 = new java.lang.StringBuilder;     case -74: goto $r201 = new java.lang.StringBuilder;     case -73: goto $r201 = new java.lang.StringBuilder;     case -72: goto $r204 = new java.lang.StringBuilder;     case -71: goto $r204 = new java.lang.StringBuilder;     case -70: goto $r203 = new java.lang.StringBuilder;     case -69: goto $r203 = new java.lang.StringBuilder;     case -68: goto $r198 = new java.lang.StringBuilder;     case -67: goto $r197 = new java.lang.StringBuilder;     case -66: goto $r200 = new java.lang.StringBuilder;     case -65: goto $r200 = new java.lang.StringBuilder;     case 72: goto $r199 = new java.lang.StringBuilder;     case 122: goto $r193 = new java.lang.StringBuilder;     case 123: goto $r194 = new java.lang.StringBuilder;     case 124: goto $r195 = new java.lang.StringBuilder;     case 125: goto $r196 = new java.lang.StringBuilder;     case 127: goto $r189 = new java.lang.StringBuilder;     default: goto $i31 = (int) b0; };	$r206 = new java.lang.StringBuilder;	specialinvoke $r206.<java.lang.StringBuilder: void <init>()>();	$r142 = virtualinvoke $r206.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("BINARY ");	$i22 = (int) b0;	$r141 = staticinvoke <java.lang.Integer: java.lang.String toString(int)>($i22);	$r143 = virtualinvoke $r142.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r141);	$r144 = virtualinvoke $r143.<java.lang.StringBuilder: java.lang.String toString()>();	return $r144
;block_num 2