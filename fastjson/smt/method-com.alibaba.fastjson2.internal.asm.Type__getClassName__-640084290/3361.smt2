...
(assert (and true (and (>= var1792 0) (>= (str.len var2147) var841) (>= var841 var1792))))
(define-const var1644 String (substring/-1240304868 var2147 var1792 var841)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>($i2, $i1) 
(assert true)
(define-const var2300 String (replace/1524665721 var1644 47 46)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String replace(char,char)>(47, 46) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
