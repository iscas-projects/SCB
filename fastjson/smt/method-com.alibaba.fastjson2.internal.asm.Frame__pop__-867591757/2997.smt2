...
(assert (and true (and (> (str.len var388) 0) (<= 0 0))))
(define-const var2229 Int (charAt/698050440 var388 0)) ; Statement: c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1312 Int (cast-from-Int-to-Int var2229)) ; Statement: $i4 = (int) c0 
 ; Statement: if $i4 != 40 goto $i5 = (int) c0 
(assert (not (not (= var1312 40)))) ; Negate: Cond: $i4 != 40  
(define-const var3575 Int (var3563_getArgumentsAndReturnSizes/-942562819 var388)) ; Statement: $i1 = staticinvoke <com.alibaba.fastjson2.internal.asm.Type: int getArgumentsAndReturnSizes(java.lang.String)>(r0) 
(define-const var2981 Int (div var3575 (to_int (^ 2 2)))) ; Statement: $i2 = $i1 >> 2 
(define-const var3336 Int (- var2981 1)) ; Statement: $i3 = $i2 - 1 
(assert true)
;(assert (pop/1151368555 var3143 var3336)) ; Statement: specialinvoke r1.<com.alibaba.fastjson2.internal.asm.Frame: void pop(int)>($i3) 

(declare-const var3143!1 var3087)
