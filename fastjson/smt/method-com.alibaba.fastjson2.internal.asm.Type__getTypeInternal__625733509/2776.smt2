...
(assert (and true (and (> (str.len var3395) var3128) (<= 0 var3128))))
(define-const var1588 Int (charAt/698050440 var3395 var3128)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var2232 Int (cast-from-Int-to-Int var1588)) ; Statement: $i6 = (int) $c1 
...
(assert (and (= var2232 40) true)) ; Intersect: Cond: $i6 == 40  and Non Conditional 
(define-const var416 var1957 var1957-init) ; Statement: $r40 = new com.alibaba.fastjson2.internal.asm.Type 
(assert true)
;(assert (<init>/-1254973680 var416 11 var3395 var3128 var2784)) ; Statement: specialinvoke $r40.<com.alibaba.fastjson2.internal.asm.Type: void <init>(int,java.lang.String,int,int)>(11, r0, i0, i2) 

(declare-const var416!1 var1957)
