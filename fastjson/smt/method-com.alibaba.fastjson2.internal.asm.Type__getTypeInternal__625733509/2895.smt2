...
(assert (and true (and (> (str.len var1930) var3285) (<= 0 var3285))))
(define-const var1280 Int (charAt/698050440 var1930 var3285)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var1314 Int (cast-from-Int-to-Int var1280)) ; Statement: $i6 = (int) $c1 
...
(assert (and (= var1314 86) (and (not (= var1314 83)) (and (not (= var1314 76)) (and (not (= var1314 74)) (and (not (= var1314 73)) (and (not (= var1314 70)) (and (not (= var1314 68)) (and (not (= var1314 67)) (and (not (= var1314 66)) (and (not (= var1314 40)) true))))))))))) ; Intersect: Cond: $i6 == 86  and Intersect: Negate: Cond: $i6 == 83   and Intersect: Negate: Cond: $i6 == 76   and Intersect: Negate: Cond: $i6 == 74   and Intersect: Negate: Cond: $i6 == 73   and Intersect: Negate: Cond: $i6 == 70   and Intersect: Negate: Cond: $i6 == 68   and Intersect: Negate: Cond: $i6 == 67   and Intersect: Negate: Cond: $i6 == 66   and Intersect: Negate: Cond: $i6 == 40   and Non Conditional          
(define-const var492 var1031 var1031-VOID_TYPE) ; Statement: $r3 = <com.alibaba.fastjson2.internal.asm.Type: com.alibaba.fastjson2.internal.asm.Type VOID_TYPE> 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
