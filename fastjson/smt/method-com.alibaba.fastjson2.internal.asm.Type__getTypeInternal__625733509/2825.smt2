...
(assert (and true (and (> (str.len var3756) var3996) (<= 0 var3996))))
(define-const var1857 Int (charAt/698050440 var3756 var3996)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var3878 Int (cast-from-Int-to-Int var1857)) ; Statement: $i6 = (int) $c1 
...
(assert (and (= var3878 67) (and (not (= var3878 66)) (and (not (= var3878 40)) true)))) ; Intersect: Cond: $i6 == 67  and Intersect: Negate: Cond: $i6 == 66   and Intersect: Negate: Cond: $i6 == 40   and Non Conditional   
(define-const var2916 var2747 var2747-CHAR_TYPE) ; Statement: $r33 = <com.alibaba.fastjson2.internal.asm.Type: com.alibaba.fastjson2.internal.asm.Type CHAR_TYPE> 
