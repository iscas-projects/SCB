...
(assert (and true (and (>= var1414 0) (>= (str.len var2508) var1610) (>= var1610 var1414))))
(define-const var317 String (substring/-1240304868 var2508 var1414 var1610)) ; Statement: $r15 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
(assert true)
(define-const var3870 var2078 (addConstantUtf8Reference/-67480876 var3273 7 var317)) ; Statement: r16 = virtualinvoke $r14.<com.alibaba.fastjson2.internal.asm.SymbolTable: com.alibaba.fastjson2.internal.asm.Symbol addConstantUtf8Reference(int,java.lang.String)>(7, $r15) 
 ; Statement: goto [?= $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index>] 
(assert true) ; Non Conditional
(define-const var3970 Int (index/-1147909603 var3870)) ; Statement: $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index> 
...
(assert (< var3970 256)) ; Cond: $i5 < 256 
(define-const var1261 var3301 (code/-1827008135 var3949!1)) ; Statement: $r7 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.ByteVector code> 
(assert true)
;(assert (put11/1583858492 var1261 18 var3970)) ; Statement: virtualinvoke $r7.<com.alibaba.fastjson2.internal.asm.ByteVector: void put11(int,int)>(18, $i5) 

(declare-const var1261!1 var3301)
(declare-const var1252 Int)
(declare-const var3970!1 Int)
(assert true) ; Non Conditional
(define-const var888 var334 (currentBasicBlock/-1827008135 var3949!1)) ; Statement: $r8 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.Label currentBasicBlock> 
 ; Statement: if $r8 == null goto return 
(assert (= var888 null-var334)) ; Cond: $r8 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
