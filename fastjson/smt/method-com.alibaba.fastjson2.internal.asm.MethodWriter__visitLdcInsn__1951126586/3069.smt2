...
(assert (and true (and (>= var2399 0) (>= (str.len var767) var480) (>= var480 var2399))))
(define-const var411 String (substring/-1240304868 var767 var2399 var480)) ; Statement: $r15 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
(assert true)
(define-const var2615 var2440 (addConstantUtf8Reference/-67480876 var3157 7 var411)) ; Statement: r16 = virtualinvoke $r14.<com.alibaba.fastjson2.internal.asm.SymbolTable: com.alibaba.fastjson2.internal.asm.Symbol addConstantUtf8Reference(int,java.lang.String)>(7, $r15) 
 ; Statement: goto [?= $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index>] 
(assert true) ; Non Conditional
(define-const var312 Int (index/-1147909603 var2615)) ; Statement: $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index> 
...
(assert (not (< var312 256))) ; Negate: Cond: $i5 < 256  
(define-const var681 var1366 (code/-1827008135 var1155!1)) ; Statement: $r12 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.ByteVector code> 
(assert true)
;(assert (put12/1392378469 var681 19 var312)) ; Statement: virtualinvoke $r12.<com.alibaba.fastjson2.internal.asm.ByteVector: com.alibaba.fastjson2.internal.asm.ByteVector put12(int,int)>(19, $i5) 

(declare-const var681!1 var1366)
...
(assert true) ; Non Conditional
(define-const var1186 var2343 (currentBasicBlock/-1827008135 var1155!1)) ; Statement: $r8 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.Label currentBasicBlock> 
 ; Statement: if $r8 == null goto return 
(assert (= var1186 null-var2343)) ; Cond: $r8 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
