...
(assert (and true (and (>= var2771 0) (>= (str.len var572) var172) (>= var172 var2771))))
(define-const var24 String (substring/-1240304868 var572 var2771 var172)) ; Statement: $r15 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
(assert true)
(define-const var2127 var2250 (addConstantUtf8Reference/-67480876 var282 7 var24)) ; Statement: r16 = virtualinvoke $r14.<com.alibaba.fastjson2.internal.asm.SymbolTable: com.alibaba.fastjson2.internal.asm.Symbol addConstantUtf8Reference(int,java.lang.String)>(7, $r15) 
 ; Statement: goto [?= $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index>] 
(assert true) ; Non Conditional
(define-const var3532 Int (index/-1147909603 var2127)) ; Statement: $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index> 
...
(assert (not (< var3532 256))) ; Negate: Cond: $i5 < 256  
(define-const var842 var2889 (code/-1827008135 var341!1)) ; Statement: $r12 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.ByteVector code> 
(assert true)
;(assert (put12/1392378469 var842 19 var3532)) ; Statement: virtualinvoke $r12.<com.alibaba.fastjson2.internal.asm.ByteVector: com.alibaba.fastjson2.internal.asm.ByteVector put12(int,int)>(19, $i5) 

(declare-const var842!1 var2889)
(declare-const var2589 Int)
(declare-const var3532!1 Int)
...
(assert true) ; Non Conditional
(define-const var2764 var2657 (currentBasicBlock/-1827008135 var341!1)) ; Statement: $r8 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.Label currentBasicBlock> 
 ; Statement: if $r8 == null goto return 
(assert (= var2764 null-var2657)) ; Cond: $r8 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
