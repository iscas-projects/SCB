...
(assert (and true (and (>= var2348 0) (>= (str.len var3231) var3561) (>= var3561 var2348))))
(define-const var2347 String (substring/-1240304868 var3231 var2348 var3561)) ; Statement: $r15 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
(assert true)
(define-const var2255 var2362 (addConstantUtf8Reference/-67480876 var3554 7 var2347)) ; Statement: r16 = virtualinvoke $r14.<com.alibaba.fastjson2.internal.asm.SymbolTable: com.alibaba.fastjson2.internal.asm.Symbol addConstantUtf8Reference(int,java.lang.String)>(7, $r15) 
 ; Statement: goto [?= $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index>] 
(assert true) ; Non Conditional
(define-const var2631 Int (index/-1147909603 var2255)) ; Statement: $i5 = r16.<com.alibaba.fastjson2.internal.asm.Symbol: int index> 
...
(assert (< var2631 256)) ; Cond: $i5 < 256 
(define-const var3775 var2123 (code/-1827008135 var1650!1)) ; Statement: $r7 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.ByteVector code> 
(assert true)
;(assert (put11/1583858492 var3775 18 var2631)) ; Statement: virtualinvoke $r7.<com.alibaba.fastjson2.internal.asm.ByteVector: void put11(int,int)>(18, $i5) 

(declare-const var3775!1 var2123)
(declare-const var1263 Int)
(declare-const var2631!1 Int)
(assert true) ; Non Conditional
(define-const var1410 var2820 (currentBasicBlock/-1827008135 var1650!1)) ; Statement: $r8 = r3.<com.alibaba.fastjson2.internal.asm.MethodWriter: com.alibaba.fastjson2.internal.asm.Label currentBasicBlock> 
 ; Statement: if $r8 == null goto return 
(assert (= var1410 null-var2820)) ; Cond: $r8 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
