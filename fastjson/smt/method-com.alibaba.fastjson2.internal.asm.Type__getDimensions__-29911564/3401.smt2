...
(assert (and true (and (> (str.len var2684) var92) (<= 0 var92))))
(define-const var1061 Int (charAt/698050440 var2684 var92)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i1) 
(define-const var1381 Int (cast-from-Int-to-Int var1061)) ; Statement: $i4 = (int) $c2 
 ; Statement: if $i4 != 91 goto return i3 
(assert (not (= var1381 91))) ; Cond: $i4 != 91 
 ; Statement: return i3 
(check-sat)
(get-model)
(get-unsat-core)
