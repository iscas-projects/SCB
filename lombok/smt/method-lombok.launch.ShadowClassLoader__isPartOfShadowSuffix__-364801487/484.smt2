...
(assert (and true (and (>= 5 0) (>= (str.len var3913) 5))))
(define-const var115 String (substring/850833817 var3913 5)) ; Statement: $r3 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int)>(5) 
(define-const var58 String (var2611_urlDecode/-772833716 var115)) ; Statement: r6 = staticinvoke <lombok.launch.ShadowClassLoader: java.lang.String urlDecode(java.lang.String)>($r3) 
(assert true)
(define-const var829 Int (length/-134980193 var58)) ; Statement: $i1 = virtualinvoke r6.<java.lang.String: int length()>() 
(assert true)
(define-const var3355 Int (length/-134980193 var2312)) ; Statement: $i0 = virtualinvoke r4.<java.lang.String: int length()>() 
 ; Statement: if $i1 <= $i0 goto return 0 
(assert (not (<= var829 var3355))) ; Negate: Cond: $i1 <= $i0  
(assert true)
(define-const var235 Bool (endsWith/985337093 var58 var2312)) ; Statement: $z3 = virtualinvoke r6.<java.lang.String: boolean endsWith(java.lang.String)>(r4) 
 ; Statement: if $z3 == 0 goto return 0 
(assert (= (ite var235 1 0) 0)) ; Cond: $z3 == 0 
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
