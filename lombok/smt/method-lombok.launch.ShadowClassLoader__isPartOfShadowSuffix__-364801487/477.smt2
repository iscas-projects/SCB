...
(assert (and true (and (>= 5 0) (>= (str.len var2827) 5))))
(define-const var292 String (substring/850833817 var2827 5)) ; Statement: $r3 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int)>(5) 
(define-const var1478 String (var1503_urlDecode/-772833716 var292)) ; Statement: r6 = staticinvoke <lombok.launch.ShadowClassLoader: java.lang.String urlDecode(java.lang.String)>($r3) 
(assert true)
(define-const var2580 Int (length/-134980193 var1478)) ; Statement: $i1 = virtualinvoke r6.<java.lang.String: int length()>() 
(assert true)
(define-const var3043 Int (length/-134980193 var2477)) ; Statement: $i0 = virtualinvoke r4.<java.lang.String: int length()>() 
 ; Statement: if $i1 <= $i0 goto return 0 
(assert (<= var2580 var3043)) ; Cond: $i1 <= $i0 
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
