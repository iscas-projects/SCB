...
(assert (and true (and (>= 4 0) (>= (str.len var3988) var323) (>= var323 4))))
(define-const var1309 String (substring/-1240304868 var3988 4 var323)) ; Statement: r0 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int,int)>(4, i11) 
(assert true)
(define-const var3944 Bool (isPartOfShadowSuffixJarBased/-787216222 var3954 var1309 var2751)) ; Statement: $z2 = specialinvoke r1.<lombok.launch.ShadowClassLoader: boolean isPartOfShadowSuffixJarBased(java.lang.String,java.lang.String)>(r0, r2) 
 ; Statement: return $z2 
(check-sat)
(get-model)
(get-unsat-core)
