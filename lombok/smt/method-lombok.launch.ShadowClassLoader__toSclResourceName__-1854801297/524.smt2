...
(assert (and true (and (>= 0 0) (>= (str.len var1803) var2892) (>= var2892 0))))
(define-const var749 String (substring/-1240304868 var1803 0 var2892)) ; Statement: $r5 = virtualinvoke r4.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(assert true)
(define-const var559 String (append/672562846 var1366 var749)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r5) 
(declare-const var1366!1 String)
(assert (= var1366!1 (str.++ var1366 var749)))
(assert true)
(define-const var1581 String (append/672562846 var559 ".SCL.")) ; Statement: $r9 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(".SCL.") 
(declare-const var559!1 String)
(assert (= var559!1 (str.++ var559 ".SCL.")))
(define-const var2092 String (sclSuffix/1139179338 var3402)) ; Statement: $r8 = r1.<lombok.launch.ShadowClassLoader: java.lang.String sclSuffix> 
(assert true)
(define-const var1580 String (append/672562846 var1581 var2092)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r8) 
(declare-const var1581!1 String)
(assert (= var1581!1 (str.++ var1581 var2092)))
(assert true)
(define-const var2779 String (toString/-2075883882 var1580)) ; Statement: $r11 = virtualinvoke $r10.<java.lang.StringBuilder: java.lang.String toString()>() 
