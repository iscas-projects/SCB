...
(assert (and true (and (>= var1488 0) (>= (str.len var3451) var862) (>= var862 var1488))))
(define-const var2804 String (substring/-1240304868 var3451 var1488 var862)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i1, $i0) 
(assert true)
(define-const var433 Int (lastIndexOf/-618837785 var3451 "__")) ; Statement: $i2 = virtualinvoke r0.<java.lang.String: int lastIndexOf(java.lang.String)>("__") 
(define-const var1679 Int (+ var433 2)) ; Statement: $i4 = $i2 + 2 
(assert true)
(define-const var2951 Int (length/-134980193 var3451)) ; Statement: $i3 = virtualinvoke r0.<java.lang.String: int length()>() 
(assert (and true (and (>= var1679 0) (>= (str.len var3451) var2951) (>= var2951 var1679))))
(define-const var1007 String (substring/-1240304868 var3451 var1679 var2951)) ; Statement: r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
(define-const var3049 String String-init) ; Statement: $r4 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var3049)) ; Statement: specialinvoke $r4.<java.lang.StringBuilder: void <init>()>() 
(declare-const var3049!1 String)
(assert (= var3049!1 ""))
(assert true)
(define-const var3248 String (append/672562846 var3049!1 var2804)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r2) 
(declare-const var3049!2 String)
(assert (= var3049!2 (str.++ var3049!1 var2804)))
(assert true)
(define-const var1850 String (append/-1166366385 var3248 46)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(46) 
(declare-const var3248!1 String)
(assert (str.prefixof var3248 var3248!1))
(assert true)
(define-const var1839 String (append/672562846 var1850 var1007)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r3) 
(declare-const var1850!1 String)
(assert (= var1850!1 (str.++ var1850 var1007)))
(assert true)
(define-const var3710 String (toString/-2075883882 var1839)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r8 
(check-sat)
(get-model)
(get-unsat-core)
