...
(define-const var580 Int (charAt/698050440 var996 0)) ; Statement: $c0 = virtualinvoke r8.<java.lang.String: char charAt(int)>(0) 
(define-const var956 Int (cast-from-Int-to-Int var580)) ; Statement: $i1 = (int) $c0 
 ; Statement: if $i1 == 47 goto $r10 = new org.antlr.runtime.CommonToken 
(assert (= var956 47)) ; Cond: $i1 == 47 
(define-const var350 var1056 var1056-init) ; Statement: $r10 = new org.antlr.runtime.CommonToken 
(assert true) ; Handling Exception: java.lang.Throwable 
(declare-const var1814 var1871) ; Statement: $r7 := @caughtexception 
(assert (not (= var1814 null-var1871)))
