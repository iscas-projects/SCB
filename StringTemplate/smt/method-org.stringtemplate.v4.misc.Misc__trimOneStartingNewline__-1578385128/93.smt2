...
(assert (and true (and (>= 2 0) (>= (str.len var3987) 2))))
(define-const var3987!1 String (substring/850833817 var3987 2)) ; Statement: r0 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(2) 
