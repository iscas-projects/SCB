...
(assert (and true (and (>= var3340 0) (>= (str.len var3076) var2951) (>= var2951 var3340))))
(define-const var1324 String (substring/-1240304868 var3076 var3340 var2951)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i0, $i2) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
