...
(assert (and true (and (>= 0 0) (>= (str.len var245) var2348) (>= var2348 0))))
(define-const var466 String (substring/-1240304868 var245 0 var2348)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
