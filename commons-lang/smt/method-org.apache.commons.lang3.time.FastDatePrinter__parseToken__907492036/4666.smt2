...
(assert (and true (and (> (str.len var2124) var1165) (<= 0 var1165))))
(define-const var1798 Int (charAt/698050440 var2124 var1165)) ; Statement: c6 = virtualinvoke r2.<java.lang.String: char charAt(int)>(i5) 
(define-const var3264 Int (cast-from-Int-to-Int var1798)) ; Statement: $i10 = (int) c6 
 ; Statement: if $i10 < 65 goto $i12 = (int) c6 
(assert (not (< var3264 65))) ; Negate: Cond: $i10 < 65  
(define-const var3313 Int (cast-from-Int-to-Int var1798)) ; Statement: $i11 = (int) c6 
 ; Statement: if $i11 <= 90 goto virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c6) 
(assert (<= var3313 90)) ; Cond: $i11 <= 90 
(assert true)
;(assert (append/-1166366385 var2250!1 var1798)) ; Statement: virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(c6) 
(declare-const var2250!2 String)
(assert (str.prefixof var2250!1 var2250!2))
(assert true) ; Non Conditional
(define-const var3568 Int (+ var1165 1)) ; Statement: $i7 = i5 + 1 
 ; Statement: if $i7 >= i0 goto r1[0] = i5 
(assert (>= var3568 var3742)) ; Cond: $i7 >= i0 
(declare-const var3759!1 (Array Int Int))
(assert (not (= var3759!1 null-__Array__Int__Int__)))
(assert (= (select var3759!1 0) var1165)) ; Statement: r1[0] = i5 
(assert true)
(define-const var1820 String (toString/-2075883882 var2250!2)) ; Statement: $r4 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
