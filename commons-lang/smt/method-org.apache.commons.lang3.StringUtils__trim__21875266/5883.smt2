...
(declare-const var2611 String) ; Statement: r0 := @parameter0: java.lang.String 
(assert (not (= var2611 null-String)))
 ; Statement: if r0 != null goto $r1 = virtualinvoke r0.<java.lang.String: java.lang.String trim()>() 
(assert (not (= var2611 null-String))) ; Cond: r0 != null 
(assert true)
(define-const var3908 String (trim/-847153721 var2611)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String trim()>() 
...
; {var2611=r0, var2595=null_type, var3908=$r1}
; {r0=var2611, null_type=var2595, $r1=var3908}
