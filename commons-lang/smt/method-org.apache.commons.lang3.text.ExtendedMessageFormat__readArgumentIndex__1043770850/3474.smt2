...
(assert (and true (and (>= var1779 0) (>= (str.len var420!1) var199) (>= var199 var1779))))
(define-const var970 String (substring/-1240304868 var420!1 var1779 var199)) ; Statement: $r13 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(i0, $i1) 
(assert true)
(define-const var1347 String (append/672562846 var1141 var970)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r13) 
(declare-const var1141!1 String)
(assert (= var1141!1 (str.++ var1141 var970)))
(assert true)
(define-const var3659 String (toString/-2075883882 var1347)) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/875830710 var2918 var3659)) ; Statement: specialinvoke $r21.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r16) 

(declare-const var2918!1 var1988)
