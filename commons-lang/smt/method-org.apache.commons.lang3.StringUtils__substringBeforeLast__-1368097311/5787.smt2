...
(assert (and true (and (>= 0 0) (>= (str.len var1577) var1192) (>= var1192 0))))
(define-const var2190 String (substring/-1240304868 var1577 0 var1192)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
