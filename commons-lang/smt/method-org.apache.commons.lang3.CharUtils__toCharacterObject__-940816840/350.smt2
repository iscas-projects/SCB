...
(assert (and true (and (> (str.len var2219) 0) (<= 0 0))))
(define-const var3477 Int (charAt/698050440 var2219 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var2120 var3719 (var3719_valueOf/-1186540555 var3477)) ; Statement: $r1 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c0) 
