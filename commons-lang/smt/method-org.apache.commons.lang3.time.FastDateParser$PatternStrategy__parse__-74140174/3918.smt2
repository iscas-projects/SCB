...
(assert (and true (and (>= var2974 0) (>= (str.len var3299) var2974))))
(define-const var1045 String (substring/850833817 var3299 var2974)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var1769 var1922 (matcher/468719934 var439 (cast-from-String-to-String var1045))) ; Statement: r5 = virtualinvoke $r3.<java.util.regex.Pattern: java.util.regex.Matcher matcher(java.lang.CharSequence)>($r4) 
(assert true)
(define-const var3238 Bool (lookingAt/-1645860844 var1769)) ; Statement: $z0 = virtualinvoke r5.<java.util.regex.Matcher: boolean lookingAt()>() 
 ; Statement: if $z0 != 0 goto $i2 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert (not (= (ite var3238 1 0) 0))) ; Cond: $z0 != 0 
(assert true)
(define-const var1694 Int (getIndex/-2136393185 var968)) ; Statement: $i2 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert true)
(define-const var3017 Int (end/-952472175 var1769 1)) ; Statement: $i1 = virtualinvoke r5.<java.util.regex.Matcher: int end(int)>(1) 
(define-const var2883 Int (+ var1694 var3017)) ; Statement: $i3 = $i2 + $i1 
(assert true)
;(assert (setIndex/-453939609 var968 var2883)) ; Statement: virtualinvoke r2.<java.text.ParsePosition: void setIndex(int)>($i3) 

(declare-const var968!1 var803)
(declare-const var2883!1 Int)
(assert true)
(define-const var1800 String (group/-653887691 var1769 1)) ; Statement: $r8 = virtualinvoke r5.<java.util.regex.Matcher: java.lang.String group(int)>(1) 
(assert true)
;(assert (setCalendar/1778664015 var2505 var2209 var1484 var1800)) ; Statement: virtualinvoke r0.<org.apache.commons.lang3.time.FastDateParser$PatternStrategy: void setCalendar(org.apache.commons.lang3.time.FastDateParser,java.util.Calendar,java.lang.String)>(r6, r7, $r8) 

(declare-const var2505!1 var207)
(declare-const var2209!1 var285)
(declare-const var1484!1 var3834)
