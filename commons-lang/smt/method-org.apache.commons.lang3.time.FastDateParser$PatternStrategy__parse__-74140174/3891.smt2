...
(assert (and true (and (>= var105 0) (>= (str.len var3623) var105))))
(define-const var1783 String (substring/850833817 var3623 var105)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var2406 var872 (matcher/468719934 var486 (cast-from-String-to-String var1783))) ; Statement: r5 = virtualinvoke $r3.<java.util.regex.Pattern: java.util.regex.Matcher matcher(java.lang.CharSequence)>($r4) 
(assert true)
(define-const var182 Bool (lookingAt/-1645860844 var2406)) ; Statement: $z0 = virtualinvoke r5.<java.util.regex.Matcher: boolean lookingAt()>() 
 ; Statement: if $z0 != 0 goto $i2 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert (not (not (= (ite var182 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(assert true)
(define-const var3243 Int (getIndex/-2136393185 var1947)) ; Statement: $i4 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert true)
;(assert (setErrorIndex/-1773443795 var1947 var3243)) ; Statement: virtualinvoke r2.<java.text.ParsePosition: void setErrorIndex(int)>($i4) 

(declare-const var1947!1 var1032)
(declare-const var3243!1 Int)
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
