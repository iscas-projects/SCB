...
(assert (and true (and (>= var3524 0) (>= (str.len var3641) var3687) (>= var3687 var3524))))
(define-const var1404 String (substring/-1240304868 var3641 var3524 var3687)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i0, i6) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
