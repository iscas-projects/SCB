...
(assert (and true (and (> (str.len var1498!1) 0) (<= 0 0))))
(define-const var1734 Int (charAt/698050440 var1498!1 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
 ; Statement: return $c0 
(check-sat)
(get-model)
(get-unsat-core)
