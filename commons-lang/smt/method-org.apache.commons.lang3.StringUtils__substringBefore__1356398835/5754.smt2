...
(assert (and true (and (>= 0 0) (>= (str.len var2282) var3773) (>= var3773 0))))
(define-const var1949 String (substring/-1240304868 var2282 0 var3773)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
