...
(assert (and true (and (>= var1721 0) (>= (str.len var1427) var2694) (>= var2694 var1721))))
(define-const var1422 String (substring/-1240304868 var1427 var1721 var2694)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i2, i5) 
(define-const var2445 Int (Int_parseInt/1370970945 var1422)) ; Statement: i10 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r2) 
(assert true)
;(assert (setIndex/-453939609 var609 var2694)) ; Statement: virtualinvoke r0.<java.text.ParsePosition: void setIndex(int)>(i5) 

(declare-const var609!1 var1277)
(declare-const var2694!1 Int)
(define-const var1610 Int (field/-524421381 var78)) ; Statement: $i3 = r4.<org.apache.commons.lang3.time.FastDateParser$NumberStrategy: int field> 
(assert true)
(define-const var1561 Int (modify/1710419509 var78 var33 var2445)) ; Statement: $i4 = virtualinvoke r4.<org.apache.commons.lang3.time.FastDateParser$NumberStrategy: int modify(org.apache.commons.lang3.time.FastDateParser,int)>(r5, i10) 
(assert true)
;(assert (set/-1736220299 var3076 var1610 var1561)) ; Statement: virtualinvoke r3.<java.util.Calendar: void set(int,int)>($i3, $i4) 

(declare-const var3076!1 var2041)
(declare-const var1610!1 Int)
(declare-const var1561!1 Int)
 ; Statement: return 1 
(check-sat)
(get-model)
(get-unsat-core)
