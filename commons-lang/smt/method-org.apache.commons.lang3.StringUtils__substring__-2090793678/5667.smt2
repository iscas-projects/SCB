...
(assert (and true (and (>= var1118 0) (>= (str.len var3504) var1118))))
(define-const var2570 String (substring/850833817 var3504 var1118)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(i2) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
