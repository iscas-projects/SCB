...
(assert (and true (and (> (str.len var2854) 0) (<= 0 0))))
(define-const var3421 Int (charAt/698050440 var2854 0)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
