...
(assert (and true (and (>= var2945 0) (>= (str.len var765) var2945))))
(define-const var2615 String (substring/850833817 var765 var2945)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(i4) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
