...
(define-const var3403 Int (charAt/698050440 var129 0)) ; Statement: c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1656 Int (cast-from-Int-to-Int var3403)) ; Statement: $i2 = (int) c0 
 ; Statement: if $i2 == 45 goto $z0 = 1 
(assert (= var1656 45)) ; Cond: $i2 == 45 
(define-const var2054 Bool (ite (= 1 1) true false)) ; Statement: $z0 = 1 
...
(assert (and true (and (>= 0 0) (>= (str.len var129) var2262) (>= var2262 0))))
(define-const var2257 String (substring/-1240304868 var129 0 var2262)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i1) 
(assert true) ; Non Conditional
 ; Statement: return $r1 
(check-sat)
(get-model)
