...
(assert (and true (and (>= 1 0) (>= (str.len var3327) var2738) (>= var2738 1))))
(define-const var1832 String (substring/-1240304868 var3327 1 var2738)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(1, i1) 
