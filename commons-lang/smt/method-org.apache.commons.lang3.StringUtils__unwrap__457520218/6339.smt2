...
(assert (and true (and (>= var3805 0) (>= (str.len var2) var3587) (>= var3587 var3805))))
(define-const var668 String (substring/-1240304868 var2 var3805 var3587)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i4, $i3) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
