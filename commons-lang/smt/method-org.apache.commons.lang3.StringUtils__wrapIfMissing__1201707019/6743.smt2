...
(define-const var1445 Int (charAt/698050440 var730 0)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1428 Int (cast-from-Int-to-Int var1445)) ; Statement: $i7 = (int) $c1 
(define-const var1012 Int (cast-from-Int-to-Int var1213)) ; Statement: $i8 = (int) c0 
 ; Statement: if $i7 == $i8 goto $z3 = 0 
(assert (= var1428 var1012)) ; Cond: $i7 == $i8 
(define-const var1759 Bool (ite (= 1 0) true false)) ; Statement: $z3 = 0 
(assert true) ; Non Conditional
(define-const var966 Bool var1759) ; Statement: z1 = $z3 
(assert true)
(define-const var2328 Int (length/-134980193 var730)) ; Statement: $i2 = virtualinvoke r0.<java.lang.String: int length()>() 
(define-const var1920 Int (- var2328 1)) ; Statement: $i3 = $i2 - 1 
(assert (and true (and (> (str.len var730) var1920) (<= 0 var1920))))
(define-const var1008 Int (charAt/698050440 var730 var1920)) ; Statement: $c4 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i3) 
(define-const var2368 Int (cast-from-Int-to-Int var1008)) ; Statement: $i9 = (int) $c4 
(define-const var3239 Int (cast-from-Int-to-Int var1213)) ; Statement: $i10 = (int) c0 
 ; Statement: if $i9 == $i10 goto $z6 = 0 
(assert (= var2368 var3239)) ; Cond: $i9 == $i10 
(define-const var1619 Bool (ite (= 1 0) true false)) ; Statement: $z6 = 0 
(define-const var1293 Bool (ite (= 1 0) true false)) ; Statement: $z5 = 0 
(assert true) ; Non Conditional
(define-const var1845 Bool var1619) ; Statement: z2 = $z6 
 ; Statement: if z1 != 0 goto $r3 = new java.lang.StringBuilder 
(assert (not (not (= (ite var966 1 0) 0)))) ; Negate: Cond: z1 != 0  
 ; Statement: if $z5 != 0 goto $r3 = new java.lang.StringBuilder 
(assert (not (not (= (ite var1293 1 0) 0)))) ; Negate: Cond: $z5 != 0  
 ; Statement: return r0 
(check-sat)
(get-model)
(get-unsat-core)
