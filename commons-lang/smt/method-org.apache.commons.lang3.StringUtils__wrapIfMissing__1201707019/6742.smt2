...
(assert (and true (and (> (str.len var3559) var893) (<= 0 var893))))
(define-const var3224 Int (charAt/698050440 var3559 var893)) ; Statement: $c4 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i3) 
(define-const var1075 Int (cast-from-Int-to-Int var3224)) ; Statement: $i9 = (int) $c4 
(define-const var1147 Int (cast-from-Int-to-Int var1850)) ; Statement: $i10 = (int) c0 
 ; Statement: if $i9 == $i10 goto $z6 = 0 
(assert (not (= var1075 var1147))) ; Negate: Cond: $i9 == $i10  
(define-const var1990 Bool (ite (= 1 1) true false)) ; Statement: $z6 = 1 
(define-const var1452 Bool (ite (= 1 1) true false)) ; Statement: $z5 = 1 
 ; Statement: goto [?= z2 = $z6] 
(assert true) ; Non Conditional
(define-const var1210 Bool var1990) ; Statement: z2 = $z6 
 ; Statement: if z1 != 0 goto $r3 = new java.lang.StringBuilder 
(assert (not (not (= (ite var2867 1 0) 0)))) ; Negate: Cond: z1 != 0  
 ; Statement: if $z5 != 0 goto $r3 = new java.lang.StringBuilder 
(assert (not (not (= (ite var1452 1 0) 0)))) ; Negate: Cond: $z5 != 0  
 ; Statement: return r0 
(check-sat)
(get-model)
(get-unsat-core)
