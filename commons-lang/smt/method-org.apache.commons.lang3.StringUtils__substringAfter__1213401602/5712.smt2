...
(assert (and true (and (>= var1131 0) (>= (str.len var677) var1131))))
(define-const var1914 String (substring/850833817 var677 var1131)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i2) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
