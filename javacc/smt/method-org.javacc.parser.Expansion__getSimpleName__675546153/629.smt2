...
(assert (and true (and (>= var3011 0) (>= (str.len var726) var3011))))
(define-const var604 String (substring/850833817 var726 var3011)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
