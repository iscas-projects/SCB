...
(assert (and true (and (>= var1724 0) (>= (str.len var893) var993) (>= var993 var1724))))
(define-const var608 String (substring/-1240304868 var893 var1724 var993)) ; Statement: $r8 = virtualinvoke r4.<java.lang.String: java.lang.String substring(int,int)>($i3, $i2) 
(assert true)
(define-const var2702 String (append/672562846 var3736 var608)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r8) 
(declare-const var3736!1 String)
(assert (= var3736!1 (str.++ var3736 var608)))
(assert true)
(define-const var1904 String (toString/-2075883882 var2702)) ; Statement: $r11 = virtualinvoke $r10.<java.lang.StringBuilder: java.lang.String toString()>() 
