...
(assert (and true (and (>= 1 0) (>= (str.len var1458) 1))))
(define-const var3943 String (substring/850833817 var1458 1)) ; Statement: $r1 = virtualinvoke r32.<java.lang.String: java.lang.String substring(int)>(1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
