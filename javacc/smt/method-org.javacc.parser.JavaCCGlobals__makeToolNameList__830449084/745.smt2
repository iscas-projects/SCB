...
(assert (and true (and (>= 0 0) (>= (str.len var971) var1776) (>= var1776 0))))
(define-const var1366 String (substring/-1240304868 var971 0 var1776)) ; Statement: r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i11) 
(assert true) ; Non Conditional
(assert true)
(define-const var1966 Int (indexOf/-1037706067 var1366 58)) ; Statement: $i0 = virtualinvoke r4.<java.lang.String: int indexOf(int)>(58) 
(define-const var1431 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i18 = (int) -1 
 ; Statement: if $i0 != $i18 goto $i1 = virtualinvoke r4.<java.lang.String: int indexOf(int)>(58) 
(assert (not (not (= var1966 var1431)))) ; Negate: Cond: $i0 != $i18  
 ; Statement: return $r7 
(check-sat)
(get-model)
(get-unsat-core)
