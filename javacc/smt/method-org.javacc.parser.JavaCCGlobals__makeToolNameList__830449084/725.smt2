...
(assert (and true (and (>= 0 0) (>= (str.len var2897) var1692) (>= var1692 0))))
(define-const var2365 String (substring/-1240304868 var2897 0 var1692)) ; Statement: r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i11) 
(assert true) ; Non Conditional
(assert true)
(define-const var376 Int (indexOf/-1037706067 var2365 58)) ; Statement: $i0 = virtualinvoke r4.<java.lang.String: int indexOf(int)>(58) 
(define-const var323 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i18 = (int) -1 
 ; Statement: if $i0 != $i18 goto $i1 = virtualinvoke r4.<java.lang.String: int indexOf(int)>(58) 
(assert (not (not (= var376 var323)))) ; Negate: Cond: $i0 != $i18  
 ; Statement: return $r7 
(check-sat)
(get-model)
(get-unsat-core)
