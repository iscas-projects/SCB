...
(assert (and true (and (> (str.len var769) var3337) (<= 0 var3337))))
(define-const var1917 Int (charAt/698050440 var769 var3337)) ; Statement: $c13 = virtualinvoke $r5.<java.lang.String: char charAt(int)>($i9) 
(define-const var1387 Int (cast-from-Int-to-Int var1917)) ; Statement: $i18 = (int) $c13 
 ; Statement: if $i18 == 10 goto $i10 = <org.javacc.parser.JavaCCGlobals: int cline> 
(assert (not (= var1387 10))) ; Negate: Cond: $i18 == 10  
(define-const var2623 Int (cast-from-Int-to-Int var1917)) ; Statement: $i19 = (int) $c13 
 ; Statement: if $i19 != 13 goto return 
(assert (not (= var2623 13))) ; Cond: $i19 != 13 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
