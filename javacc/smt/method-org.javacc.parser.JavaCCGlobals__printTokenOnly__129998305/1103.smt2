...
(assert (and true (and (> (str.len var1952) var3749) (<= 0 var3749))))
(define-const var3253 Int (charAt/698050440 var1952 var3749)) ; Statement: $c13 = virtualinvoke $r7.<java.lang.String: char charAt(int)>($i9) 
(define-const var531 Int (cast-from-Int-to-Int var3253)) ; Statement: $i18 = (int) $c13 
 ; Statement: if $i18 == 10 goto $i10 = <org.javacc.parser.JavaCCGlobals: int cline> 
(assert (= var531 10)) ; Cond: $i18 == 10 
(define-const var2478 Int var1503-cline) ; Statement: $i10 = <org.javacc.parser.JavaCCGlobals: int cline> 
(define-const var1372 Int (+ var2478 1)) ; Statement: $i11 = $i10 + 1 
(define-const var405 Int var1372) ; Statement: <org.javacc.parser.JavaCCGlobals: int cline> = $i11 
(define-const var253 Int 1) ; Statement: <org.javacc.parser.JavaCCGlobals: int ccol> = 1 
(assert true) ; Non Conditional
