...
(assert (and true (and (> (str.len var2677) 0) (<= 0 0))))
(define-const var1314 Int (charAt/698050440 var2677 0)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
 ; Statement: return $c1 
(check-sat)
(get-model)
(get-unsat-core)
