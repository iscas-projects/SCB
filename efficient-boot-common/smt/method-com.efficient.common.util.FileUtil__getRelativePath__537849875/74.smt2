...
(assert (and true (and (>= var505 0) (>= (str.len var970) var505))))
(define-const var3438 String (substring/850833817 var970 var505)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
