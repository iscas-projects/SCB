...
(assert (and true (and (>= var3719 0) (>= (str.len var2291) var3719))))
(define-const var691 String (substring/850833817 var2291 var3719)) ; Statement: $r11 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(i6) 
(assert true)
(define-const var3587 String (append/1560614132 var673 var691)) ; Statement: $r13 = virtualinvoke $r12.<java.lang.StringBuffer: java.lang.StringBuffer append(java.lang.String)>($r11) 
(declare-const var673!1 String)
(assert (str.prefixof var673 var673!1))
(assert true)
(define-const var1880 String (toString/-222306083 var3587)) ; Statement: $r14 = virtualinvoke $r13.<java.lang.StringBuffer: java.lang.String toString()>() 
(assert true)
;(assert (splitPacket/163499666 var598!1 var1483!1 var1880)) ; Statement: specialinvoke r3.<org.apache.log4j.net.SyslogAppender: void splitPacket(java.lang.String,java.lang.String)>(r2, $r14) 

(declare-const var598!2 var2017)
