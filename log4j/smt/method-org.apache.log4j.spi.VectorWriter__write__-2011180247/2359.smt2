...
(assert (and true (and (>= var391 0) (>= (str.len var281) var2697) (>= var2697 var391))))
(define-const var3462 String (substring/-1240304868 var281 var391 var2697)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, $i2) 
(assert true)
;(assert (addElement/-1717065458 var3762 (cast-from-String-to-var567 var3462))) ; Statement: virtualinvoke $r2.<java.util.Vector: void addElement(java.lang.Object)>($r3) 

(declare-const var3762!1 var378)
