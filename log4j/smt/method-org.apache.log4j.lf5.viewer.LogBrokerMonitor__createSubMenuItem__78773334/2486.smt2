...
(assert (and true (and (> (str.len var860) 0) (<= 0 0))))
(define-const var94 Int (charAt/698050440 var860 0)) ; Statement: $c0 = virtualinvoke $r3.<java.lang.String: char charAt(int)>(0) 
(assert true)
;(assert (setMnemonic/-970060803 (cast-from-var1912-to-var2008 var2711!1) var94)) ; Statement: virtualinvoke $r0.<javax.swing.JMenuItem: void setMnemonic(char)>($c0) 

(declare-const var2711!2 var1912)
(declare-const var94!1 Int)
(define-const var473 var3326 var3326-init) ; Statement: $r4 = new org.apache.log4j.lf5.viewer.LogBrokerMonitor$11 
(assert true)
;(assert (<init>/-848628922 var473 var1392 var2711!2 var1188)) ; Statement: specialinvoke $r4.<org.apache.log4j.lf5.viewer.LogBrokerMonitor$11: void <init>(org.apache.log4j.lf5.viewer.LogBrokerMonitor,javax.swing.JMenuItem,org.apache.log4j.lf5.LogLevel)>(r5, $r0, r1) 

(declare-const var473!1 var3326)
(declare-const var1392!1 var48)
(declare-const var2711!3 var1912)
(declare-const var1188!1 var3637)
(assert true)
;(assert (addActionListener/-1143302268 (cast-from-var1912-to-var2008 var2711!3) (cast-from-var3326-to-var1175 var473!1))) ; Statement: virtualinvoke $r0.<javax.swing.JMenuItem: void addActionListener(java.awt.event.ActionListener)>($r4) 

(declare-const var2711!4 var1912)
(declare-const var473!2 var3326)
 ; Statement: return $r0 
(check-sat)
(get-model)
(get-unsat-core)
