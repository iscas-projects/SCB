...
(assert (and true (and (>= 0 0) (>= (str.len var1519) var3557) (>= var3557 0))))
(define-const var566 String (substring/-1240304868 var1519 0 var3557)) ; Statement: $r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
