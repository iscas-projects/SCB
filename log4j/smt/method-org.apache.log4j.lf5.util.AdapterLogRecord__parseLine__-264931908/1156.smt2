...
(assert (and true (and (>= var1793 0) (>= (str.len var131) var1793))))
(define-const var483 String (substring/850833817 var131 var1793)) ; Statement: r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>(i0) 
(assert true)
(define-const var1087 Int (indexOf/-1209756239 var483 ")")) ; Statement: $i1 = virtualinvoke r3.<java.lang.String: int indexOf(java.lang.String)>(")") 
(define-const var1794 Int (+ var1087 1)) ; Statement: $i2 = $i1 + 1 
(assert (and true (and (>= 0 0) (>= (str.len var483) var1794) (>= var1794 0))))
(define-const var3736 String (substring/-1240304868 var483 0 var1794)) ; Statement: r4 = virtualinvoke r3.<java.lang.String: java.lang.String substring(int,int)>(0, $i2) 
 ; Statement: return r4 
(check-sat)
(get-model)
(get-unsat-core)
