...
(assert (and true (and (>= var3991 0) (>= (str.len var2306) var3991))))
(define-const var3103 String (substring/850833817 var2306 var3991)) ; Statement: $r4 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(i0) 
(assert true)
;(assert (append/672562846 var139!3 var3103)) ; Statement: virtualinvoke $r1.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r4) 
(declare-const var139!4 String)
(assert (= var139!4 (str.++ var139!3 var3103)))
(assert true)
(define-const var3444 String (toString/-2075883882 var139!4)) ; Statement: $r5 = virtualinvoke $r1.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r5 
(check-sat)
(get-model)
(get-unsat-core)
