...
(assert (and true (and (>= var818!1 0) (>= (str.len var2840) var818!1))))
(define-const var2409 String (substring/850833817 var2840 var818!1)) ; Statement: $r4 = virtualinvoke r3.<java.lang.String: java.lang.String substring(int)>(i3) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
