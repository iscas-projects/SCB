...
(assert (and true (and (> (str.len var781) 0) (<= 0 0))))
(define-const var3291 Int (charAt/698050440 var781 0)) ; Statement: $c1 = virtualinvoke r2.<java.lang.String: char charAt(int)>(0) 
(define-const var2083 Int (cast-from-Int-to-Int var3291)) ; Statement: $i4 = (int) $c1 
 ; Statement: if $i4 != 91 goto (branch) 
(assert (not (= var2083 91))) ; Cond: $i4 != 91 
 ; Statement: if r7 == null goto return 
(assert (= var1171 null-String)) ; Cond: r7 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
