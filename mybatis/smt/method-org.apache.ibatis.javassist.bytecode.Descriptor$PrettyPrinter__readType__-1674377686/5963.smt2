...
(assert (and true (and (> (str.len var1188) var815) (<= 0 var815))))
(define-const var3496 Int (charAt/698050440 var1188 var815)) ; Statement: c3 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i2) 
(define-const var195 Int 0) ; Statement: i4 = 0 
(assert true) ; Non Conditional
(define-const var3828 Int (cast-from-Int-to-Int var3496)) ; Statement: $i7 = (int) c3 
 ; Statement: if $i7 != 91 goto $i8 = (int) c3 
(assert (not (= var3828 91))) ; Cond: $i7 != 91 
(define-const var1878 Int (cast-from-Int-to-Int var3496)) ; Statement: $i8 = (int) c3 
 ; Statement: if $i8 != 76 goto r1 = staticinvoke <org.apache.ibatis.javassist.bytecode.Descriptor: org.apache.ibatis.javassist.CtClass toPrimitiveClass(char)>(c3) 
(assert (not (= var1878 76))) ; Cond: $i8 != 76 
(define-const var53 var1703 (var2468_toPrimitiveClass/-1875738372 var3496)) ; Statement: r1 = staticinvoke <org.apache.ibatis.javassist.bytecode.Descriptor: org.apache.ibatis.javassist.CtClass toPrimitiveClass(char)>(c3) 
(assert true)
(define-const var2515 String (getName/1611768686 var53)) ; Statement: $r3 = virtualinvoke r1.<org.apache.ibatis.javassist.CtClass: java.lang.String getName()>() 
(assert true)
;(assert (append/672562846 var3500 var2515)) ; Statement: virtualinvoke r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var3500!1 String)
(assert (= var3500!1 (str.++ var3500 var2515)))
(assert true) ; Non Conditional
(define-const var1075 Int var195) ; Statement: $i6 = i4 
(define-const var1517 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i12 = (int) -1 
(define-const var195!1 Int (+ var195 var1517)) ; Statement: i4 = i4 + $i12 
 ; Statement: if $i6 <= 0 goto $i0 = i2 + 1 
(assert (<= var1075 0)) ; Cond: $i6 <= 0 
(define-const var1046 Int (+ var815 1)) ; Statement: $i0 = i2 + 1 
 ; Statement: return $i0 
(check-sat)
(get-model)
(get-unsat-core)
