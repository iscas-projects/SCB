...
(assert (and true (and (>= var1187 0) (>= (str.len var3622) var3633) (>= var3633 var1187))))
(define-const var2586 String (substring/-1240304868 var3622 var1187 var3633)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, i1) 
(declare-const var2959!2 var3342)
(assert (not (= var2959!2 null-var3342)))
(assert (= (name/-286867520 var2959!2) var2586)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$TypeParameter: java.lang.String name> = $r2 
(declare-const var2959!3 var3342)
(assert (not (= var2959!3 null-var3342)))
(assert (= (superClass/-286867520 var2959!3) var108)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$TypeParameter: org.apache.ibatis.javassist.bytecode.SignatureAttribute$ObjectType superClass> = r3 
(declare-const var2959!4 var3342)
(assert (not (= var2959!4 null-var3342)))
(assert (= (superInterfaces/-286867520 var2959!4) var986)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$TypeParameter: org.apache.ibatis.javassist.bytecode.SignatureAttribute$ObjectType[] superInterfaces> = r4 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
