...
(assert (and true (and (> (str.len var1185) 0) (<= 0 0))))
(define-const var94 Int (charAt/698050440 var1185 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1209 Int (cast-from-Int-to-Int var94)) ; Statement: $i1 = (int) $c0 
 ; Statement: if $i1 == 40 goto $r9 = new java.lang.StringBuilder 
(assert (= var1209 40)) ; Cond: $i1 == 40 
(define-const var1858 String String-init) ; Statement: $r9 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1858)) ; Statement: specialinvoke $r9.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1858!1 String)
(assert (= var1858!1 ""))
(assert true)
(define-const var3463 String (append/672562846 var1858!1 "(")) ; Statement: $r4 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("(") 
(declare-const var1858!2 String)
(assert (= var1858!2 (str.++ var1858!1 "(")))
(define-const var2881 String (var1045_of/1621849684 var284)) ; Statement: $r3 = staticinvoke <org.apache.ibatis.javassist.bytecode.Descriptor: java.lang.String of(org.apache.ibatis.javassist.CtClass)>(r2) 
(assert true)
(define-const var1703 String (append/672562846 var3463 var2881)) ; Statement: $r6 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var3463!1 String)
(assert (= var3463!1 (str.++ var3463 var2881)))
(assert (and true (and (>= 1 0) (>= (str.len var1185) 1))))
(define-const var1635 String (substring/850833817 var1185 1)) ; Statement: $r5 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var3354 String (append/672562846 var1703 var1635)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r5) 
(declare-const var1703!1 String)
(assert (= var1703!1 (str.++ var1703 var1635)))
(assert true)
(define-const var3686 String (toString/-2075883882 var3354)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r8 
(check-sat)
(get-model)
(get-unsat-core)
