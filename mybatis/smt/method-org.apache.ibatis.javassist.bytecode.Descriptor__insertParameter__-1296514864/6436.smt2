...
(assert (and true (and (> (str.len var1037) 0) (<= 0 0))))
(define-const var2027 Int (charAt/698050440 var1037 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var3473 Int (cast-from-Int-to-Int var2027)) ; Statement: $i1 = (int) $c0 
 ; Statement: if $i1 == 40 goto $r9 = new java.lang.StringBuilder 
(assert (not (= var3473 40))) ; Negate: Cond: $i1 == 40  
 ; Statement: return r0 
(check-sat)
(get-model)
(get-unsat-core)
