...
(assert (and true (and (> (str.len var1156) 0) (<= 0 0))))
(define-const var2559 Int (charAt/698050440 var1156 0)) ; Statement: $c0 = virtualinvoke $r2.<java.lang.String: char charAt(int)>(0) 
(assert true)
;(assert (<init>/-1892372303 var3023 var2559)) ; Statement: specialinvoke r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$BaseType: void <init>(char)>($c0) 

(declare-const var3023!1 var2116)
