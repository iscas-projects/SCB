...
(assert (and true (and (>= var277 0) (>= (str.len var966) var277))))
(define-const var237 String (substring/850833817 var966 var277)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
