...
(assert (and true (and (> (str.len var1614) var1115) (<= 0 var1115))))
(define-const var2449 Int (charAt/698050440 var1614 var1115)) ; Statement: $c2 = virtualinvoke r2.<java.lang.String: char charAt(int)>($i1) 
(define-const var2550 Int (cast-from-Int-to-Int var2449)) ; Statement: $i5 = (int) $c2 
...
(assert (and (= var2550 66) true)) ; Intersect: Cond: $i5 == 66  and Non Conditional 
(define-const var1003 var1088 var1088-init) ; Statement: $r7 = new java.math.BigDecimal 
(assert true)
(define-const var638 Int (length/-134980193 var1614)) ; Statement: $i3 = virtualinvoke r2.<java.lang.String: int length()>() 
(define-const var2952 Int (- var638 1)) ; Statement: $i4 = $i3 - 1 
(assert (and true (and (>= 0 0) (>= (str.len var1614) var2952) (>= var2952 0))))
(define-const var2703 String (substring/-1240304868 var1614 0 var2952)) ; Statement: $r5 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(0, $i4) 
(assert true)
;(assert (<init>/-1588472495 var1003 var2703)) ; Statement: specialinvoke $r7.<java.math.BigDecimal: void <init>(java.lang.String)>($r5) 

(declare-const var1003!1 var1088)
