...
(assert (and true (and (> (str.len var3333) var2096) (<= 0 var2096))))
(define-const var1447 Int (charAt/698050440 var3333 var2096)) ; Statement: $c2 = virtualinvoke r2.<java.lang.String: char charAt(int)>($i1) 
(define-const var1523 Int (cast-from-Int-to-Int var1447)) ; Statement: $i5 = (int) $c2 
...
(assert (and (not (= var1523 66)) true)) ; Intersect: Negate: Cond: $i5 == 66   and Non Conditional 
(define-const var883 Float64 (Float64_valueOf/-1382253682 var3333)) ; Statement: $r6 = staticinvoke <java.lang.Double: java.lang.Double valueOf(java.lang.String)>(r2) 
 ; Statement: return $r6 
(check-sat)
(get-model)
(get-unsat-core)
