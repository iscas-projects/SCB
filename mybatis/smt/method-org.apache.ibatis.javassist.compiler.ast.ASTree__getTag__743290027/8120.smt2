...
(assert (and true (and (>= var222 0) (>= (str.len var3535) var222))))
(define-const var42 String (substring/850833817 var3535 var222)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
