...
(assert (and true (and (>= var3887 0) (>= (str.len var1217) var3887))))
(define-const var3164 String (substring/850833817 var1217 var3887)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
