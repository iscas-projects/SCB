...
(assert (and true (and (>= 0 0) (>= (str.len var1218) var3011) (>= var3011 0))))
(define-const var2549 String (substring/-1240304868 var1218 0 var3011)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
