...
(assert (and true (and (> (str.len var3416) var324) (<= 0 var324))))
(define-const var2472 Int (charAt/698050440 var3416 var324)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i10) 
(define-const var1186 Int (cast-from-Int-to-Int var2472)) ; Statement: $i14 = (int) $c1 
...
(assert (and (= var1186 68) true)) ; Intersect: Cond: $i14 == 68  and Non Conditional 
(define-const var675 var3755 var3315-DOUBLE) ; Statement: $r9 = <org.apache.ibatis.javassist.bytecode.stackmap.Tracer: org.apache.ibatis.javassist.bytecode.stackmap.TypeData$BasicType DOUBLE> 
(declare-const var2343!1 (Array Int var2205))
(assert (not (= var2343!1 null-__Array__Int__var2205__)))
(assert (= (select var2343!1 var2363) (cast-from-var3755-to-var2205 var675))) ; Statement: $r12[$i9] = $r9 
(define-const var1847 Int (+ var2363 1)) ; Statement: $i5 = $i9 + 1 
(define-const var3463 var3755 var3315-TOP) ; Statement: $r10 = <org.apache.ibatis.javassist.bytecode.stackmap.Tracer: org.apache.ibatis.javassist.bytecode.stackmap.TypeData$BasicType TOP> 
(declare-const var2343!2 (Array Int var2205))
(assert (not (= var2343!2 null-__Array__Int__var2205__)))
(assert (= (select var2343!2 var1847) (cast-from-var3755-to-var2205 var3463))) ; Statement: $r12[$i5] = $r10 
(define-const var3582 Int (stackTop/-2024160490 var1975)) ; Statement: $i6 = r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: int stackTop> 
(define-const var1974 Int (+ var3582 2)) ; Statement: $i7 = $i6 + 2 
(declare-const var1975!1 var3315)
(assert (not (= var1975!1 null-var3315)))
(assert (= (stackTop/-2024160490 var1975!1) var1974)) ; Statement: r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: int stackTop> = $i7 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
