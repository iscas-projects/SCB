...
(assert (and true (and (> (str.len var2591) 0) (<= 0 0))))
(define-const var2782 Int (charAt/698050440 var2591 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var2734 Int (cast-from-Int-to-Int var2782)) ; Statement: $i13 = (int) $c0 
...
(assert (not (= var2734 40))) ; Cond: $i13 != 40 
(define-const var290 (Array Int var1295) (stackTypes/-2024160490 var3341)) ; Statement: $r12 = r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: org.apache.ibatis.javassist.bytecode.stackmap.TypeData[] stackTypes> 
(define-const var2572 Int (stackTop/-2024160490 var3341)) ; Statement: $i9 = r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: int stackTop> 
(assert (and true (and (> (str.len var2591) var2884) (<= 0 var2884))))
(define-const var2785 Int (charAt/698050440 var2591 var2884)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i10) 
(define-const var3575 Int (cast-from-Int-to-Int var2785)) ; Statement: $i14 = (int) $c1 
...
(assert (and (= var3575 74) (and (not (= var3575 70)) (and (not (= var3575 68)) true)))) ; Intersect: Cond: $i14 == 74  and Intersect: Negate: Cond: $i14 == 70   and Intersect: Negate: Cond: $i14 == 68   and Non Conditional   
(define-const var3756 var2045 var3550-LONG) ; Statement: $r6 = <org.apache.ibatis.javassist.bytecode.stackmap.Tracer: org.apache.ibatis.javassist.bytecode.stackmap.TypeData$BasicType LONG> 
(declare-const var290!1 (Array Int var1295))
(assert (not (= var290!1 null-__Array__Int__var1295__)))
(assert (= (select var290!1 var2572) (cast-from-var2045-to-var1295 var3756))) ; Statement: $r12[$i9] = $r6 
(define-const var274 Int (+ var2572 1)) ; Statement: $i2 = $i9 + 1 
(define-const var2067 var2045 var3550-TOP) ; Statement: $r7 = <org.apache.ibatis.javassist.bytecode.stackmap.Tracer: org.apache.ibatis.javassist.bytecode.stackmap.TypeData$BasicType TOP> 
(declare-const var290!2 (Array Int var1295))
(assert (not (= var290!2 null-__Array__Int__var1295__)))
(assert (= (select var290!2 var274) (cast-from-var2045-to-var1295 var2067))) ; Statement: $r12[$i2] = $r7 
(define-const var3939 Int (stackTop/-2024160490 var3341)) ; Statement: $i3 = r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: int stackTop> 
(define-const var3652 Int (+ var3939 2)) ; Statement: $i4 = $i3 + 2 
(declare-const var3341!1 var3550)
(assert (not (= var3341!1 null-var3550)))
(assert (= (stackTop/-2024160490 var3341!1) var3652)) ; Statement: r1.<org.apache.ibatis.javassist.bytecode.stackmap.Tracer: int stackTop> = $i4 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
