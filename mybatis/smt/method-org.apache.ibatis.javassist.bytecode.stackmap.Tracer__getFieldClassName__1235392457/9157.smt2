...
(assert (and true (and (>= var2417 0) (>= (str.len var1811) var2134) (>= var2134 var2417))))
(define-const var1998 String (substring/-1240304868 var1811 var2417 var2134)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i3, $i2) 
(assert true)
(define-const var1055 String (replace/1524665721 var1998 47 46)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String replace(char,char)>(47, 46) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
