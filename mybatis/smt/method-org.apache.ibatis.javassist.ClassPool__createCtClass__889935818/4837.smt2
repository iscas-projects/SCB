...
(assert (and true (and (> (str.len var2033) 0) (<= 0 0))))
(define-const var854 Int (charAt/698050440 var2033 0)) ; Statement: $c0 = virtualinvoke r7.<java.lang.String: char charAt(int)>(0) 
(define-const var3235 Int (cast-from-Int-to-Int var854)) ; Statement: $i2 = (int) $c0 
 ; Statement: if $i2 != 91 goto $z0 = virtualinvoke r7.<java.lang.String: boolean endsWith(java.lang.String)>("[]") 
(assert (not (= var3235 91))) ; Cond: $i2 != 91 
(assert true)
(define-const var1452 Bool (endsWith/985337093 var2033 "[]")) ; Statement: $z0 = virtualinvoke r7.<java.lang.String: boolean endsWith(java.lang.String)>("[]") 
...
(assert true)
(define-const var1994 var158 (find/1743038193 var1805 var2033)) ; Statement: $r1 = virtualinvoke r0.<org.apache.ibatis.javassist.ClassPool: java.net.URL find(java.lang.String)>(r7) 
 ; Statement: if $r1 != null goto $r9 = new org.apache.ibatis.javassist.CtClassType 
(assert (not (not (= var1994 null-var158)))) ; Negate: Cond: $r1 != null  
