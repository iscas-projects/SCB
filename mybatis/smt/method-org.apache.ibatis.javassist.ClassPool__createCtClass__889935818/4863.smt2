...
(assert (and true (and (> (str.len var2301) 0) (<= 0 0))))
(define-const var1064 Int (charAt/698050440 var2301 0)) ; Statement: $c0 = virtualinvoke r7.<java.lang.String: char charAt(int)>(0) 
(define-const var1946 Int (cast-from-Int-to-Int var1064)) ; Statement: $i2 = (int) $c0 
 ; Statement: if $i2 != 91 goto $z0 = virtualinvoke r7.<java.lang.String: boolean endsWith(java.lang.String)>("[]") 
(assert (not (= var1946 91))) ; Cond: $i2 != 91 
(assert true)
(define-const var1272 Bool (endsWith/985337093 var2301 "[]")) ; Statement: $z0 = virtualinvoke r7.<java.lang.String: boolean endsWith(java.lang.String)>("[]") 
 ; Statement: if $z0 == 0 goto $r1 = virtualinvoke r0.<org.apache.ibatis.javassist.ClassPool: java.net.URL find(java.lang.String)>(r7) 
(assert (= (ite var1272 1 0) 0)) ; Cond: $z0 == 0 
(assert true)
(define-const var3772 var1779 (find/1743038193 var2360 var2301)) ; Statement: $r1 = virtualinvoke r0.<org.apache.ibatis.javassist.ClassPool: java.net.URL find(java.lang.String)>(r7) 
 ; Statement: if $r1 != null goto $r9 = new org.apache.ibatis.javassist.CtClassType 
(assert (not (= var3772 null-var1779))) ; Cond: $r1 != null 
(define-const var1212 var3773 var3773-init) ; Statement: $r9 = new org.apache.ibatis.javassist.CtClassType 
(assert true)
;(assert (<init>/1650614087 var1212 var2301 var2360)) ; Statement: specialinvoke $r9.<org.apache.ibatis.javassist.CtClassType: void <init>(java.lang.String,org.apache.ibatis.javassist.ClassPool)>(r7, r0) 

(declare-const var1212!1 var3773)
(declare-const var2301!1 String)
(declare-const var2360!1 var3554)
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
