...
(assert (and true (and (> (str.len var2197) 0) (<= 0 0))))
(define-const var3603 Int (charAt/698050440 var2197 0)) ; Statement: c4 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var3086 Int (cast-from-Int-to-Int var3603)) ; Statement: $i7 = (int) c4 
 ; Statement: if $i7 != 40 goto (branch) 
(assert (not (= var3086 40))) ; Cond: $i7 != 40 
 ; Statement: if z0 == 0 goto return i3 
(assert (= (ite var2619 1 0) 0)) ; Cond: z0 == 0 
 ; Statement: return i3 
(check-sat)
(get-model)
(get-unsat-core)
