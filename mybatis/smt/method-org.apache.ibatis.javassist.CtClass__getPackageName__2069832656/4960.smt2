...
(assert (and true (and (>= 0 0) (>= (str.len var993) var140) (>= var140 0))))
(define-const var807 String (substring/-1240304868 var993 0 var140)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
