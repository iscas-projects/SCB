...
(assert (and true (and (>= var252 0) (>= (str.len var1003) var2334) (>= var2334 var252))))
(define-const var2364 String (substring/-1240304868 var1003 var252 var2334)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, i1) 
(declare-const var1760!2 var3331)
(assert (not (= var1760!2 null-var3331)))
(assert (= (name/-1737529467 var1760!2) var2364)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$TypeVariable: java.lang.String name> = $r2 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
