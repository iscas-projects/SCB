...
(assert (and true (and (>= var2164 0) (>= (str.len var2254) var3251) (>= var3251 var2164))))
(define-const var2804 String (substring/-1240304868 var2254 var2164 var3251)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>(i4, i5) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
