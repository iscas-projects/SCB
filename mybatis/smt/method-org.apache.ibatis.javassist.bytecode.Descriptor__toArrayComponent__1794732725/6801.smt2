...
(assert (and true (and (>= var1725 0) (>= (str.len var733) var1725))))
(define-const var3698 String (substring/850833817 var733 var1725)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
