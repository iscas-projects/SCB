...
(assert (and true (and (>= var2651 0) (>= (str.len var119) var1376) (>= var1376 var2651))))
(define-const var170 String (substring/-1240304868 var119 var2651 var1376)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, i1) 
(assert true)
(define-const var121 String (replace/1524665721 var170 47 46)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String replace(char,char)>(47, 46) 
(declare-const var3227!2 var2429)
(assert (not (= var3227!2 null-var2429)))
(assert (= (name/-751637629 var3227!2) var121)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$ClassType: java.lang.String name> = $r3 
(declare-const var3227!3 var2429)
(assert (not (= var3227!3 null-var2429)))
(assert (= (arguments/-751637629 var3227!3) var3835)) ; Statement: r0.<org.apache.ibatis.javassist.bytecode.SignatureAttribute$ClassType: org.apache.ibatis.javassist.bytecode.SignatureAttribute$TypeArgument[] arguments> = r4 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
