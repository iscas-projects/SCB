...
(assert (and true (and (> (str.len var1014) 0) (<= 0 0))))
(define-const var3490 Int (charAt/698050440 var1014 0)) ; Statement: $c1 = virtualinvoke r2.<java.lang.String: char charAt(int)>(0) 
(define-const var105 Int (cast-from-Int-to-Int var3490)) ; Statement: $i4 = (int) $c1 
 ; Statement: if $i4 != 91 goto $r4 = interfaceinvoke r3.<java.util.Map: java.lang.Object get(java.lang.Object)>(r2) 
(assert (not (= var105 91))) ; Cond: $i4 != 91 
(define-const var1840 var3462 (var1338_get/1088891777 var1236 (cast-from-String-to-var3462 var1014))) ; Statement: $r4 = interfaceinvoke r3.<java.util.Map: java.lang.Object get(java.lang.Object)>(r2) 
(define-const var2785 String (cast-from-var3462-to-String var1840)) ; Statement: r8 = (java.lang.String) $r4 
 ; Statement: if r8 == null goto (branch) 
(assert (= var2785 null-String)) ; Cond: r8 == null 
 ; Statement: if r6 == null goto return 
(assert (= var1436 null-String)) ; Cond: r6 == null 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
