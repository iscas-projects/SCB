...
(assert (and true (and (> (str.len var3801) var2712) (<= 0 var2712))))
(define-const var147 Int (charAt/698050440 var3801 var2712)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i10) 
(define-const var3914 Int (cast-from-Int-to-Int var147)) ; Statement: $i12 = (int) $c2 
 ; Statement: if $i12 != 76 goto $c3 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(assert (not (not (= var3914 76)))) ; Negate: Cond: $i12 != 76  
(assert true)
(define-const var2712!1 Int (indexOf/1426977840 var3801 59 var2712)) ; Statement: i10 = virtualinvoke r0.<java.lang.String: int indexOf(int,int)>(59, i10) 
 ; Statement: if i10 >= 0 goto $c3 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(assert (not (>= var2712!1 0))) ; Negate: Cond: i10 >= 0  
(define-const var3055 var1439 var1439-init) ; Statement: $r9 = new java.lang.IndexOutOfBoundsException 
(assert true)
;(assert (<init>/1107025377 var3055 "bad descriptor")) ; Statement: specialinvoke $r9.<java.lang.IndexOutOfBoundsException: void <init>(java.lang.String)>("bad descriptor") 

(declare-const var3055!1 var1439)
(declare-const var737 String)
 ; Statement: throw $r9 
(check-sat)
(get-model)
(get-unsat-core)
