...
(assert (and true (and (> (str.len var162) 0) (<= 0 0))))
(define-const var1295 Int (charAt/698050440 var162 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var3767 Int (cast-from-Int-to-Int var1295)) ; Statement: $i1 = (int) $c0 
 ; Statement: if $i1 == 40 goto $r10 = new java.lang.StringBuilder 
(assert (not (= var3767 40))) ; Negate: Cond: $i1 == 40  
 ; Statement: return r0 
(check-sat)
(get-model)
(get-unsat-core)
