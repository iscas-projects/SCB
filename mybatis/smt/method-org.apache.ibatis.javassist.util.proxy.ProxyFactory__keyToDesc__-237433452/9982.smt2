...
(assert (and true (and (>= var3369 0) (>= (str.len var1739) var3369))))
(define-const var3416 String (substring/850833817 var1739 var3369)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
