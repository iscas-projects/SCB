...
(assert (and true (and (> (str.len var3098) 0) (<= 0 0))))
(define-const var2464 Int (charAt/698050440 var3098 0)) ; Statement: $c4 = virtualinvoke r4.<java.lang.String: char charAt(int)>(0) 
(define-const var2909 Int (cast-from-Int-to-Int var2464)) ; Statement: $i5 = (int) $c4 
 ; Statement: if $i5 != 91 goto return r4 
(assert (not (= var2909 91))) ; Cond: $i5 != 91 
 ; Statement: return r4 
(check-sat)
(get-model)
(get-unsat-core)
