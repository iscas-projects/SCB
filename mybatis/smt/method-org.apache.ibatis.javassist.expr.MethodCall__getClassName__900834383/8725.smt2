...
(assert (and true (and (> (str.len var1838) 0) (<= 0 0))))
(define-const var820 Int (charAt/698050440 var1838 0)) ; Statement: $c4 = virtualinvoke r4.<java.lang.String: char charAt(int)>(0) 
(define-const var1483 Int (cast-from-Int-to-Int var820)) ; Statement: $i5 = (int) $c4 
 ; Statement: if $i5 != 91 goto return r4 
(assert (not (= var1483 91))) ; Cond: $i5 != 91 
 ; Statement: return r4 
(check-sat)
(get-model)
(get-unsat-core)
