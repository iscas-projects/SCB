...
(assert (and true (and (>= 0 0) (>= (str.len var3607) var3622) (>= var3622 0))))
(define-const var1475 String (substring/-1240304868 var3607 0 var3622)) ; Statement: $r4 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int,int)>(0, $i7) 
(assert true)
;(assert (<init>/1387902529 var446 var1475 var2811)) ; Statement: specialinvoke $r7.<java.math.BigInteger: void <init>(java.lang.String,int)>($r4, b11) 

(declare-const var446!1 var192)
(declare-const var1475!1 String)
(declare-const var2811!1 Int)
(define-const var673 var738 (cast-from-var192-to-var738 var446!1)) ; Statement: r6 = $r7 
