...
(assert (and true (and (> (str.len var2775) var3650) (<= 0 var3650))))
(define-const var3244 Int (charAt/698050440 var2775 var3650)) ; Statement: $c3 = virtualinvoke r5.<java.lang.String: char charAt(int)>($i2) 
(define-const var3695 Int (cast-from-Int-to-Int var3244)) ; Statement: $i16 = (int) $c3 
...
(assert (and (not (= var3695 108)) (and (not (= var3695 104)) (and (not (= var3695 76)) (and (not (= var3695 72)) true))))) ; Intersect: Negate: Cond: $i16 == 108   and Intersect: Negate: Cond: $i16 == 104   and Intersect: Negate: Cond: $i16 == 76   and Intersect: Negate: Cond: $i16 == 72   and Non Conditional    
(define-const var2383 var2452 (cast-from-Int-to-var2452 (Int_valueOf/696420135 var2775 var3711))) ; Statement: r6 = staticinvoke <java.lang.Integer: java.lang.Integer valueOf(java.lang.String,int)>(r5, b11) 
