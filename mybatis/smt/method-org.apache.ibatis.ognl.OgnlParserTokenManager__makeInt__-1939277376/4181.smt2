...
(assert (and true (and (> (str.len var322) 0) (<= 0 0))))
(define-const var3671 Int (charAt/698050440 var322 0)) ; Statement: $c0 = virtualinvoke r5.<java.lang.String: char charAt(int)>(0) 
(define-const var3347 Int (cast-from-Int-to-Int var3671)) ; Statement: $i13 = (int) $c0 
 ; Statement: if $i13 != 48 goto (branch) 
(assert (not (= var3347 48))) ; Cond: $i13 != 48 
 ; Statement: if b11 != 16 goto $i1 = virtualinvoke r5.<java.lang.String: int length()>() 
(assert (not (= var3157 16))) ; Cond: b11 != 16 
(assert true)
(define-const var2380 Int (length/-134980193 var322)) ; Statement: $i1 = virtualinvoke r5.<java.lang.String: int length()>() 
(define-const var260 Int (- var2380 1)) ; Statement: $i2 = $i1 - 1 
(assert (and true (and (> (str.len var322) var260) (<= 0 var260))))
(define-const var1084 Int (charAt/698050440 var322 var260)) ; Statement: $c3 = virtualinvoke r5.<java.lang.String: char charAt(int)>($i2) 
(define-const var2686 Int (cast-from-Int-to-Int var1084)) ; Statement: $i16 = (int) $c3 
...
(assert (and (= var2686 76) (and (not (= var2686 72)) true))) ; Intersect: Cond: $i16 == 76  and Intersect: Negate: Cond: $i16 == 72   and Non Conditional  
(assert true)
(define-const var1687 Int (length/-134980193 var322)) ; Statement: $i4 = virtualinvoke r5.<java.lang.String: int length()>() 
(define-const var2089 Int (- var1687 1)) ; Statement: $i5 = $i4 - 1 
(assert (and true (and (>= 0 0) (>= (str.len var322) var2089) (>= var2089 0))))
(define-const var2363 String (substring/-1240304868 var322 0 var2089)) ; Statement: $r2 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int,int)>(0, $i5) 
(define-const var1315 var3803 (cast-from-Int-to-var3803 (Int_valueOf/1287719355 var2363 var3157))) ; Statement: r6 = staticinvoke <java.lang.Long: java.lang.Long valueOf(java.lang.String,int)>($r2, b11) 
