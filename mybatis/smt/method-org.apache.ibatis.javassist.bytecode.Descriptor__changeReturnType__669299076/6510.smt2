...
(assert (and true (and (>= 0 0) (>= (str.len var3513) var129) (>= var129 0))))
(define-const var2397 String (substring/-1240304868 var3513 0 var129)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(assert true)
;(assert (append/672562846 var607!1 var2397)) ; Statement: virtualinvoke $r1.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r2) 
(declare-const var607!2 String)
(assert (= var607!2 (str.++ var607!1 var2397)))
(assert true)
;(assert (append/-1166366385 var607!2 76)) ; Statement: virtualinvoke $r1.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(76) 
(declare-const var607!3 String)
(assert (str.prefixof var607!2 var607!3))
(assert true)
(define-const var3669 String (replace/1524665721 var2885 46 47)) ; Statement: $r4 = virtualinvoke r3.<java.lang.String: java.lang.String replace(char,char)>(46, 47) 
(assert true)
;(assert (append/672562846 var607!3 var3669)) ; Statement: virtualinvoke $r1.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r4) 
(declare-const var607!4 String)
(assert (= var607!4 (str.++ var607!3 var3669)))
(assert true)
;(assert (append/-1166366385 var607!4 59)) ; Statement: virtualinvoke $r1.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(59) 
(declare-const var607!5 String)
(assert (str.prefixof var607!4 var607!5))
(assert true)
(define-const var658 String (toString/-2075883882 var607!5)) ; Statement: $r5 = virtualinvoke $r1.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r5 
(check-sat)
(get-model)
(get-unsat-core)
