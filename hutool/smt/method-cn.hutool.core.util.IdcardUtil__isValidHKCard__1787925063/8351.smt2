...
(assert (and true (and (> (str.len var3708) 1) (<= 0 1))))
(define-const var2587 Int (charAt/698050440 var3708 1)) ; Statement: $c13 = virtualinvoke r6.<java.lang.String: char charAt(int)>(1) 
(define-const var3919 Int (var1857_toUpperCase/1913344327 var2587)) ; Statement: $c14 = staticinvoke <java.lang.Character: char toUpperCase(char)>($c13) 
(define-const var1229 Int (cast-from-Int-to-Int var3919)) ; Statement: $i24 = (int) $c14 
(define-const var2172 Int (- var1229 55)) ; Statement: $i15 = $i24 - 55 
(define-const var3046 Int (* var2172 8)) ; Statement: $i16 = $i15 * 8 
(define-const var3171 Int (+ var1118 var3046)) ; Statement: i19 = $i17 + $i16 
(assert (and true (and (>= 1 0) (>= (str.len var3708) 9) (>= 9 1))))
(define-const var3708!1 String (substring/-1240304868 var3708 1 9)) ; Statement: r6 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 9) 
 ; Statement: goto [?= $r3 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 7)] 
(assert true) ; Non Conditional
(assert (and true (and (>= 1 0) (>= (str.len var3708!1) 7) (>= 7 1))))
(define-const var3694 String (substring/-1240304868 var3708!1 1 7)) ; Statement: $r3 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 7) 
(assert (and true (and (>= 7 0) (>= (str.len var3708!1) 8) (>= 8 7))))
(define-const var3287 String (substring/-1240304868 var3708!1 7 8)) ; Statement: $r4 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(7, 8) 
(assert true)
(define-const var3959 (Array Int Int) (toCharArray/415275702 var3694)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.String: char[] toCharArray()>() 
(define-const var1271 Int 7) ; Statement: i20 = 7 
(define-const var777 Int (getLength-Arr-Int-1 var3959)) ; Statement: $i18 = lengthof $r5 
(define-const var3508 Int 0) ; Statement: i21 = 0 
(assert true) ; Non Conditional
 ; Statement: if i21 >= $i18 goto $r1 = "A" 
(assert (>= var3508 var777)) ; Cond: i21 >= $i18 
(define-const var3394 String "A") ; Statement: $r1 = "A" 
(assert true)
(define-const var1297 Bool (equalsIgnoreCase/-92311102 var3394 var3287)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>($r4) 
...
(define-const var710 Int (+ var3171 10)) ; Statement: i22 = i19 + 10 
 ; Statement: goto [?= $i6 = i22 % 11] 
(assert true) ; Non Conditional
(define-const var3393 Int (mod var710 11)) ; Statement: $i6 = i22 % 11 
 ; Statement: if $i6 != 0 goto $z1 = 0 
(assert (not (= var3393 0))) ; Cond: $i6 != 0 
(define-const var1513 Bool (ite (= 1 0) true false)) ; Statement: $z1 = 0 
(assert true) ; Non Conditional
 ; Statement: return $z1 
(check-sat)
(get-model)
