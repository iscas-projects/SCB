...
(assert (and true (and (>= 7 0) (>= (str.len var3718) 8) (>= 8 7))))
(define-const var2116 String (substring/-1240304868 var3718 7 8)) ; Statement: $r4 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(7, 8) 
(assert true)
(define-const var2394 (Array Int Int) (toCharArray/415275702 var3998)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.String: char[] toCharArray()>() 
(define-const var3381 Int 7) ; Statement: i20 = 7 
(define-const var3984 Int (getLength-Arr-Int-1 var2394)) ; Statement: $i18 = lengthof $r5 
(define-const var2345 Int 0) ; Statement: i21 = 0 
(assert true) ; Non Conditional
 ; Statement: if i21 >= $i18 goto $r1 = "A" 
(assert (>= var2345 var3984)) ; Cond: i21 >= $i18 
(define-const var3645 String "A") ; Statement: $r1 = "A" 
(assert true)
(define-const var1542 Bool (equalsIgnoreCase/-92311102 var3645 var2116)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>($r4) 
 ; Statement: if $z0 == 0 goto $i5 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r4) 
(assert (= (ite var1542 1 0) 0)) ; Cond: $z0 == 0 
(define-const var364 Int (Int_parseInt/1370970945 var2116)) ; Statement: $i5 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r4) 
(define-const var848 Int (+ var3307 var364)) ; Statement: i22 = i19 + $i5 
(assert true) ; Non Conditional
(define-const var1019 Int (mod var848 11)) ; Statement: $i6 = i22 % 11 
 ; Statement: if $i6 != 0 goto $z1 = 0 
(assert (not (= var1019 0))) ; Cond: $i6 != 0 
(define-const var3218 Bool (ite (= 1 0) true false)) ; Statement: $z1 = 0 
(assert true) ; Non Conditional
 ; Statement: return $z1 
(check-sat)
(get-model)
