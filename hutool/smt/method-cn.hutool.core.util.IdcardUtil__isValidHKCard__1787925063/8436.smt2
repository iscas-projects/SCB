...
(assert (and true (and (>= 1 0) (>= (str.len var374) 7) (>= 7 1))))
(define-const var3109 String (substring/-1240304868 var374 1 7)) ; Statement: $r3 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 7) 
(assert (and true (and (>= 7 0) (>= (str.len var374) 8) (>= 8 7))))
(define-const var3848 String (substring/-1240304868 var374 7 8)) ; Statement: $r4 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(7, 8) 
(assert true)
(define-const var1672 (Array Int Int) (toCharArray/415275702 var3109)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.String: char[] toCharArray()>() 
(define-const var758 Int 7) ; Statement: i20 = 7 
(define-const var3141 Int (getLength-Arr-Int-1 var1672)) ; Statement: $i18 = lengthof $r5 
(define-const var1379 Int 0) ; Statement: i21 = 0 
(assert true) ; Non Conditional
 ; Statement: if i21 >= $i18 goto $r1 = "A" 
(assert (>= var1379 var3141)) ; Cond: i21 >= $i18 
(define-const var981 String "A") ; Statement: $r1 = "A" 
(assert true)
(define-const var341 Bool (equalsIgnoreCase/-92311102 var981 var3848)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>($r4) 
 ; Statement: if $z0 == 0 goto $i5 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r4) 
(assert (not (= (ite var341 1 0) 0))) ; Negate: Cond: $z0 == 0  
(define-const var2327 Int (+ var3477 10)) ; Statement: i22 = i19 + 10 
 ; Statement: goto [?= $i6 = i22 % 11] 
(assert true) ; Non Conditional
(define-const var2839 Int (mod var2327 11)) ; Statement: $i6 = i22 % 11 
 ; Statement: if $i6 != 0 goto $z1 = 0 
(assert (not (not (= var2839 0)))) ; Negate: Cond: $i6 != 0  
(define-const var141 Bool (ite (= 1 1) true false)) ; Statement: $z1 = 1 
