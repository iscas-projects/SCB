...
(assert (and true (and (>= 1 0) (>= (str.len var1034) 9) (>= 9 1))))
(define-const var1034!1 String (substring/-1240304868 var1034 1 9)) ; Statement: r6 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 9) 
 ; Statement: goto [?= $r3 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 7)] 
(assert true) ; Non Conditional
(assert (and true (and (>= 1 0) (>= (str.len var1034!1) 7) (>= 7 1))))
(define-const var2132 String (substring/-1240304868 var1034!1 1 7)) ; Statement: $r3 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(1, 7) 
(assert (and true (and (>= 7 0) (>= (str.len var1034!1) 8) (>= 8 7))))
(define-const var1554 String (substring/-1240304868 var1034!1 7 8)) ; Statement: $r4 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(7, 8) 
(assert true)
(define-const var2851 (Array Int Int) (toCharArray/415275702 var2132)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.String: char[] toCharArray()>() 
(define-const var2348 Int 7) ; Statement: i20 = 7 
(define-const var2060 Int (getLength-Arr-Int-1 var2851)) ; Statement: $i18 = lengthof $r5 
(define-const var1746 Int 0) ; Statement: i21 = 0 
(assert true) ; Non Conditional
 ; Statement: if i21 >= $i18 goto $r1 = "A" 
(assert (>= var1746 var2060)) ; Cond: i21 >= $i18 
(define-const var191 String "A") ; Statement: $r1 = "A" 
(assert true)
(define-const var409 Bool (equalsIgnoreCase/-92311102 var191 var1554)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>($r4) 
...
(define-const var2632 Int (Int_parseInt/1370970945 var1554)) ; Statement: $i5 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r4) 
(define-const var2930 Int (+ var1192 var2632)) ; Statement: i22 = i19 + $i5 
(assert true) ; Non Conditional
(define-const var319 Int (mod var2930 11)) ; Statement: $i6 = i22 % 11 
 ; Statement: if $i6 != 0 goto $z1 = 0 
(assert (not (not (= var319 0)))) ; Negate: Cond: $i6 != 0  
(define-const var1274 Bool (ite (= 1 1) true false)) ; Statement: $z1 = 1 
