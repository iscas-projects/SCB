...
(assert (and true (and (>= 7 0) (>= (str.len var348!1) 8) (>= 8 7))))
(define-const var1651 String (substring/-1240304868 var348!1 7 8)) ; Statement: $r4 = virtualinvoke r6.<java.lang.String: java.lang.String substring(int,int)>(7, 8) 
(assert true)
(define-const var2145 (Array Int Int) (toCharArray/415275702 var2790)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.String: char[] toCharArray()>() 
(define-const var568 Int 7) ; Statement: i20 = 7 
(define-const var2162 Int (getLength-Arr-Int-1 var2145)) ; Statement: $i18 = lengthof $r5 
(define-const var823 Int 0) ; Statement: i21 = 0 
(assert true) ; Non Conditional
 ; Statement: if i21 >= $i18 goto $r1 = "A" 
(assert (>= var823 var2162)) ; Cond: i21 >= $i18 
(define-const var2688 String "A") ; Statement: $r1 = "A" 
(assert true)
(define-const var973 Bool (equalsIgnoreCase/-92311102 var2688 var1651)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equalsIgnoreCase(java.lang.String)>($r4) 
...
(define-const var3053 Int (+ var3309 10)) ; Statement: i22 = i19 + 10 
 ; Statement: goto [?= $i6 = i22 % 11] 
(assert true) ; Non Conditional
(define-const var1107 Int (mod var3053 11)) ; Statement: $i6 = i22 % 11 
 ; Statement: if $i6 != 0 goto $z1 = 0 
(assert (not (not (= var1107 0)))) ; Negate: Cond: $i6 != 0  
(define-const var667 Bool (ite (= 1 1) true false)) ; Statement: $z1 = 1 
