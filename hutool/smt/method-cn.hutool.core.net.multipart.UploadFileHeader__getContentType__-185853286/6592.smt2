...
(assert (and true (and (>= var3052 0) (>= (str.len var176) var3052))))
(define-const var820 String (substring/850833817 var176 var3052)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i2) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
