...
(assert (and true (and (>= var2843 0) (>= (str.len var2654) var2843))))
(define-const var3240 String (substring/850833817 var2654 var2843)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var3792 var1599 (matcher/468719934 var2273 (cast-from-String-to-String var3240))) ; Statement: r5 = virtualinvoke $r3.<java.util.regex.Pattern: java.util.regex.Matcher matcher(java.lang.CharSequence)>($r4) 
(assert true)
(define-const var2135 Bool (lookingAt/-1645860844 var3792)) ; Statement: $z0 = virtualinvoke r5.<java.util.regex.Matcher: boolean lookingAt()>() 
 ; Statement: if $z0 != 0 goto $i2 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert (not (not (= (ite var2135 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(assert true)
(define-const var1848 Int (getIndex/-2136393185 var353)) ; Statement: $i4 = virtualinvoke r2.<java.text.ParsePosition: int getIndex()>() 
(assert true)
;(assert (setErrorIndex/-1773443795 var353 var1848)) ; Statement: virtualinvoke r2.<java.text.ParsePosition: void setErrorIndex(int)>($i4) 

(declare-const var353!1 var1080)
