...
(assert (and true (and (> (str.len var3766) var3921) (<= 0 var3921))))
(define-const var508 Int (charAt/698050440 var3766 var3921)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>($i1) 
 ; Statement: return $c2 
(check-sat)
(get-model)
(get-unsat-core)
