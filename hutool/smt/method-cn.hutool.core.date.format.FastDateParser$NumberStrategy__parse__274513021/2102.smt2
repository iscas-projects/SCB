...
(assert (and true (and (>= var664 0) (>= (str.len var2573) var1039) (>= var1039 var664))))
(define-const var1516 String (substring/-1240304868 var2573 var664 var1039)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i2, i5) 
(define-const var1305 Int (Int_parseInt/1370970945 var1516)) ; Statement: i10 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r2) 
(assert true)
;(assert (setIndex/-453939609 var815 var1039)) ; Statement: virtualinvoke r0.<java.text.ParsePosition: void setIndex(int)>(i5) 

(declare-const var815!1 var505)
(declare-const var1039!1 Int)
(define-const var3577 Int (field/-42773609 var3752)) ; Statement: $i3 = r4.<cn.hutool.core.date.format.FastDateParser$NumberStrategy: int field> 
(assert true)
(define-const var546 Int (modify/1617327677 var3752 var2397 var1305)) ; Statement: $i4 = virtualinvoke r4.<cn.hutool.core.date.format.FastDateParser$NumberStrategy: int modify(cn.hutool.core.date.format.FastDateParser,int)>(r5, i10) 
(assert true)
;(assert (set/-1736220299 var2461 var3577 var546)) ; Statement: virtualinvoke r3.<java.util.Calendar: void set(int,int)>($i3, $i4) 

(declare-const var2461!1 var1655)
(declare-const var3577!1 Int)
(declare-const var546!1 Int)
 ; Statement: return 1 
(check-sat)
(get-model)
(get-unsat-core)
