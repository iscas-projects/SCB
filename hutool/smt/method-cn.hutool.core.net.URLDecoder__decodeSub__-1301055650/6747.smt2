...
(assert (and true (and (>= var2839 0) (>= (str.len var2113) var1000) (>= var1000 var2839))))
(define-const var668 String (substring/-1240304868 var2113 var2839 var1000)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, i1) 
(define-const var2645 var3942 var2291-CHARSET_ISO_8859_1) ; Statement: $r2 = <cn.hutool.core.util.CharsetUtil: java.nio.charset.Charset CHARSET_ISO_8859_1> 
(assert true)
(define-const var3514 (Array Int Int) (getBytes/-163691139 var668 var2645)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: byte[] getBytes(java.nio.charset.Charset)>($r2) 
(define-const var486 (Array Int Int) (var3732_decode/1570173944 var3514 var3238)) ; Statement: $r6 = staticinvoke <cn.hutool.core.net.URLDecoder: byte[] decode(byte[],boolean)>($r4, z0) 
(assert true)
;(assert (<init>/-2015205558 var2442 var486 var1348)) ; Statement: specialinvoke $r0.<java.lang.String: void <init>(byte[],java.nio.charset.Charset)>($r6, r5) 

(declare-const var2442!1 String)
(declare-const var486!1 (Array Int Int))
(declare-const var1348!1 var3942)
 ; Statement: return $r0 
(check-sat)
(get-model)
(get-unsat-core)
