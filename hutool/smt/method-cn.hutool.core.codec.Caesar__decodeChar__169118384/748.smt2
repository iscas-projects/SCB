...
(assert (and true (and (> (str.len var1764) var1241) (<= 0 var1241))))
(define-const var261 Int (charAt/698050440 var1764 var1241)) ; Statement: $c4 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(i5) 
 ; Statement: return $c4 
(check-sat)
(get-model)
(get-unsat-core)
