...
(assert (and true (and (>= var2403 0) (>= (str.len var121) var1992!1) (>= var1992!1 var2403))))
(define-const var2853 String (substring/-1240304868 var121 var2403 var1992!1)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i0, i3) 
;(assert (var3914_add/328494887 var400 (cast-from-String-to-var982 var2853))) ; Statement: interfaceinvoke r1.<java.util.List: boolean add(java.lang.Object)>($r2) 

(declare-const var400!1 var3914)
