...
(assert (and true (and (>= 1 0) (>= (str.len var3892) 1))))
(define-const var3725 String (substring/850833817 var3892 1)) ; Statement: $r16 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(1) 
(define-const var924 String (var3615_transTwo/2028843256 var3725)) ; Statement: r17 = staticinvoke <cn.hutool.core.convert.NumberWordFormatter: java.lang.String transTwo(java.lang.String)>($r16) 
