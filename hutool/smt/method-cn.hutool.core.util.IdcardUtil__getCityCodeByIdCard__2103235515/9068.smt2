...
(assert (and true (and (>= 0 0) (>= (str.len var1445) 4) (>= 4 0))))
(define-const var2987 String (substring/-1240304868 var1445 0 4)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, 4) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
