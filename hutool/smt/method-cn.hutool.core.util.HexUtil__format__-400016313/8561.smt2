...
(assert (and true (and (> (str.len var2415) 1) (<= 0 1))))
(define-const var265 Int (charAt/698050440 var2415 1)) ; Statement: $c7 = virtualinvoke r0.<java.lang.String: char charAt(int)>(1) 
(assert true)
;(assert (append/-1166366385 var2923 var265)) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>($c7) 
(declare-const var2923!1 String)
(assert (str.prefixof var2923 var2923!1))
(define-const var572 Int 2) ; Statement: i12 = 2 
(assert true) ; Non Conditional
(define-const var1632 Int (- var2824 1)) ; Statement: $i13 = $i11 - 1 
 ; Statement: if i12 >= $i13 goto $r3 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (>= var572 var1632)) ; Cond: i12 >= $i13 
(assert true)
(define-const var91 String (toString/-2075883882 var859!1)) ; Statement: $r3 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
