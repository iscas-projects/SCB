...
(assert (and true (and (>= 8 0) (>= (str.len var1275) 24) (>= 24 8))))
(define-const var3494 String (substring/-1240304868 var1275 8 24)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(8, 24) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
