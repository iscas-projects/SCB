...
(assert (and true (and (>= 0 0) (>= (str.len var65) 2) (>= 2 0))))
(define-const var2785 String (substring/-1240304868 var65 0 2)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, 2) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
