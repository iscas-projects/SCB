...
(assert (and true (and (>= var3449 0) (>= (str.len var721) var1789) (>= var1789 var3449))))
(define-const var3508 String (substring/-1240304868 var721 var3449 var1789)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i1, i2) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
