...
(assert (and true (and (>= 0 0) (>= (str.len var3832) 2) (>= 2 0))))
(define-const var3832!1 String (substring/-1240304868 var3832 0 2)) ; Statement: r9 = virtualinvoke r9.<java.lang.String: java.lang.String substring(int,int)>(0, 2) 
 ; Statement: goto [?= $z2 = virtualinvoke r9.<java.lang.String: boolean startsWith(java.lang.String)>("0")] 
(assert true) ; Non Conditional
(assert true)
(define-const var1787 Bool (startsWith/-1785782452 var3832!1 "0")) ; Statement: $z2 = virtualinvoke r9.<java.lang.String: boolean startsWith(java.lang.String)>("0") 
 ; Statement: if $z2 == 0 goto $z0 = virtualinvoke r9.<java.lang.String: boolean startsWith(java.lang.String)>("1") 
(assert (not (= (ite var1787 1 0) 0))) ; Negate: Cond: $z2 == 0  
(define-const var855 String (var3891_parseFirst/1834896543 var3832!1)) ; Statement: r10 = staticinvoke <cn.hutool.core.convert.NumberWordFormatter: java.lang.String parseFirst(java.lang.String)>(r9) 
