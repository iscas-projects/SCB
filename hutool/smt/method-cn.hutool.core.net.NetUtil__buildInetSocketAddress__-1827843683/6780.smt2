...
(assert (and true (and (>= var98 0) (>= (str.len var1760) var98))))
(define-const var833 String (substring/850833817 var1760 var98)) ; Statement: $r1 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var2703 Int (Int_parseInt/1370970945 var833)) ; Statement: i3 = staticinvoke <java.lang.Integer: int parseInt(java.lang.String)>($r1) 
 ; Statement: goto [?= $r4 = new java.net.InetSocketAddress] 
(assert true) ; Non Conditional
(define-const var3216 var3104 var3104-init) ; Statement: $r4 = new java.net.InetSocketAddress 
(assert true)
;(assert (<init>/481518073 var3216 var3690 var2703)) ; Statement: specialinvoke $r4.<java.net.InetSocketAddress: void <init>(java.lang.String,int)>(r3, i3) 

(declare-const var3216!1 var3104)
(declare-const var3690!1 String)
(declare-const var2703!1 Int)
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
