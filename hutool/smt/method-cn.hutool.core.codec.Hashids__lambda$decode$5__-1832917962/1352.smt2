...
(assert (and true (and (> (str.len var3209) var2405) (<= 0 var2405))))
(define-const var2760 Int (charAt/698050440 var3209 var2405)) ; Statement: $c1 = virtualinvoke r1.<java.lang.String: char charAt(int)>(i0) 
(define-const var2409 var1843 (var1843_valueOf/-1186540555 var2760)) ; Statement: $r2 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c1) 
(define-const var1625 Bool (var1027_contains/1636690605 var1691 (cast-from-var1843-to-var919 var2409))) ; Statement: $z0 = interfaceinvoke r0.<java.util.Set: boolean contains(java.lang.Object)>($r2) 
 ; Statement: return $z0 
(check-sat)
(get-model)
(get-unsat-core)
