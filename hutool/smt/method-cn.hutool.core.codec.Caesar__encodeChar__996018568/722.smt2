...
(assert (and true (and (> (str.len var1837) var3663) (<= 0 var3663))))
(define-const var3812 Int (charAt/698050440 var1837 var3663)) ; Statement: $c5 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(i4) 
 ; Statement: return $c5 
(check-sat)
(get-model)
(get-unsat-core)
