...
(define-const var354 Int (- 1)) ; Statement: b1 = -1 
(assert true)
(define-const var1299 Int (hashCode/-467973558 var729)) ; Statement: $i0 = virtualinvoke r0.<java.lang.String: int hashCode()>() 
