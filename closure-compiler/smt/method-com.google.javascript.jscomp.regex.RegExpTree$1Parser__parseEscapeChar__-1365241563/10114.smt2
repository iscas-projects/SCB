...
(assert (and true (and (> (str.len var2922) var3968) (<= 0 var3968))))
(define-const var1083 Int (charAt/698050440 var2922 var3968)) ; Statement: c19 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
(define-const var2829 Int (cast-from-Int-to-Int var1083)) ; Statement: $i25 = (int) c19 
