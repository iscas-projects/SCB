...
(assert (and true (and (> (str.len var981) var3178) (<= 0 var3178))))
(define-const var3937 Int (charAt/698050440 var981 var3178)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
 ; Statement: return $c2 
(check-sat)
(get-model)
(get-unsat-core)
