...
(assert (= var2055!1 ""))
(assert (and true (and (>= 0 0) (>= (str.len var82) var1525) (>= var1525 0))))
(define-const var2338 String (substring/-1240304868 var82 0 var1525)) ; Statement: $r13 = virtualinvoke r17.<java.lang.String: java.lang.String substring(int,int)>(0, $i2) 
(assert true)
(define-const var3965 String (append/672562846 var2055!1 var2338)) ; Statement: $r14 = virtualinvoke $r19.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r13) 
(declare-const var2055!2 String)
(assert (= var2055!2 (str.++ var2055!1 var2338)))
(assert true)
(define-const var3366 String (append/672562846 var3965 ".java")) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(".java") 
(declare-const var3965!1 String)
(assert (= var3965!1 (str.++ var3965 ".java")))
(assert true)
(define-const var3308 String (toString/-2075883882 var3366)) ; Statement: r18 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: goto [?= (branch)] 
(assert true) ; Non Conditional
 ; Statement: if r5 == null goto $r22 = new java.io.File 
(assert (= var1389 null-var3187)) ; Cond: r5 == null 
(define-const var2752 var3187 var3187-init) ; Statement: $r22 = new java.io.File 
(assert true)
;(assert (<init>/-1681595970 var2752 var3308)) ; Statement: specialinvoke $r22.<java.io.File: void <init>(java.lang.String)>(r18) 

(declare-const var2752!1 var3187)
