...
(assert (and true (and (>= 0 0) (>= (str.len var953) var3100) (>= var3100 0))))
(define-const var2358 String (substring/-1240304868 var953 0 var3100)) ; Statement: r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert (and true (and (>= var3100 0) (>= (str.len var953) var3100))))
(define-const var84 String (substring/850833817 var953 var3100)) ; Statement: r5 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i0) 
(assert true) ; Non Conditional
(assert true)
;(assert (renameReference/-2110412067 var1109 var829 var2928 var2358 var84)) ; Statement: virtualinvoke r2.<com.google.javascript.jscomp.Es6RenameTypeReferences: void renameReference(com.google.javascript.jscomp.NodeTraversal,com.google.javascript.rhino.Node,java.lang.String,java.lang.String)>(r3, r0, r4, r5) 

(declare-const var1109!1 var842)
(declare-const var829!1 var1957)
(declare-const var2928!1 var689)
