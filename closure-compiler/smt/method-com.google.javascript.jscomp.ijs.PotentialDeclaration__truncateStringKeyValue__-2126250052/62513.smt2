...
(assert (and true (and (>= 0 0) (>= (str.len var3169) 8) (>= 8 0))))
(define-const var2817 String (substring/-1240304868 var3169 0 8)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, 8) 
(define-const var1487 String (str.++ "\u0001.." var2817)) ; Statement: $r4 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r3) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("\u0001..") 
(define-const var3703 var2611 (var3980_string/730211268 var1487)) ; Statement: $r5 = staticinvoke <com.google.javascript.rhino.IR: com.google.javascript.rhino.Node string(java.lang.String)>($r4) 
(assert true)
(define-const var633 var2611 (srcrefTree/-1502961263 var3703 var338)) ; Statement: r6 = virtualinvoke $r5.<com.google.javascript.rhino.Node: com.google.javascript.rhino.Node srcrefTree(com.google.javascript.rhino.Node)>(r1) 
(assert true)
;(assert (replaceWith/-1153548851 var338 var633)) ; Statement: virtualinvoke r1.<com.google.javascript.rhino.Node: void replaceWith(com.google.javascript.rhino.Node)>(r6) 

(declare-const var338!1 var2611)
(declare-const var633!1 var2611)
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
