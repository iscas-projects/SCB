...
(assert (and true (and (>= var1924 0) (>= (str.len var3015) var339) (>= var339 var1924))))
(define-const var388 String (substring/-1240304868 var3015 var1924 var339)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i0, $i3) 
(define-const var3135 Int var2470-separatorChar) ; Statement: $c4 = <java.io.File: char separatorChar> 
(assert true)
(define-const var1449 String (replace/1524665721 var388 46 var3135)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String replace(char,char)>(46, $c4) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
