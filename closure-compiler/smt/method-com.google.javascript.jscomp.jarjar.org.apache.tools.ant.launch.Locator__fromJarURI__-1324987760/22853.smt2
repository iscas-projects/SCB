...
(assert (and true (and (>= var3969 0) (>= (str.len var3786) var3488) (>= var3488 var3969))))
(define-const var326 String (substring/-1240304868 var3786 var3969 var3488)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i1, i0) 
(define-const var276 String (var3167_fromURI/-1058523913 var326)) ; Statement: $r3 = staticinvoke <com.google.javascript.jscomp.jarjar.org.apache.tools.ant.launch.Locator: java.lang.String fromURI(java.lang.String)>(r2) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
