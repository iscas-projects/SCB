...
(assert (and true (and (> (str.len var1693) var99) (<= 0 var99))))
(define-const var496 Int (charAt/698050440 var1693 var99)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
(define-const var1748 Int (cast-from-Int-to-Int var496)) ; Statement: $i3 = (int) $c2 
(define-const var3739 Int (cast-from-Int-to-Int var1326)) ; Statement: $i4 = (int) c1 
 ; Statement: if $i3 != $i4 goto $z0 = 0 
(assert (not (not (= var1748 var3739)))) ; Negate: Cond: $i3 != $i4  
(define-const var3333 Bool (ite (= 1 1) true false)) ; Statement: $z0 = 1 
