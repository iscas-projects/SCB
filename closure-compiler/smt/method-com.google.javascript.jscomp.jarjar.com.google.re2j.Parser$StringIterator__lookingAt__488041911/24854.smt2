...
(assert (and true (and (> (str.len var797) var2833) (<= 0 var2833))))
(define-const var2025 Int (charAt/698050440 var797 var2833)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
(define-const var3149 Int (cast-from-Int-to-Int var2025)) ; Statement: $i3 = (int) $c2 
(define-const var353 Int (cast-from-Int-to-Int var2820)) ; Statement: $i4 = (int) c1 
 ; Statement: if $i3 != $i4 goto $z0 = 0 
(assert (not (= var3149 var353))) ; Cond: $i3 != $i4 
(define-const var172 Bool (ite (= 1 0) true false)) ; Statement: $z0 = 0 
