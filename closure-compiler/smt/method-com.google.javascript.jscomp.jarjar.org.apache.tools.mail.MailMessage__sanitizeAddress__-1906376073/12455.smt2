...
(assert (and true (and (>= var2709 0) (>= (str.len var2660) var1533) (>= var1533 var2709))))
(define-const var3305 String (substring/-1240304868 var2660 var2709 var1533)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i3, i4) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
