...
(assert (and true (and (>= 1 0) (>= (str.len var3866) 1))))
(define-const var3954 String (substring/850833817 var3866 1)) ; Statement: $r6 = virtualinvoke r5.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var2423 String (append/672562846 var408 var3954)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r6) 
(declare-const var408!1 String)
(assert (= var408!1 (str.++ var408 var3954)))
(assert true)
(define-const var1664 String (toString/-2075883882 var2423)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (setValue/-921508948 var2311 var1664)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.Manifest$Attribute: void setValue(java.lang.String)>($r9) 

(declare-const var2311!1 var2328)
