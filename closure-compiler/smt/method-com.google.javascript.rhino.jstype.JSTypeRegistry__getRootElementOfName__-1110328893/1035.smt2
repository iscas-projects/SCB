...
(assert (and true (and (>= 0 0) (>= (str.len var586) var1908) (>= var1908 0))))
(define-const var1733 String (substring/-1240304868 var586 0 var1908)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
