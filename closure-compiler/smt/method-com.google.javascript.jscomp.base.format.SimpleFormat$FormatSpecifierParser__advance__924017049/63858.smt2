...
(assert (and true (and (> (str.len var2918) var1076) (<= 0 var1076))))
(define-const var2557 Int (charAt/698050440 var2918 var1076)) ; Statement: $c4 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i2) 
 ; Statement: return $c4 
(check-sat)
(get-model)
(get-unsat-core)
