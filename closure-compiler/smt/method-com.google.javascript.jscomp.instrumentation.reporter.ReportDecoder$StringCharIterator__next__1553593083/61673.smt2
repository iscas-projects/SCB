...
(assert (and true (and (> (str.len var3163) var2323) (<= 0 var2323))))
(define-const var1993 Int (charAt/698050440 var3163 var2323)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
 ; Statement: return $c2 
(check-sat)
(get-model)
(get-unsat-core)
