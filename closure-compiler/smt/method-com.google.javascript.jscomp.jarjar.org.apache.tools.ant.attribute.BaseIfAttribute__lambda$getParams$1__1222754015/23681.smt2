...
(assert (and true (and (>= var1994 0) (>= (str.len var556) var1994))))
(define-const var1374 String (substring/850833817 var556 var1994)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r5 
(check-sat)
(get-model)
(get-unsat-core)
