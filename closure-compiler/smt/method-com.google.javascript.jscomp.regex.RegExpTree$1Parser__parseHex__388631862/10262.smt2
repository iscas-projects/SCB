...
(assert (and true (and (>= var1058 0) (>= (str.len var937) var1058))))
(define-const var3682 String (substring/850833817 var937 var1058)) ; Statement: $r11 = virtualinvoke $r10.<java.lang.String: java.lang.String substring(int)>($i9) 
(define-const var1199 String (str.++ "Abbreviated hex escape \u0001" var3682)) ; Statement: $r12 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r11) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("Abbreviated hex escape \u0001") 
(assert true)
;(assert (<init>/875830710 var482 var1199)) ; Statement: specialinvoke $r13.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r12) 

(declare-const var482!1 var2633)
