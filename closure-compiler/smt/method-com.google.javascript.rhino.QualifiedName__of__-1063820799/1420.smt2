...
(assert true) ; Non Conditional
(assert (and true (and (>= var2143 0) (>= (str.len var335) var3190) (>= var3190 var2143))))
(define-const var2489 String (substring/-1240304868 var335 var2143 var3190)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i2, $i4) 
(define-const var3167 String (var1218_addOrGet/-330268851 var2489)) ; Statement: $r2 = staticinvoke <com.google.javascript.rhino.RhinoStringPool: java.lang.String addOrGet(java.lang.String)>($r4) 
(assert true)
;(assert (add/-32866407 var2518 (cast-from-String-to-var1736 var3167))) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList$Builder: com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList$Builder add(java.lang.Object)>($r2) 

(declare-const var2518!1 var385)
(declare-const var3167!1 String)
(define-const var350!1 Int (+ var912 1)) ; Statement: i3 = $i0 + 1 
 ; Statement: if $i0 >= 0 goto $i0 = virtualinvoke r1.<java.lang.String: int indexOf(int,int)>(46, i3) 
(assert (not (>= var912 0))) ; Negate: Cond: $i0 >= 0  
(assert true)
(define-const var2635 var1934 (build/-319551664 var2518!1)) ; Statement: r5 = virtualinvoke r0.<com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList$Builder: com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList build()>() 
(define-const var2262 var22 var22-init) ; Statement: $r3 = new com.google.javascript.rhino.QualifiedName$StringListQname 
(assert true)
(define-const var3547 Int (size/-481607991 (cast-from-var1934-to-var3156 var2635))) ; Statement: $i1 = virtualinvoke r5.<com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList: int size()>() 
(assert true)
;(assert (<init>/-2005508873 var2262 var2635 var3547)) ; Statement: specialinvoke $r3.<com.google.javascript.rhino.QualifiedName$StringListQname: void <init>(com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList,int)>(r5, $i1) 

(declare-const var2262!1 var22)
(declare-const var2635!1 var1934)
