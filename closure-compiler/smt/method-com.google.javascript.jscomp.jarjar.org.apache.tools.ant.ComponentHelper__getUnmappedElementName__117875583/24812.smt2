...
(assert (and true (and (>= var3811 0) (>= (str.len var920) var3811))))
(define-const var836 String (substring/850833817 var920 var3811)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
