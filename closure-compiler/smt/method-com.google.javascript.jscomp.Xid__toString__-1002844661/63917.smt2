...
(assert (and true (and (> (str.len var842) var3510) (<= 0 var3510))))
(define-const var3078 Int (charAt/698050440 var842 var3510)) ; Statement: $c6 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i5) 
(declare-const var1110!1 (Array Int Int))
(assert (not (= var1110!1 null-__Array__Int__Int__)))
(assert (= (select var1110!1 0) var3078)) ; Statement: r0[0] = $c6 
(define-const var2507 Int var2349-START_RADIX) ; Statement: $i7 = <com.google.javascript.jscomp.Xid: int START_RADIX> 
(define-const var1830 Int (cast-from-Int-to-Int var2507)) ; Statement: $l8 = (long) $i7 
(define-const var3929 Int (div var3754 var1830)) ; Statement: $l9 = l1 / $l8 
(define-const var2766 Int (cast-from-Int-to-Int var3929)) ; Statement: i17 = (int) $l9 
(assert true) ; Non Conditional
 ; Statement: if i17 <= 0 goto $r2 = new java.lang.String 
(assert (<= var2766 0)) ; Cond: i17 <= 0 
(define-const var2839 String String-init) ; Statement: $r2 = new java.lang.String 
(assert true)
;(assert (<init>/-253222812 var2839 var1110!1 0 var1449)) ; Statement: specialinvoke $r2.<java.lang.String: void <init>(char[],int,int)>(r0, 0, i16) 

(declare-const var2839!1 String)
(declare-const var1110!2 (Array Int Int))
