...
(assert (and true (and (> (str.len var1760) var1527) (<= 0 var1527))))
(define-const var2187 Int (charAt/698050440 var1760 var1527)) ; Statement: $s3 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i2) 
 ; Statement: goto [?= return $s3] 
