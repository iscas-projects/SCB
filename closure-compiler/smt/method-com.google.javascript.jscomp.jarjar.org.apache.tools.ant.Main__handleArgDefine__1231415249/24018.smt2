...
(assert (and true (and (>= 2 0) (>= (str.len var1532) 2))))
(define-const var3390 String (substring/850833817 var1532 2)) ; Statement: r9 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(2) 
(assert true)
(define-const var1966 Int (indexOf/-1037706067 var3390 61)) ; Statement: i0 = virtualinvoke r9.<java.lang.String: int indexOf(int)>(61) 
 ; Statement: if i0 <= 0 goto $i1 = lengthof r0 
(assert (<= var1966 0)) ; Cond: i0 <= 0 
(define-const var1223 Int (getLength-Arr-String-1 var3524)) ; Statement: $i1 = lengthof r0 
(define-const var2374 Int (- var1223 1)) ; Statement: $i2 = $i1 - 1 
 ; Statement: if i4 >= $i2 goto $r2 = new com.google.javascript.jscomp.jarjar.org.apache.tools.ant.BuildException 
(assert (>= var255 var2374)) ; Cond: i4 >= $i2 
(define-const var1581 var444 var444-init) ; Statement: $r2 = new com.google.javascript.jscomp.jarjar.org.apache.tools.ant.BuildException 
...
(assert (= var2551!1 ""))
(assert true)
(define-const var1852 String (append/672562846 var2551!1 "Missing value for property ")) ; Statement: $r4 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Missing value for property ") 
(declare-const var2551!2 String)
(assert (= var2551!2 (str.++ var2551!1 "Missing value for property ")))
(assert true)
(define-const var2232 String (append/672562846 var1852 var3390)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r9) 
(declare-const var1852!1 String)
(assert (= var1852!1 (str.++ var1852 var3390)))
(assert true)
(define-const var2111 String (toString/-2075883882 var2232)) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/1864341934 var1581 var2111)) ; Statement: specialinvoke $r2.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.BuildException: void <init>(java.lang.String)>($r6) 

(declare-const var1581!1 var444)
