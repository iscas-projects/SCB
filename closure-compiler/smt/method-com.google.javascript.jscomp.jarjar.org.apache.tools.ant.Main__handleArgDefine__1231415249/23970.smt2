...
(assert (and true (and (>= 2 0) (>= (str.len var3377) 2))))
(define-const var2788 String (substring/850833817 var3377 2)) ; Statement: r9 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(2) 
(assert true)
(define-const var3493 Int (indexOf/-1037706067 var2788 61)) ; Statement: i0 = virtualinvoke r9.<java.lang.String: int indexOf(int)>(61) 
 ; Statement: if i0 <= 0 goto $i1 = lengthof r0 
(assert (not (<= var3493 0))) ; Negate: Cond: i0 <= 0  
(define-const var2507 Int (+ var3493 1)) ; Statement: $i3 = i0 + 1 
(assert (and true (and (>= var2507 0) (>= (str.len var2788) var2507))))
(define-const var1088 String (substring/850833817 var2788 var2507)) ; Statement: r10 = virtualinvoke r9.<java.lang.String: java.lang.String substring(int)>($i3) 
(assert (and true (and (>= 0 0) (>= (str.len var2788) var3493) (>= var3493 0))))
(define-const var2788!1 String (substring/-1240304868 var2788 0 var3493)) ; Statement: r9 = virtualinvoke r9.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: goto [?= $r8 = r7.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.Main: java.util.Properties definedProps>] 
(assert true) ; Non Conditional
(define-const var1395 var2961 (definedProps/1023218296 var1539)) ; Statement: $r8 = r7.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.Main: java.util.Properties definedProps> 
(assert true)
;(assert (put/1981026245 (cast-from-var2961-to-var3574 var1395) (cast-from-String-to-var1778 var2788!1) (cast-from-String-to-var1778 var1088))) ; Statement: virtualinvoke $r8.<java.util.Properties: java.lang.Object put(java.lang.Object,java.lang.Object)>(r9, r10) 

(declare-const var1395!1 var2961)
