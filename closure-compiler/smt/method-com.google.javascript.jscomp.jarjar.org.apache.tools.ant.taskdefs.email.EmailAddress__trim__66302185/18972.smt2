...
(assert (and true (and (>= var1970!1 0) (>= (str.len var701) var1605!1) (>= var1605!1 var1970!1))))
(define-const var3316 String (substring/-1240304868 var701 var1970!1 var1605!1)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i13, i14) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
