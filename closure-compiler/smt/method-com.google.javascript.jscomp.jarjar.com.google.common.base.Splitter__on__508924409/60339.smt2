...
(assert (and true (and (> (str.len var3316) 0) (<= 0 0))))
(define-const var2388 Int (charAt/698050440 var3316 0)) ; Statement: $c2 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1321 var885 (var885_on/1427090730 var2388)) ; Statement: $r3 = staticinvoke <com.google.javascript.jscomp.jarjar.com.google.common.base.Splitter: com.google.javascript.jscomp.jarjar.com.google.common.base.Splitter on(char)>($c2) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
