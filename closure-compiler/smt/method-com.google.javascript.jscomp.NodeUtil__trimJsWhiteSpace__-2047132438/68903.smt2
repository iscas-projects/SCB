...
(assert (and true (and (>= var2349 0) (>= (str.len var135) var101) (>= var101 var2349))))
(define-const var1011 String (substring/-1240304868 var135 var2349 var101)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i3, i4) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
