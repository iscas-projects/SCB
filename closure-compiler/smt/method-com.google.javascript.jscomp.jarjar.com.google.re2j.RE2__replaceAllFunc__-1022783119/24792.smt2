...
(assert (and true (and (>= var3407 0) (>= (str.len var2799) var3407))))
(define-const var484 String (substring/850833817 var2799 var3407)) ; Statement: $r9 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i10) 
(assert true)
;(assert (append/672562846 var537!1 var484)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r9) 
(declare-const var537!2 String)
(assert (= var537!2 (str.++ var537!1 var484)))
(assert true)
(define-const var1435 String (toString/-2075883882 var537!2)) ; Statement: $r10 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
