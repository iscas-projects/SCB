...
(assert (and true (and (> (str.len var2450) 0) (<= 0 0))))
(define-const var1702 Int (charAt/698050440 var2450 0)) ; Statement: $c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1063 Int (cast-from-Int-to-Int var1702)) ; Statement: $i11 = (int) $c0 
 ; Statement: if $i11 != 38 goto return 0 
(assert (not (= var1063 38))) ; Cond: $i11 != 38 
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
