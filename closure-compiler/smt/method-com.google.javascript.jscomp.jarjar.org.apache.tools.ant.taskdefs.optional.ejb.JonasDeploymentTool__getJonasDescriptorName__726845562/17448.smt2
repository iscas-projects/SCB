...
(assert (and true (and (>= var3664 0) (>= (str.len var2275) var3664))))
(define-const var719 String (substring/850833817 var2275 var3664)) ; Statement: r33 = virtualinvoke $r31.<java.lang.String: java.lang.String substring(int)>($i5) 
 ; Statement: goto [?= $z0 = virtualinvoke r33.<java.lang.String: boolean startsWith(java.lang.String)>("ejb-jar.xml")] 
(assert true) ; Non Conditional
(assert true)
(define-const var482 Bool (startsWith/-1785782452 var719 "ejb-jar.xml")) ; Statement: $z0 = virtualinvoke r33.<java.lang.String: boolean startsWith(java.lang.String)>("ejb-jar.xml") 
...
(assert (not (= (ite var482 1 0) 0))) ; Negate: Cond: $z0 == 0  
(define-const var2511 String String-init) ; Statement: $r39 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2511)) ; Statement: specialinvoke $r39.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2511!1 String)
(assert (= var2511!1 ""))
(assert true)
(define-const var2609 String (append/672562846 var2511!1 var1116)) ; Statement: $r27 = virtualinvoke $r39.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r32) 
(declare-const var2511!2 String)
(assert (= var2511!2 (str.++ var2511!1 var1116)))
(assert true)
(define-const var3915 String (append/672562846 var2609 "jonas-ejb-jar.xml")) ; Statement: $r28 = virtualinvoke $r27.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("jonas-ejb-jar.xml") 
(declare-const var2609!1 String)
(assert (= var2609!1 (str.++ var2609 "jonas-ejb-jar.xml")))
(assert true)
(define-const var2631 String (toString/-2075883882 var3915)) ; Statement: $r29 = virtualinvoke $r28.<java.lang.StringBuilder: java.lang.String toString()>() 
