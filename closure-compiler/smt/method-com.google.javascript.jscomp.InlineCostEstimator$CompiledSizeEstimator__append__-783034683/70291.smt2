...
(assert (and true (and (> (str.len var1784) var3972) (<= 0 var3972))))
(define-const var1308 Int (charAt/698050440 var1784 var3972)) ; Statement: $c2 = virtualinvoke r1.<java.lang.String: char charAt(int)>($i1) 
(declare-const var3463!1 var3947)
(assert (not (= var3463!1 null-var3947)))
(assert (= (last/-428284089 var3463!1) var1308)) ; Statement: r0.<com.google.javascript.jscomp.InlineCostEstimator$CompiledSizeEstimator: char last> = $c2 
(define-const var266 Int (cost/-428284089 var3463!1)) ; Statement: $i3 = r0.<com.google.javascript.jscomp.InlineCostEstimator$CompiledSizeEstimator: int cost> 
(assert true)
(define-const var2684 Int (length/-134980193 var1784)) ; Statement: $i4 = virtualinvoke r1.<java.lang.String: int length()>() 
(define-const var3097 Int (+ var266 var2684)) ; Statement: $i5 = $i3 + $i4 
(declare-const var3463!2 var3947)
(assert (not (= var3463!2 null-var3947)))
(assert (= (cost/-428284089 var3463!2) var3097)) ; Statement: r0.<com.google.javascript.jscomp.InlineCostEstimator$CompiledSizeEstimator: int cost> = $i5 
(define-const var2442 Int (maxCost/-428284089 var3463!2)) ; Statement: $i7 = r0.<com.google.javascript.jscomp.InlineCostEstimator$CompiledSizeEstimator: int maxCost> 
(define-const var736 Int (cost/-428284089 var3463!2)) ; Statement: $i6 = r0.<com.google.javascript.jscomp.InlineCostEstimator$CompiledSizeEstimator: int cost> 
 ; Statement: if $i7 > $i6 goto return 
(assert (> var2442 var736)) ; Cond: $i7 > $i6 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
