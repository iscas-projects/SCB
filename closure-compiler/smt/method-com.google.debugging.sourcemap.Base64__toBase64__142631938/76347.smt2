...
(assert (and true (and (> (str.len var1963) var3602) (<= 0 var3602))))
(define-const var1270 Int (charAt/698050440 var1963 var3602)) ; Statement: $c1 = virtualinvoke $r0.<java.lang.String: char charAt(int)>(i0) 
 ; Statement: return $c1 
(check-sat)
(get-model)
(get-unsat-core)
