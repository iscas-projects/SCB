...
(assert (and true (and (>= 0 0) (>= (str.len var3458) var3330) (>= var3330 0))))
(define-const var2380 String (substring/-1240304868 var3458 0 var3330)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
(assert true)
(define-const var1769 String (replace/1524665721 var2380 92 46)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String replace(char,char)>(92, 46) 
(assert true)
(define-const var2662 String (replace/1524665721 var1769 47 46)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String replace(char,char)>(47, 46) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
