...
(assert (and true (and (>= 0 0) (>= (str.len var1706) var3300) (>= var3300 0))))
(define-const var3709 String (substring/-1240304868 var1706 0 var3300)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i2) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
