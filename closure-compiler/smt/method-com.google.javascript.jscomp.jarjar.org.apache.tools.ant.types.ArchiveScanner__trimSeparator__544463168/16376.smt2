...
(assert (and true (and (>= 0 0) (>= (str.len var3393) var2201) (>= var2201 0))))
(define-const var3794 String (substring/-1240304868 var3393 0 var2201)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
