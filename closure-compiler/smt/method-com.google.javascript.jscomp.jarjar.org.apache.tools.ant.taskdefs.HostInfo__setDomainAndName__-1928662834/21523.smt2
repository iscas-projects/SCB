...
(assert (and true (and (>= 0 0) (>= (str.len var2054) var3158) (>= var3158 0))))
(define-const var109 String (substring/-1240304868 var2054 0 var3158)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert true)
;(assert (setProperty/110387416 var1190 "NAME" var109)) ; Statement: specialinvoke r1.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.HostInfo: void setProperty(java.lang.String,java.lang.String)>("NAME", $r2) 

(declare-const var1190!1 var3893)
(declare-const var3058 String)
(declare-const var109!1 String)
(define-const var538 Int (+ var3158 1)) ; Statement: $i1 = i0 + 1 
(assert (and true (and (>= var538 0) (>= (str.len var2054) var538))))
(define-const var635 String (substring/850833817 var2054 var538)) ; Statement: $r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true)
;(assert (setProperty/110387416 var1190!1 "DOMAIN" var635)) ; Statement: specialinvoke r1.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.HostInfo: void setProperty(java.lang.String,java.lang.String)>("DOMAIN", $r3) 

(declare-const var1190!2 var3893)
(declare-const var1756 String)
