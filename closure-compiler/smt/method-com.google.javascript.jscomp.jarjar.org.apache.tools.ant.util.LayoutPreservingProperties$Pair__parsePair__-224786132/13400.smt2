...
(assert (and true (and (>= 0 0) (>= (str.len var3074) var1704) (>= var1704 0))))
(define-const var2348 String (substring/-1240304868 var3074 0 var1704)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(declare-const var1441!1 var3584)
(assert (not (= var1441!1 null-var3584)))
(assert (= (name/-2080466165 var1441!1) var2348)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.LayoutPreservingProperties$Pair: java.lang.String name> = $r2 
(define-const var754 Int (+ var1704 1)) ; Statement: $i1 = i0 + 1 
(assert (and true (and (>= var754 0) (>= (str.len var3074) var754))))
(define-const var1707 String (substring/850833817 var3074 var754)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true)
;(assert (setValue/594668828 var1441!1 var1707)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.LayoutPreservingProperties$Pair: void setValue(java.lang.String)>($r3) 

(declare-const var1441!2 var3584)
(declare-const var1707!1 String)
(assert true) ; Non Conditional
(define-const var3295 String (name/-2080466165 var1441!2)) ; Statement: $r4 = r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.LayoutPreservingProperties$Pair: java.lang.String name> 
(assert true)
(define-const var3917 String (stripStart/1205947337 var1441!2 var3295 " \t\f")) ; Statement: $r5 = specialinvoke r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.LayoutPreservingProperties$Pair: java.lang.String stripStart(java.lang.String,java.lang.String)>($r4, " \t\f") 
(declare-const var1441!3 var3584)
(assert (not (= var1441!3 null-var3584)))
(assert (= (name/-2080466165 var1441!3) var3917)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.LayoutPreservingProperties$Pair: java.lang.String name> = $r5 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
