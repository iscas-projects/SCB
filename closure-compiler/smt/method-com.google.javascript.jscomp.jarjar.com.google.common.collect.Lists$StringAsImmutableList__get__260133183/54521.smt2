...
(assert (and true (and (> (str.len var657) var6!1) (<= 0 var6!1))))
(define-const var2002 Int (charAt/698050440 var657 var6!1)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(i0) 
(define-const var589 var1947 (var1947_valueOf/-1186540555 var2002)) ; Statement: $r2 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c2) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
