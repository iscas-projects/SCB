...
(assert (and true (and (>= var1202 0) (>= (str.len var3316) var1202))))
(define-const var2913 String (substring/850833817 var3316 var1202)) ; Statement: $r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i0) 
(define-const var2663 var1593 var1593-ENGLISH) ; Statement: $r2 = <java.util.Locale: java.util.Locale ENGLISH> 
(assert true)
(define-const var1996 String (toLowerCase/1946809429 var2913 var2663)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: java.lang.String toLowerCase(java.util.Locale)>($r2) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
