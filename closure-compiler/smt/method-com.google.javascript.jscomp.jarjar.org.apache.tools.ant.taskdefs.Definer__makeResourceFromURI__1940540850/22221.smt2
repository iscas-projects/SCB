...
(assert (and true (and (>= var2978 0) (>= (str.len var275) var2978))))
(define-const var1242 String (substring/850833817 var275 var2978)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var2692 Bool (startsWith/-1785782452 var1242 "//")) ; Statement: $z0 = virtualinvoke r2.<java.lang.String: boolean startsWith(java.lang.String)>("//") 
 ; Statement: if $z0 == 0 goto $r3 = new java.lang.StringBuilder 
(assert (= (ite var2692 1 0) 0)) ; Cond: $z0 == 0 
(define-const var2139 String String-init) ; Statement: $r3 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2139)) ; Statement: specialinvoke $r3.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2139!1 String)
(assert (= var2139!1 ""))
(assert true)
(define-const var1258 String (replace/1524665721 var1242 46 47)) ; Statement: $r4 = virtualinvoke r2.<java.lang.String: java.lang.String replace(char,char)>(46, 47) 
(assert true)
(define-const var1660 String (append/672562846 var2139!1 var1258)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r4) 
(declare-const var2139!2 String)
(assert (= var2139!2 (str.++ var2139!1 var1258)))
(assert true)
(define-const var1011 String (append/672562846 var1660 "/antlib.xml")) ; Statement: $r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("/antlib.xml") 
(declare-const var1660!1 String)
(assert (= var1660!1 (str.++ var1660 "/antlib.xml")))
(assert true)
(define-const var3398 String (toString/-2075883882 var1011)) ; Statement: r11 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.String toString()>() 
