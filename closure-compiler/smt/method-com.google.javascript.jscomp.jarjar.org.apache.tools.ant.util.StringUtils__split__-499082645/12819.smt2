...
(assert (and true (and (>= var2968 0) (>= (str.len var982) var2968))))
(define-const var1076 String (substring/850833817 var982 var2968)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i2) 
(assert true)
;(assert (addElement/-1717065458 var1431!1 (cast-from-String-to-var861 var1076))) ; Statement: virtualinvoke $r4.<java.util.Vector: void addElement(java.lang.Object)>($r2) 

(declare-const var1431!2 var733)
