...
(assert (and true (and (>= 0 0) (>= (str.len var367) var424) (>= var424 0))))
(define-const var631 String (substring/-1240304868 var367 0 var424)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
