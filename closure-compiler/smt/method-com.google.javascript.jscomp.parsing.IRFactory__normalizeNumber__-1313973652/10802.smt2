...
(assert (and true (and (> (str.len var2947) 0) (<= 0 0))))
(define-const var2049 Int (charAt/698050440 var2947 0)) ; Statement: $c22 = virtualinvoke r24.<java.lang.String: char charAt(int)>(0) 
(define-const var878 Int (cast-from-Int-to-Int var2049)) ; Statement: $i29 = (int) $c22 
 ; Statement: if $i29 != 46 goto $c1 = virtualinvoke r24.<java.lang.String: char charAt(int)>(0) 
(assert (not (not (= var878 46)))) ; Negate: Cond: $i29 != 46  
(define-const var1342 String (str.++ "0\u0001" var2947)) ; Statement: $r22 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>(r24) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("0\u0001") 
(define-const var1197 Float64 (Float64_parseDouble/1471110886 var1342)) ; Statement: $d10 = staticinvoke <java.lang.Double: double parseDouble(java.lang.String)>($r22) 
