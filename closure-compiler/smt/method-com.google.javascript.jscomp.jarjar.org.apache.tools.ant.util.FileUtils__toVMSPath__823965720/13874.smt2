...
(assert (and true (and (> (str.len var3478) 0) (<= 0 0))))
(define-const var1286 Int (charAt/698050440 var3478 0)) ; Statement: $c1 = virtualinvoke r4.<java.lang.String: char charAt(int)>(0) 
(define-const var3041 Int var473-separatorChar) ; Statement: $c0 = <java.io.File: char separatorChar> 
(define-const var2955 Int (cast-from-Int-to-Int var1286)) ; Statement: $i13 = (int) $c1 
(define-const var2766 Int (cast-from-Int-to-Int var3041)) ; Statement: $i14 = (int) $c0 
 ; Statement: if $i13 != $i14 goto $z4 = 0 
(assert (not (not (= var2955 var2766)))) ; Negate: Cond: $i13 != $i14  
(define-const var349 Bool (ite (= 1 1) true false)) ; Statement: $z4 = 1 
 ; Statement: goto [?= z0 = $z4] 
(assert true) ; Non Conditional
(define-const var1238 Bool var349) ; Statement: z0 = $z4 
(assert true)
(define-const var2276 Bool (isDirectory/-2122094196 var946)) ; Statement: $z1 = virtualinvoke r1.<java.io.File: boolean isDirectory()>() 
 ; Statement: if $z1 == 0 goto $z5 = 0 
(assert (= (ite var2276 1 0) 0)) ; Cond: $z1 == 0 
(define-const var399 Bool (ite (= 1 0) true false)) ; Statement: $z5 = 0 
(assert true) ; Non Conditional
(define-const var92 Bool var399) ; Statement: z2 = $z5 
(define-const var1460 String null-String) ; Statement: r28 = null 
(define-const var3 String null-String) ; Statement: r29 = null 
(define-const var3365 String null-String) ; Statement: r30 = null 
(define-const var397 Int 0) ; Statement: i10 = 0 
 ; Statement: if z0 == 0 goto (branch) 
(assert (not (= (ite var1238 1 0) 0))) ; Negate: Cond: z0 == 0  
(define-const var18 Int var473-separatorChar) ; Statement: $c7 = <java.io.File: char separatorChar> 
(define-const var3835 Int (cast-from-Int-to-Int var18)) ; Statement: $i15 = (int) $c7 
(assert true)
(define-const var637 Int (indexOf/1426977840 var3478 var3835 1)) ; Statement: i11 = virtualinvoke r4.<java.lang.String: int indexOf(int,int)>($i15, 1) 
(define-const var480 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i17 = (int) -1 
 ; Statement: if i11 != $i17 goto i10 = i11 + 1 
(assert (not (not (= var637 var480)))) ; Negate: Cond: i11 != $i17  
(define-const var739 String String-init) ; Statement: $r35 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var739)) ; Statement: specialinvoke $r35.<java.lang.StringBuilder: void <init>()>() 
(declare-const var739!1 String)
(assert (= var739!1 ""))
(assert (and true (and (>= 1 0) (>= (str.len var3478) 1))))
(define-const var1668 String (substring/850833817 var3478 1)) ; Statement: $r24 = virtualinvoke r4.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var2755 String (append/672562846 var739!1 var1668)) ; Statement: $r25 = virtualinvoke $r35.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r24) 
(declare-const var739!2 String)
(assert (= var739!2 (str.++ var739!1 var1668)))
(assert true)
(define-const var206 String (append/672562846 var2755 ":[000000]")) ; Statement: $r26 = virtualinvoke $r25.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(":[000000]") 
(declare-const var2755!1 String)
(assert (= var2755!1 (str.++ var2755 ":[000000]")))
(assert true)
(define-const var1048 String (toString/-2075883882 var206)) ; Statement: $r27 = virtualinvoke $r26.<java.lang.StringBuilder: java.lang.String toString()>() 
