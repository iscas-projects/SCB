...
(assert (and true (and (> (str.len var2822) 0) (<= 0 0))))
(define-const var3602 Int (charAt/698050440 var2822 0)) ; Statement: $c1 = virtualinvoke r4.<java.lang.String: char charAt(int)>(0) 
(define-const var1751 Int var367-separatorChar) ; Statement: $c0 = <java.io.File: char separatorChar> 
(define-const var777 Int (cast-from-Int-to-Int var3602)) ; Statement: $i13 = (int) $c1 
(define-const var2877 Int (cast-from-Int-to-Int var1751)) ; Statement: $i14 = (int) $c0 
 ; Statement: if $i13 != $i14 goto $z4 = 0 
(assert (not (= var777 var2877))) ; Cond: $i13 != $i14 
(define-const var2805 Bool (ite (= 1 0) true false)) ; Statement: $z4 = 0 
(assert true) ; Non Conditional
(define-const var1340 Bool var2805) ; Statement: z0 = $z4 
(assert true)
(define-const var1824 Bool (isDirectory/-2122094196 var3067)) ; Statement: $z1 = virtualinvoke r1.<java.io.File: boolean isDirectory()>() 
 ; Statement: if $z1 == 0 goto $z5 = 0 
(assert (= (ite var1824 1 0) 0)) ; Cond: $z1 == 0 
(define-const var438 Bool (ite (= 1 0) true false)) ; Statement: $z5 = 0 
(assert true) ; Non Conditional
(define-const var3739 Bool var438) ; Statement: z2 = $z5 
(define-const var2788 String null-String) ; Statement: r28 = null 
(define-const var1520 String null-String) ; Statement: r29 = null 
(define-const var97 String null-String) ; Statement: r30 = null 
(define-const var992 Int 0) ; Statement: i10 = 0 
 ; Statement: if z0 == 0 goto (branch) 
(assert (not (= (ite var1340 1 0) 0))) ; Negate: Cond: z0 == 0  
(define-const var1072 Int var367-separatorChar) ; Statement: $c7 = <java.io.File: char separatorChar> 
(define-const var430 Int (cast-from-Int-to-Int var1072)) ; Statement: $i15 = (int) $c7 
(assert true)
(define-const var2413 Int (indexOf/1426977840 var2822 var430 1)) ; Statement: i11 = virtualinvoke r4.<java.lang.String: int indexOf(int,int)>($i15, 1) 
(define-const var2767 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i17 = (int) -1 
 ; Statement: if i11 != $i17 goto i10 = i11 + 1 
(assert (not (not (= var2413 var2767)))) ; Negate: Cond: i11 != $i17  
(define-const var3892 String String-init) ; Statement: $r35 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var3892)) ; Statement: specialinvoke $r35.<java.lang.StringBuilder: void <init>()>() 
(declare-const var3892!1 String)
(assert (= var3892!1 ""))
(assert (and true (and (>= 1 0) (>= (str.len var2822) 1))))
(define-const var569 String (substring/850833817 var2822 1)) ; Statement: $r24 = virtualinvoke r4.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var2985 String (append/672562846 var3892!1 var569)) ; Statement: $r25 = virtualinvoke $r35.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r24) 
(declare-const var3892!2 String)
(assert (= var3892!2 (str.++ var3892!1 var569)))
(assert true)
(define-const var1312 String (append/672562846 var2985 ":[000000]")) ; Statement: $r26 = virtualinvoke $r25.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(":[000000]") 
(declare-const var2985!1 String)
(assert (= var2985!1 (str.++ var2985 ":[000000]")))
(assert true)
(define-const var1945 String (toString/-2075883882 var1312)) ; Statement: $r27 = virtualinvoke $r26.<java.lang.StringBuilder: java.lang.String toString()>() 
