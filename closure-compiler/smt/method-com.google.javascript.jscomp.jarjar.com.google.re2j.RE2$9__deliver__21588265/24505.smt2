...
(assert (and true (and (>= var1609 0) (>= (str.len var117) var993) (>= var993 var1609))))
(define-const var642 String (substring/-1240304868 var117 var1609 var993)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.String: java.lang.String substring(int,int)>($i9, $i8) 
(declare-const var2707!1 (Array Int String))
(assert (not (= var2707!1 null-__Array__Int__String__)))
(assert (= (select var2707!1 var2412) var642)) ; Statement: r1[i10] = $r5 
(assert true) ; Non Conditional
(define-const var2412!1 Int (+ var2412 1)) ; Statement: i10 = i10 + 1 
 ; Statement: goto [?= $i2 = lengthof r1] 
(assert true) ; Non Conditional
(define-const var3260!1 Int (getLength-Arr-String-1 var2707!1)) ; Statement: $i2 = lengthof r1 
 ; Statement: if i10 >= $i2 goto $r3 = r2.<com.google.javascript.jscomp.jarjar.com.google.re2j.RE2$9: java.util.List val$result> 
(assert (>= var2412!1 var3260!1)) ; Cond: i10 >= $i2 
(define-const var1664 var3238 (val$result/1129927112 var3173)) ; Statement: $r3 = r2.<com.google.javascript.jscomp.jarjar.com.google.re2j.RE2$9: java.util.List val$result> 
;(assert (var3238_add/328494887 var1664 (cast-from-__Array__Int__String__-to-var3960 var2707!1))) ; Statement: interfaceinvoke $r3.<java.util.List: boolean add(java.lang.Object)>(r1) 

(declare-const var1664!1 var3238)
(declare-const var2707!2 (Array Int String))
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
