...
(assert (and true (and (> (str.len var1483) var972) (<= 0 var972))))
(define-const var54 Int (charAt/698050440 var1483 var972)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i4) 
(define-const var800 Int (cast-from-Int-to-Int var54)) ; Statement: $i5 = (int) $c1 
 ; Statement: if $i5 != 92 goto $i2 = i3 % 2 
(assert (not (= var800 92))) ; Cond: $i5 != 92 
(define-const var2242 Int (mod var2539 2)) ; Statement: $i2 = i3 % 2 
 ; Statement: if $i2 != 1 goto $z0 = 0 
(assert (not (= var2242 1))) ; Cond: $i2 != 1 
(define-const var2093 Bool (ite (= 1 0) true false)) ; Statement: $z0 = 0 
(assert true) ; Non Conditional
 ; Statement: return $z0 
(check-sat)
(get-model)
