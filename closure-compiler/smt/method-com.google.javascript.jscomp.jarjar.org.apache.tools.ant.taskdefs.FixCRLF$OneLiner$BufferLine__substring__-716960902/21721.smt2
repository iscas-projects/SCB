...
(assert (and true (and (>= var1758 0) (>= (str.len var3995) var1758))))
(define-const var3127 String (substring/850833817 var3995 var1758)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int)>(i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
