...
(assert (and true (and (>= var2821 0) (>= (str.len var1451) var2821))))
(define-const var1925 String (substring/850833817 var1451 var2821)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i3) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
