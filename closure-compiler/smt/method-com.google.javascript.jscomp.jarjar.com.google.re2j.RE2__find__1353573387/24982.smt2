...
(assert (and true (and (>= var3641 0) (>= (str.len var2835) var3257) (>= var3257 var3641))))
(define-const var3082 String (substring/-1240304868 var2835 var3641 var3257)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>($i1, $i0) 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
