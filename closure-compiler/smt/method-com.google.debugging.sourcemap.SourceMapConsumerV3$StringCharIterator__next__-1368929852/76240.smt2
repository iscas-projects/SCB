...
(assert (and true (and (> (str.len var3251) var1519) (<= 0 var1519))))
(define-const var3009 Int (charAt/698050440 var3251 var1519)) ; Statement: $c2 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
 ; Statement: return $c2 
(check-sat)
(get-model)
(get-unsat-core)
