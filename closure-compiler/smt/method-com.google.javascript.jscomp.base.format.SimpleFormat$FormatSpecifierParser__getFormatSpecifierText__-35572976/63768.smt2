...
(assert (and true (and (>= var3059 0) (>= (str.len var2779) var1710) (>= var1710 var3059))))
(define-const var1933 String (substring/-1240304868 var2779 var3059 var1710)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>($i1, $i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
