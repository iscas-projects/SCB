...
(assert (and true (and (>= 1 0) (>= (str.len var419) var3998) (>= var3998 1))))
(define-const var3623 String (substring/-1240304868 var419 1 var3998)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(1, $i2) 
(assert true)
;(assert (append/672562846 var2979!2 var3623)) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var2979!3 String)
(assert (= var2979!3 (str.++ var2979!2 var3623)))
(assert true)
(define-const var1692 String (toString/-2075883882 var2979!3)) ; Statement: $r4 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
