...
(assert true)
(define-const var3034 Bool (startsWith/-1785782452 var507 "/")) ; Statement: $z0 = virtualinvoke r0.<java.lang.String: boolean startsWith(java.lang.String)>("/") 
 ; Statement: return $z0 
(check-sat)
(get-model)
(get-unsat-core)
; {startsWith/-1785782452=([java.lang.String, java.lang.String], boolean)}
; {var507=r0, var199=null_type, var3034=$z0}
; {r0=var507, null_type=var199, $z0=var3034}
