...
(assert (and true (and (>= 0 0) (>= (str.len var2007) var2722) (>= var2722 0))))
(define-const var352 String (substring/-1240304868 var2007 0 var2722)) ; Statement: $r14 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i2) 
(define-const var3151 String (str.++ "\u0001.ts" var352)) ; Statement: $r15 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r14) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("\u0001.ts") 
 ; Statement: goto [?= r1 = $r15] 
(assert true) ; Non Conditional
(define-const var2217 String var3151) ; Statement: r1 = $r15 
(define-const var1707 var2595 (prefixes/1462084866 var2060)) ; Statement: $r3 = r2.<com.google.javascript.jscomp.ConformanceRules$AllowList: com.google.javascript.jscomp.jarjar.com.google.common.collect.ImmutableList prefixes> 
 ; Statement: if $r3 == null goto $r4 = r2.<com.google.javascript.jscomp.ConformanceRules$AllowList: java.util.regex.Pattern regexp> 
(assert (= var1707 null-var2595)) ; Cond: $r3 == null 
(define-const var700 var2003 (regexp/1462084866 var2060)) ; Statement: $r4 = r2.<com.google.javascript.jscomp.ConformanceRules$AllowList: java.util.regex.Pattern regexp> 
 ; Statement: if $r4 == null goto $z7 = 0 
(assert (= var700 null-var2003)) ; Cond: $r4 == null 
(define-const var3135 Bool (ite (= 1 0) true false)) ; Statement: $z7 = 0 
(assert true) ; Non Conditional
 ; Statement: return $z7 
(check-sat)
(get-model)
