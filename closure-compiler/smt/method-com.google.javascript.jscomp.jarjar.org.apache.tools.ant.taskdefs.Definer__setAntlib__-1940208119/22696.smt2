...
(assert (and true (and (>= var812 0) (>= (str.len var805!1) var812))))
(define-const var1308 String (substring/850833817 var805!1 var812)) ; Statement: $r4 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var3251 String (replace/1524665721 var1308 46 47)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.String: java.lang.String replace(char,char)>(46, 47) 
(assert true)
(define-const var2166 String (append/672562846 var2839!1 var3251)) ; Statement: $r6 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r5) 
(declare-const var2839!2 String)
(assert (= var2839!2 (str.++ var2839!1 var3251)))
(assert true)
(define-const var1215 String (append/672562846 var2166 "/antlib.xml")) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("/antlib.xml") 
(declare-const var2166!1 String)
(assert (= var2166!1 (str.++ var2166 "/antlib.xml")))
(assert true)
(define-const var1155 String (toString/-2075883882 var1215)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.String toString()>() 
(declare-const var431!2 var1526)
(assert (not (= var431!2 null-var1526)))
(assert (= (resource/723307835 var431!2) var1155)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.Definer: java.lang.String resource> = $r8 
(declare-const var431!3 var1526)
(assert (not (= var431!3 null-var1526)))
(assert (= (definerSet/723307835 var431!3) (ite (= 1 1) true false))) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.Definer: boolean definerSet> = 1 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
