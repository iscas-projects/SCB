...
(assert (and true (and (>= 1 0) (>= (str.len var2353) 1))))
(define-const var1424 String (substring/850833817 var2353 1)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: java.lang.String substring(int)>(1) 
(declare-const var3846!1 var70)
(assert (not (= var3846!1 null-var70)))
(assert (= (readBuffer/1229857244 var3846!1) var1424)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.filters.ReplaceTokens: java.lang.String readBuffer> = $r4 
(define-const var3912 Int (cast-from-Int-to-Int var880)) ; Statement: $i3 = (int) c0 
 ; Statement: return $i3 
(check-sat)
(get-model)
(get-unsat-core)
