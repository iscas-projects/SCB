...
(assert (and true (and (>= var3117 0) (>= (str.len var416) var3117))))
(define-const var3988 String (substring/850833817 var416 var3117)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i1) 
