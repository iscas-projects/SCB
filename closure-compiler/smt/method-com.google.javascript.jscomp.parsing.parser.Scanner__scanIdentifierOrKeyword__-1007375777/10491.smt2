...
(assert (and true (and (>= var2054 0) (>= (str.len var3724) var3304) (>= var3304 var2054))))
(define-const var3621 String (substring/-1240304868 var3724 var2054 var3304)) ; Statement: $r18 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>(i1, $i2) 
(define-const var3719 String var3621) ; Statement: r19 = $r18 
 ; Statement: if z2 == 0 goto $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(assert (not (= (ite var2559 1 0) 0))) ; Negate: Cond: z2 == 0  
(define-const var3719!1 String (var1880_processUnicodeEscapes/-1554260635 var3621)) ; Statement: r19 = staticinvoke <com.google.javascript.jscomp.parsing.parser.Scanner: java.lang.String processUnicodeEscapes(java.lang.String)>($r18) 
 ; Statement: if r19 != null goto $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(assert (not (not (= var3719!1 null-String)))) ; Negate: Cond: r19 != null  
(define-const var3008 Int (index/-1834389046 var3172)) ; Statement: $i5 = r0.<com.google.javascript.jscomp.parsing.parser.Scanner: int index> 
(assert true)
(define-const var1356 var1090 (getPosition/-1695732445 var3172 var3008)) ; Statement: $r15 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.util.SourcePosition getPosition(int)>($i5) 
(define-const var3399 (Array Int var3050) arr-var3050-init) ; Statement: $r14 = newarray (java.lang.Object)[0] 
(assert true)
;(assert (reportError/1084259189 var3172 var1356 "Invalid escape sequence" var3399)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: void reportError(com.google.javascript.jscomp.parsing.parser.util.SourcePosition,java.lang.String,java.lang.Object[])>($r15, "Invalid escape sequence", $r14) 

(declare-const var3172!1 var1880)
(declare-const var1356!1 var1090)
(declare-const var3872 String)
(declare-const var3399!1 (Array Int var3050))
(define-const var2224 var970 var970-ERROR) ; Statement: $r16 = <com.google.javascript.jscomp.parsing.parser.TokenType: com.google.javascript.jscomp.parsing.parser.TokenType ERROR> 
(assert true)
(define-const var2187 var705 (createToken/1083011389 var3172!1 var2224 var1767)) ; Statement: $r17 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.Token createToken(com.google.javascript.jscomp.parsing.parser.TokenType,int)>($r16, i3) 
