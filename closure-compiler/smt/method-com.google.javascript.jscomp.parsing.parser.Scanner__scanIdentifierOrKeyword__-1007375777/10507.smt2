...
(assert (and true (and (>= var1630 0) (>= (str.len var3464) var536) (>= var536 var1630))))
(define-const var18 String (substring/-1240304868 var3464 var1630 var536)) ; Statement: $r18 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>(i1, $i2) 
(define-const var2618 String var18) ; Statement: r19 = $r18 
 ; Statement: if z2 == 0 goto $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(assert (= (ite var1522 1 0) 0)) ; Cond: z2 == 0 
(assert (and true (and (> (str.len var2618) 0) (<= 0 0))))
(define-const var1704 Int (charAt/698050440 var2618 0)) ; Statement: $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(define-const var2599 Bool (var282_isIdentifierStart/-1418650564 var1704)) ; Statement: $z0 = staticinvoke <com.google.javascript.jscomp.parsing.parser.Identifiers: boolean isIdentifierStart(char)>($c4) 
...
(assert (not (not (= (ite var2599 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(assert true)
(define-const var1508 var2017 (getPosition/-1695732445 var2490 var50)) ; Statement: $r11 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.util.SourcePosition getPosition(int)>(i3) 
(define-const var3575 (Array Int var2935) arr-var2935-init) ; Statement: $r8 = newarray (java.lang.Object)[2] 
(define-const var3099 var443 (var443_valueOf/-1186540555 var1704)) ; Statement: $r9 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c4) 
(declare-const var3575!1 (Array Int var2935))
(assert (not (= var3575!1 null-__Array__Int__var2935__)))
(assert (= (select var3575!1 0) (cast-from-var443-to-var2935 var3099))) ; Statement: $r8[0] = $r9 
(define-const var1128 Int (cast-from-Int-to-Int var1704)) ; Statement: $i18 = (int) $c4 
(define-const var2250 Int (Int_valueOf/-1371140006 var1128)) ; Statement: $r10 = staticinvoke <java.lang.Integer: java.lang.Integer valueOf(int)>($i18) 
(declare-const var3575!2 (Array Int var2935))
(assert (not (= var3575!2 null-__Array__Int__var2935__)))
(assert (= (select var3575!2 1) (cast-from-Int-to-var2935 var2250))) ; Statement: $r8[1] = $r10 
(assert true)
;(assert (reportError/1084259189 var2490 var1508 "Character \u0027%c\u0027 (U+%04X) is not a valid identifier start char" var3575!2)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: void reportError(com.google.javascript.jscomp.parsing.parser.util.SourcePosition,java.lang.String,java.lang.Object[])>($r11, "Character \'%c\' (U+%04X) is not a valid identifier start char", $r8) 

(declare-const var2490!1 var2612)
(declare-const var1508!1 var2017)
(declare-const var1557 String)
(declare-const var3575!3 (Array Int var2935))
(define-const var3730 var1753 var1753-ERROR) ; Statement: $r12 = <com.google.javascript.jscomp.parsing.parser.TokenType: com.google.javascript.jscomp.parsing.parser.TokenType ERROR> 
(assert true)
(define-const var2039 var892 (createToken/1083011389 var2490!1 var3730 var50)) ; Statement: $r13 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.Token createToken(com.google.javascript.jscomp.parsing.parser.TokenType,int)>($r12, i3) 
