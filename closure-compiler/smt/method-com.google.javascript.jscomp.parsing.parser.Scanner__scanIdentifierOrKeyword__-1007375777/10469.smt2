...
(assert (and true (and (> (str.len var1763) 0) (<= 0 0))))
(define-const var3348 Int (charAt/698050440 var1763 0)) ; Statement: $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(define-const var2755 Bool (var1470_isIdentifierStart/-1418650564 var3348)) ; Statement: $z0 = staticinvoke <com.google.javascript.jscomp.parsing.parser.Identifiers: boolean isIdentifierStart(char)>($c4) 
...
(assert (not (not (= (ite var2755 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(assert true)
(define-const var2695 var1936 (getPosition/-1695732445 var627 var80)) ; Statement: $r11 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.util.SourcePosition getPosition(int)>(i3) 
(define-const var3768 (Array Int var2166) arr-var2166-init) ; Statement: $r8 = newarray (java.lang.Object)[2] 
(define-const var1578 var3835 (var3835_valueOf/-1186540555 var3348)) ; Statement: $r9 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c4) 
(declare-const var3768!1 (Array Int var2166))
(assert (not (= var3768!1 null-__Array__Int__var2166__)))
(assert (= (select var3768!1 0) (cast-from-var3835-to-var2166 var1578))) ; Statement: $r8[0] = $r9 
(define-const var448 Int (cast-from-Int-to-Int var3348)) ; Statement: $i18 = (int) $c4 
(define-const var2615 Int (Int_valueOf/-1371140006 var448)) ; Statement: $r10 = staticinvoke <java.lang.Integer: java.lang.Integer valueOf(int)>($i18) 
(declare-const var3768!2 (Array Int var2166))
(assert (not (= var3768!2 null-__Array__Int__var2166__)))
(assert (= (select var3768!2 1) (cast-from-Int-to-var2166 var2615))) ; Statement: $r8[1] = $r10 
(assert true)
;(assert (reportError/1084259189 var627 var2695 "Character \u0027%c\u0027 (U+%04X) is not a valid identifier start char" var3768!2)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: void reportError(com.google.javascript.jscomp.parsing.parser.util.SourcePosition,java.lang.String,java.lang.Object[])>($r11, "Character \'%c\' (U+%04X) is not a valid identifier start char", $r8) 

(declare-const var627!1 var2023)
(declare-const var2695!1 var1936)
(declare-const var3935 String)
(declare-const var3768!3 (Array Int var2166))
(define-const var3738 var2060 var2060-ERROR) ; Statement: $r12 = <com.google.javascript.jscomp.parsing.parser.TokenType: com.google.javascript.jscomp.parsing.parser.TokenType ERROR> 
(assert true)
(define-const var3216 var2602 (createToken/1083011389 var627!1 var3738 var80)) ; Statement: $r13 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.Token createToken(com.google.javascript.jscomp.parsing.parser.TokenType,int)>($r12, i3) 
