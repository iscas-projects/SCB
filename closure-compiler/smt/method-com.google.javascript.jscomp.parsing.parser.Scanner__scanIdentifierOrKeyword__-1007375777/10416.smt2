...
(assert (and true (and (>= var1049 0) (>= (str.len var1490) var924) (>= var924 var1049))))
(define-const var3869 String (substring/-1240304868 var1490 var1049 var924)) ; Statement: $r18 = virtualinvoke $r1.<java.lang.String: java.lang.String substring(int,int)>(i1, $i2) 
(define-const var2316 String var3869) ; Statement: r19 = $r18 
 ; Statement: if z2 == 0 goto $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(assert (not (= (ite var3065 1 0) 0))) ; Negate: Cond: z2 == 0  
(define-const var2316!1 String (var598_processUnicodeEscapes/-1554260635 var3869)) ; Statement: r19 = staticinvoke <com.google.javascript.jscomp.parsing.parser.Scanner: java.lang.String processUnicodeEscapes(java.lang.String)>($r18) 
 ; Statement: if r19 != null goto $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(assert (not (not (= var2316!1 null-String)))) ; Negate: Cond: r19 != null  
(define-const var41 Int (index/-1834389046 var1354)) ; Statement: $i5 = r0.<com.google.javascript.jscomp.parsing.parser.Scanner: int index> 
(assert true)
(define-const var3907 var853 (getPosition/-1695732445 var1354 var41)) ; Statement: $r15 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.util.SourcePosition getPosition(int)>($i5) 
(define-const var3187 (Array Int var333) arr-var333-init) ; Statement: $r14 = newarray (java.lang.Object)[0] 
(assert true)
;(assert (reportError/1084259189 var1354 var3907 "Invalid escape sequence" var3187)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: void reportError(com.google.javascript.jscomp.parsing.parser.util.SourcePosition,java.lang.String,java.lang.Object[])>($r15, "Invalid escape sequence", $r14) 

(declare-const var1354!1 var598)
(declare-const var3907!1 var853)
(declare-const var3244 String)
(declare-const var3187!1 (Array Int var333))
(define-const var354 var3982 var3982-ERROR) ; Statement: $r16 = <com.google.javascript.jscomp.parsing.parser.TokenType: com.google.javascript.jscomp.parsing.parser.TokenType ERROR> 
(assert true)
(define-const var2477 var3550 (createToken/1083011389 var1354!1 var354 var2023)) ; Statement: $r17 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.Token createToken(com.google.javascript.jscomp.parsing.parser.TokenType,int)>($r16, i3) 
