...
(assert (and true (and (> (str.len var877) 0) (<= 0 0))))
(define-const var3152 Int (charAt/698050440 var877 0)) ; Statement: $c4 = virtualinvoke r19.<java.lang.String: char charAt(int)>(0) 
(define-const var2002 Bool (var2852_isIdentifierStart/-1418650564 var3152)) ; Statement: $z0 = staticinvoke <com.google.javascript.jscomp.parsing.parser.Identifiers: boolean isIdentifierStart(char)>($c4) 
...
(assert (not (not (= (ite var2002 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(assert true)
(define-const var912 var1532 (getPosition/-1695732445 var623 var3060)) ; Statement: $r11 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.util.SourcePosition getPosition(int)>(i3) 
(define-const var1150 (Array Int var379) arr-var379-init) ; Statement: $r8 = newarray (java.lang.Object)[2] 
(define-const var376 var169 (var169_valueOf/-1186540555 var3152)) ; Statement: $r9 = staticinvoke <java.lang.Character: java.lang.Character valueOf(char)>($c4) 
(declare-const var1150!1 (Array Int var379))
(assert (not (= var1150!1 null-__Array__Int__var379__)))
(assert (= (select var1150!1 0) (cast-from-var169-to-var379 var376))) ; Statement: $r8[0] = $r9 
(define-const var1563 Int (cast-from-Int-to-Int var3152)) ; Statement: $i18 = (int) $c4 
(define-const var1883 Int (Int_valueOf/-1371140006 var1563)) ; Statement: $r10 = staticinvoke <java.lang.Integer: java.lang.Integer valueOf(int)>($i18) 
(declare-const var1150!2 (Array Int var379))
(assert (not (= var1150!2 null-__Array__Int__var379__)))
(assert (= (select var1150!2 1) (cast-from-Int-to-var379 var1883))) ; Statement: $r8[1] = $r10 
(assert true)
;(assert (reportError/1084259189 var623 var912 "Character \u0027%c\u0027 (U+%04X) is not a valid identifier start char" var1150!2)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: void reportError(com.google.javascript.jscomp.parsing.parser.util.SourcePosition,java.lang.String,java.lang.Object[])>($r11, "Character \'%c\' (U+%04X) is not a valid identifier start char", $r8) 

(declare-const var623!1 var2876)
(declare-const var912!1 var1532)
(declare-const var2097 String)
(declare-const var1150!3 (Array Int var379))
(define-const var2935 var486 var486-ERROR) ; Statement: $r12 = <com.google.javascript.jscomp.parsing.parser.TokenType: com.google.javascript.jscomp.parsing.parser.TokenType ERROR> 
(assert true)
(define-const var1808 var3681 (createToken/1083011389 var623!1 var2935 var3060)) ; Statement: $r13 = virtualinvoke r0.<com.google.javascript.jscomp.parsing.parser.Scanner: com.google.javascript.jscomp.parsing.parser.Token createToken(com.google.javascript.jscomp.parsing.parser.TokenType,int)>($r12, i3) 
