...
(assert (and true (and (>= var2674 0) (>= (str.len var620) var2674))))
(define-const var1497 String (substring/850833817 var620 var2674)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
