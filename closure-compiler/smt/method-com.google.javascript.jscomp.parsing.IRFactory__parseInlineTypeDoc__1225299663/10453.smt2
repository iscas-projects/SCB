...
(assert (and true (and (>= 3 0) (>= (str.len var494) 3))))
(define-const var2441 String (substring/850833817 var494 3)) ; Statement: $r8 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(3) 
(define-const var3171 Int (+ var1277 3)) ; Statement: $i2 = i1 + 3 
(assert true)
;(assert (<init>/-777501959 var2390 var2441 var2796 var3171)) ; Statement: specialinvoke $r7.<com.google.javascript.jscomp.parsing.JsDocTokenStream: void <init>(java.lang.String,int,int)>($r8, i0, $i2) 

(declare-const var2390!1 var1987)
(declare-const var2441!1 String)
(declare-const var2796!1 Int)
(declare-const var3171!1 Int)
(define-const var281 var2266 (location/508785874 var937)) ; Statement: $r9 = r0.<com.google.javascript.jscomp.parsing.parser.trees.Comment: com.google.javascript.jscomp.parsing.parser.util.SourceRange location> 
(define-const var3921 var612 (start/-1854350486 var281)) ; Statement: $r10 = $r9.<com.google.javascript.jscomp.parsing.parser.util.SourceRange: com.google.javascript.jscomp.parsing.parser.util.SourcePosition start> 
(define-const var666 Int (offset/-590926884 var3921)) ; Statement: $i3 = $r10.<com.google.javascript.jscomp.parsing.parser.util.SourcePosition: int offset> 
(define-const var2016 var1265 (templateNode/179838982 var1088)) ; Statement: $r15 = r11.<com.google.javascript.jscomp.parsing.IRFactory: com.google.javascript.rhino.Node templateNode> 
(define-const var546 var3923 (config/179838982 var1088)) ; Statement: $r14 = r11.<com.google.javascript.jscomp.parsing.IRFactory: com.google.javascript.jscomp.parsing.Config config> 
(define-const var3640 var295 (jsDocSourceKind/179838982 var1088)) ; Statement: $r13 = r11.<com.google.javascript.jscomp.parsing.IRFactory: com.google.javascript.jscomp.parsing.JsDocInfoParser$JsDocSourceKind jsDocSourceKind> 
(define-const var1737 var1162 (errorReporter/179838982 var1088)) ; Statement: $r12 = r11.<com.google.javascript.jscomp.parsing.IRFactory: com.google.javascript.rhino.ErrorReporter errorReporter> 
(assert true)
;(assert (<init>/-1990791248 var40 var2390!1 var494 var666 var2016 var546 var3640 var1737)) ; Statement: specialinvoke $r6.<com.google.javascript.jscomp.parsing.JsDocInfoParser: void <init>(com.google.javascript.jscomp.parsing.JsDocTokenStream,java.lang.String,int,com.google.javascript.rhino.Node,com.google.javascript.jscomp.parsing.Config,com.google.javascript.jscomp.parsing.JsDocInfoParser$JsDocSourceKind,com.google.javascript.rhino.ErrorReporter)>($r7, r1, $i3, $r15, $r14, $r13, $r12) 

(declare-const var40!1 var766)
(declare-const var2390!2 var1987)
(declare-const var494!1 String)
(declare-const var666!1 Int)
(declare-const var2016!1 var1265)
(declare-const var546!1 var3923)
(declare-const var3640!1 var295)
(declare-const var1737!1 var1162)
(assert true)
(define-const var20 var201 (parseInlineTypeDoc/1664246354 var40!1)) ; Statement: $r16 = virtualinvoke $r6.<com.google.javascript.jscomp.parsing.JsDocInfoParser: com.google.javascript.rhino.JSDocInfo parseInlineTypeDoc()>() 
