...
(assert (and true (and (>= var3968 0) (>= (str.len var829) var3968))))
(define-const var2849 String (substring/850833817 var829 var3968)) ; Statement: r8 = virtualinvoke $r5.<java.lang.String: java.lang.String substring(int)>($i3) 
(define-const var1972 var3293 (var3293_inRange/58924713 48 57)) ; Statement: $r6 = staticinvoke <com.google.javascript.jscomp.jarjar.com.google.common.base.CharMatcher: com.google.javascript.jscomp.jarjar.com.google.common.base.CharMatcher inRange(char,char)>(48, 57) 
(assert true)
(define-const var120 String (trimLeadingFrom/-1450992632 var1972 (cast-from-String-to-String var2849))) ; Statement: $r7 = virtualinvoke $r6.<com.google.javascript.jscomp.jarjar.com.google.common.base.CharMatcher: java.lang.String trimLeadingFrom(java.lang.CharSequence)>(r8) 
 ; Statement: return $r7 
(check-sat)
(get-model)
(get-unsat-core)
