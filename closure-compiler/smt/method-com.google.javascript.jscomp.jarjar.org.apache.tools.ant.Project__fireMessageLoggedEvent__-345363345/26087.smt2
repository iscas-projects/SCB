...
(assert (and true (and (>= 0 0) (>= (str.len var1116) var637) (>= var637 0))))
(define-const var3271 String (substring/-1240304868 var1116 0 var637)) ; Statement: $r12 = virtualinvoke r16.<java.lang.String: java.lang.String substring(int,int)>(0, i4) 
(assert true)
;(assert (setMessage/-720084151 var2760 var3271 var3655)) ; Statement: virtualinvoke r1.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.BuildEvent: void setMessage(java.lang.String,int)>($r12, i0) 

(declare-const var2760!1 var3432)
(declare-const var3271!1 String)
(declare-const var3655!1 Int)
 ; Statement: goto [?= $r3 = r2.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.Project: java.lang.ThreadLocal isLoggingMessage>] 
(assert true) ; Non Conditional
(define-const var1355 var280 (isLoggingMessage/173117946 var1313)) ; Statement: $r3 = r2.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.Project: java.lang.ThreadLocal isLoggingMessage> 
(assert true)
(define-const var3751 var2375 (get/-896773187 var1355)) ; Statement: $r5 = virtualinvoke $r3.<java.lang.ThreadLocal: java.lang.Object get()>() 
(define-const var3343 var2382 var2382-FALSE) ; Statement: $r4 = <java.lang.Boolean: java.lang.Boolean FALSE> 
...
(assert (not (= var3751 (cast-from-var2382-to-var2375 var3343)))) ; Negate: Cond: $r5 == $r4  
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
