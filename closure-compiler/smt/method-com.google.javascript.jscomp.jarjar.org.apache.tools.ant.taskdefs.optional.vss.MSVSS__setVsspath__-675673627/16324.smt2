...
(assert (and true (and (>= 5 0) (>= (str.len var2253) 5))))
(define-const var2211 String (substring/850833817 var2253 5)) ; Statement: r6 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(5) 
 ; Statement: goto [?= $z1 = virtualinvoke r6.<java.lang.String: boolean startsWith(java.lang.String)>("$")] 
(assert true) ; Non Conditional
(assert true)
(define-const var3122 Bool (startsWith/-1785782452 var2211 "$")) ; Statement: $z1 = virtualinvoke r6.<java.lang.String: boolean startsWith(java.lang.String)>("$") 
 ; Statement: if $z1 == 0 goto $r2 = new java.lang.StringBuilder 
(assert (= (ite var3122 1 0) 0)) ; Cond: $z1 == 0 
(define-const var1904 String String-init) ; Statement: $r2 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1904)) ; Statement: specialinvoke $r2.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1904!1 String)
(assert (= var1904!1 ""))
(assert true)
(define-const var1451 String (append/672562846 var1904!1 "$")) ; Statement: $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("$") 
(declare-const var1904!2 String)
(assert (= var1904!2 (str.++ var1904!1 "$")))
(assert true)
(define-const var1918 String (append/672562846 var1451 var2211)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r6) 
(declare-const var1451!1 String)
(assert (= var1451!1 (str.++ var1451 var2211)))
(assert true)
(define-const var1894 String (toString/-2075883882 var1918)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.String toString()>() 
(declare-const var2160!1 var2527)
(assert (not (= var2160!1 null-var2527)))
(assert (= (vssPath/1944491110 var2160!1) var1894)) ; Statement: r1.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.vss.MSVSS: java.lang.String vssPath> = $r5 
(assert true) ; Non Conditional
 ; Statement: return 
(check-sat)
(get-model)
