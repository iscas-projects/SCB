...
(assert (and true (and (>= var3690 0) (>= (str.len var231) var2646) (>= var2646 var3690))))
(define-const var3339 String (substring/-1240304868 var231 var3690 var2646)) ; Statement: $r4 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>($i1, $i0) 
;(assert (var2188_add/328494887 var2342 (cast-from-String-to-var2455 var3339))) ; Statement: interfaceinvoke $r3.<java.util.List: boolean add(java.lang.Object)>($r4) 

(declare-const var2342!1 var2188)
