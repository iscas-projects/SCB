...
(assert (and true (and (>= var1370 0) (>= (str.len var402) var1370))))
(define-const var3344 String (substring/850833817 var402 var1370)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
