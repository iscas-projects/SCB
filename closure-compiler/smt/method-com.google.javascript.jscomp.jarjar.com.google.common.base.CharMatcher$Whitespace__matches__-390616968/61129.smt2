...
(assert (and true (and (> (str.len var2548) var3674) (<= 0 var3674))))
(define-const var1781 Int (charAt/698050440 var2548 var3674)) ; Statement: $c4 = virtualinvoke $r0.<java.lang.String: char charAt(int)>($i3) 
(define-const var207 Int (cast-from-Int-to-Int var1781)) ; Statement: $i6 = (int) $c4 
(define-const var2265 Int (cast-from-Int-to-Int var2854)) ; Statement: $i7 = (int) c0 
 ; Statement: if $i6 != $i7 goto $z0 = 0 
(assert (not (not (= var207 var2265)))) ; Negate: Cond: $i6 != $i7  
(define-const var1357 Bool (ite (= 1 1) true false)) ; Statement: $z0 = 1 
