...
(assert (and true (and (> (str.len var1074) var434) (<= 0 var434))))
(define-const var1235 Int (charAt/698050440 var1074 var434)) ; Statement: $c4 = virtualinvoke $r0.<java.lang.String: char charAt(int)>($i3) 
(define-const var236 Int (cast-from-Int-to-Int var1235)) ; Statement: $i6 = (int) $c4 
(define-const var3823 Int (cast-from-Int-to-Int var687)) ; Statement: $i7 = (int) c0 
 ; Statement: if $i6 != $i7 goto $z0 = 0 
(assert (not (= var236 var3823))) ; Cond: $i6 != $i7 
(define-const var634 Bool (ite (= 1 0) true false)) ; Statement: $z0 = 0 
