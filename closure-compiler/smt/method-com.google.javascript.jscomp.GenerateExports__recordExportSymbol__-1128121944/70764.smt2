...
(assert (and true (and (>= 0 0) (>= (str.len var690) var1499) (>= var1499 0))))
(define-const var2544 String (substring/-1240304868 var690 0 var1499)) ; Statement: $r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
;(assert (var1385_add/-1142548109 var660 (cast-from-String-to-var2891 var2544))) ; Statement: interfaceinvoke $r2.<java.util.Set: boolean add(java.lang.Object)>($r3) 

(declare-const var660!1 var1385)
