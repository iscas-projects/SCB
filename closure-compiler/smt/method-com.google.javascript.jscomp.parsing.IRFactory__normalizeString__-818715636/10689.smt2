...
(assert (and true (and (>= 1 0) (>= (str.len var725) var2693) (>= var2693 1))))
(define-const var3275 String (substring/-1240304868 var725 1 var2693)) ; Statement: $r26 = virtualinvoke r25.<java.lang.String: java.lang.String substring(int,int)>(1, $i35) 
(assert true) ; Non Conditional
