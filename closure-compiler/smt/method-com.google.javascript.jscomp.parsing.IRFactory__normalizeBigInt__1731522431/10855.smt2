...
(assert (and true (and (> (str.len var2614) 0) (<= 0 0))))
(define-const var2412 Int (charAt/698050440 var2614 0)) ; Statement: $c6 = virtualinvoke r15.<java.lang.String: char charAt(int)>(0) 
(define-const var3804 Int (cast-from-Int-to-Int var2412)) ; Statement: $i9 = (int) $c6 
 ; Statement: if $i9 != 48 goto $r21 = new java.math.BigInteger 
(assert (not (= var3804 48))) ; Cond: $i9 != 48 
(define-const var1563 var3083 var3083-init) ; Statement: $r21 = new java.math.BigInteger 
(assert true)
;(assert (<init>/-169914562 var1563 var2614)) ; Statement: specialinvoke $r21.<java.math.BigInteger: void <init>(java.lang.String)>(r15) 

(declare-const var1563!1 var3083)
