...
(assert (and true (and (>= 0 0) (>= (str.len var2817) var3604) (>= var3604 0))))
(define-const var1013 String (substring/-1240304868 var2817 0 var3604)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
