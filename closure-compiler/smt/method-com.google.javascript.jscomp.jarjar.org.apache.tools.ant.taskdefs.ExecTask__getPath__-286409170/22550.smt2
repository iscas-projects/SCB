...
(assert (and true (and (>= var2740 0) (>= (str.len var1144) var2740))))
(define-const var1287 String (substring/850833817 var1144 var2740)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i0) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
