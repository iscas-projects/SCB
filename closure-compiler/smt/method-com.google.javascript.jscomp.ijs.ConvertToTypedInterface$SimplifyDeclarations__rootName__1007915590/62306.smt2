...
(assert true)
(define-const var1728 Int (indexOf/-1037706067 var1080 46)) ; Statement: i0 = virtualinvoke r0.<java.lang.String: int indexOf(int)>(46) 
(define-const var217 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i2 = (int) -1 
 ; Statement: if i0 != $i2 goto $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert (not (= var1728 var217))) ; Cond: i0 != $i2 
(assert (and true (and (>= 0 0) (>= (str.len var1080) var1728) (>= var1728 0))))
(define-const var545 String (substring/-1240304868 var1080 0 var1728)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var1080=r0, var2291=null_type, var1728=i0, var217=$i2, var545=$r1}
; {r0=var1080, null_type=var2291, i0=var1728, $i2=var217, $r1=var545}
