...
(assert (and true (and (> (str.len var2524) 0) (<= 0 0))))
(define-const var718 Int (charAt/698050440 var2524 0)) ; Statement: c0 = virtualinvoke r1.<java.lang.String: char charAt(int)>(0) 
(assert true)
(define-const var3492 Int (getLastChar/1243116251 var2471!1)) ; Statement: c1 = virtualinvoke r0.<com.google.javascript.jscomp.CodeConsumer: char getLastChar()>() 
(define-const var374 Int (cast-from-Int-to-Int var718)) ; Statement: $i2 = (int) c0 
 ; Statement: if $i2 == 43 goto $i4 = (int) c1 
(assert (= var374 43)) ; Cond: $i2 == 43 
(define-const var1893 Int (cast-from-Int-to-Int var3492)) ; Statement: $i4 = (int) c1 
(define-const var1190 Int (cast-from-Int-to-Int var718)) ; Statement: $i5 = (int) c0 
 ; Statement: if $i4 != $i5 goto $z0 = staticinvoke <java.lang.Character: boolean isLetter(char)>(c0) 
(assert (not (not (= var1893 var1190)))) ; Negate: Cond: $i4 != $i5  
(assert true)
;(assert (append/1413479590 var2471!1 " ")) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.CodeConsumer: void append(java.lang.String)>(" ") 

(declare-const var2471!2 var3196)
(declare-const var1505 String)
 ; Statement: goto [?= virtualinvoke r0.<com.google.javascript.jscomp.CodeConsumer: void appendOp(java.lang.String,boolean)>(r1, z1)] 
(assert true) ; Non Conditional
(assert true)
;(assert (appendOp/2078454657 var2471!2 var2524 var2170)) ; Statement: virtualinvoke r0.<com.google.javascript.jscomp.CodeConsumer: void appendOp(java.lang.String,boolean)>(r1, z1) 

(declare-const var2471!3 var3196)
(declare-const var2524!1 String)
(declare-const var2170!1 Bool)
 ; Statement: if z1 == 0 goto return 
(assert (= (ite var2170!1 1 0) 0)) ; Cond: z1 == 0 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
