...
(assert (= var3962!1 ""))
(assert (and true (and (>= 0 0) (>= (str.len var648) var857) (>= var857 0))))
(define-const var3743 String (substring/-1240304868 var648 0 var857)) ; Statement: $r11 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert true)
(define-const var726 String (append/672562846 var3962!1 var3743)) ; Statement: $r14 = virtualinvoke $r10.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r11) 
(declare-const var3962!2 String)
(assert (= var3962!2 (str.++ var3962!1 var3743)))
(define-const var2157 var1996 (this$0/-2113169594 var3915)) ; Statement: $r12 = r3.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.Native2Ascii$ExtMapper: com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.Native2Ascii this$0> 
(define-const var3618 String (var1996_access$100/894178095 var2157)) ; Statement: $r13 = staticinvoke <com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.Native2Ascii: java.lang.String access$100(com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.Native2Ascii)>($r12) 
(assert true)
(define-const var3155 String (append/672562846 var726 var3618)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r13) 
(declare-const var726!1 String)
(assert (= var726!1 (str.++ var726 var3618)))
(assert true)
(define-const var470 String (toString/-2075883882 var3155)) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.String toString()>() 
(declare-const var2716!1 (Array Int String))
(assert (not (= var2716!1 null-__Array__Int__String__)))
(assert (= (select var2716!1 0) var470)) ; Statement: $r9[0] = $r16 
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
