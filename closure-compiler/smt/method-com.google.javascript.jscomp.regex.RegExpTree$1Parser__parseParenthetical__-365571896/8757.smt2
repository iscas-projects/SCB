...
(assert (and true (and (>= var57 0) (>= (str.len var2306) var57))))
(define-const var816 String (substring/850833817 var2306 var57)) ; Statement: $r23 = virtualinvoke $r22.<java.lang.String: java.lang.String substring(int)>($i47) 
(define-const var3324 String (str.++ "Malformed parenthetical: \u0001" var816)) ; Statement: $r24 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r23) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("Malformed parenthetical: \u0001") 
(assert true)
;(assert (<init>/875830710 var1844 var3324)) ; Statement: specialinvoke $r38.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r24) 

(declare-const var1844!1 var555)
