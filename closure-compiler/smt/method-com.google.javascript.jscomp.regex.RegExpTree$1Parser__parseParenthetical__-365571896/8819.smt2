...
(assert (and true (and (>= var1721 0) (>= (str.len var2050) var1721))))
(define-const var3685 String (substring/850833817 var2050 var1721)) ; Statement: $r23 = virtualinvoke $r22.<java.lang.String: java.lang.String substring(int)>($i47) 
(define-const var3833 String (str.++ "Malformed parenthetical: \u0001" var3685)) ; Statement: $r24 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r23) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("Malformed parenthetical: \u0001") 
(assert true)
;(assert (<init>/875830710 var2088 var3833)) ; Statement: specialinvoke $r38.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r24) 

(declare-const var2088!1 var2698)
