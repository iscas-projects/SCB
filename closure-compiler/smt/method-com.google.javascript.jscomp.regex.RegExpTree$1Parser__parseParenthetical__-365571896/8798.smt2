...
(assert (and true (and (>= var3411 0) (>= (str.len var1808) var3411))))
(define-const var448 String (substring/850833817 var1808 var3411)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: java.lang.String substring(int)>($i47) 
(define-const var3009 String (str.++ "Unclosed parenthetical group: \u0001" var448)) ; Statement: $r5 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r4) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("Unclosed parenthetical group: \u0001") 
(assert true)
;(assert (<init>/875830710 var1899 var3009)) ; Statement: specialinvoke $r39.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r5) 

(declare-const var1899!1 var2573)
