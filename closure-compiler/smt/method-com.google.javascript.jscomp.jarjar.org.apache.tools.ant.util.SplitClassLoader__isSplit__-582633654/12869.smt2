...
(assert (and true (and (>= var740 0) (>= (str.len var1215) var740))))
(define-const var759 String (substring/850833817 var1215 var740)) ; Statement: r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var2902 (Array Int String) (splitClasses/2006981118 var1798)) ; Statement: r3 = r2.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.SplitClassLoader: java.lang.String[] splitClasses> 
(define-const var3338 Int (getLength-Arr-String-1 var2902)) ; Statement: i2 = lengthof r3 
(define-const var3134 Int 0) ; Statement: i3 = 0 
(assert true) ; Non Conditional
 ; Statement: if i3 >= i2 goto return 0 
(assert (>= var3134 var3338)) ; Cond: i3 >= i2 
 ; Statement: return 0 
(check-sat)
(get-model)
(get-unsat-core)
