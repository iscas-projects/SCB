...
(assert (and true (and (> (str.len var1296) var2666) (<= 0 var2666))))
(define-const var3765 Int (charAt/698050440 var1296 var2666)) ; Statement: $c1 = virtualinvoke $r1.<java.lang.String: char charAt(int)>($i0) 
 ; Statement: return $c1 
(check-sat)
(get-model)
(get-unsat-core)
