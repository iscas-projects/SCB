...
(assert (and true (and (> (str.len var1160) var3172) (<= 0 var3172))))
(define-const var2700 Int (charAt/698050440 var1160 var3172)) ; Statement: $c1 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(i0) 
 ; Statement: return $c1 
(check-sat)
(get-model)
(get-unsat-core)
