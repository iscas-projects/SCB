...
(assert (and true (and (>= 0 0) (>= (str.len var3050) var2117) (>= var2117 0))))
(define-const var270 String (substring/-1240304868 var3050 0 var2117)) ; Statement: $r18 = virtualinvoke $r17.<java.lang.String: java.lang.String substring(int,int)>(0, i4) 
(declare-const var1259!1 var1951)
(assert (not (= var1259!1 null-var1951)))
(assert (= (comment/1087169286 var1259!1) var270)) ; Statement: r4.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.ChangeLogParser: java.lang.String comment> = $r18 
(assert true)
;(assert (saveEntry/1191947372 var1259!1)) ; Statement: specialinvoke r4.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.ChangeLogParser: void saveEntry()>() 

(declare-const var1259!2 var1951)
(declare-const var1259!3 var1951)
(assert (not (= var1259!3 null-var1951)))
(assert (= (status/1087169286 var1259!3) 1)) ; Statement: r4.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.ChangeLogParser: int status> = 1 
