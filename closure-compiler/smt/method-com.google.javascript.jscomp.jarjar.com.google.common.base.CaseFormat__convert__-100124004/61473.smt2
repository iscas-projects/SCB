...
(assert (and true (and (>= var365 0) (>= (str.len var11) var365))))
(define-const var3351 String (substring/850833817 var11 var365)) ; Statement: $r5 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i6) 
(assert true)
(define-const var2140 String (normalizeWord/-1423240668 var3306 var3351)) ; Statement: $r6 = virtualinvoke r4.<com.google.javascript.jscomp.jarjar.com.google.common.base.CaseFormat: java.lang.String normalizeWord(java.lang.String)>($r5) 
(assert true)
(define-const var3685 String (append/672562846 var3397 var2140)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r6) 
(declare-const var3397!1 String)
(assert (= var3397!1 (str.++ var3397 var2140)))
(assert true)
(define-const var2226 String (toString/-2075883882 var3685)) ; Statement: $r20 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true) ; Non Conditional
