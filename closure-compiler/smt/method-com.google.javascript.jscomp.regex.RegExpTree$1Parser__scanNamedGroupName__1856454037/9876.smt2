...
(assert (and true (and (> (str.len var1968) var690) (<= 0 var690))))
(define-const var1583 Int (charAt/698050440 var1968 var690)) ; Statement: $c1 = virtualinvoke $r1.<java.lang.String: char charAt(int)>(i0) 
(define-const var2379 Bool (var3073_isIdentifierStart/450707217 var1583)) ; Statement: $z0 = staticinvoke <com.google.javascript.jscomp.regex.RegExpTree: boolean isIdentifierStart(char)>($c1) 
 ; Statement: if $z0 != 0 goto i7 = i6 + 1 
(assert (not (not (= (ite var2379 1 0) 0)))) ; Negate: Cond: $z0 != 0  
(define-const var1271 var2553 var2553-init) ; Statement: $r18 = new java.lang.IllegalArgumentException 
(define-const var602 String (val$pattern/117970391 var1638)) ; Statement: $r15 = r0.<com.google.javascript.jscomp.regex.RegExpTree$1Parser: java.lang.String val$pattern> 
(assert (and true (and (>= var690 0) (>= (str.len var602) var690))))
(define-const var1278 String (substring/850833817 var602 var690)) ; Statement: $r16 = virtualinvoke $r15.<java.lang.String: java.lang.String substring(int)>(i0) 
(define-const var1158 String (str.++ "Invalid capture group name: <\u0001" var1278)) ; Statement: $r17 = dynamicinvoke "makeConcatWithConstants" <java.lang.String (java.lang.String)>($r16) <java.lang.invoke.StringConcatFactory: java.lang.invoke.CallSite makeConcatWithConstants(java.lang.invoke.MethodHandles$Lookup,java.lang.String,java.lang.invoke.MethodType,java.lang.String,java.lang.Object[])>("Invalid capture group name: <\u0001") 
(assert true)
;(assert (<init>/875830710 var1271 var1158)) ; Statement: specialinvoke $r18.<java.lang.IllegalArgumentException: void <init>(java.lang.String)>($r17) 

(declare-const var1271!1 var2553)
