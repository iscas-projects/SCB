...
(assert (and true (and (>= var3802 0) (>= (str.len var323) var3802))))
(define-const var3902 String (substring/850833817 var323 var3802)) ; Statement: $r44 = virtualinvoke $r41.<java.lang.String: java.lang.String substring(int)>($i4) 
(assert true)
(define-const var2206 Int (indexOf/-1209756239 var1639 ":")) ; Statement: $i5 = virtualinvoke $r42.<java.lang.String: int indexOf(java.lang.String)>(":") 
(define-const var3168 Int (+ var2206 1)) ; Statement: $i6 = $i5 + 1 
(assert (and true (and (>= var3168 0) (>= (str.len var1639) var3168))))
(define-const var3548 String (substring/850833817 var1639 var3168)) ; Statement: $r45 = virtualinvoke $r42.<java.lang.String: java.lang.String substring(int)>($i6) 
(define-const var99 var1700 var1700-init) ; Statement: $r11 = new com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1 
(assert true)
;(assert (<init>/1196464854 var99)) ; Statement: specialinvoke $r11.<com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1: void <init>()>() 

(declare-const var99!1 var1700)
(assert true)
(define-const var348 ClassObject (getType/-733762398 (cast-from-var1700-to-var2801 var99!1))) ; Statement: $r46 = virtualinvoke $r11.<com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1: java.lang.reflect.Type getType()>() 
(define-const var710 var1392 var1392-init) ; Statement: $r12 = new com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder 
(assert true)
;(assert (<init>/-1728377939 var710)) ; Statement: specialinvoke $r12.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: void <init>()>() 

(declare-const var710!1 var1392)
(assert true)
(define-const var3949 var1392 (disableHtmlEscaping/-1001101450 var710!1)) ; Statement: $r13 = virtualinvoke $r12.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder disableHtmlEscaping()>() 
(assert true)
(define-const var2872 var1153 (create/-1678241402 var3949)) ; Statement: $r47 = virtualinvoke $r13.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: com.google.javascript.jscomp.jarjar.com.google.gson.Gson create()>() 
(assert true)
(define-const var2741 var193 (fromJson/-750099079 var2872 var598 var348)) ; Statement: $r14 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r43, $r46) 
(define-const var3228 var413 (cast-from-var193-to-var413 var2741)) ; Statement: $r48 = (java.util.List) $r14 
(assert true)
(define-const var2452 var193 (fromJson/-750099079 var2872 var3902 var348)) ; Statement: $r15 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r44, $r46) 
(define-const var3164 var413 (cast-from-var193-to-var413 var2452)) ; Statement: $r49 = (java.util.List) $r15 
(assert true)
(define-const var2631 var193 (fromJson/-750099079 var2872 var3548 var348)) ; Statement: $r16 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r45, $r46) 
(define-const var3958 var413 (cast-from-var193-to-var413 var2631)) ; Statement: $r50 = (java.util.List) $r16 
(define-const var17 var3823 (var2789_stream/-1288525013 (cast-from-var413-to-var2789 var3958))) ; Statement: $r18 = interfaceinvoke $r50.<java.util.List: java.util.stream.Stream stream()>() 
(define-const var3229 var2809 var3369_bootstrap$/-188630264) ; Statement: $r17 = staticinvoke <com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$valueOf__1011: java.util.function.Function bootstrap$()>() 
(define-const var940 var3823 (var3823_map/130902797 var17 var3229)) ; Statement: $r20 = interfaceinvoke $r18.<java.util.stream.Stream: java.util.stream.Stream map(java.util.function.Function)>($r17) 
(define-const var645 var2008 var1834_toList/714215649) ; Statement: $r19 = staticinvoke <java.util.stream.Collectors: java.util.stream.Collector toList()>() 
(define-const var3142 var193 (var3823_collect/-2050842585 var940 var645)) ; Statement: $r21 = interfaceinvoke $r20.<java.util.stream.Stream: java.lang.Object collect(java.util.stream.Collector)>($r19) 
(define-const var795 var413 (cast-from-var193-to-var413 var3142)) ; Statement: $r51 = (java.util.List) $r21 
(define-const var2391 Int 3) ; Statement: i15 = 3 
(assert true) ; Non Conditional
(define-const var2427 Int (var413_size/-959786421 var233!1)) ; Statement: $i16 = interfaceinvoke r4.<java.util.List: int size()>() 
 ; Statement: if i15 >= $i16 goto return $r0 
(assert (>= var2391 var2427)) ; Cond: i15 >= $i16 
 ; Statement: return $r0 
(check-sat)
(get-model)
(get-unsat-core)
