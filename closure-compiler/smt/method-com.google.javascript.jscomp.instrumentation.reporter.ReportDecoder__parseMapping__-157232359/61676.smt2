...
(assert (and true (and (>= var2716 0) (>= (str.len var2896) var2716))))
(define-const var475 String (substring/850833817 var2896 var2716)) ; Statement: $r44 = virtualinvoke $r41.<java.lang.String: java.lang.String substring(int)>($i4) 
(assert true)
(define-const var3649 Int (indexOf/-1209756239 var3889 ":")) ; Statement: $i5 = virtualinvoke $r42.<java.lang.String: int indexOf(java.lang.String)>(":") 
(define-const var2643 Int (+ var3649 1)) ; Statement: $i6 = $i5 + 1 
(assert (and true (and (>= var2643 0) (>= (str.len var3889) var2643))))
(define-const var928 String (substring/850833817 var3889 var2643)) ; Statement: $r45 = virtualinvoke $r42.<java.lang.String: java.lang.String substring(int)>($i6) 
(define-const var772 var2032 var2032-init) ; Statement: $r11 = new com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1 
(assert true)
;(assert (<init>/1196464854 var772)) ; Statement: specialinvoke $r11.<com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1: void <init>()>() 

(declare-const var772!1 var2032)
(assert true)
(define-const var443 ClassObject (getType/-733762398 (cast-from-var2032-to-var2630 var772!1))) ; Statement: $r46 = virtualinvoke $r11.<com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$1: java.lang.reflect.Type getType()>() 
(define-const var2498 var691 var691-init) ; Statement: $r12 = new com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder 
(assert true)
;(assert (<init>/-1728377939 var2498)) ; Statement: specialinvoke $r12.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: void <init>()>() 

(declare-const var2498!1 var691)
(assert true)
(define-const var558 var691 (disableHtmlEscaping/-1001101450 var2498!1)) ; Statement: $r13 = virtualinvoke $r12.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder disableHtmlEscaping()>() 
(assert true)
(define-const var2077 var1771 (create/-1678241402 var558)) ; Statement: $r47 = virtualinvoke $r13.<com.google.javascript.jscomp.jarjar.com.google.gson.GsonBuilder: com.google.javascript.jscomp.jarjar.com.google.gson.Gson create()>() 
(assert true)
(define-const var1661 var3980 (fromJson/-750099079 var2077 var2161 var443)) ; Statement: $r14 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r43, $r46) 
(define-const var3782 var0 (cast-from-var3980-to-var0 var1661)) ; Statement: $r48 = (java.util.List) $r14 
(assert true)
(define-const var1506 var3980 (fromJson/-750099079 var2077 var475 var443)) ; Statement: $r15 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r44, $r46) 
(define-const var2121 var0 (cast-from-var3980-to-var0 var1506)) ; Statement: $r49 = (java.util.List) $r15 
(assert true)
(define-const var2012 var3980 (fromJson/-750099079 var2077 var928 var443)) ; Statement: $r16 = virtualinvoke $r47.<com.google.javascript.jscomp.jarjar.com.google.gson.Gson: java.lang.Object fromJson(java.lang.String,java.lang.reflect.Type)>($r45, $r46) 
(define-const var2485 var0 (cast-from-var3980-to-var0 var2012)) ; Statement: $r50 = (java.util.List) $r16 
(define-const var1558 var3653 (var2563_stream/-1288525013 (cast-from-var0-to-var2563 var2485))) ; Statement: $r18 = interfaceinvoke $r50.<java.util.List: java.util.stream.Stream stream()>() 
(define-const var1067 var2652 var2720_bootstrap$/-188630264) ; Statement: $r17 = staticinvoke <com.google.javascript.jscomp.instrumentation.reporter.ReportDecoder$valueOf__1011: java.util.function.Function bootstrap$()>() 
(define-const var2916 var3653 (var3653_map/130902797 var1558 var1067)) ; Statement: $r20 = interfaceinvoke $r18.<java.util.stream.Stream: java.util.stream.Stream map(java.util.function.Function)>($r17) 
(define-const var3246 var2999 var590_toList/714215649) ; Statement: $r19 = staticinvoke <java.util.stream.Collectors: java.util.stream.Collector toList()>() 
(define-const var829 var3980 (var3653_collect/-2050842585 var2916 var3246)) ; Statement: $r21 = interfaceinvoke $r20.<java.util.stream.Stream: java.lang.Object collect(java.util.stream.Collector)>($r19) 
(define-const var3539 var0 (cast-from-var3980-to-var0 var829)) ; Statement: $r51 = (java.util.List) $r21 
(define-const var3593 Int 3) ; Statement: i15 = 3 
(assert true) ; Non Conditional
(define-const var84 Int (var0_size/-959786421 var1136!1)) ; Statement: $i16 = interfaceinvoke r4.<java.util.List: int size()>() 
 ; Statement: if i15 >= $i16 goto return $r0 
(assert (>= var3593 var84)) ; Cond: i15 >= $i16 
 ; Statement: return $r0 
(check-sat)
(get-model)
(get-unsat-core)
