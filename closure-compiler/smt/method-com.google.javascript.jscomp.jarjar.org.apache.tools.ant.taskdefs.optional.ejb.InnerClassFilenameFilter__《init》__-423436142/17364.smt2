...
(assert (and true (and (>= 0 0) (>= (str.len var2350) var3538) (>= var3538 0))))
(define-const var2829 String (substring/-1240304868 var2350 0 var3538)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, i1) 
(declare-const var1957!2 var1880)
(assert (not (= var1957!2 null-var1880)))
(assert (= (baseClassName/-1032202652 var1957!2) var2829)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.ejb.InnerClassFilenameFilter: java.lang.String baseClassName> = $r2 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
