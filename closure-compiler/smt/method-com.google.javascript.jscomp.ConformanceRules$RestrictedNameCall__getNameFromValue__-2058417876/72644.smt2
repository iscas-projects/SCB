...
(assert (and true (and (>= 0 0) (>= (str.len var1317) var695) (>= var695 0))))
(define-const var1212 String (substring/-1240304868 var1317 0 var695)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
