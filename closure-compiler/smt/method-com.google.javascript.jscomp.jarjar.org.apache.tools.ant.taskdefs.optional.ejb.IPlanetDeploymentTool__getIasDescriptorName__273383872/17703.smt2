...
(assert (and true (and (>= var2344 0) (>= (str.len var3163) var2344))))
(define-const var3777 String (substring/850833817 var3163 var2344)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: java.lang.String substring(int)>($i2) 
(assert true)
(define-const var1093 Bool (= var3777 "ejb-jar.xml")) ; Statement: $z0 = virtualinvoke $r4.<java.lang.String: boolean equals(java.lang.Object)>("ejb-jar.xml") 
 ; Statement: if $z0 == 0 goto $r5 = r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.ejb.IPlanetDeploymentTool: java.lang.String descriptorName> 
(assert (not (= (ite var1093 1 0) 0))) ; Negate: Cond: $z0 == 0  
(define-const var1334 String "") ; Statement: r13 = "" 
(define-const var846 String "ejb-jar.xml") ; Statement: r14 = "ejb-jar.xml" 
 ; Statement: goto [?= $r24 = new java.lang.StringBuilder] 
(assert true) ; Non Conditional
(define-const var2141 String String-init) ; Statement: $r24 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2141)) ; Statement: specialinvoke $r24.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2141!1 String)
(assert (= var2141!1 ""))
(assert true)
(define-const var1812 String (append/672562846 var2141!1 var1466)) ; Statement: $r18 = virtualinvoke $r24.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r12) 
(declare-const var2141!2 String)
(assert (= var2141!2 (str.++ var2141!1 var1466)))
(assert true)
(define-const var3995 String (append/672562846 var1812 var1334)) ; Statement: $r19 = virtualinvoke $r18.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r13) 
(declare-const var1812!1 String)
(assert (= var1812!1 (str.++ var1812 var1334)))
(assert true)
(define-const var2713 String (append/672562846 var3995 "ias-")) ; Statement: $r20 = virtualinvoke $r19.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("ias-") 
(declare-const var3995!1 String)
(assert (= var3995!1 (str.++ var3995 "ias-")))
(assert true)
(define-const var3055 String (append/672562846 var2713 var846)) ; Statement: $r21 = virtualinvoke $r20.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r14) 
(declare-const var2713!1 String)
(assert (= var2713!1 (str.++ var2713 var846)))
(assert true)
(define-const var2486 String (toString/-2075883882 var3055)) ; Statement: $r22 = virtualinvoke $r21.<java.lang.StringBuilder: java.lang.String toString()>() 
(declare-const var3230!1 var3287)
(assert (not (= var3230!1 null-var3287)))
(assert (= (iasDescriptorName/-1920223749 var3230!1) var2486)) ; Statement: r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.ejb.IPlanetDeploymentTool: java.lang.String iasDescriptorName> = $r22 
(define-const var3101 String (iasDescriptorName/-1920223749 var3230!1)) ; Statement: $r23 = r0.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.optional.ejb.IPlanetDeploymentTool: java.lang.String iasDescriptorName> 
