...
(assert (and true (and (>= 0 0) (>= (str.len var88) var73) (>= var73 0))))
(define-const var2316 String (substring/-1240304868 var88 0 var73)) ; Statement: r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(define-const var1756 Int (+ var2154 1)) ; Statement: $i2 = i0 + 1 
(assert (and true (and (>= var1756 0) (>= (str.len var88) var1756))))
(define-const var2990 String (substring/850833817 var88 var1756)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i2) 
(define-const var3934 (Array Int Int) (var3963_textToNumericFormatV4/888634563 var2990)) ; Statement: r3 = staticinvoke <com.google.javascript.jscomp.jarjar.com.google.common.net.InetAddresses: byte[] textToNumericFormatV4(java.lang.String)>(r2) 
 ; Statement: if r3 != null goto $b3 = r3[0] 
(assert (not (not (= var3934 null-__Array__Int__Int__)))) ; Negate: Cond: r3 != null  
