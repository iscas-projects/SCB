...
(assert (and true (and (>= 0 0) (>= (str.len var944) var1384) (>= var1384 0))))
(define-const var3467 String (substring/-1240304868 var944 0 var1384)) ; Statement: $r8 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i1) 
(define-const var1712 String "this") ; Statement: $r1 = "this" 
(assert true)
(define-const var2348 Bool (= var1712 var3467)) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean equals(java.lang.Object)>($r8) 
 ; Statement: if $z0 == 0 goto $r2 = "super" 
(assert (not (= (ite var2348 1 0) 0))) ; Negate: Cond: $z0 == 0  
(define-const var919 var1001 var529_thisNode/385872336) ; Statement: r9 = staticinvoke <com.google.javascript.rhino.IR: com.google.javascript.rhino.Node thisNode()>() 
 ; Statement: goto [?= virtualinvoke r9.<com.google.javascript.rhino.Node: void setLength(int)>(i1)] 
(assert true) ; Non Conditional
(assert true)
;(assert (setLength/1649856911 var919 var1384)) ; Statement: virtualinvoke r9.<com.google.javascript.rhino.Node: void setLength(int)>(i1) 

(declare-const var919!1 var1001)
(declare-const var1384!1 Int)
(define-const var1955 Int (+ var1384!1 1)) ; Statement: i2 = i1 + 1 
(assert true) ; Non Conditional
(assert true)
(define-const var3276 Int (length/-134980193 var944)) ; Statement: $i3 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if i1 >= $i3 goto return r9 
(assert (>= var1384!1 var3276)) ; Cond: i1 >= $i3 
 ; Statement: return r9 
(check-sat)
(get-model)
(get-unsat-core)
