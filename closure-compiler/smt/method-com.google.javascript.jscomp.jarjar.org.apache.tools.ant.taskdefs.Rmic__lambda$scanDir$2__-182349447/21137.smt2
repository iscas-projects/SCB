...
(assert (and true (and (>= 0 0) (>= (str.len var1894) var2391) (>= var2391 0))))
(define-const var3285 String (substring/-1240304868 var1894 0 var2391)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
