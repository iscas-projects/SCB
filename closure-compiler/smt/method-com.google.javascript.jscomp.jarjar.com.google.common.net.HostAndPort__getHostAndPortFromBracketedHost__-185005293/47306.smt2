...
(assert (and true (and (>= 1 0) (>= (str.len var2046!2) var899) (>= var899 1))))
(define-const var3342 String (substring/-1240304868 var2046!2 1 var899)) ; Statement: $r4 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(1, $i6) 
(define-const var566 Int (+ var899 1)) ; Statement: $i7 = $i6 + 1 
(assert true)
(define-const var2652 Int (length/-134980193 var2046!2)) ; Statement: $i8 = virtualinvoke r0.<java.lang.String: int length()>() 
 ; Statement: if $i7 != $i8 goto $i1 = $i6 + 1 
(assert (not (not (= var566 var2652)))) ; Negate: Cond: $i7 != $i8  
(define-const var957 (Array Int String) arr-String-init) ; Statement: $r3 = newarray (java.lang.String)[2] 
(declare-const var957!1 (Array Int String))
(assert (not (= var957!1 null-__Array__Int__String__)))
(assert (= (select var957!1 0) var3342)) ; Statement: $r3[0] = $r4 
(declare-const var957!2 (Array Int String))
(assert (not (= var957!2 null-__Array__Int__String__)))
(assert (= (select var957!2 1) "")) ; Statement: $r3[1] = "" 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
