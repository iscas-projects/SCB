...
(assert (and true (and (>= var1877 0) (>= (str.len var1703) var2923) (>= var2923 var1877))))
(define-const var204 String (substring/-1240304868 var1703 var1877 var2923)) ; Statement: r4 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i0, $i3) 
(assert true)
(define-const var750 Bool (getHandleDirSep/-448991300 (cast-from-var3896-to-var779 var1191))) ; Statement: $z0 = virtualinvoke r1.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.util.PackageNameMapper: boolean getHandleDirSep()>() 
 ; Statement: if $z0 == 0 goto $c4 = <java.io.File: char separatorChar> 
(assert (= (ite var750 1 0) 0)) ; Cond: $z0 == 0 
(define-const var1927 Int var3508-separatorChar) ; Statement: $c4 = <java.io.File: char separatorChar> 
(assert true)
(define-const var772 String (replace/1524665721 var204 var1927 46)) ; Statement: $r2 = virtualinvoke r4.<java.lang.String: java.lang.String replace(char,char)>($c4, 46) 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
