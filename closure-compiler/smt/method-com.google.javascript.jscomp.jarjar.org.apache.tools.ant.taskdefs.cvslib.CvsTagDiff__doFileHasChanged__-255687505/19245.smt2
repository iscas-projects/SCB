...
(assert (and true (and (>= 0 0) (>= (str.len var1700) var1880) (>= var1880 0))))
(define-const var841 String (substring/-1240304868 var1700 0 var1880)) ; Statement: r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert true)
(define-const var1092 Int (indexOf/1795197748 var1700 " to " var1880)) ; Statement: i1 = virtualinvoke r0.<java.lang.String: int indexOf(java.lang.String,int)>(" to ", i0) 
(define-const var2386 String " changed from revision ") ; Statement: $r2 = " changed from revision " 
(assert true)
(define-const var3923 Int (length/-134980193 var2386)) ; Statement: $i2 = virtualinvoke $r2.<java.lang.String: int length()>() 
(define-const var3538 Int (+ var1880 var3923)) ; Statement: $i3 = i0 + $i2 
(assert (and true (and (>= var3538 0) (>= (str.len var1700) var1092) (>= var1092 var3538))))
(define-const var2338 String (substring/-1240304868 var1700 var3538 var1092)) ; Statement: r3 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i3, i1) 
(define-const var2142 String " to ") ; Statement: $r4 = " to " 
(assert true)
(define-const var24 Int (length/-134980193 var2142)) ; Statement: $i4 = virtualinvoke $r4.<java.lang.String: int length()>() 
(define-const var96 Int (+ var1092 var24)) ; Statement: $i5 = i1 + $i4 
(assert (and true (and (>= var96 0) (>= (str.len var1700) var96))))
(define-const var2765 String (substring/850833817 var1700 var96)) ; Statement: r5 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i5) 
(define-const var3660 var1576 var1576-init) ; Statement: $r10 = new com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.CvsTagEntry 
(assert true)
;(assert (<init>/-2093450607 var3660 var841 var2765 var2338)) ; Statement: specialinvoke $r10.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.CvsTagEntry: void <init>(java.lang.String,java.lang.String,java.lang.String)>(r1, r5, r3) 

(declare-const var3660!1 var1576)
(declare-const var841!1 String)
(declare-const var2765!1 String)
(declare-const var2338!1 String)
;(assert (var2554_add/328494887 var2004 (cast-from-var1576-to-var2476 var3660!1))) ; Statement: interfaceinvoke r7.<java.util.List: boolean add(java.lang.Object)>($r10) 

(declare-const var2004!1 var2554)
(declare-const var3660!2 var1576)
(assert true)
(define-const var106 String (toString/-273996893 var3660!2)) ; Statement: $r9 = virtualinvoke $r10.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.CvsTagEntry: java.lang.String toString()>() 
(assert true)
;(assert (log/456963423 (cast-from-var1333-to-var669 var3770) var106 3)) ; Statement: virtualinvoke r8.<com.google.javascript.jscomp.jarjar.org.apache.tools.ant.taskdefs.cvslib.CvsTagDiff: void log(java.lang.String,int)>($r9, 3) 

(declare-const var3770!1 var1333)
