...
(assert (and true (and (>= 0 0) (>= (str.len var3279) var250) (>= var250 0))))
(define-const var1307 String (substring/-1240304868 var3279 0 var250)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
