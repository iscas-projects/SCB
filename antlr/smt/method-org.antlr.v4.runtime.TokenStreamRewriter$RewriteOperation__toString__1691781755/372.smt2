...
(assert (and true (and (>= var2862 0) (>= (str.len var3465) var2106) (>= var2106 var2862))))
(define-const var3025 String (substring/-1240304868 var3465 var2862 var2106)) ; Statement: r16 = virtualinvoke r15.<java.lang.String: java.lang.String substring(int,int)>($i2, $i1) 
(define-const var2586 String String-init) ; Statement: $r2 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2586)) ; Statement: specialinvoke $r2.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2586!1 String)
(assert (= var2586!1 ""))
(assert true)
(define-const var1659 String (append/672562846 var2586!1 "<")) ; Statement: $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("<") 
(declare-const var2586!2 String)
(assert (= var2586!2 (str.++ var2586!1 "<")))
(assert true)
(define-const var3964 String (append/672562846 var1659 var3025)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r16) 
(declare-const var1659!1 String)
(assert (= var1659!1 (str.++ var1659 var3025)))
(assert true)
(define-const var891 String (append/672562846 var3964 "@")) ; Statement: $r8 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("@") 
(declare-const var3964!1 String)
(assert (= var3964!1 (str.++ var3964 "@")))
(define-const var1755 var2828 (this$0/-227227365 var1486)) ; Statement: $r5 = r0.<org.antlr.v4.runtime.TokenStreamRewriter$RewriteOperation: org.antlr.v4.runtime.TokenStreamRewriter this$0> 
(define-const var561 var1967 (tokens/849795300 var1755)) ; Statement: $r6 = $r5.<org.antlr.v4.runtime.TokenStreamRewriter: org.antlr.v4.runtime.TokenStream tokens> 
(define-const var3373 Int (index/-227227365 var1486)) ; Statement: $i3 = r0.<org.antlr.v4.runtime.TokenStreamRewriter$RewriteOperation: int index> 
(define-const var191 var1354 (var1967_get/-1982438416 var561 var3373)) ; Statement: $r7 = interfaceinvoke $r6.<org.antlr.v4.runtime.TokenStream: org.antlr.v4.runtime.Token get(int)>($i3) 
(assert true)
(define-const var684 String (append/-1031950772 var891 (cast-from-var1354-to-var1542 var191))) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.Object)>($r7) 
(declare-const var891!1 String)
(assert (str.prefixof var891 var891!1))
(assert true)
(define-const var2662 String (append/672562846 var684 ":\u0022")) ; Statement: $r11 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(":\"") 
(declare-const var684!1 String)
(assert (= var684!1 (str.++ var684 ":\u0022")))
(define-const var2216 var1542 (text/-227227365 var1486)) ; Statement: $r10 = r0.<org.antlr.v4.runtime.TokenStreamRewriter$RewriteOperation: java.lang.Object text> 
(assert true)
(define-const var2305 String (append/-1031950772 var2662 var2216)) ; Statement: $r12 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.Object)>($r10) 
(declare-const var2662!1 String)
(assert (str.prefixof var2662 var2662!1))
(assert true)
(define-const var142 String (append/672562846 var2305 "\u0022>")) ; Statement: $r13 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("\">") 
(declare-const var2305!1 String)
(assert (= var2305!1 (str.++ var2305 "\u0022>")))
(assert true)
(define-const var2012 String (toString/-2075883882 var142)) ; Statement: $r14 = virtualinvoke $r13.<java.lang.StringBuilder: java.lang.String toString()>() 
