...
(assert (and true (and (>= 0 0) (>= (str.len var1263) var2683) (>= var2683 0))))
(define-const var3477 String (substring/-1240304868 var1263 0 var2683)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i5) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
