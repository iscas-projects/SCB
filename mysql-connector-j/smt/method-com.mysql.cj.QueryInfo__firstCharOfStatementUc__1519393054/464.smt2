...
(assert (and true (and (> (str.len var954) var96) (<= 0 var96))))
(define-const var1204 Int (charAt/698050440 var954 var96)) ; Statement: $c1 = virtualinvoke r0.<java.lang.String: char charAt(int)>(i0) 
(define-const var1229 Int (var2011_toUpperCase/1913344327 var1204)) ; Statement: $c2 = staticinvoke <java.lang.Character: char toUpperCase(char)>($c1) 
 ; Statement: return $c2 
(check-sat)
(get-model)
(get-unsat-core)
