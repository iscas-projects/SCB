...
(assert (and true (and (>= 0 0) (>= (str.len var1342) var3909) (>= var3909 0))))
(define-const var3107 String (substring/-1240304868 var1342 0 var3909)) ; Statement: $r9 = virtualinvoke r7.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(assert true)
;(assert (append/672562846 var913!1 var3107)) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r9) 
(declare-const var913!2 String)
(assert (= var913!2 (str.++ var913!1 var3107)))
(define-const var2623 String (var476_getString/-1547297038 "MysqlIO.25")) ; Statement: $r10 = staticinvoke <com.mysql.cj.Messages: java.lang.String getString(java.lang.String)>("MysqlIO.25") 
(assert true)
;(assert (append/672562846 var913!2 var2623)) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r10) 
(declare-const var913!3 String)
(assert (= var913!3 (str.++ var913!2 var2623)))
(assert true)
(define-const var1142 String (toString/-2075883882 var913!3)) ; Statement: r11 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
