...
(assert (and true (and (>= 0 0) (>= (str.len var2874) var2848) (>= var2848 0))))
(define-const var819 String (substring/-1240304868 var2874 0 var2848)) ; Statement: $r25 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i74) 
(assert true)
(define-const var1601 String (trim/-847153721 var819)) ; Statement: r26 = virtualinvoke $r25.<java.lang.String: java.lang.String trim()>() 
...
(define-const var1218 Int (var2501_indexOfIgnoreCase/1193821831 var1601 "DECIMAL")) ; Statement: $i1 = staticinvoke <com.mysql.cj.util.StringUtils: int indexOfIgnoreCase(java.lang.String,java.lang.String)>(r26, "DECIMAL") 
(define-const var1897 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i84 = (int) -1 
...
(assert (not (= var1218 var1897))) ; Cond: $i1 != $i84 
(define-const var1835 Int (var2501_indexOfIgnoreCase/1193821831 var2874 "UNSIGNED")) ; Statement: $i75 = staticinvoke <com.mysql.cj.util.StringUtils: int indexOfIgnoreCase(java.lang.String,java.lang.String)>(r0, "UNSIGNED") 
(define-const var1849 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i92 = (int) -1 
 ; Statement: if $i75 == $i92 goto $r27 = <com.mysql.cj.MysqlType: com.mysql.cj.MysqlType DECIMAL> 
(assert (= var1835 var1849)) ; Cond: $i75 == $i92 
(define-const var3691 var2295 var2295-DECIMAL) ; Statement: $r27 = <com.mysql.cj.MysqlType: com.mysql.cj.MysqlType DECIMAL> 
(assert true) ; Non Conditional
