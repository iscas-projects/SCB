...
(assert (and true (and (>= 0 0) (>= (str.len var3460) var2873) (>= var2873 0))))
(define-const var1024 String (substring/-1240304868 var3460 0 var2873)) ; Statement: $r25 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i74) 
(assert true)
(define-const var744 String (trim/-847153721 var1024)) ; Statement: r26 = virtualinvoke $r25.<java.lang.String: java.lang.String trim()>() 
 ; Statement: goto [?= $i1 = staticinvoke <com.mysql.cj.util.StringUtils: int indexOfIgnoreCase(java.lang.String,java.lang.String)>(r26, "DECIMAL")] 
(assert true) ; Non Conditional
(define-const var2008 Int (var425_indexOfIgnoreCase/1193821831 var744 "DECIMAL")) ; Statement: $i1 = staticinvoke <com.mysql.cj.util.StringUtils: int indexOfIgnoreCase(java.lang.String,java.lang.String)>(r26, "DECIMAL") 
(define-const var71 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i84 = (int) -1 
...
(assert (not (= var2008 var71))) ; Cond: $i1 != $i84 
(define-const var2013 Int (var425_indexOfIgnoreCase/1193821831 var3460 "UNSIGNED")) ; Statement: $i75 = staticinvoke <com.mysql.cj.util.StringUtils: int indexOfIgnoreCase(java.lang.String,java.lang.String)>(r0, "UNSIGNED") 
(define-const var335 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i92 = (int) -1 
 ; Statement: if $i75 == $i92 goto $r27 = <com.mysql.cj.MysqlType: com.mysql.cj.MysqlType DECIMAL> 
(assert (not (= var2013 var335))) ; Negate: Cond: $i75 == $i92  
(define-const var1441 var763 var763-DECIMAL_UNSIGNED) ; Statement: $r27 = <com.mysql.cj.MysqlType: com.mysql.cj.MysqlType DECIMAL_UNSIGNED> 
