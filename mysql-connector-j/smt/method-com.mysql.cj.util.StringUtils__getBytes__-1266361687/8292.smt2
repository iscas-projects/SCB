...
(assert (and true (and (>= var2855 0) (>= (str.len var3413) var1059) (>= var1059 var2855))))
(define-const var3925 String (substring/-1240304868 var3413 var2855 var1059)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(i0, $i2) 
(assert true)
(define-const var3388 (Array Int Int) (getBytes/1068683673 var3925)) ; Statement: $r2 = virtualinvoke $r1.<java.lang.String: byte[] getBytes()>() 
 ; Statement: return $r2 
(check-sat)
(get-model)
(get-unsat-core)
