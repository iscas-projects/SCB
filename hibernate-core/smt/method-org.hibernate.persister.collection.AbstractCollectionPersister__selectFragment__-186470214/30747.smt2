...
(assert (and true (and (>= 2 0) (>= (str.len var919) 2))))
(define-const var1994 String (substring/850833817 var919 2)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.String: java.lang.String substring(int)>(2) 
 ; Statement: return $r5 
(check-sat)
(get-model)
(get-unsat-core)
