...
(assert (and true (and (>= 0 0) (>= (str.len var2608) var609) (>= var609 0))))
(define-const var686 String (substring/-1240304868 var2608 0 var609)) ; Statement: $r5 = virtualinvoke r7.<java.lang.String: java.lang.String substring(int,int)>(0, i4) 
(assert true)
;(assert (append/672562846 var927!1 var686)) ; Statement: virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r5) 
(declare-const var927!2 String)
(assert (= var927!2 (str.++ var927!1 var686)))
 ; Statement: goto [?= $r2 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" OPTION (")] 
(assert true) ; Non Conditional
(assert true)
(define-const var3044 String (append/672562846 var927!2 " OPTION (")) ; Statement: $r2 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" OPTION (") 
(declare-const var927!3 String)
(assert (= var927!3 (str.++ var927!2 " OPTION (")))
(assert true)
(define-const var762 String (append/672562846 var3044 var127)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r1) 
(declare-const var3044!1 String)
(assert (= var3044!1 (str.++ var3044 var127)))
(assert true)
;(assert (append/672562846 var762 ")")) ; Statement: virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(")") 
(declare-const var762!1 String)
(assert (= var762!1 (str.++ var762 ")")))
(define-const var579 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i8 = (int) -1 
 ; Statement: if i4 <= $i8 goto $r4 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (<= var609 var579)) ; Cond: i4 <= $i8 
(assert true)
(define-const var3502 String (toString/-2075883882 var927!3)) ; Statement: $r4 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r4 
(check-sat)
(get-model)
(get-unsat-core)
