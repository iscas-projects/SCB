...
(assert (and true (and (>= 1 0) (>= (str.len var1988) 30) (>= 30 1))))
(define-const var2836 String (substring/-1240304868 var1988 1 30)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(1, 30) 
