...
(assert (and true (and (>= 0 0) (>= (str.len var3538) var916) (>= var916 0))))
(define-const var1047!1 String (substring/-1240304868 var3538 0 var916)) ; Statement: r12 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, $i6) 
 ; Statement: goto [?= $r14 = new java.math.BigDecimal] 
(assert true) ; Non Conditional
(declare-const var2882 var2655) ; Statement: $r4 := @caughtexception 
(assert (not (= var2882 null-var2655)))
(define-const var550 var1297 var1297-init) ; Statement: $r16 = new org.hibernate.HibernateException 
(define-const var2914 String String-init) ; Statement: $r15 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2914)) ; Statement: specialinvoke $r15.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2914!1 String)
(assert (= var2914!1 ""))
(assert true)
(define-const var1817 String (append/672562846 var2914!1 "Could not parse literal [")) ; Statement: $r7 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("Could not parse literal [") 
(declare-const var2914!2 String)
(assert (= var2914!2 (str.++ var2914!1 "Could not parse literal [")))
(assert true)
(define-const var3463 String (append/672562846 var1817 var3538)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r0) 
(declare-const var1817!1 String)
(assert (= var1817!1 (str.++ var1817 var3538)))
(assert true)
(define-const var661 String (append/672562846 var3463 "] as big-decimal")) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("] as big-decimal") 
(declare-const var3463!1 String)
(assert (= var3463!1 (str.++ var3463 "] as big-decimal")))
(assert true)
(define-const var2273 String (toString/-2075883882 var661)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (<init>/-1245322999 var550 var2273 var2882)) ; Statement: specialinvoke $r16.<org.hibernate.HibernateException: void <init>(java.lang.String,java.lang.Throwable)>($r10, $r4) 

(declare-const var550!1 var1297)
(declare-const var2273!1 String)
(declare-const var2882!1 var2655)
(define-const var3046 var2655 (cast-from-var1297-to-var2655 var550!1)) ; Statement: $r17 = (java.lang.Throwable) $r16 
 ; Statement: throw $r17 
(check-sat)
(get-model)
(get-unsat-core)
