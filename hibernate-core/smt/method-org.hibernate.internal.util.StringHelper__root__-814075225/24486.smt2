...
(assert (and true (and (>= 0 0) (>= (str.len var43) var410) (>= var410 0))))
(define-const var848 String (substring/-1240304868 var43 0 var410)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
