...
(assert (and true (and (>= 1 0) (>= (str.len var465) 1))))
(define-const var969 String (substring/850833817 var465 1)) ; Statement: $r11 = virtualinvoke $r10.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var2983 String (append/672562846 var2277 var969)) ; Statement: $r13 = virtualinvoke $r12.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r11) 
(declare-const var2277!1 String)
(assert (= var2277!1 (str.++ var2277 var969)))
(assert true)
(define-const var2433 String (toString/-2075883882 var2983)) ; Statement: r14 = virtualinvoke $r13.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var1092 String String-init) ; Statement: $r15 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var1092)) ; Statement: specialinvoke $r15.<java.lang.StringBuilder: void <init>()>() 
(declare-const var1092!1 String)
(assert (= var1092!1 ""))
(assert true)
(define-const var2805 String (append/672562846 var1092!1 "get")) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("get") 
(declare-const var1092!2 String)
(assert (= var1092!2 (str.++ var1092!1 "get")))
(assert true)
(define-const var3325 String (append/672562846 var2805 var2433)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r14) 
(declare-const var2805!1 String)
(assert (= var2805!1 (str.++ var2805 var2433)))
(assert true)
(define-const var191 String (toString/-2075883882 var3325)) ; Statement: $r18 = virtualinvoke $r17.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var2022 var2474 (var2891_get/1088891777 var3309 (cast-from-String-to-var2474 var191))) ; Statement: $r19 = interfaceinvoke r7.<java.util.Map: java.lang.Object get(java.lang.Object)>($r18) 
(define-const var3770 var1110 (cast-from-var2474-to-var1110 var2022)) ; Statement: r20 = (net.bytebuddy.description.method.MethodDescription) $r19 
(define-const var3029 String String-init) ; Statement: $r21 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var3029)) ; Statement: specialinvoke $r21.<java.lang.StringBuilder: void <init>()>() 
(declare-const var3029!1 String)
(assert (= var3029!1 ""))
(assert true)
(define-const var3640 String (append/672562846 var3029!1 "is")) ; Statement: $r22 = virtualinvoke $r21.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("is") 
(declare-const var3029!2 String)
(assert (= var3029!2 (str.++ var3029!1 "is")))
(assert true)
(define-const var1840 String (append/672562846 var3640 var2433)) ; Statement: $r23 = virtualinvoke $r22.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r14) 
(declare-const var3640!1 String)
(assert (= var3640!1 (str.++ var3640 var2433)))
(assert true)
(define-const var2250 String (toString/-2075883882 var1840)) ; Statement: $r24 = virtualinvoke $r23.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var951 var2474 (var2891_get/1088891777 var3309 (cast-from-String-to-var2474 var2250))) ; Statement: $r25 = interfaceinvoke r7.<java.util.Map: java.lang.Object get(java.lang.Object)>($r24) 
(define-const var3807 var1110 (cast-from-var2474-to-var1110 var951)) ; Statement: r26 = (net.bytebuddy.description.method.MethodDescription) $r25 
 ; Statement: if r20 == null goto $r27 = staticinvoke <java.util.Optional: java.util.Optional ofNullable(java.lang.Object)>(r26) 
(assert (= var3770 null-var1110)) ; Cond: r20 == null 
(define-const var1823 var1644 (var1644_ofNullable/-1077078438 (cast-from-var1110-to-var2474 var3807))) ; Statement: $r27 = staticinvoke <java.util.Optional: java.util.Optional ofNullable(java.lang.Object)>(r26) 
