...
(assert (and true (and (>= var3552 0) (>= (str.len var2734) var3552))))
(define-const var3195 String (substring/850833817 var2734 var3552)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var2749 String (append/672562846 var1917 var3195)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var1917!1 String)
(assert (= var1917!1 (str.++ var1917 var3195)))
(assert true)
(define-const var677 String (toString/-2075883882 var2749)) ; Statement: r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var3589 var898 (resolveInHibernateNamespace/880302857 var3901 var677)) ; Statement: r8 = virtualinvoke r7.<org.hibernate.internal.util.xml.DTDEntityResolver: java.io.InputStream resolveInHibernateNamespace(java.lang.String)>(r6) 
...
(assert (not (not (= var3589 null-var898)))) ; Negate: Cond: r8 != null  
(define-const var371 var1148 var2054-LOG) ; Statement: $r12 = <org.hibernate.internal.util.xml.DTDEntityResolver: org.hibernate.internal.CoreMessageLogger LOG> 
;(assert (var1148_debugf/585189783 var371 "Unable to locate [%s] on classpath" (cast-from-String-to-var1271 var2734))) ; Statement: interfaceinvoke $r12.<org.hibernate.internal.CoreMessageLogger: void debugf(java.lang.String,java.lang.Object)>("Unable to locate [%s] on classpath", r1) 

(declare-const var371!1 var1148)
(declare-const var1475 String)
(declare-const var2734!1 String)
(assert true)
(define-const var1548 Int (length/-134980193 var1700)) ; Statement: $i1 = virtualinvoke r2.<java.lang.String: int length()>() 
(assert (and true (and (>= var1548 0) (>= (str.len var2734!1) var1548))))
(define-const var2312 String (substring/850833817 var2734!1 var1548)) ; Statement: $r13 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i1) 
(assert true)
(define-const var749 Int (indexOf/-1209756239 var2312 "2.0")) ; Statement: $i2 = virtualinvoke $r13.<java.lang.String: int indexOf(java.lang.String)>("2.0") 
(define-const var580 Int (cast-from-Int-to-Int (- 1))) ; Statement: $i4 = (int) -1 
 ; Statement: if $i2 <= $i4 goto return r15 
(assert (<= var749 var580)) ; Cond: $i2 <= $i4 
