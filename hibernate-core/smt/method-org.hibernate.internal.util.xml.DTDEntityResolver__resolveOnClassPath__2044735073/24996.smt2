...
(assert (and true (and (>= var1022 0) (>= (str.len var2617) var1022))))
(define-const var65 String (substring/850833817 var2617 var1022)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>($i0) 
(assert true)
(define-const var102 String (append/672562846 var1145 var65)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r3) 
(declare-const var1145!1 String)
(assert (= var1145!1 (str.++ var1145 var65)))
(assert true)
(define-const var2559 String (toString/-2075883882 var102)) ; Statement: r6 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var2596 var1401 (resolveInHibernateNamespace/880302857 var1200 var2559)) ; Statement: r8 = virtualinvoke r7.<org.hibernate.internal.util.xml.DTDEntityResolver: java.io.InputStream resolveInHibernateNamespace(java.lang.String)>(r6) 
 ; Statement: if r8 != null goto $r9 = <org.hibernate.internal.util.xml.DTDEntityResolver: org.hibernate.internal.CoreMessageLogger LOG> 
(assert (not (= var2596 null-var1401))) ; Cond: r8 != null 
(define-const var663 var2959 var1484-LOG) ; Statement: $r9 = <org.hibernate.internal.util.xml.DTDEntityResolver: org.hibernate.internal.CoreMessageLogger LOG> 
;(assert (var2959_debugf/585189783 var663 "Located [%s] in classpath" (cast-from-String-to-var1935 var2617))) ; Statement: interfaceinvoke $r9.<org.hibernate.internal.CoreMessageLogger: void debugf(java.lang.String,java.lang.Object)>("Located [%s] in classpath", r1) 

(declare-const var663!1 var2959)
(declare-const var3181 String)
(declare-const var2617!1 String)
(define-const var3599 var376 var376-init) ; Statement: $r17 = new org.xml.sax.InputSource 
(assert true)
;(assert (<init>/-1889831121 var3599 var2596)) ; Statement: specialinvoke $r17.<org.xml.sax.InputSource: void <init>(java.io.InputStream)>(r8) 

(declare-const var3599!1 var376)
(declare-const var2596!1 var1401)
(define-const var1961!1 var376 var3599!1) ; Statement: r15 = $r17 
(assert true)
;(assert (setPublicId/-915846722 var3599!1 var82)) ; Statement: virtualinvoke $r17.<org.xml.sax.InputSource: void setPublicId(java.lang.String)>(r11) 

(declare-const var3599!2 var376)
(declare-const var82!1 String)
(assert true)
;(assert (setSystemId/1014383032 var3599!2 var2617!1)) ; Statement: virtualinvoke $r17.<org.xml.sax.InputSource: void setSystemId(java.lang.String)>(r1) 

(declare-const var3599!3 var376)
