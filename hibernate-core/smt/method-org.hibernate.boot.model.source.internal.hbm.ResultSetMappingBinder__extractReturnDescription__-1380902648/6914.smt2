...
(assert (and true (and (>= 0 0) (>= (str.len var1863) var1220) (>= var1220 0))))
(define-const var794 String (substring/-1240304868 var1863 0 var1220)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
(define-const var386 var3509 (var2610_findEntityBinding/881271259 var1289 null-String var794)) ; Statement: $r5 = interfaceinvoke r2.<org.hibernate.boot.model.source.internal.hbm.HbmLocalMetadataBuildingContext: org.hibernate.mapping.PersistentClass findEntityBinding(java.lang.String,java.lang.String)>(null, $r4) 
(assert true)
(define-const var3108 String (getClassName/1810648442 var386)) ; Statement: r6 = virtualinvoke $r5.<org.hibernate.mapping.PersistentClass: java.lang.String getClassName()>() 
(assert true)
(define-const var1696 String (getRole/1433297865 var3800)) ; Statement: $r7 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryCollectionLoadReturnType: java.lang.String getRole()>() 
(define-const var1387 Int (+ var1220 1)) ; Statement: $i1 = i0 + 1 
(assert (and true (and (>= var1387 0) (>= (str.len var1696) var1387))))
(define-const var2894 String (substring/850833817 var1696 var1387)) ; Statement: r8 = virtualinvoke $r7.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var2228 var2707 var2707-init) ; Statement: $r21 = new org.hibernate.engine.query.spi.sql.NativeSQLQueryCollectionReturn 
(assert true)
(define-const var1955 String (getAlias/-830303573 var3800)) ; Statement: $r13 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryCollectionLoadReturnType: java.lang.String getAlias()>() 
(assert true)
(define-const var456 String (getAlias/-830303573 var3800)) ; Statement: $r10 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryCollectionLoadReturnType: java.lang.String getAlias()>() 
(define-const var3791 var3088 (var3025_extractPropertyResults/-1913882704 var456 (cast-from-var940-to-var1344 var3800) null-var3509 var1289)) ; Statement: $r12 = staticinvoke <org.hibernate.boot.model.source.internal.hbm.ResultSetMappingBinder: java.util.Map extractPropertyResults(java.lang.String,org.hibernate.boot.jaxb.hbm.spi.NativeQueryNonScalarRootReturn,org.hibernate.mapping.PersistentClass,org.hibernate.boot.model.source.internal.hbm.HbmLocalMetadataBuildingContext)>($r10, r0, null, r2) 
(assert true)
(define-const var253 var1980 (getLockMode/457134242 var3800)) ; Statement: $r11 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryCollectionLoadReturnType: org.hibernate.LockMode getLockMode()>() 
(assert true)
;(assert (<init>/2004484223 var2228 var1955 var3108 var2894 var3791 var253)) ; Statement: specialinvoke $r21.<org.hibernate.engine.query.spi.sql.NativeSQLQueryCollectionReturn: void <init>(java.lang.String,java.lang.String,java.lang.String,java.util.Map,org.hibernate.LockMode)>($r13, r6, r8, $r12, $r11) 

(declare-const var2228!1 var2707)
(declare-const var1955!1 String)
(declare-const var3108!1 String)
(declare-const var2894!1 String)
(declare-const var3791!1 var3088)
(declare-const var253!1 var1980)
