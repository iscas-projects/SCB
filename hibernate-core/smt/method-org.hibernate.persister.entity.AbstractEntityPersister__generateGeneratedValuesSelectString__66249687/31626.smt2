...
(assert (and true (and (>= 2 0) (>= (str.len var939) 2))))
(define-const var83 String (substring/850833817 var939 2)) ; Statement: $r37 = virtualinvoke $r36.<java.lang.String: java.lang.String substring(int)>(2) 
...
(assert (= var3631!1 ""))
(assert true)
(define-const var777 String (getRootAlias/-884767280 var2824)) ; Statement: $r12 = specialinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String getRootAlias()>() 
(assert true)
(define-const var3662 String (fromTableFragment/-838615174 (cast-from-var3672-to-var186 var2824) var777)) ; Statement: $r13 = virtualinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String fromTableFragment(java.lang.String)>($r12) 
(assert true)
(define-const var3573 String (append/672562846 var3631!1 var3662)) ; Statement: $r16 = virtualinvoke $r11.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r13) 
(declare-const var3631!2 String)
(assert (= var3631!2 (str.++ var3631!1 var3662)))
(assert true)
(define-const var3675 String (getRootAlias/-884767280 var2824)) ; Statement: $r14 = specialinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String getRootAlias()>() 
(assert true)
(define-const var2679 String (fromJoinFragment/-1778024351 var2824 var3675 (ite (= 1 1) true false) (ite (= 1 0) true false))) ; Statement: $r15 = virtualinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String fromJoinFragment(java.lang.String,boolean,boolean)>($r14, 1, 0) 
(assert true)
(define-const var2005 String (append/672562846 var3573 var2679)) ; Statement: $r17 = virtualinvoke $r16.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r15) 
(declare-const var3573!1 String)
(assert (= var3573!1 (str.++ var3573 var2679)))
(assert true)
(define-const var2686 String (toString/-2075883882 var2005)) ; Statement: $r38 = virtualinvoke $r17.<java.lang.StringBuilder: java.lang.String toString()>() 
(define-const var2682 String String-init) ; Statement: $r18 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2682)) ; Statement: specialinvoke $r18.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2682!1 String)
(assert (= var2682!1 ""))
(define-const var2561 String (String_join/-1520935655 (cast-from-String-to-String "=? and ") (cast-from-__Array__Int__String__-to-__Array__Int__String__ var469))) ; Statement: $r19 = staticinvoke <java.lang.String: java.lang.String join(java.lang.CharSequence,java.lang.CharSequence[])>("=? and ", $r35) 
(assert true)
(define-const var480 String (append/672562846 var2682!1 var2561)) ; Statement: $r20 = virtualinvoke $r18.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r19) 
(declare-const var2682!2 String)
(assert (= var2682!2 (str.++ var2682!1 var2561)))
(assert true)
(define-const var1181 String (append/672562846 var480 "=?")) ; Statement: $r23 = virtualinvoke $r20.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("=?") 
(declare-const var480!1 String)
(assert (= var480!1 (str.++ var480 "=?")))
(assert true)
(define-const var3913 String (getRootAlias/-884767280 var2824)) ; Statement: $r21 = specialinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String getRootAlias()>() 
(assert true)
(define-const var2243 String (whereJoinFragment/-433422514 var2824 var3913 (ite (= 1 1) true false) (ite (= 1 0) true false))) ; Statement: $r22 = virtualinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: java.lang.String whereJoinFragment(java.lang.String,boolean,boolean)>($r21, 1, 0) 
(assert true)
(define-const var3283 String (append/672562846 var1181 var2243)) ; Statement: $r24 = virtualinvoke $r23.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r22) 
(declare-const var1181!1 String)
(assert (= var1181!1 (str.++ var1181 var2243)))
(assert true)
(define-const var3385 String (toString/-2075883882 var3283)) ; Statement: $r39 = virtualinvoke $r24.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var1324 var1613 (setSelectClause/398150799 var2590!1 var83)) ; Statement: $r25 = virtualinvoke $r0.<org.hibernate.sql.Select: org.hibernate.sql.Select setSelectClause(java.lang.String)>($r37) 
(assert true)
(define-const var1907 var1613 (setFromClause/1818208161 var1324 var2686)) ; Statement: $r26 = virtualinvoke $r25.<org.hibernate.sql.Select: org.hibernate.sql.Select setFromClause(java.lang.String)>($r38) 
(assert true)
(define-const var1958 var1613 (setOuterJoins/840368943 var1907 "" "")) ; Statement: $r27 = virtualinvoke $r26.<org.hibernate.sql.Select: org.hibernate.sql.Select setOuterJoins(java.lang.String,java.lang.String)>("", "") 
(assert true)
(define-const var1543 var1613 (setWhereClause/1091603732 var1958 var3385)) ; Statement: $r28 = virtualinvoke $r27.<org.hibernate.sql.Select: org.hibernate.sql.Select setWhereClause(java.lang.String)>($r39) 
(assert true)
(define-const var2820 String (toStatementString/-1084413137 var1543)) ; Statement: $r29 = virtualinvoke $r28.<org.hibernate.sql.Select: java.lang.String toStatementString()>() 
