...
(assert (and true (and (>= 2 0) (>= (str.len var3015) 2))))
(define-const var1014 String (substring/850833817 var3015 2)) ; Statement: $r14 = virtualinvoke $r13.<java.lang.String: java.lang.String substring(int)>(2) 
(assert true)
;(assert (setSelectClause/398150799 var2376!1 var1014)) ; Statement: virtualinvoke $r10.<org.hibernate.sql.Select: org.hibernate.sql.Select setSelectClause(java.lang.String)>($r14) 

(declare-const var2376!2 var3127)
(declare-const var1014!1 String)
(assert true)
;(assert (setFromClause/1818208161 var2376!2 var2781)) ; Statement: virtualinvoke $r10.<org.hibernate.sql.Select: org.hibernate.sql.Select setFromClause(java.lang.String)>(r5) 

(declare-const var2376!3 var3127)
(declare-const var2781!1 String)
(assert true)
;(assert (setWhereClause/1091603732 var2376!3 var411)) ; Statement: virtualinvoke $r10.<org.hibernate.sql.Select: org.hibernate.sql.Select setWhereClause(java.lang.String)>(r4) 

(declare-const var2376!4 var3127)
(declare-const var411!1 String)
(assert true)
(define-const var3816 String (toFromFragmentString/701527262 var3637)) ; Statement: $r16 = virtualinvoke r6.<org.hibernate.sql.JoinFragment: java.lang.String toFromFragmentString()>() 
(assert true)
(define-const var2574 String (toWhereFragmentString/-1276368279 var3637)) ; Statement: $r15 = virtualinvoke r6.<org.hibernate.sql.JoinFragment: java.lang.String toWhereFragmentString()>() 
(assert true)
;(assert (setOuterJoins/840368943 var2376!4 var3816 var2574)) ; Statement: virtualinvoke $r10.<org.hibernate.sql.Select: org.hibernate.sql.Select setOuterJoins(java.lang.String,java.lang.String)>($r16, $r15) 

(declare-const var2376!5 var3127)
(declare-const var3816!1 String)
(declare-const var2574!1 String)
(assert true)
(define-const var3792 var2532 (getFactory/36801881 var1110)) ; Statement: $r17 = virtualinvoke r1.<org.hibernate.persister.entity.AbstractEntityPersister: org.hibernate.engine.spi.SessionFactoryImplementor getFactory()>() 
(define-const var1230 var3545 (var2940_getSessionFactoryOptions/-1909602825 (cast-from-var2532-to-var2940 var3792))) ; Statement: $r18 = interfaceinvoke $r17.<org.hibernate.engine.spi.SessionFactoryImplementor: org.hibernate.boot.spi.SessionFactoryOptions getSessionFactoryOptions()>() 
(define-const var2506 Bool (var3545_isCommentsEnabled/348952998 var1230)) ; Statement: $z0 = interfaceinvoke $r18.<org.hibernate.boot.spi.SessionFactoryOptions: boolean isCommentsEnabled()>() 
 ; Statement: if $z0 == 0 goto $r19 = virtualinvoke $r10.<org.hibernate.sql.Select: java.lang.String toStatementString()>() 
(assert (= (ite var2506 1 0) 0)) ; Cond: $z0 == 0 
(assert true)
(define-const var3909 String (toStatementString/-1084413137 var2376!5)) ; Statement: $r19 = virtualinvoke $r10.<org.hibernate.sql.Select: java.lang.String toStatementString()>() 
