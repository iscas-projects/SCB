...
(assert (and true (and (>= 1 0) (>= (str.len var1125) 1))))
(define-const var77 String (substring/850833817 var1125 1)) ; Statement: $r2 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(1) 
(assert true)
(define-const var3254 String (append/672562846 var823 var77)) ; Statement: $r4 = virtualinvoke $r3.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r2) 
(declare-const var823!1 String)
(assert (= var823!1 (str.++ var823 var77)))
(assert true)
(define-const var2842 String (toString/-2075883882 var3254)) ; Statement: $r5 = virtualinvoke $r4.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r5 
(check-sat)
(get-model)
(get-unsat-core)
