...
(assert (and true (and (>= 1 0) (>= (str.len var2351) 25) (>= 25 1))))
(define-const var18 String (substring/-1240304868 var2351 1 25)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int,int)>(1, 25) 
