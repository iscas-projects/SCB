...
(assert (and true (and (>= var930 0) (>= (str.len var3648) var930))))
(define-const var1599 String (substring/850833817 var3648 var930)) ; Statement: $r11 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i2) 
(assert true)
;(assert (append/672562846 var226!5 var1599)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r11) 
(declare-const var226!6 String)
(assert (= var226!6 (str.++ var226!5 var1599)))
 ; Statement: goto [?= $r14 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var3395 String (toString/-2075883882 var226!6)) ; Statement: $r14 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
