...
(assert (and true (and (>= var2438 0) (>= (str.len var428) var2438))))
(define-const var2763 String (substring/850833817 var428 var2438)) ; Statement: r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var3488 (Array Int String) arr-String-init) ; Statement: $r3 = newarray (java.lang.String)[2] 
(declare-const var3488!1 (Array Int String))
(assert (not (= var3488!1 null-__Array__Int__String__)))
(assert (= (select var3488!1 0) var1257)) ; Statement: $r3[0] = r1 
(declare-const var3488!2 (Array Int String))
(assert (not (= var3488!2 null-__Array__Int__String__)))
(assert (= (select var3488!2 1) var2763)) ; Statement: $r3[1] = r2 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
