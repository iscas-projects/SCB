...
(assert (and true (and (>= 1 0) (>= (str.len var3064) 1))))
(define-const var324!1 String (substring/850833817 var3064 1)) ; Statement: r24 = virtualinvoke $r19.<java.lang.String: java.lang.String substring(int)>(1) 
 ; Statement: goto [?= $r25 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder select>] 
(assert true) ; Non Conditional
(define-const var3136 String (select/-1123813506 var1671)) ; Statement: $r25 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder select> 
(assert true)
(define-const var920 String (toString/-2075883882 var3136)) ; Statement: $r26 = virtualinvoke $r25.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var642 String (append/672562846 var3440!2 var920)) ; Statement: $r27 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r26) 
(declare-const var3440!3 String)
(assert (= var3440!3 (str.++ var3440!2 var920)))
(assert true)
(define-const var3369 String (append/672562846 var642 " from")) ; Statement: $r28 = virtualinvoke $r27.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" from") 
(declare-const var642!1 String)
(assert (= var642!1 (str.++ var642 " from")))
(assert true)
;(assert (append/672562846 var3369 var324!1)) ; Statement: virtualinvoke $r28.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r24) 
(declare-const var3369!1 String)
(assert (= var3369!1 (str.++ var3369 var324!1)))
(define-const var2386 var3282 (joins/-1123813506 var1671)) ; Statement: $r29 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.sql.JoinFragment joins> 
(assert true)
(define-const var3939 String (toWhereFragmentString/-1276368279 var2386)) ; Statement: $r30 = virtualinvoke $r29.<org.hibernate.sql.JoinFragment: java.lang.String toWhereFragmentString()>() 
(assert true)
(define-const var3604 String (trim/-847153721 var3939)) ; Statement: $r31 = virtualinvoke $r30.<java.lang.String: java.lang.String trim()>() 
(define-const var780 String (where/-1123813506 var1671)) ; Statement: $r32 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder where> 
(assert true)
(define-const var3112 String (toString/-2075883882 var780)) ; Statement: $r33 = virtualinvoke $r32.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var725 String (trim/-847153721 var3112)) ; Statement: $r34 = virtualinvoke $r33.<java.lang.String: java.lang.String trim()>() 
(assert true)
(define-const var3503 Int (length/-134980193 var3604)) ; Statement: $i3 = virtualinvoke $r31.<java.lang.String: int length()>() 
 ; Statement: if $i3 <= 0 goto $z5 = 0 
(assert (not (<= var3503 0))) ; Negate: Cond: $i3 <= 0  
(define-const var3049 Bool (ite (= 1 1) true false)) ; Statement: $z5 = 1 
 ; Statement: goto [?= z3 = $z5] 
(assert true) ; Non Conditional
(define-const var366 Bool var3049) ; Statement: z3 = $z5 
(assert true)
(define-const var3667 Int (length/-134980193 var725)) ; Statement: $i0 = virtualinvoke $r34.<java.lang.String: int length()>() 
 ; Statement: if $i0 <= 0 goto $z8 = 0 
(assert (<= var3667 0)) ; Cond: $i0 <= 0 
(define-const var3359 Bool (ite (= 1 0) true false)) ; Statement: $z8 = 0 
(define-const var3375 Bool (ite (= 1 0) true false)) ; Statement: $z7 = 0 
(assert true) ; Non Conditional
(define-const var1607 Bool var3375) ; Statement: z4 = $z7 
 ; Statement: if z3 != 0 goto virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" where ") 
(assert (not (not (= (ite var366 1 0) 0)))) ; Negate: Cond: z3 != 0  
 ; Statement: if $z8 == 0 goto $r35 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder groupBy> 
(assert (= (ite var3359 1 0) 0)) ; Cond: $z8 == 0 
(define-const var2097 String (groupBy/-1123813506 var1671)) ; Statement: $r35 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder groupBy> 
(assert true)
(define-const var759 Int (length/-171891354 var2097)) ; Statement: $i4 = virtualinvoke $r35.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i4 <= 0 goto $r4 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder having> 
(assert (<= var759 0)) ; Cond: $i4 <= 0 
(define-const var1735 String (having/-1123813506 var1671)) ; Statement: $r4 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder having> 
(assert true)
(define-const var3664 Int (length/-171891354 var1735)) ; Statement: $i1 = virtualinvoke $r4.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i1 <= 0 goto $r5 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder orderBy> 
(assert (<= var3664 0)) ; Cond: $i1 <= 0 
(define-const var342 String (orderBy/-1123813506 var1671)) ; Statement: $r5 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder orderBy> 
(assert true)
(define-const var1168 Int (length/-171891354 var342)) ; Statement: $i2 = virtualinvoke $r5.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i2 <= 0 goto $r6 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.dialect.Dialect dialect> 
(assert (<= var1168 0)) ; Cond: $i2 <= 0 
(define-const var1580 var3439 (dialect/-1123813506 var1671)) ; Statement: $r6 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.dialect.Dialect dialect> 
(assert true)
(define-const var185 String (toString/-2075883882 var3440!3)) ; Statement: $r7 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var1745 String (transformSelectString/323702850 var1580 var185)) ; Statement: $r8 = virtualinvoke $r6.<org.hibernate.dialect.Dialect: java.lang.String transformSelectString(java.lang.String)>($r7) 
 ; Statement: return $r8 
(check-sat)
(get-model)
(get-unsat-core)
