...
(declare-fun comment/-1123813506 (var2139) String)
(define-fun append/672562846 ((s String) (tail String)) String (str.++ s tail))
(declare-fun distinct/-1123813506 (var2139) Bool)
(declare-fun joins/-1123813506 (var2139) var1881)
(declare-fun toFromFragmentString/701527262 (var1881) String)
(define-fun startsWith/-1785782452 ((s String) (prefix String)) Bool (str.prefixof prefix s))
(declare-fun select/-1123813506 (var2139) String)
...
(declare-fun where/-1123813506 (var2139) String)
(define-fun length/-134980193 ((s String)) Int (str.len s))
(declare-fun groupBy/-1123813506 (var2139) String)
(declare-fun length/-171891354 (String) Int)
(declare-fun having/-1123813506 (var2139) String)
(declare-fun orderBy/-1123813506 (var2139) String)
(declare-fun dialect/-1123813506 (var2139) var2648)
(declare-fun transformSelectString/323702850 (var2648 String) String)
(declare-const null-var2139 var2139)
(declare-const null-String String)
(declare-const var1061 var2139) ; Statement: r1 := @this: org.hibernate.sql.QuerySelect 
(assert (not (= var1061 null-var2139)))
(define-const var3604 String String-init) ; Statement: $r0 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/543593434 var3604 50)) ; Statement: specialinvoke $r0.<java.lang.StringBuilder: void <init>(int)>(50) 

(declare-const var3604!1 String)
(declare-const var2918 Int)
(define-const var2202 String (comment/-1123813506 var1061)) ; Statement: $r2 = r1.<org.hibernate.sql.QuerySelect: java.lang.String comment> 
...
(assert (= var2202 null-String)) ; Cond: $r2 == null 
(assert true)
;(assert (append/672562846 var3604!1 "select ")) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("select ") 
(declare-const var3604!2 String)
(assert (= var3604!2 (str.++ var3604!1 "select ")))
(define-const var1708 Bool (distinct/-1123813506 var1061)) ; Statement: $z0 = r1.<org.hibernate.sql.QuerySelect: boolean distinct> 
...
(define-const var818 var1881 (joins/-1123813506 var1061)) ; Statement: $r3 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.sql.JoinFragment joins> 
(assert true)
(define-const var648 String (toFromFragmentString/701527262 var818)) ; Statement: $r19 = virtualinvoke $r3.<org.hibernate.sql.JoinFragment: java.lang.String toFromFragmentString()>() 
(define-const var1415 String var648) ; Statement: r24 = $r19 
(assert true)
(define-const var3901 Bool (startsWith/-1785782452 var648 ",")) ; Statement: $z1 = virtualinvoke $r19.<java.lang.String: boolean startsWith(java.lang.String)>(",") 
 ; Statement: if $z1 == 0 goto $z2 = virtualinvoke $r19.<java.lang.String: boolean startsWith(java.lang.String)>(" inner join") 
(assert (= (ite var3901 1 0) 0)) ; Cond: $z1 == 0 
(assert true)
(define-const var3853 Bool (startsWith/-1785782452 var648 " inner join")) ; Statement: $z2 = virtualinvoke $r19.<java.lang.String: boolean startsWith(java.lang.String)>(" inner join") 
 ; Statement: if $z2 == 0 goto $r25 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder select> 
(assert (= (ite var3853 1 0) 0)) ; Cond: $z2 == 0 
(define-const var1048 String (select/-1123813506 var1061)) ; Statement: $r25 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder select> 
(assert true)
(define-const var3185 String (toString/-2075883882 var1048)) ; Statement: $r26 = virtualinvoke $r25.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var3059 String (append/672562846 var3604!2 var3185)) ; Statement: $r27 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r26) 
(declare-const var3604!3 String)
(assert (= var3604!3 (str.++ var3604!2 var3185)))
(assert true)
(define-const var3590 String (append/672562846 var3059 " from")) ; Statement: $r28 = virtualinvoke $r27.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" from") 
(declare-const var3059!1 String)
(assert (= var3059!1 (str.++ var3059 " from")))
(assert true)
;(assert (append/672562846 var3590 var1415)) ; Statement: virtualinvoke $r28.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r24) 
(declare-const var3590!1 String)
(assert (= var3590!1 (str.++ var3590 var1415)))
(define-const var615 var1881 (joins/-1123813506 var1061)) ; Statement: $r29 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.sql.JoinFragment joins> 
(assert true)
(define-const var1631 String (toWhereFragmentString/-1276368279 var615)) ; Statement: $r30 = virtualinvoke $r29.<org.hibernate.sql.JoinFragment: java.lang.String toWhereFragmentString()>() 
(assert true)
(define-const var2915 String (trim/-847153721 var1631)) ; Statement: $r31 = virtualinvoke $r30.<java.lang.String: java.lang.String trim()>() 
(define-const var971 String (where/-1123813506 var1061)) ; Statement: $r32 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder where> 
(assert true)
(define-const var3478 String (toString/-2075883882 var971)) ; Statement: $r33 = virtualinvoke $r32.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var353 String (trim/-847153721 var3478)) ; Statement: $r34 = virtualinvoke $r33.<java.lang.String: java.lang.String trim()>() 
(assert true)
(define-const var1622 Int (length/-134980193 var2915)) ; Statement: $i3 = virtualinvoke $r31.<java.lang.String: int length()>() 
 ; Statement: if $i3 <= 0 goto $z5 = 0 
(assert (<= var1622 0)) ; Cond: $i3 <= 0 
(define-const var830 Bool (ite (= 1 0) true false)) ; Statement: $z5 = 0 
(assert true) ; Non Conditional
(define-const var2403 Bool var830) ; Statement: z3 = $z5 
(assert true)
(define-const var3029 Int (length/-134980193 var353)) ; Statement: $i0 = virtualinvoke $r34.<java.lang.String: int length()>() 
 ; Statement: if $i0 <= 0 goto $z8 = 0 
(assert (<= var3029 0)) ; Cond: $i0 <= 0 
(define-const var15 Bool (ite (= 1 0) true false)) ; Statement: $z8 = 0 
(define-const var1544 Bool (ite (= 1 0) true false)) ; Statement: $z7 = 0 
(assert true) ; Non Conditional
(define-const var1546 Bool var1544) ; Statement: z4 = $z7 
 ; Statement: if z3 != 0 goto virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" where ") 
(assert (not (not (= (ite var2403 1 0) 0)))) ; Negate: Cond: z3 != 0  
 ; Statement: if $z8 == 0 goto $r35 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder groupBy> 
(assert (= (ite var15 1 0) 0)) ; Cond: $z8 == 0 
(define-const var2271 String (groupBy/-1123813506 var1061)) ; Statement: $r35 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder groupBy> 
(assert true)
(define-const var1921 Int (length/-171891354 var2271)) ; Statement: $i4 = virtualinvoke $r35.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i4 <= 0 goto $r4 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder having> 
(assert (<= var1921 0)) ; Cond: $i4 <= 0 
(define-const var1477 String (having/-1123813506 var1061)) ; Statement: $r4 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder having> 
(assert true)
(define-const var682 Int (length/-171891354 var1477)) ; Statement: $i1 = virtualinvoke $r4.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i1 <= 0 goto $r5 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder orderBy> 
(assert (<= var682 0)) ; Cond: $i1 <= 0 
(define-const var2746 String (orderBy/-1123813506 var1061)) ; Statement: $r5 = r1.<org.hibernate.sql.QuerySelect: java.lang.StringBuilder orderBy> 
(assert true)
(define-const var1363 Int (length/-171891354 var2746)) ; Statement: $i2 = virtualinvoke $r5.<java.lang.StringBuilder: int length()>() 
 ; Statement: if $i2 <= 0 goto $r6 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.dialect.Dialect dialect> 
(assert (<= var1363 0)) ; Cond: $i2 <= 0 
(define-const var544 var2648 (dialect/-1123813506 var1061)) ; Statement: $r6 = r1.<org.hibernate.sql.QuerySelect: org.hibernate.dialect.Dialect dialect> 
(assert true)
(define-const var1217 String (toString/-2075883882 var3604!3)) ; Statement: $r7 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
(define-const var832 String (transformSelectString/323702850 var544 var1217)) ; Statement: $r8 = virtualinvoke $r6.<org.hibernate.dialect.Dialect: java.lang.String transformSelectString(java.lang.String)>($r7) 
 ; Statement: return $r8 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var2139=org.hibernate.sql.QuerySelect, var1061=r1, var3604=$r0, var2918=50, var2202=$r2, var1939=null_type, var1708=$z0, var1881=org.hibernate.sql.JoinFragment, var818=$r3, var648=$r19, var1415=r24, var3901=$z1, var3853=$z2, var1048=$r25, var3185=$r26, var3059=$r27, var3590=$r28, var615=$r29, var1631=$r30, var2915=$r31, var971=$r32, var3478=$r33, var353=$r34, var1622=$i3, var830=$z5, var2403=z3, var3029=$i0, var15=$z8, var1544=$z7, var1546=z4, var2271=$r35, var1921=$i4, var1477=$r4, var682=$i1, var2746=$r5, var1363=$i2, var2648=org.hibernate.dialect.Dialect, var544=$r6, var1217=$r7, var832=$r8}
; {org.hibernate.sql.QuerySelect=var2139, r1=var1061, $r0=var3604, 50=var2918, $r2=var2202, null_type=var1939, $z0=var1708, org.hibernate.sql.JoinFragment=var1881, $r3=var818, $r19=var648, r24=var1415, $z1=var3901, $z2=var3853, $r25=var1048, $r26=var3185, $r27=var3059, $r28=var3590, $r29=var615, $r30=var1631, $r31=var2915, $r32=var971, $r33=var3478, $r34=var353, $i3=var1622, $z5=var830, z3=var2403, $i0=var3029, $z8=var15, $z7=var1544, z4=var1546, $r35=var2271, $i4=var1921, $r4=var1477, $i1=var682, $r5=var2746, $i2=var1363, org.hibernate.dialect.Dialect=var2648, $r6=var544, $r7=var1217, $r8=var832}
