...
(assert (and true (and (> (str.len var2319) 0) (<= 0 0))))
(define-const var2457 Int (charAt/698050440 var2319 0)) ; Statement: c0 = virtualinvoke r0.<java.lang.String: char charAt(int)>(0) 
(define-const var1684 String "`\u0022[") ; Statement: $r1 = "`\"[" 
(define-const var1331 Int (cast-from-Int-to-Int var2457)) ; Statement: $i3 = (int) c0 
(assert true)
(define-const var451 Int (indexOf/-1037706067 var1684 var1331)) ; Statement: i1 = virtualinvoke $r1.<java.lang.String: int indexOf(int)>($i3) 
(assert true)
(define-const var3758 String (getUnquotedAliasString/-449901868 var1216 var2319 var451)) ; Statement: r3 = specialinvoke r2.<org.hibernate.sql.Alias: java.lang.String getUnquotedAliasString(java.lang.String,int)>(r0, i1) 
 ; Statement: if i1 < 0 goto return r3 
(assert (< var451 0)) ; Cond: i1 < 0 
 ; Statement: return r3 
(check-sat)
(get-model)
(get-unsat-core)
