...
(assert (and true (and (>= 0 0) (>= (str.len var2038) var923) (>= var923 0))))
(define-const var1957 String (substring/-1240304868 var2038 0 var923)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.String: java.lang.String substring(int,int)>(0, $i1) 
(declare-const var1942!3 var2759)
(assert (not (= var1942!3 null-var2759)))
(assert (= (columnSpec/1732383027 var1942!3) var1957)) ; Statement: r0.<org.hibernate.hql.internal.ast.tree.IntoClause: java.lang.String columnSpec> = $r7 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
