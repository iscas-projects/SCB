...
(declare-fun toLowerCase/1946809429 (String var847) String)
...
(declare-const var847-ROOT var847)
(declare-const var3910 var476) ; Statement: r4 := @this: org.hibernate.dialect.Oracle8iDialect 
(assert (not (= var3910 null-var476)))
(declare-const var1408 String) ; Statement: r5 := @parameter0: java.lang.String 
(assert (not (= var1408 null-String)))
(declare-const var2354 Bool) ; Statement: z1 := @parameter1: boolean 
(assert (not (= var2354 null-Bool)))
(assert true)
(define-const var3790 String (trim/-847153721 var1408)) ; Statement: r6 = virtualinvoke r5.<java.lang.String: java.lang.String trim()>() 
(define-const var1343 Bool (ite (= 1 0) true false)) ; Statement: z2 = 0 
(define-const var3340 var847 var847-ROOT) ; Statement: $r0 = <java.util.Locale: java.util.Locale ROOT> 
(assert true)
(define-const var2684 String (toLowerCase/1946809429 var3790 var3340)) ; Statement: $r1 = virtualinvoke r6.<java.lang.String: java.lang.String toLowerCase(java.util.Locale)>($r0) 
(assert true)
(define-const var3970 Bool (endsWith/985337093 var2684 " for update")) ; Statement: $z0 = virtualinvoke $r1.<java.lang.String: boolean endsWith(java.lang.String)>(" for update") 
 ; Statement: if $z0 == 0 goto $r2 = new java.lang.StringBuilder 
(assert (= (ite var3970 1 0) 0)) ; Cond: $z0 == 0 
(define-const var1096 String String-init) ; Statement: $r2 = new java.lang.StringBuilder 
(assert true)
(define-const var2132 Int (length/-134980193 var3790)) ; Statement: $i0 = virtualinvoke r6.<java.lang.String: int length()>() 
(define-const var1159 Int (+ var2132 100)) ; Statement: $i1 = $i0 + 100 
(assert true)
;(assert (<init>/543593434 var1096 var1159)) ; Statement: specialinvoke $r2.<java.lang.StringBuilder: void <init>(int)>($i1) 
...
(assert (= (ite var2354 1 0) 0)) ; Cond: z1 == 0 
(assert true)
;(assert (append/672562846 var1096!1 "select * from ( ")) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("select * from ( ") 
(declare-const var1096!2 String)
(assert (= var1096!2 (str.++ var1096!1 "select * from ( ")))
(assert true) ; Non Conditional
(assert true)
;(assert (append/672562846 var1096!2 var3790)) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r6) 
(declare-const var1096!3 String)
(assert (= var1096!3 (str.++ var1096!2 var3790)))
...
(assert (= (ite var2354 1 0) 0)) ; Cond: z1 == 0 
(assert true)
;(assert (append/672562846 var1096!3 " ) where rownum <= ?")) ; Statement: virtualinvoke $r2.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" ) where rownum <= ?") 
(declare-const var1096!4 String)
(assert (= var1096!4 (str.++ var1096!3 " ) where rownum <= ?")))
(assert true) ; Non Conditional
 ; Statement: if z2 == 0 goto $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (= (ite var1343 1 0) 0)) ; Cond: z2 == 0 
(assert true)
(define-const var2679 String (toString/-2075883882 var1096!4)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
...
; {var476=org.hibernate.dialect.Oracle8iDialect, var3910=r4, var1408=r5, var2000=null_type, var2354=z1, var3790=r6, var1343=z2, var847=java.util.Locale, var3340=$r0, var2684=$r1, var3970=$z0, var1096=$r2, var2132=$i0, var1159=$i1, var2679=$r3}
; {org.hibernate.dialect.Oracle8iDialect=var476, r4=var3910, r5=var1408, null_type=var2000, z1=var2354, r6=var3790, z2=var1343, java.util.Locale=var847, $r0=var3340, $r1=var2684, $z0=var3970, $r2=var1096, $i0=var2132, $i1=var1159, $r3=var2679}
