...
(assert (and true (and (>= var2829 0) (>= (str.len var2453) var2162) (>= var2162 var2829))))
(define-const var1133 String (substring/-1240304868 var2453 var2829 var2162)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>($i2, $i1) 
