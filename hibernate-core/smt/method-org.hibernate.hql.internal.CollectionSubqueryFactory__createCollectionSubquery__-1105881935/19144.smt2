...
(assert (and true (and (>= 5 0) (>= (str.len var2231) 5))))
(define-const var1619 String (substring/850833817 var2231 5)) ; Statement: $r13 = virtualinvoke $r12.<java.lang.String: java.lang.String substring(int)>(5) 
(assert true)
(define-const var1699 String (append/672562846 var270 var1619)) ; Statement: $r15 = virtualinvoke $r14.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r13) 
(declare-const var270!1 String)
(assert (= var270!1 (str.++ var270 var1619)))
(assert true)
(define-const var2255 String (toString/-2075883882 var1699)) ; Statement: $r16 = virtualinvoke $r15.<java.lang.StringBuilder: java.lang.String toString()>() 
