...
(assert (and true (and (>= var3543 0) (>= (str.len var1119) var3543))))
(define-const var1509 String (substring/850833817 var1119 var3543)) ; Statement: r5 = virtualinvoke $r4.<java.lang.String: java.lang.String substring(int)>($i1) 
(define-const var1240 var54 var54-init) ; Statement: $r19 = new org.hibernate.engine.query.spi.sql.NativeSQLQueryJoinReturn 
(assert true)
(define-const var3146 String (getAlias/1869527025 var386)) ; Statement: $r11 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryJoinReturnType: java.lang.String getAlias()>() 
(assert true)
(define-const var361 String (getAlias/1869527025 var386)) ; Statement: $r8 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryJoinReturnType: java.lang.String getAlias()>() 
(define-const var3177 var1073 (var2368_extractPropertyResults/-1913882704 var361 (cast-from-var478-to-var2748 var386) null-var68 var594)) ; Statement: $r10 = staticinvoke <org.hibernate.boot.model.source.internal.hbm.ResultSetMappingBinder: java.util.Map extractPropertyResults(java.lang.String,org.hibernate.boot.jaxb.hbm.spi.NativeQueryNonScalarRootReturn,org.hibernate.mapping.PersistentClass,org.hibernate.boot.model.source.internal.hbm.HbmLocalMetadataBuildingContext)>($r8, r0, null, r7) 
(assert true)
(define-const var3886 var2713 (getLockMode/759282204 var386)) ; Statement: $r9 = virtualinvoke r0.<org.hibernate.boot.jaxb.hbm.spi.JaxbHbmNativeQueryJoinReturnType: org.hibernate.LockMode getLockMode()>() 
(assert true)
;(assert (<init>/-1350977741 var1240 var3146 var781 var1509 var3177 var3886)) ; Statement: specialinvoke $r19.<org.hibernate.engine.query.spi.sql.NativeSQLQueryJoinReturn: void <init>(java.lang.String,java.lang.String,java.lang.String,java.util.Map,org.hibernate.LockMode)>($r11, r3, r5, $r10, $r9) 

(declare-const var1240!1 var54)
(declare-const var3146!1 String)
(declare-const var781!1 String)
(declare-const var1509!1 String)
(declare-const var3177!1 var1073)
(declare-const var3886!1 var2713)
