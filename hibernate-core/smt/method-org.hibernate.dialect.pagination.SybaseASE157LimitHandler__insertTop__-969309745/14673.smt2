...
(assert (and true (and (>= var2744 0) (>= (str.len var2282) var2744))))
(define-const var902 String (substring/850833817 var2282 var2744)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i0) 
(assert true)
(define-const var210 var245 (matcher/468719934 var3845 (cast-from-String-to-String var902))) ; Statement: $r4 = virtualinvoke $r2.<java.util.regex.Pattern: java.util.regex.Matcher matcher(java.lang.CharSequence)>($r3) 
(assert true)
(define-const var3560 Bool (matches/-149940873 var210)) ; Statement: $z0 = virtualinvoke $r4.<java.util.regex.Matcher: boolean matches()>() 
 ; Statement: if $z0 == 0 goto $r5 = new java.lang.StringBuilder 
(assert (not (= (ite var3560 1 0) 0))) ; Negate: Cond: $z0 == 0  
 ; Statement: return r1 
(check-sat)
(get-model)
(get-unsat-core)
