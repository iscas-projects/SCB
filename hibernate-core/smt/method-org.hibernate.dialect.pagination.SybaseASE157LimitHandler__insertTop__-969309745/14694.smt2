...
(assert (and true (and (>= var3200 0) (>= (str.len var512) var3200))))
(define-const var1383 String (substring/850833817 var512 var3200)) ; Statement: $r3 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i0) 
(assert true)
(define-const var2592 var1300 (matcher/468719934 var3987 (cast-from-String-to-String var1383))) ; Statement: $r4 = virtualinvoke $r2.<java.util.regex.Pattern: java.util.regex.Matcher matcher(java.lang.CharSequence)>($r3) 
(assert true)
(define-const var115 Bool (matches/-149940873 var2592)) ; Statement: $z0 = virtualinvoke $r4.<java.util.regex.Matcher: boolean matches()>() 
 ; Statement: if $z0 == 0 goto $r5 = new java.lang.StringBuilder 
(assert (= (ite var115 1 0) 0)) ; Cond: $z0 == 0 
(define-const var1240 String String-init) ; Statement: $r5 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/-1061048412 var1240 var512)) ; Statement: specialinvoke $r5.<java.lang.StringBuilder: void <init>(java.lang.String)>(r1) 
(declare-const var1240!1 String)
(assert (= var1240!1 var512))
(define-const var2390 String String-init) ; Statement: $r6 = new java.lang.StringBuilder 
(assert true)
;(assert (<init>/1968657023 var2390)) ; Statement: specialinvoke $r6.<java.lang.StringBuilder: void <init>()>() 
(declare-const var2390!1 String)
(assert (= var2390!1 ""))
(assert true)
(define-const var1482 String (append/672562846 var2390!1 "top ")) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("top ") 
(declare-const var2390!2 String)
(assert (= var2390!2 (str.++ var2390!1 "top ")))
(assert true)
(define-const var8 String (append/-1001720160 var1482 var651)) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(int)>(i1) 
(declare-const var1482!1 String)
(assert (str.prefixof var1482 var1482!1))
(assert true)
(define-const var1589 String (append/672562846 var8 " ")) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" ") 
(declare-const var8!1 String)
(assert (= var8!1 (str.++ var8 " ")))
(assert true)
(define-const var1725 String (toString/-2075883882 var1589)) ; Statement: $r10 = virtualinvoke $r9.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert true)
;(assert (insert/1196171004 var1240!1 var3200 var1725)) ; Statement: virtualinvoke $r5.<java.lang.StringBuilder: java.lang.StringBuilder insert(int,java.lang.String)>(i0, $r10) 

(declare-const var1240!2 String)
(declare-const var3200!1 Int)
(declare-const var1725!1 String)
(assert true)
(define-const var1242 String (toString/-2075883882 var1240!2)) ; Statement: $r11 = virtualinvoke $r5.<java.lang.StringBuilder: java.lang.String toString()>() 
