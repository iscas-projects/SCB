...
(assert (and true (and (>= 0 0) (>= (str.len var1920) var3731) (>= var3731 0))))
(define-const var637 String (substring/-1240304868 var1920 0 var3731)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(0, i0) 
