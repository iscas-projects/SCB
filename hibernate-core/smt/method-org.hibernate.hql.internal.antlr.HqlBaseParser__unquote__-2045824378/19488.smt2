...
(assert (and true (and (>= 1 0) (>= (str.len var1764) var412) (>= var412 1))))
(define-const var1880 String (substring/-1240304868 var1764 1 var412)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(1, $i1) 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
