...
(assert (and true (and (>= var1078 0) (>= (str.len var3550) var1078))))
(define-const var3902 String (substring/850833817 var3550 var1078)) ; Statement: $r3 = virtualinvoke r2.<java.lang.String: java.lang.String substring(int)>($i1) 
(declare-const var1503!3 var3587)
(assert (not (= var1503!3 null-var3587)))
(assert (= (propertyName/-1130545024 var1503!3) var3902)) ; Statement: r0.<org.hibernate.property.access.internal.PropertyAccessStrategyIndexBackRefImpl: java.lang.String propertyName> = $r3 
 ; Statement: return 
(check-sat)
(get-model)
(get-unsat-core)
