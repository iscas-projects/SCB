...
(assert (and true (and (> (str.len var3383) var951) (<= 0 var951))))
(define-const var2496 Int (charAt/698050440 var3383 var951)) ; Statement: $c2 = virtualinvoke r11.<java.lang.String: char charAt(int)>($i1) 
(define-const var857 Bool (var3348_isDigit/-731660569 var2496)) ; Statement: $z0 = staticinvoke <java.lang.Character: boolean isDigit(char)>($c2) 
 ; Statement: if $z0 == 0 goto return r11 
(assert (= (ite var857 1 0) 0)) ; Cond: $z0 == 0 
