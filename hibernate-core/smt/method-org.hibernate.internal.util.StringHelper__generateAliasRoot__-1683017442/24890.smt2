...
(assert (and true (and (> (str.len var3934) var3420) (<= 0 var3420))))
(define-const var3126 Int (charAt/698050440 var3934 var3420)) ; Statement: $c2 = virtualinvoke r11.<java.lang.String: char charAt(int)>($i1) 
(define-const var1530 Bool (var736_isDigit/-731660569 var3126)) ; Statement: $z0 = staticinvoke <java.lang.Character: boolean isDigit(char)>($c2) 
...
(assert (= var244!1 ""))
(assert true)
(define-const var716 String (append/672562846 var244!1 var3934)) ; Statement: $r7 = virtualinvoke $r6.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(r11) 
(declare-const var244!2 String)
(assert (= var244!2 (str.++ var244!1 var3934)))
(assert true)
(define-const var2874 String (append/672562846 var716 "x")) ; Statement: $r8 = virtualinvoke $r7.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>("x") 
(declare-const var716!1 String)
(assert (= var716!1 (str.++ var716 "x")))
(assert true)
(define-const var1488 String (toString/-2075883882 var2874)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.StringBuilder: java.lang.String toString()>() 
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
