...
(assert (and true (and (>= 1 0) (>= (str.len var2387) 1))))
(define-const var1335 String (substring/850833817 var2387 1)) ; Statement: $r2 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int)>(1) 
