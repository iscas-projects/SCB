...
(assert (and true (and (>= 1 0) (>= (str.len var3678) var128) (>= var128 1))))
(define-const var903 String (substring/-1240304868 var3678 1 var128)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String substring(int,int)>(1, $i1) 
