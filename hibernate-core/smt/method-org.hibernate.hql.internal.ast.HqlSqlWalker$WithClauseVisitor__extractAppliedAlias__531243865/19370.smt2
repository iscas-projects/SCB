...
(assert (and true (and (>= 0 0) (>= (str.len var3952) var643) (>= var643 0))))
(define-const var446 String (substring/-1240304868 var3952 0 var643)) ; Statement: $r3 = virtualinvoke $r2.<java.lang.String: java.lang.String substring(int,int)>(0, $i0) 
 ; Statement: return $r3 
(check-sat)
(get-model)
(get-unsat-core)
