...
(assert (and true (and (>= 2 0) (>= (str.len var2383) 2))))
(define-const var3458 String (substring/850833817 var2383 2)) ; Statement: $r9 = virtualinvoke $r8.<java.lang.String: java.lang.String substring(int)>(2) 
 ; Statement: return $r9 
(check-sat)
(get-model)
(get-unsat-core)
