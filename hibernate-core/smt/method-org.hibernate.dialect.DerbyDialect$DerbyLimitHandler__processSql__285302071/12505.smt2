...
(assert (and true (and (>= 0 0) (>= (str.len var2394) var301) (>= var301 0))))
(define-const var2754 String (substring/-1240304868 var2394 0 var301)) ; Statement: $r21 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i7) 
(assert true)
;(assert (append/672562846 var1785!1 var2754)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r21) 
(declare-const var1785!2 String)
(assert (= var1785!2 (str.++ var1785!1 var2754)))
...
(define-const var757 Bool (var3287_hasFirstRow/-2097898482 var262)) ; Statement: $z4 = staticinvoke <org.hibernate.dialect.pagination.LimitHelper: boolean hasFirstRow(org.hibernate.engine.spi.RowSelection)>(r8) 
...
(assert (not (= (ite var757 1 0) 0))) ; Negate: Cond: $z4 == 0  
(assert true)
(define-const var887 String (append/672562846 var1785!2 " offset ")) ; Statement: $r17 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" offset ") 
(declare-const var1785!3 String)
(assert (= var1785!3 (str.++ var1785!2 " offset ")))
(assert true)
(define-const var2596 Int (getFirstRow/1410679095 var262)) ; Statement: $r16 = virtualinvoke r8.<org.hibernate.engine.spi.RowSelection: java.lang.Integer getFirstRow()>() 
(assert true)
(define-const var3973 String (append/-1031950772 var887 (cast-from-Int-to-var540 var2596))) ; Statement: $r18 = virtualinvoke $r17.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.Object)>($r16) 
(declare-const var887!1 String)
(assert (str.prefixof var887 var887!1))
(assert true)
;(assert (append/672562846 var3973 " rows fetch next ")) ; Statement: virtualinvoke $r18.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" rows fetch next ") 
(declare-const var3973!1 String)
(assert (= var3973!1 (str.++ var3973 " rows fetch next ")))
...
(assert true) ; Non Conditional
(assert true)
(define-const var2971 Int (getMaxOrLimit/1324675775 (cast-from-var2597-to-var938 var3712) var262)) ; Statement: $i3 = virtualinvoke r5.<org.hibernate.dialect.DerbyDialect$DerbyLimitHandler: int getMaxOrLimit(org.hibernate.engine.spi.RowSelection)>(r8) 
(assert true)
(define-const var3140 String (append/-1001720160 var1785!3 var2971)) ; Statement: $r9 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(int)>($i3) 
(declare-const var1785!4 String)
(assert (str.prefixof var1785!3 var1785!4))
(assert true)
;(assert (append/672562846 var3140 " rows only")) ; Statement: virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" rows only") 
(declare-const var3140!1 String)
(assert (= var3140!1 (str.++ var3140 " rows only")))
(define-const var3651 var1717 (this$0/-1977892673 var3712)) ; Statement: $r10 = r5.<org.hibernate.dialect.DerbyDialect$DerbyLimitHandler: org.hibernate.dialect.DerbyDialect this$0> 
(define-const var2582 Bool (var1717_access$100/247021877 var3651 var687)) ; Statement: $z2 = staticinvoke <org.hibernate.dialect.DerbyDialect: boolean access$100(org.hibernate.dialect.DerbyDialect,int)>($r10, i2) 
...
(assert true)
;(assert (append/-1166366385 var1785!4 32)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(char)>(32) 
(declare-const var1785!5 String)
(assert (str.prefixof var1785!4 var1785!5))
(assert (and true (and (>= var687 0) (>= (str.len var2394) var687))))
(define-const var1980 String (substring/850833817 var2394 var687)) ; Statement: $r15 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int)>(i2) 
(assert true)
;(assert (append/672562846 var1785!5 var1980)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r15) 
(declare-const var1785!6 String)
(assert (= var1785!6 (str.++ var1785!5 var1980)))
 ; Statement: goto [?= $r22 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>()] 
(assert true) ; Non Conditional
(assert true)
(define-const var603 String (toString/-2075883882 var1785!6)) ; Statement: $r22 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
