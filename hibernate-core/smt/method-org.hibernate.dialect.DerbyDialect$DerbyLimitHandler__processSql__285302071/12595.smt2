...
(assert (and true (and (>= 0 0) (>= (str.len var1819) var1404) (>= var1404 0))))
(define-const var2393 String (substring/-1240304868 var1819 0 var1404)) ; Statement: $r21 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(0, $i7) 
(assert true)
;(assert (append/672562846 var1921!1 var2393)) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>($r21) 
(declare-const var1921!2 String)
(assert (= var1921!2 (str.++ var1921!1 var2393)))
...
(define-const var3756 Bool (var1569_hasFirstRow/-2097898482 var3353)) ; Statement: $z4 = staticinvoke <org.hibernate.dialect.pagination.LimitHelper: boolean hasFirstRow(org.hibernate.engine.spi.RowSelection)>(r8) 
...
(assert (= (ite var3756 1 0) 0)) ; Cond: $z4 == 0 
(assert true)
;(assert (append/672562846 var1921!2 " fetch first ")) ; Statement: virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" fetch first ") 
(declare-const var1921!3 String)
(assert (= var1921!3 (str.++ var1921!2 " fetch first ")))
(assert true) ; Non Conditional
(assert true)
(define-const var351 Int (getMaxOrLimit/1324675775 (cast-from-var1252-to-var121 var1622) var3353)) ; Statement: $i3 = virtualinvoke r5.<org.hibernate.dialect.DerbyDialect$DerbyLimitHandler: int getMaxOrLimit(org.hibernate.engine.spi.RowSelection)>(r8) 
(assert true)
(define-const var278 String (append/-1001720160 var1921!3 var351)) ; Statement: $r9 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.StringBuilder append(int)>($i3) 
(declare-const var1921!4 String)
(assert (str.prefixof var1921!3 var1921!4))
(assert true)
;(assert (append/672562846 var278 " rows only")) ; Statement: virtualinvoke $r9.<java.lang.StringBuilder: java.lang.StringBuilder append(java.lang.String)>(" rows only") 
(declare-const var278!1 String)
(assert (= var278!1 (str.++ var278 " rows only")))
(define-const var2731 var488 (this$0/-1977892673 var1622)) ; Statement: $r10 = r5.<org.hibernate.dialect.DerbyDialect$DerbyLimitHandler: org.hibernate.dialect.DerbyDialect this$0> 
(define-const var2047 Bool (var488_access$100/247021877 var2731 var3130)) ; Statement: $z2 = staticinvoke <org.hibernate.dialect.DerbyDialect: boolean access$100(org.hibernate.dialect.DerbyDialect,int)>($r10, i2) 
...
(assert (= (ite var2047 1 0) 0)) ; Cond: $z2 == 0 
(define-const var3114 var488 (this$0/-1977892673 var1622)) ; Statement: $r11 = r5.<org.hibernate.dialect.DerbyDialect$DerbyLimitHandler: org.hibernate.dialect.DerbyDialect this$0> 
(define-const var101 Bool (var488_access$200/2019219242 var3114 var3979)) ; Statement: $z3 = staticinvoke <org.hibernate.dialect.DerbyDialect: boolean access$200(org.hibernate.dialect.DerbyDialect,java.lang.String)>($r11, r4) 
 ; Statement: if $z3 == 0 goto $r22 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
(assert (= (ite var101 1 0) 0)) ; Cond: $z3 == 0 
(assert true)
(define-const var1949 String (toString/-2075883882 var1921!4)) ; Statement: $r22 = virtualinvoke $r0.<java.lang.StringBuilder: java.lang.String toString()>() 
