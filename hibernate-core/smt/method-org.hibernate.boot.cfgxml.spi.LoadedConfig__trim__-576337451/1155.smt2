...
(declare-const var3736 String) ; Statement: r0 := @parameter0: java.lang.String 
(assert (not (= var3736 null-String)))
 ; Statement: if r0 != null goto $r1 = virtualinvoke r0.<java.lang.String: java.lang.String trim()>() 
(assert (not (= var3736 null-String))) ; Cond: r0 != null 
(assert true)
(define-const var3057 String (trim/-847153721 var3736)) ; Statement: $r1 = virtualinvoke r0.<java.lang.String: java.lang.String trim()>() 
 ; Statement: return $r1 
(check-sat)
(get-model)
(get-unsat-core)
; {trim/-847153721=([java.lang.String], java.lang.String)}
; {var3736=r0, var3554=null_type, var3057=$r1}
; {r0=var3736, null_type=var3554, $r1=var3057}
