...
(assert (and true (and (>= var907 0) (>= (str.len var2133) var3558) (>= var3558 var907))))
(define-const var287 String (substring/-1240304868 var2133 var907 var3558)) ; Statement: $r5 = virtualinvoke r1.<java.lang.String: java.lang.String substring(int,int)>(i0, i1) 
 ; Statement: goto [?= r2 = $r5] 
(assert true) ; Non Conditional
(define-const var124 String var287) ; Statement: r2 = $r5 
(define-const var600 var596 var1055-LOG) ; Statement: $r3 = <org.hibernate.engine.spi.SubselectFetch: org.hibernate.internal.CoreMessageLogger LOG> 
(define-const var3122 Bool (var596_isTraceEnabled/-699489552 var600)) ; Statement: $z0 = interfaceinvoke $r3.<org.hibernate.internal.CoreMessageLogger: boolean isTraceEnabled()>() 
